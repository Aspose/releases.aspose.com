---
title: "Aspose.diagram | Βιβλιοθήκη Java για να δημιουργήσετε, να εξαγάγετε έγγραφα Visio" 
...
- Linux
- Unix
family_listing_page_title: "Aspose.diagram για java" 
family_listing_page_description: "Το Aspose.Diagram για το Java είναι ένα εύχρηστο API JAVA που επιτρέπει στους προγραμματιστές να δημιουργούν, να χειρίζονται και να μετατρέπουν φυσικές μορφές αρχείων οχημάτων από τις εφαρμογές Java και χωρίς να χρειάζεται να βασίζονται στο Microsoft Visio ®." 
