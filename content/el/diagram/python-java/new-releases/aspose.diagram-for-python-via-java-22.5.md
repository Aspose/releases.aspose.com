---
title: "Λήψεις ---New-Releases-aspose.diagram-for-python-via-java-22.5."
description:  "    . " 
keywords:  "    . " 
page_type:  single_release_page
folder_link: " diagram/python-java/new-releases/aspose.diagram-for-python-via-java-22.5/"
folder_name: "Aspose.Διάγραμμα για Python μέσω Java 22.5"
...
Intro_text: "Περιέχει Aspose.Diagram για Python μέσω έκδοσης Java 22.5."
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.Διάγραμμα για Python μέσω Java 22.5" imagelink="/resources/img/zip-icon.png">}}
  ...
  {{< Releases/ReleasesFileFeatures >}}
      <h4>Σημειώσεις έκδοσης</h4><div> <a href="https://docs.aspose.com/diagram/java/aspose-diagram-for-python-via-java-22-5-release-notes/">https://docs.aspose.com/diagram/java/aspose-diagram-for-python-via-java-22-5-release-notes/</a></div>
  {{< /Releases/ReleasesFileFeatures >}}
 {{< /Releases/ReleasesFileArea >}}
{{< /Releases/ReleasesWapper >}}
