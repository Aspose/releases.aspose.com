---
title: "Βελτιστοποιημένη ταχύτητα αλλαγής μεγέθους εικόνας μέσω API για εφαρμογές C#, ASP.NET"
description: "C# .NET API με μεγαλύτερη ταχύτητα αλλαγής μεγέθους εικόνας, εκτέλεση εικονοστοιχείων τέλεια και ακριβή στοίχιση κειμένου, βελτιωμένη κάλυψη δοκιμής υποδειγματοληψίας YCbCr σε RGb για Jpeg2000."
keywords: ""
page_type: single_release_page
folder_link: " imaging/net/new-releases/aspose.imaging-for-.net-22.2/"
folder_name: "Aspose.Imaging για .NET 22.2"
download_link: " /imaging/net/new-releases/aspose.imaging-for-.net-22.2/0b3fdb9d409842d8906d3454587476bb"
download_text: " Download"
Intro_text: "Περιέχει Aspose.Imaging για έκδοση .NET 22.2."
...
{{< Releases/ReleasesHeading H2txt="Aspose.Imaging για .NET 22.2" imagelink="/resources/img/msi-icon.png">}}
...
<h4>Σημειώσεις έκδοσης</h4><div> <a href="https://releases.aspose.com/imaging/net/release-notes/2022/aspose-imaging-for-net-22-2-release-notes/">https://releases.aspose.com/imaging/net/release-notes/2022/aspose-imaging-for-net-22-2-release-notes/</a></div>
{{< /Releases/ReleasesFileFeatures >}}
...
Για μια πλήρη λίστα λειτουργιών, βελτιώσεων και επιδιορθώσεων σφαλμάτων σε αυτήν την έκδοση, επισκεφτείτε τη διεύθυνση [Aspose.Imaging for .NET 22.2](http://localhost:1313/imaging/net/new-releases/aspose.imaging-for-.net-22.2/).
