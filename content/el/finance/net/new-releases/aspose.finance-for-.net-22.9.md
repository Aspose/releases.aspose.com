---
title: "GroupDocs Support for Financial Format API for C#, .NET Apps"
description: "C# .NET API που τώρα έρχεται με την πρόσθετη υποστήριξη του GroupDocs. Βελτιωμένο API επεξεργασίας και χειρισμού ψηφιακών μορφών οικονομικών δεδομένων υψηλού κωδικού εσωτερικής εγκατάστασης."
keywords: ""
page_type: single_release_page
folder_link: "/finance/net/new-releases/aspose.finance-for-.net-22.9/"
folder_name: "Aspose.Finance για .NET 22.9"
download_link: "/finance/net/new-releases/aspose.finance-for-.net-22.9/a24dcaf17dd88a38c56751460addd6bf-2-7920"
download_text: "Download"
Intro_text: "Aspose.Finance για .NET 22.9"
...
{{< Releases/ReleasesHeading H2txt="Aspose.Finance για .NET 22.9" imagelink="/resources/img/msi-icon.png">}}
...
<h4>Σημειώσεις έκδοσης</h4><div> <a href='https://releases.aspose.com/finance/net/release-notes/2022/aspose-finance-for-net-22-9-release-notes/'>https://releases.aspose.com/finance/net/release-notes/2022/aspose-finance-for-net-22-9-release-notes/</a></div>
{{< /Releases/ReleasesFileFeatures >}}
{{< Releases/ReleasesFileFeatures >}}
...
# Υποστήριξη GroupDocs

Προστέθηκε η υποστήριξη GroupDocs.

> Για μια πλήρη λίστα λειτουργιών, βελτιώσεων και διορθώσεων σφαλμάτων σε αυτήν την έκδοση, επισκεφτείτε τη διεύθυνση [Aspose.Finance for .NET 22.9 Release Notes](https://releases.aspose.com/finance/net/release-notes/2022/aspose-finance-for-net-22-9-release-notes/).
