---
title: "Επικύρωση στοιχείων Schemaref στο XBRL API για εφαρμογές C#, ASP.NET"
description: "C# .NET API με υποστήριξη για επικύρωση των? Στοιχεία Schemaref, χαρακτηριστικό ID στοιχείου περιβάλλοντος και υποστοιχείο οντότητας στο στοιχείο περιβάλλοντος στα αρχεία «XBRL»."
keywords: ""
page_type: single_release_page
folder_link: "/finance/net/new-releases/aspose.finance-for-.net-22.7/"
folder_name: "Aspose.Finance για .NET 22.7"
download_link: "/finance/net/new-releases/aspose.finance-for-.net-22.7/ed035dc3cdf99d153301c6b7499e8694-2-7696"
download_text: "Download"
Intro_text: "Aspose.Finance για .NET 22.7"
...
{{< Releases/ReleasesHeading H2txt="Aspose.Finance για .NET 22.7" imagelink="/resources/img/msi-icon.png">}}
...
<h4>Σημειώσεις έκδοσης</h4><div> <a href='https://docs.aspose.com/finance/net/aspose-finance-for-net-22-7-release-notes/'>https://docs.aspose.com/finance/net/aspose-finance-for-net-22-7-release-notes/</a></div>
{{< /Releases/ReleasesFileFeatures >}}
{{< Releases/ReleasesFileFeatures >}}
...
> Για μια πλήρη λίστα λειτουργιών, βελτιώσεων και διορθώσεων σφαλμάτων σε αυτήν την έκδοση, επισκεφτείτε τη διεύθυνση [Aspose.Finance for .NET 22.7 Release Notes](https://docs.aspose.com/finance/net/aspose-finance-for-net-22-7-release-notes/).
