---
title: "Επεκτάσεις απόδοσης για SSRS | Aspose.Total for Reporting Services"
description: "Επιτρέπει στους προγραμματιστές να εξάγουν εύκολα αναφορές RDL σε μορφές εγγράφων Word, Excel, PowerPoint και PDF. Μπορείτε επίσης να βελτιώσετε τη ροή εργασίας προσθέτοντας τους γραμμωτούς κώδικες στα εξαγόμενα έγγραφα."
keywords: "SSRS Extensions  "
family_listing_page_title: "Aspose.Total for Reporting Services"
family_listing_page_description: "Εξαγωγή αναφορών RDL σε Word, Excel, PowerPoint και άλλες μορφές από τις υπηρεσίες αναφοράς του SQL Server."
