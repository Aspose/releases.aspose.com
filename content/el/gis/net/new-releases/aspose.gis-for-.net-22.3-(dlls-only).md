...
folder_name: "Aspose.gis για .NET 22.3 (μόνο DLLS)"
...
download_count: "   Added: 2 weeks ago [3/29/2022]  Κατεβάστεs: 3  Views: 6"
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.gis για .NET 22.3 (μόνο DLLS)" imagelink="/resources/img/zip-icon.png">}}
  {{< Releases/ReleasesButtons >}}
    {{< Releases/ReleasesSingleButtons text=" Κατεβάστε" link="/gis/net/new-releases/aspose.gis-for-.net-22.3-(dlls-only)/006ef58d6dad46ef97faa58d13e9d1b8%20%20" >}}
