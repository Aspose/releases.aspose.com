---
title: "Aspose.html | Βιβλιοθήκη κλάσης Java για χειρισμό αρχείων HTML" 
...
family_listing_page_description: "Το Aspose.html για το Java είναι ένα προηγμένο API χειραγώγησης HTML που κατασκευάστηκε για να εκτελέσει ένα ευρύ φάσμα εργασιών χειρισμού HTML απευθείας στις εφαρμογές Java." 
...
Οι [Java HTML API](https://products.aspose.com/html/java) βοηθούν τους προγραμματιστές να γράφουν, να διαβάζουν, να τροποποιούν, να περιηγούνται και να μετατρέπουν (x) έγγραφα HTML από εφαρμογές Java.

Το aspose.html για το Java API λειτουργεί ως πρόγραμμα περιήγησης που σας επιτρέπει να κάνετε [Δημιουργήστε ή ανοίξτε τα υπάρχοντα έγγραφα HTML](https://docs.aspose.com/html/java/creating-a-document/) από διάφορες πηγές, προκειμένου να εκτελέσετε λειτουργίες χειραγώγησης, όπως αφαιρέστε και αντικαταστήστε τους κόμβους HTML, αποθηκεύστε έγγραφα HTML, Extract CSS από HTML, διαμορφώστε ένα έγγραφο Sandbox και πολλά άλλα. Μπορείτε να περιηγηθείτε στα έγγραφα HTML χρησιμοποιώντας διάφορες μεθόδους, όπως η μεταφορά στοιχείων, η μεταφορά εγγράφων, τα ερωτήματα XPATH και τα ερωτήματα επιλογής CSS καθώς και το χειρισμό HTML DOM μέσω Javascrip αρχεία σε άλλες μορφές αρχείων.
