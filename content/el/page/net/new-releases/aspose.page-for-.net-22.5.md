---
title: "Ορίστε τα μεταδεδομένα XMP στο API Εγγράφων EPS για C#, εφαρμογές ASP.NET"
description: "C# .NET API για τη ρύθμιση των μεταδεδομένων XMP της Adobe (Extensible Metadata Platform) στα έγγραφα EPS (Encapsulated PostScript), αυξάνοντας την αποτελεσματικότητα της εφαρμογής."
keywords: ""
...
Intro_text: "Περιέχει Aspose.Page για έκδοση .NET 22.5."
...
# Ρύθμιση μεταδεδομένων XMP σε EPS
