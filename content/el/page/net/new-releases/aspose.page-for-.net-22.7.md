---
title: "Μετατροπή XPS σε Image Set Image Size API για εφαρμογές C#, ASP.NET"
description: "C# .NET API για μετατροπή XPS σε μορφές εικόνας με επιλογή ορισμού του απαιτούμενου μεγέθους εικόνας. Υποστηρίζει μετατροπή XPS σε μορφές εικόνας ράστερ BMP, JPG, PNG και TIFF."
keywords: ""
...
Intro_text: "Περιέχει Aspose.Page για έκδοση .NET 22.7."
...
> Για μια πλήρη λίστα λειτουργιών, βελτιώσεων και διορθώσεων σφαλμάτων σε αυτήν την έκδοση, επισκεφτείτε τη διεύθυνση [Aspose.Page for .NET 22.7 Release Notes](https://releases.aspose.com/page/net/release-notes/2022/aspose-page-for-net-22-7-release-notes/).
