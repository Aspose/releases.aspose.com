---
title: "Χρήση γραμματοσειρών Wingdings & Zapfdingbats μέσω API για εφαρμογές C#, .NET"
description: "Το C# .NET API προσφέρει καλύτερο χειρισμό των γραμματοσειρών dingbat αντικαθιστώντας τη γραμματοσειρά Wingdings με τη δωρεάν γραμματοσειρά Zapfdingbats που υποστηρίζει διάφορες μορφές εγγράφων."
keywords: "    . "
page_type: single_release_page
folder_link: " page/net/new-releases/aspose.page-for-.net-22.2/"
folder_name: "Aspose.Page for .Net 22.2"
download_link: " /page/net/new-releases/aspose.page-for-.net-22.2/609651ab29be4e888efd1af4013dff0b"
download_text: " Download"
Intro_text: "Περιέχει Aspose.Page για έκδοση .NET 22.2."
...
{{< Releases/ReleasesHeading H2txt="Aspose.Page for .Net 22.2" imagelink="/resources/img/msi-icon.png">}}
...
# Αντικαταστήστε το Wingdings με δωρεάν γραμματοσειρά Zapfdingbats

Αυτή η έκδοση του API προσφέρει καλύτερο χειρισμό των γραμματοσειρών dingbat αντικαθιστώντας τη γραμματοσειρά Wingdings με τη δωρεάν γραμματοσειρά Zapfdingbats που υποστηρίζει διάφορες μορφές εγγράφων.

> Για μια πλήρη λίστα λειτουργιών, βελτιώσεων και διορθώσεων σφαλμάτων σε αυτήν την έκδοση, επισκεφτείτε τη διεύθυνση [Aspose.Page for .NET 22.2 Release Notes](https://releases.aspose.com/page/net/release-notes/2022/aspose-page-for-net-22-2-release-notes/).
