---
title: "Aspose.omr | Βιβλιοθήκη κλάσης Java για εκχύλιση ψηφιακών σημείων" 
...
- [Δημιουργήστε πρότυπα OMR](https://docs.aspose.com/omr/java/create-omr-template/) από τη σήμανση κειμένου.
...
Το ASPOSPER.OMR APIs Java φιλοξενείται στο [Θέτω σε αποθήκη](https://repository.aspose.com/omr/). Μπορείτε εύκολα να χρησιμοποιήσετε το aspose.omr για το Java API απευθείας στα έργα Maven σας με απλές διαμορφώσεις. Για τις λεπτομερείς οδηγίες, επισκεφτείτε τη σελίδα τεκμηρίωσης [Installing Aspose.OMR for Java from Maven Repository](https://docs.aspose.com/omr/java/installation/).
