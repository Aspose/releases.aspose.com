...
intro_text: "Contains Aspose.OMR for .NET 22.7 release"
...
> For a complete list of features, enhancements, and bug fixes in this release please visit, [Aspose.OMR for .NET 22.7 Σημειώσεις έκδοσης](https://docs.aspose.com/omr/net/aspose-omr-for-net-22-7-release-notes/).
