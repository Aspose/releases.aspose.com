---
title: "Συμπίεση σε GZip XZ & BZip2 Formats API for C#, ASP.NET Apps"
description: "C# .NET API για συμπίεση αρχείων CPIO σε συμπίεση αρχειοθέτησης GZIP, BZIP2 και XZ, με σεβασμό των μορφών TAR και CPIO κατά την αποθήκευση σε BZIP2, υποστηρίζει snappy αλγόριθμο."
keywords: ""
page_type: single_release_page
folder_link: "/zip/net/new-releases/aspose.zip-for-.net-22.7/"
folder_name: "Aspose.ZIP για .NET 22.7"
download_link: "/zip/net/new-releases/aspose.zip-for-.net-22.7/49f751667e00512477c0664562d7d64b-2-7721"
download_text: "Download"
Intro_text: "Aspose.ZIP για έκδοση .NET 22.7."
...
{{< Releases/ReleasesHeading H2txt="Aspose.ZIP για .NET 22.7" imagelink="/resources/img/msi-icon.png">}}
...
<h4>Σημειώσεις έκδοσης</h4><div> <a href='https://releases.aspose.com/zip/net/release-notes/2022/aspose-zip-for-net-22-7-release-notes/'>https://releases.aspose.com/zip/net/release-notes/2022/aspose-zip-for-net-22-7-release-notes/</a></div>
{{< /Releases/ReleasesFileFeatures >}}
{{< Releases/ReleasesFileFeatures >}}
...
> Για μια πλήρη λίστα λειτουργιών, βελτιώσεων και διορθώσεων σφαλμάτων σε αυτήν την έκδοση, επισκεφτείτε τη διεύθυνση [Aspose.ZIP for .NET 22.7 Release Notes](https://releases.aspose.com/zip/net/release-notes/2022/aspose-zip-for-net-22-7-release-notes/).
