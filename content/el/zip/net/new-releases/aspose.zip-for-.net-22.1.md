---
title: "Βελτιωμένη εξαγωγή cpio & Tar μέσω API για εφαρμογές C#, ASP.NET"
description: "Νέα έκδοση του C# .NET API με δυνατότητα εξαγωγής αρχείων «Z» χρησιμοποιώντας API εσωτερικής εγκατάστασης. Διορθώθηκαν τα σφάλματα που ενεργοποιήθηκαν στην εξαγωγή «cpio» και «πίσσας»."
keywords: ""
page_type: single_release_page
folder_link: " zip/net/new-releases/aspose.zip-for-.net-22.1/"
folder_name: "Aspose.ZIP για .NET 22.1"
download_link: " /zip/net/new-releases/aspose.zip-for-.net-22.1/c15d703160244e16a37304e85f1c6a8c"
download_text: " Download"
Intro_text: "Aspose.ZIP για έκδοση .NET 22.1."
...
{{< Releases/ReleasesHeading H2txt="Aspose.ZIP για .NET 22.1" imagelink="/resources/img/msi-icon.png">}}
