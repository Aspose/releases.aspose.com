---
title: "LZX & Deflate με βάση το CAB Extraction API για εφαρμογές C#, ASP.NET"
description: "C# .NET API που μπορεί να εξαγάγει αρχεία «CAB» που έχουν συμπιεστεί χρησιμοποιώντας αλγόριθμους «LZX» και Deflate, βελτιωμένη εξαγωγή του κρυπτογραφημένου «RAR5» στο .NET 6."
keywords: ""
page_type: single_release_page
folder_link: " zip/net/new-releases/aspose.zip-for-.net-22.3/"
folder_name: "Aspose.ZIP για .NET 22.3"
download_link: " /zip/net/new-releases/aspose.zip-for-.net-22.3/fbd379bca0b049df88c596552bd82d7e"
download_text: " Download"
Intro_text: "Aspose.ZIP για έκδοση .NET 22.3."
...
{{< Releases/ReleasesHeading H2txt="Aspose.ZIP για .NET 22.3" imagelink="/resources/img/msi-icon.png">}}
...
Εξαγάγετε τα αρχεία «CAB» που έχουν συμπιεστεί χρησιμοποιώντας αλγόριθμους «LZX» και Deflate.

# Εξαγωγή κρυπτογραφημένου RAR5
