...
linktitle: Aspose.3D για Node.js μέσω Java 25.7 Σημειώσεις Έκδοσης
title: Aspose.3D για Node.js μέσω Java 25.7 Σημειώσεις Έκδοσης
weight: 6
description: Aspose.3D για Node.js μέσω Java 25.7 Σημειώσεις έκδοσης – οι τελευταίες ενημερώσεις και διορθώσεις.
type: repository
layout: release
---
...
Αυτή η σελίδα περιέχει πληροφορίες σημειώσεων έκδοσης για το Aspose.3D για Node.js μέσω Java 25.7.
...
| THREEDNET-1690 |  "Δεν είναι δυνατή η apertura di questo file" για μορφή gLTF | Διόρθωση σφάλματος |
| THREEDNET-1692 | Αποτυχία apertura του αρχείου DRC | Διόρθωση σφάλματος |
