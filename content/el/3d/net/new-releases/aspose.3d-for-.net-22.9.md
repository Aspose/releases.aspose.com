---
title: "Υποστήριξη αρχείων Temp για FBX Importer API για C#, εφαρμογές ASP.NET"
description: "C# .NET API με εσωτερική υποστήριξη προσωρινού συστήματος αρχείων για εισαγωγέα FBX και βελτιωμένη υποστήριξη για την εξαγωγή αρχείων GLTF μέσω 3D Format Manipulation API."
keywords: ""
page_type: single_release_page
folder_link: "/3d/net/new-releases/aspose.3d-for-.net-22.9/"
folder_name: "Aspose.3D για .NET 22.9"
download_link: "/3d/net/new-releases/aspose.3d-for-.net-22.9/ed9ae82228966fc44cf8672fcc17c1e8-3-7878"
download_text: "Download"
Intro_text: "Περιέχει Aspose.3D για έκδοση .NET 22.9."
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.3D για .NET 22.9" imagelink="/resources/img/msi-icon.png">}}
  ...
  {{< Releases/ReleasesFileFeatures >}}
      <h4>Σημειώσεις έκδοσης</h4><div> <a href='https://docs.aspose.com/3d/net/aspose-3d-for-net-22-9-release-notes/'>https://docs.aspose.com/3d/net/aspose-3d-for-net-22-9-release-notes/</a></div>
  {{< /Releases/ReleasesFileFeatures >}}
  {{< Releases/ReleasesFileFeatures >}}
      <h4>Περιγραφή</h4><div class="HTMLDescription"> Περιέχει Aspose.3D για έκδοση .NET 22.9.</div>
  {{< /Releases/ReleasesFileFeatures >}}
...
> Για μια πλήρη λίστα λειτουργιών, βελτιώσεων και διορθώσεων σφαλμάτων σε αυτήν την έκδοση, επισκεφτείτε τη διεύθυνση [Aspose.3D for .NET 22.9 Release Notes](https://docs.aspose.com/3d/net/aspose-3d-for-net-22-9-release-notes/).
