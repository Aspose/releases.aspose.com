---
title: "Μεγάλη υποστήριξη πλέγματος & συγχώνευση 3D σκηνή API για C#, ASP.NET Apps" 
description: "C# .NET API με βελτιωμένη υποστήριξη του μεγάλου πλέγματος σε εξαγωγή αρχείου U3D / PDF, ενισχυμένη τρισδιάστατη σκηνή που συγχωνεύεται για να συγχωνεύσει τα πάντα από οποιονδήποτε κόμβο στον τρέχοντα κόμβο." 
keywords: "    ." 
page_type:  single_release_page
folder_link: " 3d/net/new-releases/aspose.3d-for-.net-22.3/"
folder_name: " Aspose.3d για .NET 22.3" 
download_link: " /3d/net/new-releases/aspose.3d-for-.net-22.3/34c194c9a52c43788eaf0ae7c19c77dd"
download_text: " Κατεβάστε" 

Intro_text: "Περιέχει aspose.3d για .NET 22.3 Release."
image_link: "/resources/img/msi-icon.png"
download_count: "   3/4/2022  Κατεβάστεs: 15  Views: 25"
...
{{< Releases/ReleasesHeading H2txt=" Aspose.3d για .NET 22.3" imagelink="/resources/img/msi-icon.png">}}
{{< Releases/ReleasesButtons >}}
{{< Releases/ReleasesSingleButtons text=" Κατεβάστε" link="/3d/net/new-releases/aspose.3d-for-.net-22.3/34c194c9a52c43788eaf0ae7c19c77dd%20%20" >}}
...
Απλοποίησε τις λειτουργίες για τη συγχώνευση σκηνών. Αυτή η νέα μέθοδος επιτρέπει τη συγχώνευση όλων από έναν άλλο κόμβο στον τρέχοντα κόμβο.
...
> Για μια πλήρη λίστα χαρακτηριστικών, βελτιώσεων και διορθώσεων σφαλμάτων σε αυτή την έκδοση, παρακαλώ επισκεφθείτε, [ASPOSPES3D για NET 223 Σημειώσεις κυκλοφορίας](https://docs.aspose.com/3d/net/aspose-3d-for-net-22-3-release-notes/).
{{% /Releases/ReleasesFileFeatures %}}
{{< /Common/wrapper >}}
{{< /Releases/ReleasesFileFeatures >}}
{{< /Releases/ReleasesFileArea >}}
