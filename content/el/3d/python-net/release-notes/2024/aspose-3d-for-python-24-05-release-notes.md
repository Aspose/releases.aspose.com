...
linktitle: Aspose.3D για Python μέσω .NET 24.5 Σημειώσεις Έκδοσης
title: Aspose.3D για Python μέσω .NET 24.5 Σημειώσεις Έκδοσης
weight: 8
description: Aspose.3D για Python μέσω .NET 24.5 Σημειώσεις έκδοσης – οι τελευταίες ενημερώσεις και διορθώσεις.
type: repository
layout: release
---
...
Αυτή η σελίδα περιέχει πληροφορίες σημειώσεων έκδοσης για το Aspose.3D για Python μέσω .NET 24.5.
...
| THREEDNET-1541 | Δεν μπορεί να διαβαστεί πίνακας χρωμάτων κορυφής συμπιεσμένης μορφής σε JT 9.5 χωρίς ενεργοποίηση ποσοτικοποίησης. | Διόρθωση σφάλματος |
...
Αυτή η έκδοση είναι κυρίως έκδοση διόρθωσης σφαλμάτων που επικεντρώθηκε στη συμβατότητα με το Blender και το JT.
