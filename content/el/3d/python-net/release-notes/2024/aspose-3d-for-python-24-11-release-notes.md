...
linktitle: Aspose.3D για Python μέσω .NET 24.11 Σημειώσεις Έκδοσης
title: Aspose.3D για Python μέσω .NET 24.11 Σημειώσεις Έκδοσης
weight: 2
description: Aspose.3D για Python μέσω .NET 24.11 Σημειώσεις έκδοσης – οι τελευταίες ενημερώσεις και διορθώσεις.
type: repository
layout: release
---
...
Αυτή η σελίδα περιέχει πληροφορίες σημειώσεων έκδοσης για το Aspose.3D για Python μέσω .NET 24.11.
...
| THREEDNET-1618 | Βελτίωση του TriMesh για την υποστήριξη triangulation στόχου μορφής | Εργασία |
| THREEDNET-1619 | Διατήρηση deformers κατά τη διάρκεια της διάσπασης meshes | Εργασία |
