...
linktitle: Aspose.3D για Java Έκδοση 24.9 Σημειώσεις Έκδοσης
title: Aspose.3D για Java 24.9 Σημειώσεις Έκδοσης
weight: 4
description: Aspose.3D για Java 24.9 Σημειώσεις έκδοσης – οι τελευταίες ενημερώσεις και διορθώσεις.
type: repository
layout: release
---
...
Αυτή η σελίδα περιέχει πληροφορίες σημειώσεων έκδοσης για το Aspose.3D για Java 24.9.
...
| THREEDNET-1588 | Έκθεση εσωτερικών σημαιών ιδιοκτησίας και προσθήκη υποστήριξης για επιπλέον δεδομένα για ιδιοκτησία | Βελτίωση |
