...
linktitle: Aspose.3D για Java Σημειώσεις Έκδοσης 25.3
title: Aspose.3D για Java Σημειώσεις Έκδοσης 25.3
weight: 10
description: Aspose.3D για Java 25.3 Σημειώσεις έκδοσης – οι τελευταίες ενημερώσεις και διορθώσεις.
type: repository
layout: release
---
...
Αυτή η σελίδα περιέχει πληροφορίες σημειώσεων έκδοσης για το Aspose.3D για Java 25.3.
...
| THREEDNET-1660 | Απέτυχε η τετραγωνοποίηση καμπύλης B-Spline | Διόρθωση σφαλμάτων |
| THREEDNET-1661 | Το πλέγμα που δημιουργήθηκε από το προηγμένο BRep δεν μπορεί να χρησιμοποιηθεί ως τελεστής Boolean | Διόρθωση σφαλμάτων |
| THREEDNET-1662 | Το πλέγμα που δημιουργήθηκε από την γραμμική επιμήκυνση δεν είναι manifold | Διόρθωση σφαλμάτων |
