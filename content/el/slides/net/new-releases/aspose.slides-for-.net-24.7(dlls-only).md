...
title: "Λήψεις ---Νέες εκδόσεις-aspose.slides-for-.net-24.7(μόνο dlls)"
description: " "
keywords: ""
page_type: single_release_page
folder_link: "/slides/net/new-releases/aspose.slides-for-.net-24.7(dlls-only)/"
folder_name: "Aspose.Slides για .NET 24.7 (μόνο DLL)"
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.Slides για .NET 24.7 (μόνο DLL)" imagelink="/resources/img/zip-icon.png">}}
  {{< Releases/ReleasesButtons >}}
    {{< Releases/ReleasesSingleButtons text="Κατεβάστε" link="/slides/net/new-releases/aspose.slides-for-.net-24.7(dlls-only)/3bdbb0f43b3a4e1a19a9faddcc428ba6-36-11213" >}}
  ...
  {{< /Releases/ReleasesFileFeatures >}}
  {{< Releases/ReleasesFileFeatures >}}
      <h4>Περιγραφή</h4><div class="HTMLDescription">Περιέχει Aspose.Slides για έκδοση .NET 24.7 (μόνο για DLL).</div>
  {{< /Releases/ReleasesFileFeatures >}}
 {{< /Releases/ReleasesFileArea >}}
{{< /Releases/ReleasesWapper >}}
