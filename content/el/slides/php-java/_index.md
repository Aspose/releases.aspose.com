---
title: "Aspose - Λήψεις"
description: "Περιέχει αρχεία για διαφάνειες"
keywords: "slides"
family_listing_page_title: "Aspose.Slides για PHP μέσω Java"
family_listing_page_description: "Ένα API επεξεργασίας παρουσίασης που επιτρέπει στις εφαρμογές PHP να χειρίζονται, να αποδίδουν και να μετατρέπουν παρουσιάσεις PowerPoint χωρίς να απαιτείται εφαρμογή Microsoft PowerPoint."
...
{{< Common/h1 text="Aspose.Slides για PHP μέσω Java" >}}
{{< Common/paragraph>}}
ΕΝΑ
{{< Common/link href="https://products.aspose.com/slides/php-java/" text="API επεξεργασίας παρουσίασης"  >}}που επιτρέπει στις εφαρμογές PHP να χειρίζονται, να αποδίδουν και να μετατρέπουν παρουσιάσεις PowerPoint χωρίς να απαιτείται εφαρμογή Microsoft PowerPoint.
{{< Common/h4 text="PHP API για Παρουσιάσεις"  >}} 
{{< Common/ul>}}
...
{{< /Common/paragraph>}}
{{< Common/hr >}}
{{< Common/h4 text="Λήψη aspose/slides από το Composer"  >}}
{{< Common/paragraph class="package-instructions">}}
Το aspose/slides είναι διαθέσιμο στο Packagist ως το
{{< Common/link href="https://packagist.org/packages/aspose/slides" text="aspose/slides"  >}}πακέτο. Εκτελέστε την ακόλουθη εντολή:
{{< /Common/paragraph>}}
