---
title: "Render Gantt Chart, Immutable Work Time API C#, ASP.NET Apps"
description: "C# .NET API για να κάνετε την τιμή του χρόνου εργασίας του έργου αμετάβλητη, διαβάστε, γράψτε την Ημερομηνία κατάστασης έως, από το αρχείο XER, υποστήριξη διακριτικού ακύρωσης για τη φόρτωση του έργου."
keywords: ""
page_type: single_release_page
folder_link: " tasks/net/new-releases/-aspose.tasks-for-.net-22.3/"
folder_name: "Aspose.Tasks για .NET 22.3"
download_link: " /tasks/net/new-releases/-aspose.tasks-for-.net-22.3/979f1b2d8a3746e58779d874d9cfe76a"
download_text: " Download"
Intro_text: "Περιέχει MSI με Aspose.Tasks για έκδοση .NET 22.3."
...
{{< Releases/ReleasesHeading H2txt="Aspose.Tasks για .NET 22.3" imagelink="/resources/img/msi-icon.png">}}
...
# Κάντε το "WorkingTime" αμετάβλητο

Έκανε την τιμή του χρόνου εργασίας αμετάβλητη.

# Βελτιωμένη λειτουργικότητα της ημερομηνίας κατάστασης

Προστέθηκε η δυνατότητα ανάγνωσης και εγγραφής της Ημερομηνίας Κατάστασης προς ή από ένα αρχείο «XER».

# Διακριτικό ακύρωσης για φόρτωση έργου
