---
title: "Διαβάστε το Ποσοστό ολοκλήρωσης του έργου API για εφαρμογές C#, ASP.NET" 
description: "C# .NET API για πρόσβαση στις κλασματικές τιμές αριθμού του φυσικού ποσοστού πλήρους & εκατοστημόρου για να διαβάσετε το ποσοστό (%) ολοκλήρωση των έργων Primavera®." 
keywords: ""
page_type: single_release_page
folder_link: "/tasks/net/new-releases/aspose.tasks-for-.net-23.1/"
folder_name: "Aspose.tasks για το .NET 23.1" 
download_link: "/tasks/net/new-releases/aspose.tasks-for-.net-23.1/238bc62fd7141eb2c31f8e556cc608ed-5-8395"
download_text: "Κατεβάστε" 
intro_text: "Περιέχει MSI με aspose.tasks για .NET 23.1 απελευθέρωση." 
...
{{< Releases/ReleasesHeading H2txt="Aspose.tasks για το .NET 23.1" imagelink="/resources/img/msi-icon.png">}}
{{< Releases/ReleasesButtons >}}
{{< Releases/ReleasesSingleButtons text="Κατεβάστε" link="/tasks/net/new-releases/aspose.tasks-for-.net-23.1/238bc62fd7141eb2c31f8e556cc608ed-5-8395" >}}
...
{{< Releases/ReleasesFileFeatures >}}
<h4>Περιγραφή</h4>
<div class="HTMLDescription">Περιέχει MSI με aspose.tasks για .NET 23.1 απελευθέρωση.</div>
{{< /Releases/ReleasesFileFeatures >}}
...
> Για μια πλήρη λίστα χαρακτηριστικών, βελτιώσεων και διορθώσεων σφαλμάτων σε αυτή την έκδοση, επισκεφθείτε, [Asposetasks για Net 231 Σημειώσεις κυκλοφορίας](https://releases.aspose.com/tasks/net/release-notes/2023/aspose-tasks-for-net-23-1-release-notes/).
{{% /Releases/ReleasesFileFeatures %}}
{{< /Common/wrapper >}}
{{< /Releases/ReleasesFileFeatures >}}
{{< /Releases/ReleasesFileArea >}}
