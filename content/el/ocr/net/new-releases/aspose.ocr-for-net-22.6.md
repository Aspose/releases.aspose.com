...
intro_text: "Νέο νευρωνικό δίκτυο, αναγνώριση επιτραπέζιων και αφαίρεση του συστήματος."
...
For a complete list of features, enhancements, and bug fixes in this release please visit, [Aspose.OCR for .NET 22.6 - Σημειώσεις έκδοσης](https://releases.aspose.com/ocr/net/release-notes/2022/aspose-ocr-for-net-22-6-release-notes/).
