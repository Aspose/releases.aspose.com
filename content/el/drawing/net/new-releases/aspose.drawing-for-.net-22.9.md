---
title: "Εξοικονομήστε 1 BPP (Bits ανά pixel) TIFF & BMP API για εφαρμογές C#, .NET"
description: "C# .NET API με δυνατότητα αποθήκευσης 1 BPP (Bits Per Pixel) .TIFF και .BMP μορφές, φόρτωση σχεδίων, γραφικών και αρχείων εικόνας από ροή web μέσω API."
keywords: ""
...
Intro_text: "Το πρόγραμμα εγκατάστασης MSI για το Aspose.Drawing για .NET 22.9"
...
<h4>Σημειώσεις έκδοσης</h4><div> <a href='https://releases.aspose.com/drawing/net/release-notes/2022/aspose-drawing-for-net-22-9-release-notes/'>https://releases.aspose.com/drawing/net/release-notes/2022/aspose-drawing-for-net-22-9-release-notes/</a></div>
{{< /Releases/ReleasesFileFeatures >}}
{{< Releases/ReleasesFileFeatures >}}
...
# Εξοικονομήστε 1 BPP TIFF & BMP

Υλοποιήθηκε η αποθήκευση σε μορφές 1 (ένα) BPP (Bits Per Pixel) .TIFF και .BMP.

# Φορτώστε αρχεία εικόνας από μια ροή Ιστού

Προστέθηκε η δυνατότητα φόρτωσης αρχείων εικόνας από ροή web.

> Για μια πλήρη λίστα λειτουργιών, βελτιώσεων και διορθώσεων σφαλμάτων σε αυτήν την έκδοση, επισκεφτείτε τη διεύθυνση [Aspose.Drawing for .NET 22.9 Release Notes](https://releases.aspose.com/drawing/net/release-notes/2022/aspose-drawing-for-net-22-9-release-notes/).
