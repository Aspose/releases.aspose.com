---
title: "Υποστήριξη εναλλακτικής γραμματοσειράς σε Linux μέσω API για C#, εφαρμογές ASP.NET"
description: "C# .NET API με υποστήριξη εναλλακτικής γραμματοσειράς σε Linux. Εάν μια γραμματοσειρά έχει μόνο πλάγιο στυλ, είναι επίσης διαθέσιμη η εναλλακτική για αυτήν τη γραμματοσειρά. Δυνατότητα σχεδίασης γραμμών anti-alias."
keywords: ""
...
Intro_text: "Το πρόγραμμα εγκατάστασης MSI για το Aspose.Drawing για .NET 22.5"
...
<h4>Σημειώσεις έκδοσης</h4><div> <a href='https://releases.aspose.com/drawing/net/release-notes/2022/aspose-drawing-for-net-22-5-release-notes/'>https://releases.aspose.com/drawing/net/release-notes/2022/aspose-drawing-for-net-22-5-release-notes/</a></div>
{{< /Releases/ReleasesFileFeatures >}}
{{< Releases/ReleasesFileFeatures >}}
...
> Για μια πλήρη λίστα λειτουργιών, βελτιώσεων και διορθώσεων σφαλμάτων σε αυτήν την έκδοση, επισκεφτείτε τη διεύθυνση [Aspose.Drawing for .NET 22.5 Release Notes](https://releases.aspose.com/drawing/net/release-notes/2022/aspose-drawing-for-net-22-5-release-notes/).
