---
title: "Προσθέστε εφέ πλάγιας και έντονης γραμματοσειράς μέσω API για εφαρμογές C#, ASP.NET"
description: "C# .NET API με υποστήριξη για τα εφέ πλάγιας και έντονης γραμματοσειράς στα σχέδια, δυνατότητα διαφάνειας αρχείων GIF, βελτίωσε την υποστήριξη για τους κωδικοποιητές εικόνας."
keywords: ""
...
Intro_text: "Το πρόγραμμα εγκατάστασης MSI για το Aspose.Drawing για .NET 22.4"
