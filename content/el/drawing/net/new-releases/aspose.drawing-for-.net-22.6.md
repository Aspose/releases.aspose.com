---
title: "Image Shrinking & Vector Scaling API για εφαρμογές C#, ASP.NET"
description: "C# .NET API με καλύτερη ποιότητα στη συρρίκνωση μεγαλύτερων εικόνων, διανυσματική κλίμακα για μετα-αρχεία, επεξεργασία και αποθήκευση αρχείων GIF πολλαπλών καρέ, προσθήκη στρογγυλών και τριγωνικών κεφαλαίων παύλας."
keywords: ""
...
Intro_text: "Το πρόγραμμα εγκατάστασης MSI για το Aspose.Drawing για .NET 22.6"
...
> Για μια πλήρη λίστα λειτουργιών, βελτιώσεων και διορθώσεων σφαλμάτων σε αυτήν την έκδοση, επισκεφτείτε τη διεύθυνση [Aspose.Drawing for .NET 22.6 Release Notes](https://releases.aspose.com/drawing/net/release-notes/2022/aspose-drawing-for-net-22-6-release-notes/).
