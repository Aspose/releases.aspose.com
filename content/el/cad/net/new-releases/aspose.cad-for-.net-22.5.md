---
title: "Εξαγωγή DWG σε WMF και OBJ σε DXF μέσω API για εφαρμογές C# ASP.NET"
description: "C# .NET API με βελτιωμένη δυνατότητα εξαγωγής της μορφής DWG σε WMF, βελτιστοποιημένο μέγεθος αρχείου για εξαγωγή OBJ σε DXF, επιλύθηκε το πρόβλημα επικάλυψης κειμένου εντός του εξαγόμενου PDF."
keywords: ""
page_type: single_release_page
folder_link: "/cad/net/new-releases/aspose.cad-for-.net-22.5/"
folder_name: "Aspose.CAD για .NET 22.5"
...
{{< Releases/ReleasesHeading H2txt="Aspose.CAD για .NET 22.5" imagelink="/resources/img/msi-icon.png">}}
