---
title: "Διατήρηση τρισδιάστατων μοντέλων, απόδοση αεροπλάνων μέσω API για C#, Εφαρμογές .NET"
description: "C# .NET API με δυνατότητα διατήρησης των τρισδιάστατων ενσύρματων μοντέλων, απόδοσης διπλής όψης επίπεδα, κλιμάκωσης υδατογραφημάτων, βελτιωμένης απόδοσης και μετατροπής DWG σε PDF."
keywords: ""
page_type: single_release_page
folder_link: "/cad/net/new-releases/aspose.cad-for-.net-22.8/"
folder_name: "Aspose.CAD για .NET 22.8"
download_link: "/cad/net/new-releases/aspose.cad-for-.net-22.8/bae6befe64efa7a5904bff6485be0655-10-7855"
download_text: "Download"
Intro_text: "Περιέχει πρόγραμμα εγκατάστασης MSI για πλήρη εγκατάσταση προϊόντος του Aspose.CAD για .NET v22.8"
...
{{< Releases/ReleasesHeading H2txt="Aspose.CAD για .NET 22.8" imagelink="/resources/img/msi-icon.png">}}
...
<h4>Σημειώσεις έκδοσης</h4><div> <a href='https://releases.aspose.com/cad/net/release-notes/2022/aspose-cad-for-net-22-8-release-notes/'>https://releases.aspose.com/cad/net/release-notes/2022/aspose-cad-for-net-22-8-release-notes/</a></div>
{{< /Releases/ReleasesFileFeatures >}}
{{< Releases/ReleasesFileFeatures >}}
...
> Για μια πλήρη λίστα λειτουργιών, βελτιώσεων και διορθώσεων σφαλμάτων σε αυτήν την έκδοση, επισκεφτείτε τη διεύθυνση [Aspose.CAD for .NET 22.8 - Release Notes](https://releases.aspose.com/cad/net/release-notes/2022/aspose-cad-for-net-22-8-release-notes/).
