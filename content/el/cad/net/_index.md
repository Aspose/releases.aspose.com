...
family_listing_page_description: "Το Aspose.CAD για .NET επιτρέπει στους προγραμματιστές να μετατρέπουν αρχεία μορφών AutoCAD DWG και DXF και DGN, DWF, DWFX, IFC, IGS, IGES, STL, DWT, FBX, CF2, CF2, OBJ και άλλες μορφές CAD σε PDF, SVG, WMF και Εικόνες ράστερ. Είναι ένα εγγενές API και δεν απαιτεί την εγκατάσταση του AutoCAD ή άλλου λογισμικού."
