...
linktitle: Aspose.Cells for PHP via Java 23.6 Σημείωση έκδοσης
title: Aspose.Cells for PHP via Java 23.6 Σημείωση έκδοσης
weight: 7
description: Aspose.Cells for PHP via Java 23.6 Σημειώσεις έκδοσης – οι πιο πρόσφατες βελτιώσεις, νέες δυνατότητες και επιδιορθώσεις
type: repositor
layout: releas
...
{{% alert color="primary" %}}
 ...
 Αυτή η σελίδα περιέχει σημειώσεις έκδοσης για[Aspose.Cells for PHP via Java 23.6](https://releases.aspose.com/cells/php/new-releases/aspose.cells-for-php-via-java-23.6/).
