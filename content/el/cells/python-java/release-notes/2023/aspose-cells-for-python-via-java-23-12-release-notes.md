...
linktitle: Aspose.Cells for Python via Java 23.12 Σημείωση έκδοσης
title: Aspose.Cells for Python via Java 23.12 Σημείωση έκδοσης
weight: 1
description: Aspose.Cells for Python via Java 23.12 Σημειώσεις έκδοσης – οι πιο πρόσφατες ενημερώσεις και επιδιορθώσεις
type: repositor
layout: releas
...
{{% alert color="primary" %}}
 ...
 Αυτή η σελίδα περιέχει σημειώσεις έκδοσης για[Aspose.Cells for Python via Java 23.12](https://releases.aspose.com/cells/python-java/new-releases/aspose.cells-for-python-via-java-23.12/).
...
|CELLSPYTHONJAVA-79|Μεγάλος αριθμός ετικετών του άξονα x εκτυπώνεται στη μέση του γραφήματος αντί στο κάτω μέρος|
