...
linktitle: Aspose.Cells for Python via Java 23.2 Σημείωση έκδοσης
title: Aspose.Cells for Python via Java 23.2 Σημείωση έκδοσης
weight: 11
description: Aspose.Cells for Python via Java 23.2 Σημειώσεις έκδοσης – οι πιο πρόσφατες βελτιώσεις, νέες δυνατότητες και επιδιορθώσεις
type: repositor
layout: releas
...
{{% alert color="primary" %}}
 ...
 Αυτή η σελίδα περιέχει σημειώσεις έκδοσης για[Aspose.Cells for Python via Java 23.2](https://releases.aspose.com/cells/python-java/new-releases/aspose.cells-for-python-via-java-23.2/).
