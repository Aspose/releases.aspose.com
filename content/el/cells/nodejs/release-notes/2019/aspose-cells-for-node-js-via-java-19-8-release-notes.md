...
linktitle: Aspose.Cells for Node.js via Java 19.8 Σημείωση έκδοσης
title: Aspose.Cells for Node.js via Java 19.8 Σημείωση έκδοσης
weight: 10
description: Aspose.Cells for Node.js via Java 19.8 Σημειώσεις έκδοσης – οι πιο πρόσφατες βελτιώσεις, νέες δυνατότητες και επιδιορθώσεις
type: repositor
layout: releas
...
Αυτή η σελίδα περιέχει σημειώσεις έκδοσης για Aspose.Cells for Node.js via Java 19.8.
...
|CELLSJAVA-42954|Έγινε εξαίρεση κατά τη φόρτωση και αποθήκευση του αρχείου XLSX|Εξαίρεση|
|CELLSJAVA-42957|Μη έγκυρη τιμή FontUnderlineType εμφανίζεται κατά την αποθήκευση του αρχείου XLSX|Εξαίρεση|
