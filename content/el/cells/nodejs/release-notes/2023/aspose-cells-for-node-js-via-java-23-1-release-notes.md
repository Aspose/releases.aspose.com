...
linktitle: Aspose.Cells for Node.js via Java 23.1 Σημείωση έκδοσης
title: Aspose.Cells for Node.js via Java 23.1 Σημείωση έκδοσης
weight: 12
description: Aspose.Cells for Node.js via Java 23.1 Σημειώσεις έκδοσης – οι πιο πρόσφατες βελτιώσεις, νέες δυνατότητες και επιδιορθώσεις
type: repositor
layout: releas
...
{{% alert color="primary" %}}
 ...
 Αυτή η σελίδα περιέχει σημειώσεις έκδοσης για[Aspose.Cells for Node.js via Java 23.1](https://releases.aspose.com/cells/nodejs/new-releases/aspose.cells-for-node.js-via-java-23.1/).
