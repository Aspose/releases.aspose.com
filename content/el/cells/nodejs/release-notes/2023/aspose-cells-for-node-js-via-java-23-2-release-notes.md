---
id: aspose-cells-for-node-js-via-java-23-2-release-note
slug: aspose-cells-for-node-js-via-java-23-2-release-note
linktitle: Aspose.Cells for Node.js via Java 23.2 Σημείωση έκδοσης
title: Aspose.Cells for Node.js via Java 23.2 Σημείωση έκδοσης
weight: 11
description: Aspose.Cells for Node.js via Java 23.2 Σημειώσεις έκδοσης – οι πιο πρόσφατες βελτιώσεις, νέες δυνατότητες και επιδιορθώσεις
type: repositor
layout: releas
family_listing_page_title: Aspose.Cells for Node.js via Java 23.2 Release Note
keywords: Aspose.Cells for Node.js via Java 23.2 Release Notes, Aspose.Cells for Node.js via Java 23.2 updates and fixe
---
{{% alert color="primary" %}}

 Αυτή η σελίδα περιέχει σημειώσεις έκδοσης για[Aspose.Cells for Node.js via Java 23.2](https://releases.aspose.com/cells/nodejs/new-releases/aspose.cells-for-node.js-via-java-23.2/).
