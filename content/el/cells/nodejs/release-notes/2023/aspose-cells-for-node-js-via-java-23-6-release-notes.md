...
linktitle: Aspose.Cells for Node.js via Java 23.6 Σημείωση έκδοσης
title: Aspose.Cells for Node.js via Java 23.6 Σημείωση έκδοσης
weight: 7
description: Aspose.Cells for Node.js via Java 23.6 Σημειώσεις έκδοσης – οι πιο πρόσφατες βελτιώσεις, νέες δυνατότητες και επιδιορθώσεις
type: repositor
layout: releas
...
{{% alert color="primary" %}}
 ...
 Αυτή η σελίδα περιέχει σημειώσεις έκδοσης για[Aspose.Cells for Node.js via Java 23.6](https://releases.aspose.com/cells/nodejs/new-releases/aspose.cells-for-node.js-via-java-23.6/).
...
|CELLSNODEJSJAVA-44|Το περιεχόμενο του πλαισίου κειμένου είναι θολό κατά τη μετατροπή του αρχείου σε PDF|
|CELLSNODEJSJAVA-46|Το κείμενο Cell αποκόπηκε και αναδιπλώθηκε λανθασμένα κατά τη μετατροπή του βιβλίου εργασίας σε PDF|
|CELLSNODEJSJAVA-47|Η μορφοποίηση ημερομηνίας δεν εφαρμόζεται σε όλες τις στήλες στο Aspose.Cells|
