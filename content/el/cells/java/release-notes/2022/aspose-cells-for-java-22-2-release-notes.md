...
linktitle: Aspose.Cells for Java 22.2 Σημείωση έκδοσης
title: Aspose.Cells for Java 22.2 Σημείωση έκδοσης
weight: 11
description: Aspose.Cells for Java 22.2 Σημειώσεις έκδοσης – οι πιο πρόσφατες βελτιώσεις, νέες δυνατότητες και επιδιορθώσεις
type: repositor
layout: releas
...
{{% alert color="primary" %}}
 ...
 Αυτή η σελίδα περιέχει σημειώσεις έκδοσης για[Aspose.Cells for Java 22.2](https://releases.aspose.com/cells/java/new-releases/aspose.cells-for-java-22.2/).
