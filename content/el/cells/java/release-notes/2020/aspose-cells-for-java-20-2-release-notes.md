...
linktitle: Aspose.Cells for Java 20.2 Σημείωση έκδοσης
title: Aspose.Cells for Java 20.2 Σημείωση έκδοσης
weight: 50
description: Aspose.Cells for Java 20.2 Σημειώσεις έκδοσης – οι πιο πρόσφατες βελτιώσεις, νέες δυνατότητες και επιδιορθώσεις
type: repositor
layout: releas
...
{{% alert color="primary" %}}
 ...
 Αυτή η σελίδα περιέχει σημειώσεις έκδοσης για[Aspose.Cells for Java 20.2](https://releases.aspose.com/cells/java/new-releases/aspose.cells-for-java-20.2/).
