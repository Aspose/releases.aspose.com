...
linktitle: Aspose.Cells for Java 21.9 Σημείωση έκδοσης
title: Aspose.Cells for Java 21.9 Σημείωση έκδοσης
weight: 4
description: Aspose.Cells for Java 21.9 Σημειώσεις έκδοσης – οι πιο πρόσφατες βελτιώσεις, νέες δυνατότητες και επιδιορθώσεις
type: repositor
layout: releas
...
{{% alert color="primary" %}}
 ...
 Αυτή η σελίδα περιέχει σημειώσεις έκδοσης για[Aspose.Cells for Java 21.9](https://releases.aspose.com/cells/java/new-releases/aspose.cells-for-java-21.9/).
