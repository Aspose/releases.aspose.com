...
linktitle: Aspose.Cells for Java 23.10 Σημείωση Έκδοσης
title: Aspose.Cells for Java 23.10 Σημείωση Έκδοσης
weight: 3
description: Aspose.Cells for Java 23.10 Σημειώσεις έκδοσης – οι πιο πρόσφατες ενημερώσεις και επιδιορθώσεις
type: repositor
layout: releas
...
{{% alert color="primary" %}}
 ...
 Αυτή η σελίδα περιέχει σημειώσεις έκδοσης για[Aspose.Cells for Java 23.10](https://releases.aspose.com/cells/java/23-10/).
