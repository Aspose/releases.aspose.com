...
linktitle: Aspose.Cells for Java 23.7 Σημείωση έκδοσης
title: Aspose.Cells for Java 23.7 Σημείωση έκδοσης
weight: 6
description: Aspose.Cells for Java 23.7 Σημειώσεις έκδοσης – οι πιο πρόσφατες βελτιώσεις, νέες δυνατότητες και επιδιορθώσεις
type: repositor
layout: releas
...
{{% alert color="primary" %}}
 ...
 Αυτή η σελίδα περιέχει σημειώσεις έκδοσης για[Aspose.Cells for Java 23.7](https://releases.aspose.com/cells/java/23-7/).
