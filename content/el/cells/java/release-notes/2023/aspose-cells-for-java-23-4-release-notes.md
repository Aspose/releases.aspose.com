...
linktitle: Aspose.Cells for Java 23.4 Σημείωση έκδοσης
title: Aspose.Cells for Java 23.4 Σημείωση έκδοσης
weight: 9
description: Aspose.Cells for Java 23.4 Σημειώσεις έκδοσης – οι πιο πρόσφατες βελτιώσεις, νέες δυνατότητες και επιδιορθώσεις
type: repositor
layout: releas
...
{{% alert color="primary" %}}
 ...
 Αυτή η σελίδα περιέχει σημειώσεις έκδοσης για[Aspose.Cells for Java 23.4](https://releases.aspose.com/cells/java/23-4/).
