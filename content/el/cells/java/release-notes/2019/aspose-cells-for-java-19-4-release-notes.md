...
linktitle: Aspose.Cells for Java 19.4 Σημείωση έκδοσης
title: Aspose.Cells for Java 19.4 Σημείωση έκδοσης
weight: 90
description: Aspose.Cells for Java 19.4 Σημειώσεις έκδοσης – οι πιο πρόσφατες βελτιώσεις, νέες δυνατότητες και διορθώσεις
type: repositor
layout: releas
...
Αυτή η σελίδα περιέχει σημειώσεις έκδοσης για Aspose.Cells for Java 19.4.
...
|CELLSJAVA-42856|Πρόβλημα μετατροπής Excel σε HTML|Εντομο|
...
|CELLSJAVA-42874|Απώλεια στήλης κατά την εξαγωγή του αρχείου στο HTML|Εντομο|
...
###  **Προσθέτει μεθόδους CommentCollection.AddThreadedComment() και CommentCollection.GetThreadedComments().**
Προσθέτει και λαμβάνει τα σχόλια με νήματα.
###  **Προσθέτει την ιδιότητα Chart.SubTitle.**
