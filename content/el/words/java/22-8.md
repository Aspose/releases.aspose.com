---
title: "Aspose.words 22.8 | Έγγραφο στο AZW3 | Docx σε AZW3 | API Java" 
description: "Βιβλιοθήκη Java για να δημιουργήσετε Επεξεργασία και μετατροπή εγγράφων λέξεων. Aspose.words 22.8 Μετατροπή υποστήριξης των μορφών AZW3, Kindle και Mobipocket και πολλά άλλα." 
layout: package
...
## Τι νέο υπάρχει στο aspose.words για το Java API 22.8
- azw3 to docs converter and reader
- Kindle and Mobipocket formats converter and reader
- Επιτρέψτε την απόσταση κυττάρων σε πίνακες κατά την απόδοση.
- Support of chess pawn symbol when converting to PDF from Έγγραφα
- Can Convert Phonetic Guide content to TXT

Δείτε [Release Notes of Aspose.Words for Java 22.8](https://docs.aspose.com/words/java/aspose-words-for-java-22-8-release-notes/) για πλήρεις λεπτομέρειες.
...
### ** Πώς να μετατρέψετε το έγγραφο Word σε μορφή AZW3 χρησιμοποιώντας Java **

Το [AZW3](https://docs.fileformat.com/ebook/azw3/) είναι η επέκταση μορφής αρχείου που χρησιμοποιείται από τους αναγνώστες του Amazon Kindle.

```java
import com.aspose.words.Document;
import com.aspose.words.DocSaveOptions;

public class AsposeΈγγραφα2Azw3Converter {
