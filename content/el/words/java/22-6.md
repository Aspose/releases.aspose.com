---
title: "Aspose.words 22.6 | Νέο έγγραφο σε μορφές σταθερής σελίδας" 
description: "Βιβλιοθήκη Java για να δημιουργήσετε Επεξεργασία και μετατροπή εγγράφων λέξεων. Aspose.words 22.6 Υποστηρίζει τη μετατροπή των εγγράφων σε μορφές σταθερής σελίδας και πολλά άλλα." 
layout: package
...
## Τι νέο υπάρχει στο aspose.words για το Java API 22.6
- Μετατροπή εγγράφων σε μορφές σταθερής σελίδας με υψηλή ποιότητα και απόδοση.
- API για διαγράμματα σχεδίασης με υποστήριξη της κλίσης, της υφής και των μοτίβων.
- Improvement in converting DOCX to HTML
- Add loading progress notification for ODT documents
- Βελτίωση στη φόρτωση των εγγράφων ePUB με οντότητες XHTML.

Δείτε [Release Notes of Aspose.Words for Java 22.6](https://docs.aspose.com/words/java/aspose-words-for-java-22-6-release-notes/) για πλήρεις λεπτομέρειες.
...
### ** Πώς να μετατρέψετε το έγγραφο σε μορφή σταθερής σελίδας JPEG με υψηλή ποιότητα χρησιμοποιώντας Java **
...
public class AsposeΈγγραφα2FIXEDPageJpgeHighQualityConverter {
...
- ** [Δωρεάν online εύρεση και αντικατάσταση](https://products.aspose.app/words/replace) ** Για να βρείτε και να αντικαταστήσετε το κείμενο στη λέξη, PDF έγγραφα.

- ** [Δωρεάν online επεξεργαστής μεταδεδομένων εγγράφων](https://products.aspose.app/words/metadata) ** για προβολή & amp; Επεξεργασία ιδιοτήτων μεταδεδομένων της Microsoft Word & amp; Έγγραφα OpenOffice.
