---
title: "Aspose.words 19.5 | Μορφές εγγράφων διαδικασίας μέσω Java API" 
...
layout: package
publishdate: "2019-05-07T00:00:00+00:00"
type: repository
weight: 00	#rem
---
...
### ** Πώς να μετατρέψετε το RTF σε PDF χρησιμοποιώντας Java **
...
- ** [Δωρεάν online περιστροφή](https://products.aspose.app/words/rotate) ** Για να περιστρέψετε έγγραφα και εικόνες PDF. Αλλάξτε τον προσανατολισμό της σελίδας από πορτρέτο στο τοπίο και προς την αντίθετη κατεύθυνση.
