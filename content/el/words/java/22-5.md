---
title: "Aspose.words 22.5 | Νέο έγγραφο στον μετατροπέα Epub" 
description: "Βιβλιοθήκη Java για να δημιουργήσετε Επεξεργασία και μετατροπή εγγράφων λέξεων. Aspose.words 22.5 Υποστήριξη της μετατροπής Epub, φόρτωση XML, βελτίωση στο RTF σε PDF και πολλά άλλα." 
layout: package
...
## Τι νέο υπάρχει στο aspose.words για το Java API 22.5
...
Δείτε [Release Notes of Aspose.Words for Java 22.5](https://docs.aspose.com/words/java/aspose-words-for-java-22-5-release-notes/) για πλήρεις λεπτομέρειες.
...
### ** Πώς να μετατρέψετε το έγγραφο Word σε μορφή αρχείου Epub χρησιμοποιώντας Java **

Το [Epub](https://docs.fileformat.com/ebook/epub/) είναι η επέκταση μορφής αρχείου που χρησιμοποιείται για την παροχή μιας τυπικής μορφής ψηφιακής δημοσίευσης για τους εκδότες και τους καταναλωτές.
...
public class AsposeΈγγραφα2EpubConverter {
