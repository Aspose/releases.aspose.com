---
title: "Aspose.words 20.5 | Μορφές εγγράφων διαδικασίας μέσω Java API" 
...
layout: package
publishdate: "2020-05-10T00:00:00+00:00"
type: repository
weight: 00	#rem
---
...
### ** Πώς να προσθέσετε κωδικό πρόσβασης στο έγγραφο Word χρησιμοποιώντας Java **
{{< gist  aspose-com-kb 2933a2335a3ba469020ac8a40b4117ea "How to Add Password to Word Document using Java.java" >}}
...
- ** [Δωρεάν γεννήτρια online τιμολογίου](https://products.aspose.app/words/invoice) ** Για να δημιουργήσετε τιμολόγια και λογαριασμούς εισάγοντας δεδομένα από τη μορφή JSON.

- ** [Δωρεάν συγχώνευση ηλεκτρονικού ταχυδρομείου στο διαδίκτυο](https://products.aspose.app/words/mailmerge) ** Για να δημιουργήσετε μηνύματα ηλεκτρονικού ταχυδρομείου και έγγραφα χρησιμοποιώντας σύνταξη προτύπου συγχώνευσης αλληλογραφίας.
