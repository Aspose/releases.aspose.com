---
title: "Aspose.words 21.9 | Μορφές εγγράφων διαδικασίας μέσω Java API" 
...
### ** Πώς να προσθέσετε σχόλια σε λέξη χρησιμοποιώντας java **
...
- ** [Δωρεάν προστάτης ηλεκτρονικών εγγράφων](https://products.aspose.app/words/protect) ** Για να προστατεύσετε τα έγγραφα λέξεων σας με κωδικό πρόσβασης χρησιμοποιώντας το αγαπημένο σας πρόγραμμα περιήγησης.
