---
title: "Aspose.words 22.7 | Τα έγγραφα του New στο PDF/UA-1 WCAG 2.0" 
description: "Βιβλιοθήκη Java για να δημιουργήσετε Επεξεργασία και μετατροπή εγγράφων λέξεων. Aspose.words 22.7 Υποστηρίζει WCAG 2.0 PDF, πεδίο βάσης δεδομένων, OPENTYPE (CFF) και πολλά άλλα." 
layout: package
...
## Τι νέο υπάρχει στο aspose.words για το Java API 22.7
...
Δείτε [Release Notes of Aspose.Words for Java 22.7](https://docs.aspose.com/words/java/aspose-words-for-java-22-7-release-notes/) για πλήρεις λεπτομέρειες.
...
### ** Μετατρέψτε το έγγραφο σε PDF/UA-1 συμβατό με το WCAG 2.0 σε Java **
...
public class AsposeΈγγραφα2PDF_UA_1_Compliant_WCAG20_Converter {
