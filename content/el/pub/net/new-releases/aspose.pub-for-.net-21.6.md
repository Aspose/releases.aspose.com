---
title: "Μετατροπή MS Publisher 2000 PUB σε PDF μέσω API για εφαρμογές C#"
description: "Το PUB Conversion API υποστηρίζει πλέον τη μετατροπή αρχείων PUB του Microsoft Publisher 2000 σε μορφή αρχείου Adobe PDF εντός των εφαρμογών C#, ASP.NET. Συμμόρφωση .NET Framework 5.0."
keywords: "    . "
page_type: single_release_page
folder_link: " pub/net/new-releases/aspose.pub-for-.net-21.6/"
folder_name: "Aspose.PUB για .NET 21.6"
download_link: " /pub/net/new-releases/aspose.pub-for-.net-21.6/7d256447cb2e431e9b19f17cda0a72de"
download_text: " Download"
Intro_text: "Περιέχει Aspose.PUB για έκδοση .NET 21.6."
...
{{< Releases/ReleasesHeading H2txt="Aspose.PUB για .NET 21.6" imagelink="/resources/img/msi-icon.png">}}
...
<h4>Σημειώσεις έκδοσης</h4><div> <a href="https://releases.aspose.com/pub/net/release-notes/2021/aspose-pub-for-net-21-6-release-notes/">https://releases.aspose.com/pub/net/release-notes/2021/aspose-pub-for-net-21-6-release-notes/</a></div>
{{< /Releases/ReleasesFileFeatures >}}
...
> Για μια πλήρη λίστα λειτουργιών, βελτιώσεων και διορθώσεων σφαλμάτων σε αυτήν την έκδοση, επισκεφτείτε τη διεύθυνση [Aspose.PUB for .NET 21.6 Release Notes](https://releases.aspose.com/pub/net/release-notes/2021/aspose-pub-for-net-21-6-release-notes/).
