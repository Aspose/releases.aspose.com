---
title: "Pesan Email MBOX Inbox Management API untuk C#, ASP.NET Apps"
description: "C# .NET API dengan penanganan pengiriman email yang lebih baik melalui SMTP, peningkatan kemampuan IMAP Message Seen Flag (benar / salah), peningkatan manajemen email Kotak Masuk MBOX."
keywords: ""
page_type: single_release_page
folder_link: " email/net/new-releases/aspose.email-for-.net-22.1/"
folder_name: "Aspose.Email untuk .NET 22.1"
download_link: " /email/net/new-releases/aspose.email-for-.net-22.1/12ed1f779c6744248edb23edf597495b"
download_text: " Download"
Intro_text: "Ini berisi Aspose.Email untuk .NET 22.1 rilis."
...
{{< Releases/ReleasesHeading H2txt="Aspose.Email untuk .NET 22.1" imagelink="/resources/img/msi-icon.png">}}
...
# Penanganan Pengiriman Email yang Lebih Baik melalui SMTP

Saat bekerja dengan API versi 21.12, masalah `Operasi telah dibatalkan` terjadi dalam beberapa kasus saat mengirim email melalui SMTP. Masalah ini sekarang telah diselesaikan.

# Peningkatan Penanganan Bendera Terlihat IMAP

Sebelumnya, flag Aspose IMAP Seen selalu dikembalikan sebagai `false`. Masalah ini sekarang telah diperbaiki.

# Peningkatan dalam Manajemen Kotak Masuk MBOX
