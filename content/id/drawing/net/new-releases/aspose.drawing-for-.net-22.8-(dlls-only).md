...
title: "Unduhan --- rilis baru-aspose.drawing-for-.net-22.8- (hanya-dlls)"
description: " "
keywords: ""
page_type: single_release_page
folder_link: "/drawing/net/new-releases/aspose.drawing-for-.net-22.8-(dlls-only)/"
folder_name: "Aspose.drawing untuk .NET 22.8 (DLLS saja)"
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.drawing untuk .NET 22.8 (DLLS saja)" imagelink="/resources/img/zip-icon.png">}}
  {{< Releases/ReleasesButtons >}}
    {{< Releases/ReleasesSingleButtons text="Unduh" link="/drawing/net/new-releases/aspose.drawing-for-.net-22.8-(dlls-only)/4ba9e05d530a16606727c1b2c0348d65-2-7794" >}}
