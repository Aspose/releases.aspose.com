---
title: "Unduh File JAR Prosesor Presentasi | Aspose.Slide"
description: "Unduh file JAR untuk membuat, mengedit, mengonversi format presentasi PowerPoint® & OpenOffice®. Bekerja dengan slide, bentuk, bagan, objek, kontrol, & lainnya melalui API."
keywords: "Java PPTX Library, Java PPT Library, PowerPoint Java API"
family_listing_page_title: "Aspose.Slide untuk Java"
family_listing_page_description: "Aspose.Slides for Java adalah manipulasi dan pemrosesan presentasi PowerPoint untuk membaca, menulis, memanipulasi, dan mengonversi file PowerPoint dalam aplikasi berbasis Java apa pun. API tidak memiliki ketergantungan eksternal sehingga dapat digunakan tanpa memerlukan Microsoft PowerPoint."
...
{{< Common/h3 text="Unduh Aspose.Slides untuk bekerja dengan Presentasi PowerPoint®"  >}}
...
{{< Common/link href="https://repository.aspose.com/slides/" text="Aspose.Slides untuk Java API"  >}}langsung di proyek berbasis Maven Anda dengan menambahkan konfigurasi berikut ke pom.xml Anda. Untuk petunjuk rinci, silakan kunjungi
{{< Common/link href="https://docs.aspose.com/slides/java/installation/" text="Menginstal Aspose.Slides untuk Java dari Repositori Maven"  >}}halaman dokumentasi.
...
## Mengapa mengunduh Aspose.Slides untuk Java?

[Aspose.Slides](https://products.aspose.com/slides/java) untuk Java adalah API lokal untuk bekerja dengan presentasi Microsoft PowerPoint® dari dalam Aplikasi Java Anda. Hal ini memungkinkan pengembang untuk membaca, menulis, mengubah dan memanipulasi presentasi PowerPoint® dalam aplikasi Java dengan kemampuan untuk memanipulasi berbagai elemen dokumen seperti slide, tabel, teks, bagan, bentuk, gambar dan diagram SmartArt dan banyak lagi.

## Manipulasi File PowerPoint® melalui Java

- Muat & konversi presentasi ke format lain.
- Buat presentasi dari awal.
- Memanipulasi semua elemen presentasi melalui model objek intuitif.
- Buat atau sematkan bagan.
- Membuat atau memanipulasi bentuk.

Silakan periksa [product overview](https://docs.aspose.com/slides/java/product-overview/) untuk mengetahui semua tentang Aspose.Slides untuk Java.
