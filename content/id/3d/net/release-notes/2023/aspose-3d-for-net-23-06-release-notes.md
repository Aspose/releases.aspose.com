...
linktitle: Catatan Rilis Aspose.3D untuk .NET 23.6
title: Catatan Rilis Aspose.3D untuk .NET 23.6
weight: 7
description: Catatan Rilis Aspose.3D untuk .NET 23.6 – pembaruan dan perbaikan terbaru.
type: repository
layout: release
---
...
Halaman ini berisi informasi catatan rilis untuk Aspose.3D for .NET 23.6.
...
Aspose.3D for .NET 23.6 menambahkan dukungan eksperimental untuk IFC(2.3 dan 4), dukungan lebih lanjut untuk file IFC akan hadir di masa mendatang.
