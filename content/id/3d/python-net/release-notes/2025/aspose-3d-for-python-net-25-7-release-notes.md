...
linktitle: Catatan Rilis Aspose.3D untuk Python melalui .NET 25.7
title: Catatan Rilis Aspose.3D untuk Python melalui .NET 25.7
weight: 6
description: Catatan Rilis Aspose.3D untuk Python melalui .NET 25.7 – pembaruan dan perbaikan terbaru.
type: repository
layout: release
---
...
Halaman ini berisi informasi catatan rilis untuk Aspose.3D untuk Python via .NET 25.7.
...
Kelas ini mendefinisikan pengelompokan hubungan logis, berbeda dari kelas `Node` yang mewakili hubungan hierarkis untuk rendering. Saat ini, fungsionalitas ini hanya tersedia saat bekerja dengan format IFC.
