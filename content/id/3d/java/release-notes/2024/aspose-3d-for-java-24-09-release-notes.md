...
linktitle: Catatan Rilis Aspose.3D untuk Java 24.9
title: Catatan Rilis Aspose.3D untuk Java 24.9
weight: 4
description: Catatan Rilis Aspose.3D untuk Java 24.9 – pembaruan dan perbaikan terbaru.
type: repository
layout: release
---
...
Halaman ini berisi informasi catatan rilis untuk Aspose.3D untuk Java 24.9.
...
| :- | :- | :- |
| THREEDNET-1576 | Ekspos utilitas sistem sumbu internal ke pengguna. | Tugas |
...
| THREEDNET-1588 | Ekspos flag internal properti dan tambahkan dukungan data tambahan untuk properti | Peningkatan |
