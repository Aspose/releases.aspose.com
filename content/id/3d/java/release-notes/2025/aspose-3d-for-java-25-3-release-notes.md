...
linktitle: Catatan Rilis Aspose.3D untuk Java 25.3
title: Catatan Rilis Aspose.3D untuk Java 25.3
weight: 10
description: Catatan Rilis Aspose.3D untuk Java 25.3 – pembaruan dan perbaikan terbaru.
type: repository
layout: release
---
...
Halaman ini berisi informasi catatan rilis untuk Aspose.3D untuk Java 25.3.
...
| THREEDNET-1662 | Mesh yang dihasilkan dari Linear Extrusion bukan manifold | Perbaikan bug |
