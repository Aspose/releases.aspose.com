---
title: "API Ekstraksi CAB berbasis LZX & Deflate untuk Aplikasi C#, ASP.NET"
description: "C# .NET API yang dapat mengekstrak arsip `CAB` yang telah dikompresi menggunakan algoritma `LZX` dan Deflate, meningkatkan ekstraksi `RAR5` terenkripsi di .NET 6."
keywords: ""
page_type: single_release_page
folder_link: " zip/net/new-releases/aspose.zip-for-.net-22.3/"
folder_name: "Aspose.ZIP untuk .NET 22.3"
download_link: " /zip/net/new-releases/aspose.zip-for-.net-22.3/fbd379bca0b049df88c596552bd82d7e"
download_text: " Download"
Intro_text: "Aspose.ZIP untuk .NET 22.3 rilis."
...
{{< Releases/ReleasesHeading H2txt="Aspose.ZIP untuk .NET 22.3" imagelink="/resources/img/msi-icon.png">}}
...
Ekstrak arsip `CAB` yang telah dikompres menggunakan algoritma `LZX` dan Deflate.

# Ekstrak RAR5 Terenkripsi
