---
title: "Kompres ke GZip XZ & BZip2 Format API untuk C#, ASP.NET Apps"
description: "C# .NET API untuk mengompresi arsip CPIO ke kompresi arsip GZIP, BZIP2, & XZ, menghormati format TAR dan CPIO sambil menyimpan ke BZIP2, mendukung algoritme tajam."
keywords: ""
page_type: single_release_page
folder_link: "/zip/net/new-releases/aspose.zip-for-.net-22.7/"
folder_name: "Aspose.ZIP untuk .NET 22.7"
download_link: "/zip/net/new-releases/aspose.zip-for-.net-22.7/49f751667e00512477c0664562d7d64b-2-7721"
download_text: "Download"
Intro_text: "Aspose.ZIP untuk .NET 22.7 rilis."
...
{{< Releases/ReleasesHeading H2txt="Aspose.ZIP untuk .NET 22.7" imagelink="/resources/img/msi-icon.png">}}
...
# Kompatibilitas Kompresi Arsip CPIO yang Ditingkatkan

Dukungan untuk mengompresi arsip `CPIO` ke `GZIP`, `BZIP2`, & kompresi arsip `XZ`. Sementara format `TAR` dan `CPIO` juga dihormati saat menyimpan ke `BZIP2`.

# Dukungan untuk Algoritma Snappy
