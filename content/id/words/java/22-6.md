---
title: "Aspose.Words 22.6 | Dokter Baru untuk Memperbaiki Format Halaman" 
description: "Perpustakaan Java untuk membuat tampilan edit dan mengonversi dokumen Word. Aspose.Words 22.6 mendukung konversi dokumen ke format halaman yang tetap dan banyak lagi." 
layout: package
...
## Apa yang baru di Aspose.Words untuk Java API 22.6
- Konversi dokumen ke format halaman tetap dengan kualitas dan kinerja tinggi.
- API untuk grafik DrawingML dengan dukungan gradien, tekstur dan pola mengisi.
- Improvement in converting DOCX to HTML
- Add loading progress notification for ODT documents
- Peningkatan dalam memuat dokumen EPUB dengan entitas XHTML.

Silakan lihat [Release Notes of Aspose.Words for Java 22.6](https://docs.aspose.com/words/java/aspose-words-for-java-22-6-release-notes/) untuk detail lengkap.
...
### ** Cara mengonversi dokumen ke format jpeg halaman tetap dengan kualitas tinggi menggunakan java **
...
public class AsposeDokumen2FIXEDPageJpgeHighQualityConverter {
