---
title: "Aspose.Words 22.5 | Dokumen Baru untuk Konverter Epub" 
description: "Perpustakaan Java untuk membuat tampilan edit dan mengonversi dokumen Word. Aspose.Words 22.5 Dukungan Konversi Epub, Memuat XML, Peningkatan RTF ke PDF dan banyak lagi." 
layout: package
...
## Apa yang baru di Aspose.Words untuk Java API 22.5
...
Silakan lihat [Release Notes of Aspose.Words for Java 22.5](https://docs.aspose.com/words/java/aspose-words-for-java-22-5-release-notes/) untuk detail lengkap.
...
### ** Cara Mengonversi Dokumen Kata ke Format File Epub Menggunakan Java **

[Epub](https://docs.fileformat.com/ebook/epub/) adalah ekstensi format file yang digunakan untuk memberikan format publikasi digital standar untuk penerbit dan konsumen.
...
public class AsposeDokumen2EpubConverter {
