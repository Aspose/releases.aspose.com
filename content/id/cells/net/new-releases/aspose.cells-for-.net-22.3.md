---
title: Aplikasi Templat Spreadsheet XLT (Excel) OTS (Calc) API C# .NET
description: C# .NET API dengan dukungan untuk format templat spreadsheet Excel® (XLT) & Calc (OTS), diatur di dalam batas, mengurutkan nilai bidang pivot sesuai kolom atau baris yang dipilih
keywords: ""
...
{{< Releases/ReleasesWapper >}}
  ...
  {{< Releases/ReleasesButtons >}}
    {{< Releases/ReleasesSingleButtons text=" Unduh" link="/cells/net/new-releases/aspose.cells-for-.net-22.3/c293581525754554a9ea2092b4c27669%20%20" >}}
...
#  Dukungan untuk Format Templat Spreadsheet

Rilis API ini telah memperkenalkan dukungan untuk format templat spreadsheet untuk Excel&reg; (XLT) & OpenOffice Calc&reg; (OTS) program. Ini didukung sebagai format output melalui `SaveFormat.Ots` & `SaveFormat.Xlt`.

#  Tetapkan Batas Dalam

Kemampuan untuk mengatur batas dalam.

#  Urutkan PivotField per Baris atau Kolom yang Dipilih
