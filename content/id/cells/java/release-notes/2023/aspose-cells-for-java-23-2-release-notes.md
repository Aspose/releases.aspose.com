...
linktitle: Aspose.Cells for Java 23.2 Catatan Rilis
title: Aspose.Cells for Java 23.2 Catatan Rilis
weight: 11
description: Aspose.Cells for Java 23.2 Catatan Rilis – penyempurnaan terbaru, fitur baru, dan perbaikan
type: repositor
layout: releas
...
{{% alert color="primary" %}}
 ...
 Halaman ini berisi catatan rilis untuk[Aspose.Cells for Java 23.2](https://releases.aspose.com/cells/java/23-2/).
