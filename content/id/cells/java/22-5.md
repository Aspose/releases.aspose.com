---
title: "Aspose.Cells 22.5 | Format spreadsheet proses melalui Java API" 
...
[Aspose.Cells for Java](https://products.aspose.com/cells/java) adalah API pemrosesan spreadsheet Excel pemenang penghargaan yang memungkinkan pengembang Java untuk menyematkan kemampuan membaca, menulis, dan memanipulasi Excel? Spreadsheets (XLS, XLSX, XLSM, XLSB, XLTX, SpreadsheetML, CSV, ODS), HTML, MHTML, PDF, dan Format File Gambar ke dalam aplikasi Java mereka sendiri tanpa perlu mengandalkan Microsoft Excel?.
