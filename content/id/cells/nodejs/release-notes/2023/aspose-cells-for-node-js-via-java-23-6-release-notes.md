...
linktitle: Aspose.Cells for Node.js via Java 23.6 Catatan Rilis
title: Aspose.Cells for Node.js via Java 23.6 Catatan Rilis
weight: 7
description: Aspose.Cells for Node.js via Java 23.6 Catatan Rilis – penyempurnaan terkini, fitur baru, dan perbaikan
type: repositor
layout: releas
...
{{% alert color="primary" %}}
 ...
 Halaman ini berisi catatan rilis untuk[Aspose.Cells for Node.js via Java 23.6](https://releases.aspose.com/cells/nodejs/new-releases/aspose.cells-for-node.js-via-java-23.6/).
...
|CELLSNODEJSJAVA-44|Konten kotak teks buram saat mengonversi file ke PDF|
|CELLSNODEJSJAVA-46|Teks Cell terpotong dan dibungkus dengan tidak benar saat mengonversi buku kerja menjadi PDF|
|CELLSNODEJSJAVA-47|Pemformatan tanggal tidak diterapkan pada semua kolom di Aspose.Cells|
