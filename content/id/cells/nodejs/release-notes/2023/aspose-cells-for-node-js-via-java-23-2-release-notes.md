...
linktitle: Aspose.Cells for Node.js via Java 23.2 Catatan Rilis
title: Aspose.Cells for Node.js via Java 23.2 Catatan Rilis
weight: 11
description: Aspose.Cells for Node.js via Java 23.2 Catatan Rilis – penyempurnaan terkini, fitur baru, dan perbaikan
type: repositor
layout: releas
...
{{% alert color="primary" %}}
 ...
 Halaman ini berisi catatan rilis untuk[Aspose.Cells for Node.js via Java 23.2](https://releases.aspose.com/cells/nodejs/new-releases/aspose.cells-for-node.js-via-java-23.2/).
