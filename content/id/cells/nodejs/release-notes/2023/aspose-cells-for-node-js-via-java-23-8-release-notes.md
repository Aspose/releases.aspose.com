...
linktitle: Aspose.Cells for Node.js via Java 23.8 Catatan Rilis
title: Aspose.Cells for Node.js via Java 23.8 Catatan Rilis
weight: 5
description: Aspose.Cells for Node.js via Java 23.8 Catatan Rilis – penyempurnaan terkini, fitur baru, dan perbaikan
type: repositor
layout: releas
...
{{% alert color="primary" %}}
 ...
 Halaman ini berisi catatan rilis untuk[Aspose.Cells for Node.js via Java 23.8](https://releases.aspose.com/cells/nodejs/new-releases/aspose.cells-for-node.js-via-java-23.8/).
