...
linktitle: Aspose.Cells for Node.js via Java 23.7 Catatan Rilis
title: Aspose.Cells for Node.js via Java 23.7 Catatan Rilis
weight: 6
description: Aspose.Cells for Node.js via Java 23.7 Catatan Rilis – penyempurnaan terkini, fitur baru, dan perbaikan
type: repositor
layout: releas
...
{{% alert color="primary" %}}
 ...
 Halaman ini berisi catatan rilis untuk[Aspose.Cells for Node.js via Java 23.7](https://releases.aspose.com/cells/nodejs/new-releases/aspose.cells-for-node.js-via-java-23.7/).
...
|CELLSNODEJSJAVA-50|Teks tidak dapat diganti dengan benar setelah mewarisi kelas PivotGlobalizationSettings|
