...
linktitle: Aspose.Cells for PHP via Java 22.5 Catatan Rilis
title: Aspose.Cells for PHP via Java 22.5 Catatan Rilis
weight: 8
description: Aspose.Cells for PHP via Java 22.5 Catatan Rilis – penyempurnaan terkini, fitur baru, dan perbaikan
type: repositor
layout: releas
...
{{% alert color="primary" %}}
 ...
 Halaman ini berisi catatan rilis untuk[Aspose.Cells for PHP via Java 22.5](https://releases.aspose.com/cells/php/new-releases/aspose.cells-for-php-via-java-22.5/).
