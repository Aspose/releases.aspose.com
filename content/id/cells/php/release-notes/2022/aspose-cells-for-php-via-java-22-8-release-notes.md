...
linktitle: Aspose.Cells for PHP via Java 22.8 Catatan Rilis
title: Aspose.Cells for PHP via Java 22.8 Catatan Rilis
weight: 5
description: Aspose.Cells for PHP via Java 22.8 Catatan Rilis – penyempurnaan terkini, fitur baru, dan perbaikan
type: repositor
layout: releas
...
{{% alert color="primary" %}}
 ...
 Halaman ini berisi catatan rilis untuk[Aspose.Cells for PHP via Java 22.8](https://releases.aspose.com/cells/php/new-releases/aspose.cells-for-php-via-java-22.8/).
