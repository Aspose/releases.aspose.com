...
description: "Ini berisi file untuk barcode"
keywords: "barcode "
family_listing_page_title: "Aspose.BarCode untuk Python melalui Java"
family_listing_page_description: "Aspose.BarCode untuk Python melalui Java"
...
{{< Common/h2 text="Unduh Aspose.Barcode untuk Python melalui Java dari PIP"  >}}
{{< Common/paragraph class="package-instructions">}}
Anda dapat dengan mudah menggunakan <b>aspose-barcode</b> untuk Python dari
{{< Common/link href="https://pypi.org/project/aspose-barcode/" text="pip"  >}}dengan perintah berikut.
{{< /Common/paragraph>}}
...
### Pemrosesan Barcode Python melalui Fitur API Java On-premise

- Menawarkan dukungan untuk sebagian besar spesifikasi dan standar barcode populer.
- Anda dapat membaca dan mengekspor kode batang dalam berbagai format gambar, misalnya JPEG, PNG, GIF & BMP.
- Kemampuan untuk bekerja dengan label barcode.
- Dukungan untuk dimensi X serta dimensi Y untuk barcode 2D.
