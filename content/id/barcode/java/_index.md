---
title: "Unduh File JAR Pemrosesan Kode Batang | Aspose.BarCode API"
description: "Unduh file JAR untuk menghasilkan, mengenali, & mengonversi kode batang. Mendukung simbologi barcode numerik, alfanumerik, dan 2D. Sesuaikan kode batang di Aplikasi Java Anda."
keywords: "Generate barcode Java, Scan barcode java"
family_listing_page_title: "Aspose.BarCode untuk Java"
family_listing_page_description: "Aspose.BarCode for Java adalah komponen pengenalan dan pembuatan kode batang yang tangguh dan andal. Hal ini memungkinkan para pengembang untuk dengan cepat dan mudah menambahkan pembuatan kode batang dan fungsionalitas pengenalan ke aplikasi Java mereka berdasarkan platform Java SE, Java EE dan Java ME."
...
{{< Common/h2 text="Unduh Perpustakaan Kode Batang untuk Aplikasi Java"  >}}
...
{{< Common/link href="https://repository.aspose.com/barcode/" text="Aspose.BarCode untuk Java API"  >}}langsung di proyek berbasis Maven Anda dengan menambahkan konfigurasi berikut ke pom.xml Anda. Untuk petunjuk rinci, silakan kunjungi
{{< Common/link href="https://docs.aspose.com/barcode/java/installation/" text="Menginstal Aspose.BarCode untuk Java dari Maven Repository"  >}}halaman dokumentasi.
...
## Mengapa mengunduh Aspose.BarCode untuk Java?

[Aspose.BarCode for Java](https://products.aspose.com/barcode/java) adalah komponen pengenalan dan pembuatan kode batang yang kuat dan andal, yang ditulis dalam Java, memungkinkan pengembang untuk dengan cepat dan mudah menambahkan fungsi pengenalan dan pembuatan kode batang ke aplikasi Java mereka.
...
- Atur teks Kode barcode, tampilan dan properti lainnya.
- Dukungan Checksum dan Data Tambahan.
- Cetak gambar barcode.

### Simbologi Kode Batang

- **Numerik Saja:** EAN13, EAN8, UPCA, UPCE, BooklandEAN, Interleaved2of5, Standard2of5, MSI, Code11, Codabar, Postnet, Planet, EAN14(SCC14), SSCC18, ITF14, Leticode, OPC
...
- **Simbol 2D:** PDF417, DataMatrix, QR, Swiss QR (QR Bill)
- **Dukungan Encoding Saja:** Australia Post, Aztec
...
- **OS apa pun yang mendukung Java:**
- **Java Runtime:** `JRE 1.8` atau lebih tinggi
- **Pengembangan Java:** `J2SE 8.0 (1.8)`, atau lebih tinggi.
