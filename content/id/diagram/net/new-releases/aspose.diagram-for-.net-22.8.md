...
> Untuk daftar lengkap fitur, penyempurnaan, dan perbaikan bug dalam rilis ini, kunjungi [Aspose.Diagram for .NET 22.8 Release Notes](https://docs.aspose.com/diagram/net/aspose-diagram-for-net-22-8-release-notes/).
