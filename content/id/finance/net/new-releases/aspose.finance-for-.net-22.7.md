---
title: "Validasi Elemen Schemaref di XBRL API untuk C#, ASP.NET Apps"
description: "C# .NET API dengan dukungan untuk validasi; Elemen skema, atribut ID elemen konteks, dan sub-elemen entitas dalam elemen konteks dalam file `XBRL`."
keywords: ""
page_type: single_release_page
folder_link: "/finance/net/new-releases/aspose.finance-for-.net-22.7/"
folder_name: "Aspose.Finance untuk .NET 22.7"
download_link: "/finance/net/new-releases/aspose.finance-for-.net-22.7/ed035dc3cdf99d153301c6b7499e8694-2-7696"
download_text: "Download"
Intro_text: "Aspose.Finance untuk .NET 22.7"
...
{{< Releases/ReleasesHeading H2txt="Aspose.Finance untuk .NET 22.7" imagelink="/resources/img/msi-icon.png">}}
...
# Elemen Schemaref dalam Validasi XBRL

Dukungan untuk validasi elemen Schemaref dalam file `XBRL`.

# Validasi Atribut ID Elemen Konteks

Menambahkan validasi atribut ID elemen konteks dalam file `XBRL`.

# Validasi Sub-elemen Entitas

Tambahan validasi sub-elemen entitas dalam elemen konteks dalam file `XBRL`.

> Untuk daftar lengkap fitur, penyempurnaan, dan perbaikan bug dalam rilis ini, kunjungi [Aspose.Finance for .NET 22.7 Release Notes](https://docs.aspose.com/finance/net/aspose-finance-for-net-22-7-release-notes/).
