---
title: "Ekspor DWG ke WMF dan OBJ ke DXF melalui API untuk Aplikasi C# ASP.NET"
description: "C# .NET API dengan fitur ekspor yang ditingkatkan dari format DWG ke WMF, ukuran file yang dioptimalkan untuk ekspor OBJ ke DXF, menyelesaikan masalah tumpang tindih teks dalam PDF yang diekspor."
keywords: ""
page_type: single_release_page
folder_link: "/cad/net/new-releases/aspose.cad-for-.net-22.5/"
folder_name: "Aspose.CAD untuk .NET 22.5"
...
{{< Releases/ReleasesHeading H2txt="Aspose.CAD untuk .NET 22.5" imagelink="/resources/img/msi-icon.png">}}
...
Meningkatkan fitur ekspor format DWG ke WMF.

# Pengoptimalan Ukuran File untuk Ekspor OBJ ke DXF

Memperbaiki masalah ukuran file yang sangat besar setelah mengekspor OBJ ke format DXF.

# Peningkatan Ekspor PDF
