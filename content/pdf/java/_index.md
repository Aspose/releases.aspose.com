---
title: "Download PDF Document Processing JAR Files | Aspose.PDF API"
description: "Download Java classes JAR to create, compress & convert PDF files. Supports custom fonts, JavaScript, bookmarks, images, export, annotation, forms, & printing."
...
homepage_package_link: "https://repository.aspose.com/repo/com/aspose/aspose-pdf/"
...
{{< Common/h3 text="Download Aspose.PDF to Process & Manipulate PDF Files"  >}}
{{< Common/paragraph class="package-instructions">}}
Aspose hosts all Java APIs at the {{< Common/link href="https://repository.aspose.com" text="Aspose Repository"  >}}. You can easily use the {{< Common/link href="https://repository.aspose.com/repo/com/aspose/aspose-pdf/" text="Aspose.PDF for Java API"  >}} directly in your Maven based projects by adding following configurations to your pom.xml. For the detailed instructions please visit {{< Common/link href="https://docs.aspose.com/pdf/java/installation/" text="Installing Aspose.PDF for Java from Maven Repository"  >}} documentation page.
...
**Microsoft Office&reg;:** DOC, DOCX, XLS, XLSX, PPTX\
