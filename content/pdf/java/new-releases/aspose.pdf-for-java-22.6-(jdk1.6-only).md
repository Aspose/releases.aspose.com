...
folder_name: "Aspose.PDF for Java 22.6 (JDK1.6 only)"
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.PDF for Java 22.6 (JDK1.6 only)" imagelink="/resources/img/random-file-icon.png">}}
  ...
  {{< Releases/ReleasesFileFeatures >}}
      <h4>Release Notes</h4><div><a href='https://docs.aspose.com/pdf/java/aspose-pdf-for-java-22-6-release-notes/'>https://docs.aspose.com/pdf/java/aspose-pdf-for-java-22-6-release-notes/</a></div>
  {{< /Releases/ReleasesFileFeatures >}}
  {{< Releases/ReleasesFileFeatures >}}
