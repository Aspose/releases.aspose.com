...
title: "Téléchargements --- Nouvelles versions-aspose.words-pour-.net-23.2- (DLLS-Only)"
description: " "
keywords: ""
page_type: single_release_page
folder_link: "/words/net/new-releases/aspose.words-for-.net-23.2-(dlls-only)/"
folder_name: "Aspose.Words pour .net 23.2 (DLLS uniquement)"
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.Words pour .net 23.2 (DLLS uniquement)" imagelink="/resources/img/zip-icon.png">}}
  {{< Releases/ReleasesButtons >}}
    {{< Releases/ReleasesSingleButtons text="Télécharger" link="/words/net/new-releases/aspose.words-for-.net-23.2-(dlls-only)/ee059fac2083019c30ef65b74ab6d07a-17-8486" >}}
