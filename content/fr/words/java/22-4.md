---
title: "Aspose.Words 22.4 | Document de New" 
description: "Bibliothèque Java pour créer l'édition de vue et convertir des documents de mots. Aspose.Words 22.4 Prise en charge de la conversion PDF / A-4, amélioration du document avec du texte arabe en PDF." 
layout: package
...
## Quoi de neuf dans Aspose.Words pour Java API 22.4
...
Veuillez consulter [Release Notes of Aspose.Words for Java 22.4](https://docs.aspose.com/words/java/aspose-words-for-java-22-4-release-notes/) pour plus de détails.
...
### ** Convertir Docx en PDF avec du texte arabe en utilisant Java **
