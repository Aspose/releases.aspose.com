---
title: "Aspose.Words 22.6 | Doc de New" 
description: "Bibliothèque Java pour créer l'édition de vue et convertir des documents de mots. ASPOSE.WORDS 22.6 prend en charge la conversion des documents en formats de page fixes et plus encore." 
layout: package
...
## Quoi de neuf dans Aspose.Words pour Java API 22.6
- Conversion des documents en formats de pages fixes de haute qualité et performances.
- API pour les tableaux de dessinml avec le support de dégradé, de texture et de remplissage de motifs.
- Improvement in converting DOCX to HTML
- Add loading progress notification for ODT documents
- Amélioration du chargement des documents EPUB avec des entités XHTML.

Veuillez consulter [Release Notes of Aspose.Words for Java 22.6](https://docs.aspose.com/words/java/aspose-words-for-java-22-6-release-notes/) pour plus de détails.
...
### ** Comment convertir le document au format JPEG de page fixe avec de haute qualité en utilisant Java **
...
- ** [Trouver et remplacer en ligne gratuit](https://products.aspose.app/words/replace) ** Pour trouver et remplacer le texte en documents Word, PDF.
