---
title: "Aspose.Words 22.8 | Doc à Azw3 | Docx à azw3 | API Java" 
description: "Bibliothèque Java pour créer l'édition de vue et convertir des documents de mots. ASPOSE.WORDS 22.8 Conversion de support des formats Azw3, Kindle et Mobipocket et plus encore." 
layout: package
...
## Quoi de neuf dans Aspose.Words pour Java API 22.8
- azw3 to docs converter and reader
- Kindle and Mobipocket formats converter and reader
- Autoriser l'espacement des cellules dans les tables lors du rendu.
- Support of chess pawn symbol when converting to PDF from Docs
- Can Convert Phonetic Guide content to TXT

Veuillez consulter [Release Notes of Aspose.Words for Java 22.8](https://docs.aspose.com/words/java/aspose-words-for-java-22-8-release-notes/) pour plus de détails.
...
### ** Comment convertir le document Word au format Azw3 à l'aide de Java **

[Azw3](https://docs.fileformat.com/ebook/azw3/) est une extension de format de fichier utilisé par les lecteurs d'Amazon Kindle.
