...
title: "Téléchargements --- Nouvelles versions-aspose.pdf-for-java-22.7- (JDK1.6-uniquement)"
description: " "
keywords: ""
page_type: single_release_page
folder_link: "/pdf/java/new-releases/aspose.pdf-for-java-22.7-(jdk1.6-only)/"
folder_name: "Aspose.pdf pour Java 22.7 (JDK1.6 seulement)"
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.pdf pour Java 22.7 (JDK1.6 seulement)" imagelink="/resources/img/random-file-icon.png">}}
  {{< Releases/ReleasesButtons >}}
    {{< Releases/ReleasesSingleButtons text="Télécharger" link="/pdf/java/new-releases/aspose.pdf-for-java-22.7-(jdk1.6-only)/e8ffeb532f34d54ff1c05a014682dd84-15-7714" >}}
