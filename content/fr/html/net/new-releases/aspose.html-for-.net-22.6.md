---
title: "API de conversion et de traitement HTML vers JPG pour C#, applications ASP.NET"
description: "API C # .NET pour convertir avec précision le format d'image HTML au format JPG dans vos applications. Algorithmes améliorés pour le rendu et la mise en page de fractionnement de page. Utilisation optimisée de la mémoire."
keywords: ""
page_type: single_release_page
folder_link: "/html/net/new-releases/aspose.html-for-.net-22.6/"
folder_name: "Aspose.HTML pour .NET 22.6"
download_link: "/html/net/new-releases/aspose.html-for-.net-22.6/b74811a5038f48b643c657551772dcfc-4-7574"
download_text: "Download"
Intro_text: "Il contient Aspose.HTML pour la version .NET 22.6."
...
{{< Releases/ReleasesHeading H2txt="Aspose.HTML pour .NET 22.6" imagelink="/resources/img/msi-icon.png">}}
...
<h4>Notes de version</h4><div> <a href='https://docs.aspose.com/html/net/aspose-html-for-net-22-6-release-notes'>https://docs.aspose.com/html/net/aspose-html-for-net-22-6-release-notes</a></div>
{{< /Releases/ReleasesFileFeatures >}}
{{< Releases/ReleasesFileFeatures >}}
...
# Amélioration de la conversion HTML en JPG

Introduction de quelques améliorations dans la conversion d'image HTML en JPG, car auparavant le texte était décalé en haut à gauche de l'image. L'exemple de code C# suivant fonctionne comme un convertisseur HTML vers JPG via l'API.
