---
title: "Amélioration de l'extraction cpio et tar via l'API pour les applications C#, ASP.NET"
description: "Nouvelle version de l'API C # .NET avec la possibilité d'extraire des archives Z à l'aide de l'API sur site. Correction des bogues qui se déclenchaient lors de l'extraction de `cpio` et 'tar'."
keywords: ""
page_type: single_release_page
folder_link: " zip/net/new-releases/aspose.zip-for-.net-22.1/"
folder_name: "Aspose.ZIP pour .NET 22.1"
download_link: " /zip/net/new-releases/aspose.zip-for-.net-22.1/c15d703160244e16a37304e85f1c6a8c"
download_text: " Download"
Intro_text: "Aspose.ZIP pour la version .NET 22.1."
...
{{< Releases/ReleasesHeading H2txt="Aspose.ZIP pour .NET 22.1" imagelink="/resources/img/msi-icon.png">}}
...
{{< Common/li class="hide" id="author-update-c15d703160244e16a37304e85f1c6a8c" >}} Eugène85 {{< /Common/li >}}
...
# Extraire les archives Z

Possibilité d'extraire les archives 'Z'.

# Amélioration de l'extraction CPIO

Correction de ce bogue qui se déclenchait lors de l'extraction de `cpio`.

# Extraction TAR améliorée
