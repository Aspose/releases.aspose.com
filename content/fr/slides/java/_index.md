---
title: "Aspose.slides | Bibliothèque Java pour traiter les formats PowerPoint" 
...
- WordArt
- VBA Macros
family_listing_page_title: "Aspose.s glisse pour Java" 
family_listing_page_description: "ASPOSE.SLAIDS POUR Java est la manipulation et le traitement de l'API de présentation PowerPoint pour lire, écrire, manipuler et convertir des fichiers PowerPoint dans n'importe quelle application basée sur Java. L'API n'a pas de dépendances externes afin qu'elle puisse être utilisée sans nécessiter Microsoft PowerPoint." 
...
Découvrez le [Présentation du produit](https://docs.aspose.com/slides/java/product-overview/) pour tout savoir sur Aspose.s glisser pour Java.
