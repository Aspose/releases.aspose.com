---
title: "Aspose.page | Bibliothèque de classe Java pour le traitement post-scriptumal" 
...
family_listing_page_description: "Aspose.page est une API Java est conçue pour permettre aux développeurs de travailler avec des documents XPS et EPS. À l'aide de l'API, vous pouvez créer, modifier et enregistrer existant ainsi que de nouveaux documents XPS. De plus, vous pouvez convertir les documents XPS et EPS en PDF et images. Il fournit des capacités de manipulation étendues et peut être intégré à tout type d'applications GUI de bureau, d'applications Web et d'applications de console." 
...
[Aspose.Page for Java](https://products.aspose.com/page/java) Offre pour créer et manipuler des documents XPS. Il fournit également des fonctionnalités pour convertir les documents XPS, PS et EPS en formats d'image et PDF.
