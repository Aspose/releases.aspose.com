...
title: "Téléchargements --- Nouvelles versions-aspose.font-for-.net-22.7- (DLLS-Only)"
description: " "
keywords: ""
page_type: single_release_page
folder_link: "/font/net/new-releases/aspose.font-for-.net-22.7-(dlls-only)/"
folder_name: "Aspose.font pour .net 22.7 (DLLS uniquement)"
download_link: "/font/net/new-releases/aspose.font-for-.net-22.7-(dlls-only)/a821e538f34d0a508759100a7ab7809c-1-7647"
download_text: "Télécharger"
intro_text: "This ZIP file contains only the Aspose.Font for .NET assemblies. The assemblies are the same as in the MSI installer of the product of the same version. Télécharger this if you want to use Aspose.Font without the MSI installer, i.e. you cannot run MSI installers on Mono."
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.font pour .net 22.7 (DLLS uniquement)" imagelink="/resources/img/zip-icon.png">}}
  {{< Releases/ReleasesButtons >}}
    {{< Releases/ReleasesSingleButtons text="Télécharger" link="/font/net/new-releases/aspose.font-for-.net-22.7-(dlls-only)/a821e538f34d0a508759100a7ab7809c-1-7647" >}}
