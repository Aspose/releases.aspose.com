...
linktitle: Aspose.3D pour Node.js via Java 25.6 Notes de publication
title: Aspose.3D pour Node.js via Java 25.6 Notes de publication
weight: 7
description: Aspose.3D pour Node.js via Java 25.6 – Notes de publication – les dernières mises à jour et corrections.
type: repository
layout: release
---
...
Cette page contient des informations sur les notes de publication pour Aspose.3D pour Node.js via Java 25.6.
...
Un nouveau champ a été ajouté, qui vous permet d'accéder à l'instance Node/Entity dans BooleanOperand.