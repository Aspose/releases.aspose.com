...
linktitle: Aspose.3D pour Node.js via Java 24.9 Notes de publication
title: Aspose.3D pour Node.js via Java 24.9 Notes de publication
weight: 4
description: Aspose.3D pour Node.js via Java 24.9 – Notes de publication – les dernières mises à jour et corrections.
type: repository
layout: release
---
...
Cette page contient des informations sur les notes de publication pour Aspose.3D pour Node.js via Java 24.9.
...
| THREEDNET-1588 | Exposer les indicateurs internes de la propriété et ajouter une prise en charge de données supplémentaires pour la propriété | Amélioration |
...
Ces classes vous permettent de configurer les fonctionnalités liées à 3MF, comme le marquage du nœud de scène à construire.
