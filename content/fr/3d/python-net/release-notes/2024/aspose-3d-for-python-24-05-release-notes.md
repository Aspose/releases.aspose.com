...
linktitle: Notes de publication Aspose.3D pour Python via .NET 24.5
title: Notes de publication Aspose.3D pour Python via .NET 24.5
weight: 8
description: Aspose.3D pour Python via .NET 24.5 – Notes de publication – les dernières mises à jour et corrections.
type: repository
layout: release
---
...
Cette page contient des informations sur les notes de publication pour Aspose.3D pour Python via .NET 24.5.
...
### Membres ajoutés à la classe **aspose.threed.Scene**:
...
Nouveau champ ajouté pour obtenir la version du programme d'installation Aspose.3D actuel.