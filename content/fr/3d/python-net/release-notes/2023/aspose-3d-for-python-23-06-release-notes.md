...
linktitle: Notes de publication Aspose.3D pour Python via .NET 23.6
title: Notes de publication Aspose.3D pour Python via .NET 23.6
weight: 7
description: Aspose.3D pour Python via .NET 23.6 – Notes de publication – les dernières mises à jour et corrections.
type: repository
layout: release
---
...
Cette page contient des informations sur les notes de publication pour Aspose.3D pour Python via .NET 23.6.
...
Aspose.3D pour Python via .NET 23.6 a ajouté une prise en charge expérimentale d'IFC (2.3 et 4), et davantage de prise en charge des fichiers IFC sera ajoutée à l'avenir.
