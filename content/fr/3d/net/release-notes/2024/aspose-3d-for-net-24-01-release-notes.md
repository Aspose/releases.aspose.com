...
linktitle: Notes de publication Aspose.3D pour .NET 24.1
title: Notes de publication Aspose.3D pour .NET 24.1
weight: 12
description: Notes de publication Aspose.3D pour .NET 24.1 – les dernières mises à jour et corrections.
type: repository
layout: release
---
...
Cette page contient des informations sur les notes de publication pour Aspose.3D pour .NET 24.1.
...
| THREEDNET-1475 | Exportation d'animations en GLTF | Tâche |
| THREEDNET-1476 | Autoriser l'exportation d'animations de rotation basées sur les angles d'Euler vers glTF | Amélioration |
...
| THREEDNET-1477 | Les coordonnées de la texture sont corrompues lors de la sauvegarde de fichiers glTF. | Correction de bug |
...
Les interfaces plus anciennes dans *AnimationChannel* conçues pour accéder aux séquences d'images clés seront obsolètes à l'avenir. Cette nouvelle propriété servira de remplacement. Actuellement, il n'y a aucune indication qu'une seule séquence d'images clés est utilisée pour un canal d'animation unique.
...
{{< highlight csharp >}}
        ...
        /// </summary>
        /// <param name="t">t est entre 0 et 1</param>
        /// <param name="v1">Première valeur</param>
        /// <param name="v2">Deuxième valeur</param>
