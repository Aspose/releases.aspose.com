...
linktitle: Notes de publication Aspose.3D pour .NET 23.2
title: Notes de publication Aspose.3D pour .NET 23.2
weight: 11
description: Notes de publication Aspose.3D pour .NET 23.2 – les dernières mises à jour et corrections.
type: repository
layout: release
---
...
Cette page contient des informations sur les notes de publication pour Aspose.3D pour .NET 23.2.
...
Dans la version 23.2, nous avons corrigé quelques bogues dans glTF et Draco, et il n'y a pas de modifications de l'API.