...
linktitle: Notes de publication Aspose.3D pour .NET 25.7
title: Notes de publication Aspose.3D pour .NET 25.7
weight: 6
description: Notes de publication Aspose.3D pour .NET 25.7 – les dernières mises à jour et corrections.
type: repository
layout: release
---
...
Cette page contient des informations sur les notes de publication pour Aspose.3D pour .NET 25.7.
...
| THREEDNET-1699 | Ajouter la prise en charge du groupement IFC | Tâche |
...
Cette classe définit les regroupements de relations logiques, distincts de la classe `Node` qui représente les relations hiérarchiques pour le rendu. Actuellement, cette fonctionnalité n'est disponible que lors du travail avec le format IFC.
