---
title: "Prise en charge des fichiers temporaires pour l'API FBX Importer pour C#, applications ASP.NET"
description: "API C# .NET avec prise en charge du système de fichiers temporaire interne pour l'importateur FBX et prise en charge améliorée de l'exportation de fichiers GLTF via l'API de manipulation de format 3D."
keywords: ""
page_type: single_release_page
folder_link: "/3d/net/new-releases/aspose.3d-for-.net-22.9/"
folder_name: "Aspose.3D pour .NET 22.9"
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.3D pour .NET 22.9" imagelink="/resources/img/msi-icon.png">}}
...
# Prise en charge des fichiers temporaires pour l'importateur FBX

Ajout de la prise en charge du système de fichiers temporaire interne pour l'importateur FBX.

# Amélioration de l'exportation GLTF
