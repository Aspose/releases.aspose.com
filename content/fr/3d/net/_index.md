---
title: Télécharger C# Gameware, CAD et DLL de traitement 3D | Aspose.3D
description: Télécharger la DLL contenant la bibliothèque de classes C# pour travailler avec des fichiers 3D (3DS, 3MF, DAE, DFX, USD, Blender, OpenUSD, MA, gITF, U3D), des maillages, des géométries, des scènes, des animations via l’API .NET sur site.
...
Ouvrez le {{< Common/link href="https://www.nuget.org/packages/Aspose.3D/" text="NuGet"  >}} Package Manager dans Microsoft Visual Studio&reg;, recherchez <b>Aspose.3D</b> et installez-le. Vous pouvez également utiliser la commande suivante dans la console du Package Manager. Pour des instructions détaillées, veuillez consulter la page de documentation {{< Common/link href="https://docs.aspose.com/3d/net/installation/" text="Installation"  >}}. 
...
[Page Produit](https://products.aspose.com/3d/net/) | [Docs](https://docs.aspose.com/3d/net/) | [Référence API](https://reference.aspose.com/3d/net/) | [Exemples](https://github.com/aspose-3d/Aspose.3D-for-.NET/tree/master/Examples) | [Blog](https://blog.aspose.com/category/3d/) | [Versions](https://releases.aspose.com/) | [Support](https://forum.aspose.com/c/3d) | [Licence](https://purchase.aspose.com/temporary-license)

[Aspose.3D pour .NET](https://products.aspose.com/3d/net/) permet aux applications .NET d’interagir avec les formats de documents 3D. L’API .NET 3D permet aux ingénieurs de lire, convertir, créer, modifier et contrôler le contenu des [formats de documents 3D](https://docs.aspose.com/3d/net/supported-file-formats/) sans qu’aucun logiciel de modélisation ou de rendu 3D ne soit installé sur la machine.

## Détection du format de fichier 3D

> ### Exemple de programmation pour détecter le format
...
## Travail avec les transformations 3D

> ### Ajouter une transformation au nœud
...
> ### Simplifier la création d’une matrice de transformation
...
> ### Ajouter des informations d’actif à la scène
...
> ### Configurer la caméra cible dans un fichier 3D
...
> #### Vulkan : uniquement plateforme x64, matériel compatible :
...
Vous pouvez exécuter le fragment de code ci‑dessous pour voir comment Aspose.3D fonctionne dans votre environnement ou consulter le [dépôt GitHub](https://github.com/aspose-3d/Aspose.3D-for-.NET) pour d’autres scénarios d’utilisation courants.
