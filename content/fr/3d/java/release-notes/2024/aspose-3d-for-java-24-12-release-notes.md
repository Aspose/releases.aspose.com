...
linktitle: Notes de publication Aspose.3D pour Java 24.12
title: Notes de publication Aspose.3D pour Java 24.12
weight: 1
description: Notes de publication Aspose.3D pour Java 24.12 – les dernières mises à jour et corrections.
type: repository
layout: release
---
...
Cette page contient des informations sur les notes de publication pour Aspose.3D pour Java 24.12.
...
### Classe renommée de **Aspose.ThreeD.Utilities.IOUtils** à **Aspose.ThreeD.Utilities.IOExtension**