---
title: "Téléchargez les fichiers JAR pour créer et composer TeX | API Aspose.TeX"
description: "Téléchargez les fichiers JAR pour ajouter une fonctionnalité de composition dans votre application. Convertissez TeX et LaTeX en PDF, XPS, SVG, etc. Prend en charge les sous-ensembles de polices, la ligature, la rastérisation, etc."
keywords: "tex"
family_listing_page_title: "Aspose.TeX pour Java"
family_listing_page_description: "Aspose.TeX pour Java est une API Java créée pour permettre aux développeurs de créer des applications pour la composition de fichiers TeX."
...
{{< Common/h2 text="Télécharger Aspose.TeX vers les fichiers TypeSet TeX"  >}}
{{< Common/paragraph class="package-instructions">}}
Aspose héberge toutes les API Java au
{{< Common/link href="https://repository.aspose.com" text="Référentiel Aspose"  >}}. Vous pouvez facilement utiliser l'API Aspose.TeX pour Java directement dans vos projets basés sur Maven en ajoutant les configurations suivantes à votre pom.xml. Pour les instructions détaillées, veuillez visiter
{{< Common/link href="https://docs.aspose.com/tex/java/installation/" text="Installation d'Aspose.TeX pour Java à partir du référentiel Maven"  >}}page documentaire.
...
## Pourquoi télécharger Aspose.TeX pour Java ?

Aspose.TeX pour Java est une bibliothèque qui fournit une extension de moteur TeX appelée ObjectTeX. Il peut être utilisé pour composer des documents décrits par des fichiers TeX. "Objet" signifie que le résultat de la composition intermédiaire est un modèle d'objet spécifique qui peut ensuite être uniformément converti en un certain nombre de formats finaux.
