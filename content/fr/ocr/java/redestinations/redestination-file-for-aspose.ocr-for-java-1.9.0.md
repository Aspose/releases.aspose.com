...
Intro_text: "Aspose.OCR pour Java utilise un fichier de ressources pour effectuer des opérations OCR sur l'i..."
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Fichier de ressources pour Aspose.OCR pour Java 1.9.0" imagelink="/ressources/img/zip-icon.png">}}
