---
title: "API d'exportation de caractères spéciaux hongrois pour C#, applications ASP.NET"
description: "API C # .NET pour exporter les caractères spéciaux hongrois de DWG au format PDF, résolution de l'exception de conversion DWG en PDF, amélioration de la sensibilité de la scène en mouvement."
keywords: ""
page_type: single_release_page
folder_link: "/cad/net/new-releases/aspose.cad-for-.net-22.9/"
folder_name: "Aspose.CAD pour .NET 22.9"
download_link: "/cad/net/new-releases/aspose.cad-for-.net-22.9/745f60fdf74c2633f882960b7eb8e9bf-12-7979"
download_text: "Download"
Intro_text: "Contient le programme d'installation MSI pour l'installation complète du produit Aspose.CAD pour .NET v22.9"
...
{{< Releases/ReleasesHeading H2txt="Aspose.CAD pour .NET 22.9" imagelink="/resources/img/msi-icon.png">}}
...
# Exporter les caractères spéciaux hongrois

Auparavant, dans certains cas, les caractères spéciaux hongrois étaient exportés à tort de DWG vers PDF. Dans cette version de l'API, le problème susmentionné a été résolu.

# Amélioration de la conversion DWG en PDF

Correction de `OutOfMemoryError` lors de la conversion du format `DWG` au format `PDF`.

# Sensibilité de déplacement de scène améliorée
