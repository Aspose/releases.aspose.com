...
title: "Téléchargements --- Nouvelles sorties-aspose.omr-for- .net-22.8- (DLLS-Only)"
description: " "
keywords: ""
page_type: single_release_page
folder_link: "/omr/net/new-releases/aspose.omr-for-.net-22.8-(dlls-only)/"
folder_name: "Aspose.omr pour .net 22.8 (DLLS uniquement)"
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.omr pour .net 22.8 (DLLS uniquement)" imagelink="/resources/img/zip-icon.png">}}
  {{< Releases/ReleasesButtons >}}
    {{< Releases/ReleasesSingleButtons text="Télécharger" link="/omr/net/new-releases/aspose.omr-for-.net-22.8-(dlls-only)/7c7ea16d496e1d11a6911590fddde65c-16-7783" >}}
