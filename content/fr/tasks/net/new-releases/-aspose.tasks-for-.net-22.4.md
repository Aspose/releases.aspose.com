---
title: "Importer des fichiers XER multi-projets via l'API pour les applications C#, ASP.NET"
description: "API C # .NET avec prise en charge de l'importation de fichiers Primavera P6 XER multi-projets, amélioration de l'importation des contraintes de tâche pour XER, lecture des champs définis par l'utilisateur pour le format XER."
keywords: ""
page_type: single_release_page
folder_link: " tasks/net/new-releases/-aspose.tasks-for-.net-22.4/"
folder_name: "Aspose.Tasks pour .NET 22.4"
download_link: " /tasks/net/new-releases/-aspose.tasks-for-.net-22.4/cb38223312834315985a65994c750d25"
download_text: " Download"
Intro_text: "Il contient MSI avec Aspose.Tasks pour la version .NET 22.4."
...
{{< Releases/ReleasesHeading H2txt="Aspose.Tasks pour .NET 22.4" imagelink="/resources/img/msi-icon.png">}}
...
# Importer des fichiers XER multi-projets

Extension de l'importation Primavera P6 `XER` et prise en charge désormais de l'importation de fichiers `XER` avec plus d'un (1) projet.

# Importation améliorée des contraintes de tâche pour XER

Ajout de la possibilité de spécifier le comportement d'importation des contraintes de tâche pour le format `XER`.

# Lire les champs définis par l'utilisateur pour le format XER
