---
title: "Diagramme de Gantt de rendu, API de temps de travail immuable C #, applications ASP.NET"
description: "API C # .NET pour rendre la valeur du temps de travail du projet immuable, lire, écrire la date d'état, à partir du fichier XER, prise en charge du jeton d'annulation pour le chargement du projet."
keywords: ""
page_type: single_release_page
folder_link: " tasks/net/new-releases/-aspose.tasks-for-.net-22.3/"
folder_name: "Aspose.Tasks pour .NET 22.3"
download_link: " /tasks/net/new-releases/-aspose.tasks-for-.net-22.3/979f1b2d8a3746e58779d874d9cfe76a"
download_text: " Download"
Intro_text: "Il contient MSI avec Aspose.Tasks pour la version .NET 22.3."
...
{{< Releases/ReleasesHeading H2txt="Aspose.Tasks pour .NET 22.3" imagelink="/resources/img/msi-icon.png">}}
...
# Rendre `WorkingTime` immuable

Rendu la valeur du temps de travail immuable.

# Fonctionnalité améliorée de la date d'état

Ajout de la possibilité de lire et d'écrire la date d'état vers ou depuis un fichier `XER`.

# Jeton d'annulation pour le chargement du projet
