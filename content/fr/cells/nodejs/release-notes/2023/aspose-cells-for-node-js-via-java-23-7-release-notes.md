...
linktitle: Aspose.Cells for Node.js via Java 23.7 Note de version
title: Aspose.Cells for Node.js via Java 23.7 Note de version
weight: 6
description: Aspose.Cells for Node.js via Java 23.7 Notes de version – les dernières améliorations, nouvelles fonctionnalités et correctifs
type: repositor
layout: releas
...
{{% alert color="primary" %}}
 ...
 Cette page contient des notes de version pour[Aspose.Cells for Node.js via Java 23.7](https://releases.aspose.com/cells/nodejs/new-releases/aspose.cells-for-node.js-via-java-23.7/).
...
|CELLSNODEJSJAVA-50|Les textes ne peuvent pas être remplacés correctement après avoir hérité de la classe PivotGlobalizationSettings|
