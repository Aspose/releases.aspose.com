...
linktitle: "Aspose.Cells for Node.js via Java 20.2 Notes de mise à jour"
title: "Aspose.Cells for Node.js via Java 20.2 Notes de mise à jour"
weight: 10
description: "Aspose.Cells for Node.js via Java 20.2 Notes de mise à jour – the latest updates and fixes."
type: "repository"
layout: "release"
family_listing_page_title: "Aspose.Cells for Node.js via Java 20.2 Notes de mise à jour"
---
{{% alert color="primary" %}} 

Cette page contient les notes de version pour Aspose.Cells for Node.js via Java 20.2.
