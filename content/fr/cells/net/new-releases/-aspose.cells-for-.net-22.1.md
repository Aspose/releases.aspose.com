---
title: Détection automatique du format de fichier CSV et TSV API pour l'application C#, ASP.NET
description: C# .NET API avec prise en charge de la définition du nom du travail d'impression pour restituer les feuilles de calcul à l'imprimante, détection automatique du fichier texte comme CSV/TSV, exclusion des lignes/colonnes masquées de la plage
keywords: ""
...
{{< Releases/ReleasesWapper >}}
  ...
  {{< Releases/ReleasesButtons >}}
    {{< Releases/ReleasesSingleButtons text=" Télécharger" link="/cells/net/new-releases/-aspose.cells-for-.net-22.1/8aa0c74982524d5d9ec0a165334ff68d%20%20" >}}
  ...
  {{< Releases/ReleasesFileArea >}}
    ...
    {{< Releases/ReleasesDetailsUl >}}
      ...
      {{< Common/li id="size-update-8aa0c74982524d5d9ec0a165334ff68d" >}} 101,4 Mo{{< /Common/li >}} 
      {{< Common/li class="hide" >}} Posté par:{{< /Common/li >}} 
      {{< Common/li class="hide" id="author-update-8aa0c74982524d5d9ec0a165334ff68d" >}} <li> Vues :{{< /Common/li >}} 
      {{< Common/li >}} 205: {{< /Common/li >}} 
      {{< Common/li id="205-update-8aa0c74982524d5d9ec0a165334ff68d" >}} Date ajoutée::{{< /Common/li >}} 
...
Ajout de la prise en charge pour fournir et définir le nom du travail d'impression avec `PrinterSettings` lors du rendu des feuilles de calcul sur l'imprimante.

#  Détection automatique du format de fichier `CSV` et `TSV`

Cette version API introduit la possibilité de détecter automatiquement les fichiers texte aux formats de fichiers `CSV` séparés par des virgules et `TSV` séparés par des tabulations à l'aide de API.

#  Exclure les lignes/colonnes masquées de la plage
