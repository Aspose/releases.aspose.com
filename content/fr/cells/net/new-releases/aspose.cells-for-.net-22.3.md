---
title: Modèle de feuille de calcul XLT (Excel) OTS (Calc) API C# .NET Application
description: C# .NET API avec prise en charge des formats de modèles de feuilles de calcul Excel® (XLT) et Calc (OTS), définition des bordures intérieures, tri des valeurs des champs pivots selon la colonne ou la ligne sélectionnée
keywords: ""
...
{{< Releases/ReleasesWapper >}}
  ...
  {{< Releases/ReleasesButtons >}}
    {{< Releases/ReleasesSingleButtons text=" Télécharger" link="/cells/net/new-releases/aspose.cells-for-.net-22.3/c293581525754554a9ea2092b4c27669%20%20" >}}
  ...
  {{< Releases/ReleasesFileArea >}}
    ...
    {{< Releases/ReleasesDetailsUl >}}
      ...
      {{< Common/li id="size-update-c293581525754554a9ea2092b4c27669" >}} 102,1 Mo{{< /Common/li >}} 
...
#  Prise en charge des formats de modèles de feuilles de calcul

Cette version API a introduit la prise en charge des formats de modèles de feuilles de calcul pour Excel® et Excel®. (XLT) et OpenOffice Calc® (OTS). Ceux-ci sont pris en charge comme formats de sortie via `SaveFormat.Ots` et `SaveFormat.Xlt`.

#  Définir des bordures intérieures

Possibilité de définir les bordures intérieures.

#  Trier PivotField par ligne ou colonne sélectionnée
