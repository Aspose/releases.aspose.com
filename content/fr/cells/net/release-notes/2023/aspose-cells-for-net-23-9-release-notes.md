...
linktitle: Aspose.Cells for .NET 23.9 Note de version
title: Aspose.Cells for .NET 23.9 Note de version
weight: 4
description: Aspose.Cells pour .Net 23.9 Notes de version – dernières améliorations, nouvelles fonctionnalités et correctifs
type: repositor
layout: releas
...
{{% alert color="primary" %}}
 ...
 Cette page contient des notes de version pour[Aspose.Cells for .NET 23.9](https://www.nuget.org/packages/Aspose.Cells/23.9.0).
...
|CELLSNET-53961|Régression : Cell.StringValueWithoutFormat() ne renvoie pas la valeur correcte|
