...
linktitle: "Aspose.Cells for Java 19.4 Notes de mise à jour"
title: "Aspose.Cells for Java 19.4 Notes de mise à jour"
weight: 90
description: "Aspose.Cells for Java 19.4 Notes de mise à jour – the latest updates and fixes."
type: "repository"
layout: "release"
family_listing_page_title: "Aspose.Cells for Java 19.4 Notes de mise à jour"
---
{{% alert color="primary" %}} 

Cette page contient les notes de version pour Aspose.Cells for Java 19.4.
...
|CELLSJAVA-42856|Problème de conversion Excel vers HTML|Punaise|
...
|CELLSJAVA-42874|Perte de colonne lors de l'export du fichier vers HTML|Punaise|
...
### **Ajoute les méthodes CommentCollection.AddThreadedComment() et CommentCollection.GetThreadedComments().**
Ajoute et obtient les commentaires filetés.
### **Ajoute la propriété Chart.SubTitle.**
