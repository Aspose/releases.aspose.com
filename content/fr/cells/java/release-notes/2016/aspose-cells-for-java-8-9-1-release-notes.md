...
linktitle: "Aspose.Cells for Java 8.9.1 Notes de mise à jour"
title: "Aspose.Cells for Java 8.9.1 Notes de mise à jour"
weight: 60
description: "Aspose.Cells for Java 8.9.1 Notes de mise à jour – the latest updates and fixes."
type: "repository"
layout: "release"
family_listing_page_title: "Aspose.Cells for Java 8.9.1 Notes de mise à jour"
---
## **1) Aspose.Cells**
...
Étant donné que la base de code de Aspose.Cells for Java correspond au code de la version .NET pertinente, la plupart des modifications, améliorations et correctifs inclus dans le Aspose.Cells for .NET v8.9.1 sont également inclus dans ce Aspose.Cells for Java v8.9.1.
