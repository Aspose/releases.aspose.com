---
title: "Aspose.email | Bibliothèque de classe Java pour traiter les formats Outlook" 
...
family_listing_page_description: "Aspose.email pour Java est un ensemble d'API de traitement par e-mail pour créer, manipuler ou convertir des formats de messages tels que MSG, EML & MHT à partir des applications Java. L'API offre la possibilité de manipuler le contenu des messages, les en-têtes, les pièces jointes et les propriétés MAPI ainsi que la capacité d'envoyer et de recevoir des messages via un certain nombre de protocoles populaires" 
