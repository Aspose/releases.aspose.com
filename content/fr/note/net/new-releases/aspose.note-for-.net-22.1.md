---
title: "Get Set API de couleur d'arrière-plan de page OneNote® pour les applications C#, .NET"
description: "API C# .NET avec la possibilité d'obtenir ou de définir la couleur d'arrière-plan de la page d'un document Micorosft OneNote® .ONE. Indentation améliorée pour le contenu OutlineElement."
keywords: ""
page_type: single_release_page
folder_link: " note/net/new-releases/aspose.note-for-.net-22.1/"
folder_name: "Aspose.Note pour .NET 22.1"
download_link: " /note/net/new-releases/aspose.note-for-.net-22.1/22ac41f1a603464baebf4913e5abee7a"
download_text: " Download"
Intro_text: "Il contient Aspose.Note pour la version .NET 22.1."
...
{{< Releases/ReleasesHeading H2txt="Aspose.Note pour .NET 22.1" imagelink="/resources/img/msi-icon.png">}}
...
# Obtenir ou définir la couleur d'arrière-plan de la page OneNote®

Possibilité d'obtenir ou de définir la couleur d'arrière-plan de la page d'un document Microsoft OneNote® via l'API.

# Amélioration de l'indentation pour le contenu de `OutlineElement`
