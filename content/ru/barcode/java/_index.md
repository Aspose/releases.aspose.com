---
title: "Aspose.barcode | Процесс 1D, 2D и почтовые штрих -коды через Java" 
...
family_listing_page_description: "Aspose.barcode для Java - это надежный и надежный компонент генерации и распознавания штрих -кода. Это позволяет разработчикам быстро и легко добавлять функции генерации и распознавания штрих -кодов в свои приложения Java на основе платформ Java SE, Java EE и Java ME." 
...
[Aspose.BarCode for Java](https://products.aspose.com/barcode/java) - это надежный и надежный компонент генерации и распознавания штрих -кодов, написанный на Java, он позволяет разработчикам быстро и легко добавлять генерацию и функциональность распознавания штрих -кодов в свои приложения Java.
...
- ** java runtime: ** `jre 8` или выше
- ** Java Development: ** `java se 8` или выше.
