---
title: "Оптимизация размера PSD при экспорте через API для приложений C#, ASP.NET"
description: "C# .NET API с поддержкой ресурсов раздела изображений PSD 4000-4999; т.е. ресурс(ы) подключаемого модуля оптимизировали размер файла PSD после экспорта с подпапками."
keywords: ""
page_type: single_release_page
folder_link: "/psd/net/new-releases/aspose.psd-for-.net-22.7/"
folder_name: "Aspose.PSD для .NET 22.7"
download_link: "/psd/net/new-releases/aspose.psd-for-.net-22.7/fc770812bf472a7e51d285f141daf048-6-7604"
download_text: "Download"
Intro_text: "Он содержит Aspose.PSD для выпуска .NET 22.7."
...
{{< Releases/ReleasesHeading H2txt="Aspose.PSD для .NET 22.7" imagelink="/resources/img/msi-icon.png">}}
...
# Поддержка ресурса подключаемого модуля PSD

Добавлена поддержка ресурса PSD Image Section Resource 4000-4999; т. е. ресурс(ы) подключаемого модуля.

# Улучшенная оптимизация размера файла PSD
