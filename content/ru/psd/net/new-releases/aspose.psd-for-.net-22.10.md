---
title: "Эффект прозрачности обводки PSD через API для приложений C#, ASP.NET"
description: "C# .NET API для применения эффекта прозрачной обводки в PSD-графике Photoshop, анализа и рендеринга азиатских символов, создания временной шкалы, настройки определенных кадров."
keywords: ""
page_type: single_release_page
folder_link: "/psd/net/new-releases/aspose.psd-for-.net-22.10/"
folder_name: "Aspose.PSD для .NET 22.10"
download_link: "/psd/net/new-releases/aspose.psd-for-.net-22.10/b0e93000b745d64a41993103f2e608df-6-7952"
download_text: "Download"
Intro_text: "Он содержит Aspose.PSD для выпуска .NET 22.10."
...
{{< Releases/ReleasesHeading H2txt="Aspose.PSD для .NET 22.10" imagelink="/resources/img/msi-icon.png">}}
...
<h4>Примечания к выпуску</h4><div> <a href='https://releases.aspose.com/psd/net/release-notes/2022/aspose-psd-for-net-22-10-release-notes/'>https://releases.aspose.com/psd/net/release-notes/2022/aspose-psd-for-net-22-10-release-notes/</a></div>
{{< /Releases/ReleasesFileFeatures >}}
{{< Releases/ReleasesFileFeatures >}}
...
# Эффекты прозрачной обводки Photoshop®
Прозрачность работает для эффекта «Обводка» с внутренним положением для файлов PSD.
...
# Разбор и рендеринг азиатских символов в Photoshop®
Разберите или обновите текст некоторыми азиатскими символами, например, китайскими.
...
# Создание временной шкалы Photoshop® через C# .NET API
Создавайте эффекты временной шкалы и настраивайте определенные кадры.
...
Полный список функций, улучшений и ошибок, исправленных в этом выпуске, см. на странице [Aspose.PSD for .NET 22.10 - Release Notes](https://releases.aspose.com/psd/net/release-notes/2022/aspose-psd-for-net-22-10-release-notes/).
