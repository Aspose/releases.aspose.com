---
title: "Aspose.words 21,7 | Форматы документов процесса через Java API" 
...
- ** [Бесплатное слияние почты онлайн](https://products.aspose.app/words/mailmerge) ** для создания электронных писем и документов с использованием синтаксиса шаблона Mail Merge.
