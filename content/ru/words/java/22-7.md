---
title: "Aspose.words 22.7 | Новые документы в PDF/UA-1 WCAG 2.0" 
description: "Библиотека Java для создания редактирования и преобразования документов Word. Aspose.words 22.7 поддерживает WCAG 2.0 PDF, поле базы данных, OpenType (CFF) и многое другое." 
layout: package
...
## Что нового в Aspose.words для Java API 22.7
...
Пожалуйста, смотрите [Release Notes of Aspose.Words for Java 22.7](https://docs.aspose.com/words/java/aspose-words-for-java-22-7-release-notes/) для получения полной информации.
...
### ** Конвертировать документ в PDF/UA-1, соответствующий WCAG 2.0 в Java **
...
public class AsposeДок2PDF_UA_1_Compliant_WCAG20_Converter {
