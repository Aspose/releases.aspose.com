---
title: "Aspose.words 22.9 | Слово TO PDF уменьшить размер | Java API" 
description: "Библиотека Java для создания редактирования и преобразования документов Word. Aspose.words 22.9 Поддержка преобразования в PDF с кэшированием форм, чтобы уменьшить размер файла PDF и многое другое." 
layout: package
...
## Что нового в Aspose.words для Java API 22.9
- Внедрение кэширования заголовка/нижнего колонтитула, чтобы уменьшить размер PDF.
- Внедрение водяных знаков кэширует через кадр XOBjects.
- Улучшение в табличных границах, клеточные границы во время рендеринга в PDF.
- Улучшение в RTF в PDF -преобразование в сжимаемом столе.
- Фиксированный текст перекрытый рендеринг по толке на изображение SVG.
- Фиксированные значения метки данных Изменены заказа во время рендеринга.

Пожалуйста, смотрите [Release Notes of Aspose.Words for Java 22.9](https://docs.aspose.com/words/java/aspose-words-for-java-22-9-release-notes/) для получения полной информации.
...
### ** Как уменьшить размер файла при преобразовании Word в PDF, используя Java **
...
public class AsposeДок2PDFReduceFileSizeConverter {
...
- ** [Free Online Document Поиск](https://products.aspose.app/words/search) ** для поиска контента внутри документов с помощью строк и регулярных выражений.
