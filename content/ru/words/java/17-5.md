---
title: "Aspose.words 17.5 | Форматы документов процесса через Java API" 
...
### ** Как добавить комментарии в Word, используя Java **
...
- ** [Бесплатное онлайн -вращение](https://products.aspose.app/words/rotate) **, чтобы повернуть документы и изображения PDF. Изменить ориентацию страницы с портрета на пейзаж и в противоположном направлении.

- ** [Бесплатный онлайн -перевод](https://products.aspose.app/words/translator) ** в простой перевод для слов, PDF и другого документа.
