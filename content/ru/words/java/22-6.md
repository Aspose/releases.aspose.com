---
title: "Aspose.words 22.6 | Новый DOC для фиксированных форматов страниц" 
description: "Библиотека Java для создания редактирования и преобразования документов Word. Aspose.words 22.6 поддерживает преобразование документов в фиксированные форматы страниц и многое другое." 
layout: package
...
## Что нового в Aspose.words для Java API 22.6
- Преобразование документов в фиксированные форматы страниц с высоким качеством и производительностью.
- API для графиков рисования с поддержкой градиента, текстуры и заполнения рисунка.
- Improvement in converting DOCX to HTML
- Add loading progress notification for ODT documents
- Улучшение загрузки документов EPUB с помощью объектов XHTML.

Пожалуйста, смотрите [Release Notes of Aspose.Words for Java 22.6](https://docs.aspose.com/words/java/aspose-words-for-java-22-6-release-notes/) для получения полной информации.
...
### ** Как преобразовать документ в фиксированную страницу JPEG Format с высоким качеством с использованием Java **
...
public class AsposeДок2FIXEDPageJpgeHighQualityConverter {
...
- ** [Бесплатная онлайн найти и заменить](https://products.aspose.app/words/replace) **, чтобы найти и заменить текст в Word, PDF документы.
