...
title: "Загрузки --- Новые релизы-слов для Java-22.6- (JDK1.6)"
description: " "
keywords: ""
page_type: single_release_page
folder_link: "/words/java/new-releases/aspose.words-for-java-22.6-(jdk1.6-only)/"
folder_name: "Aspose.words для Java 22.6 (только JDK1.6)"
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.words для Java 22.6 (только JDK1.6)" imagelink="/resources/img/random-file-icon.png">}}
  {{< Releases/ReleasesButtons >}}
    {{< Releases/ReleasesSingleButtons text="Скачать" link="/words/java/new-releases/aspose.words-for-java-22.6-(jdk1.6-only)/b099751731d0313831feb46f6929a351-4-7584" >}}
