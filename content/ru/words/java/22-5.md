---
title: "Aspose.words 22.5 | Новый документ Epub Converter" 
description: "Библиотека Java для создания редактирования и преобразования документов Word. Aspose.words 22.5 Поддержите преобразование Эвеб, загрузка XML, улучшение RTF в PDF и многое другое." 
layout: package
...
[Aspose.Words for Java](https://products.aspose.com/words/java) - это расширенный API обработки текстов Java, который позволяет вам выполнять большой диапазон задач обработки документов непосредственно в ваших приложениях Java. Aspose.words для Java API поддерживает обработку слов (DOC, DOCX, OOXML, RTF) HTML, OpenDocument, PDF, Эвеб, XPS, SWF и все форматы изображений. С помощью Aspose.words вы можете генерировать, изменять и преобразовать документы без использования Microsoft Word & Reg;.

## Что нового в Aspose.words для Java API 22.5
- Words to Эвеб file format conversion and rendering
...
Пожалуйста, смотрите [Release Notes of Aspose.Words for Java 22.5](https://docs.aspose.com/words/java/aspose-words-for-java-22-5-release-notes/) для получения полной информации.
...
### ** Как преобразовать документ Word в формат файла epub, используя Java **

[Эвеб](https://docs.fileformat.com/ebook/epub/) - расширение формата файла, используемое для предоставления стандартного цифрового формата публикации для издателей и потребителей.
...
public class AsposeДок2ЭвебConverter {

	//Java Main function to convert doc to Эвеб document
	public static void main(String[] args) throws Exception {
		...
		// Save the input word DOCX file to Эвеб document format
		wordDoc.save(dataDir + "SaveWordToЭвеб.epub", SaveFormat.Эвеб);
	}
}
```
...
- ** [Бесплатный онлайн -документы Защитник](https://products.aspose.app/words/protect) **, чтобы защитить документы Word с помощью пароля с помощью вашего любимого браузера.
