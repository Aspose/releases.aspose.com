...
title: "Загрузки --- Новые релизы-слов-for-.net-22.9- (только DLLS)"
description: " "
keywords: ""
page_type: single_release_page
folder_link: "/words/net/new-releases/aspose.words-for-.net-22.9-(dlls-only)/"
folder_name: "Aspose.words для .net 22.9 (только DLL)"
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.words для .net 22.9 (только DLL)" imagelink="/resources/img/zip-icon.png">}}
  {{< Releases/ReleasesButtons >}}
    {{< Releases/ReleasesSingleButtons text="Скачать" link="/words/net/new-releases/aspose.words-for-.net-22.9-(dlls-only)/ec53847d57f13c548771dc5bd99a05de-17-7858" >}}
  ...
  {{< Releases/ReleasesFileFeatures >}}
      <h4>Выпуск заметок</h4><div><a href='https://docs.aspose.com/words/net/aspose-words-for-net-22-9-release-notes/'>https://docs.aspose.com/words/net/aspose-words-for-net-22-9-release-notes/</a></div>
  {{< /Releases/ReleasesFileFeatures >}}
  {{< Releases/ReleasesFileFeatures >}}
