...
intro_text: "Он содержит aspose.font для выпуска .NET 22.7"
...
> For a complete list of features, enhancements, and bug fixes in this release please visit, [Aspose.Font for .NET 22.7 Выпуск заметок](https://releases.aspose.com/font/net/release-notes/2022/aspose-font-for-net-22-7-release-notes/).
