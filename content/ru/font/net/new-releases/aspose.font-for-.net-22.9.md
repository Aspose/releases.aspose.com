---
title: "OTF TO TTF | OpenType to trueType | API для C#, приложения ASP.NET"
...
{{< Releases/ReleasesHeading H2txt="Aspose.font для .net 22.9" imagelink="/resources/img/msi-icon.png">}}
{{< Releases/ReleasesButtons >}}
{{< Releases/ReleasesSingleButtons text="Скачать" link="/font/net/new-releases/aspose.font-for-.net-22.9/5db29c34ea08d295441b3b3891ae064f-1-7904" >}}
...
> For a complete list of features, enhancements, and bug fixes in this release please visit, [Aspose.Font for .NET 22.9 Выпуск заметок](https://releases.aspose.com/font/net/release-notes/2022/aspose-font-for-net-22-9-release-notes/).
