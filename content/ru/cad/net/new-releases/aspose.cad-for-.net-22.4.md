---
title: "Преобразование DXF в TIFF и DWG в WMF API для приложений C#, ASP.NET"
description: "C# .NET API с улучшенным управлением памятью при преобразовании AutoCAD® DXF в TIFF, экспорте DWG в WMF, экспорте изображения из встроенных данных изображения, улучшенном рендеринге DWG."
keywords: ""
page_type: single_release_page
folder_link: " cad/net/new-releases/aspose.cad-for-.net-22.4/"
folder_name: "Aspose.CAD для .NET 22.4"
...
{{< Releases/ReleasesHeading H2txt="Aspose.CAD для .NET 22.4" imagelink="/resources/img/msi-icon.png">}}
...
Утечка памяти наблюдалась при преобразовании AutoCAD® DXF в формат TIFF (растровая графика). Таким образом, этот выпуск API предлагает лучшее управление памятью для преобразования DXF в TIFF.

# Улучшенный экспорт DWG в WMF

Улучшен экспорт AutoCAD® `DWG` в `WMF` (метафайл Windows).

# Экспорт встроенного изображения

Возможность экспорта изображения из встроенных данных изображения.

# Улучшенный рендеринг `DWG`
