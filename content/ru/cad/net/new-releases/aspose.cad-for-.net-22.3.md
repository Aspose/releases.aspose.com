---
title: "Поддержка CAD Big Font Convert DWG to PDF API для приложений C# .NET"
description: "C# .NET API с добавленной поддержкой большого шрифта, преобразованием DWG в PDF с эффективным использованием памяти, улучшенным экспортом COLLADA DAE в OBJ форматов САПР через API."
keywords: ""
page_type: single_release_page
folder_link: " cad/net/new-releases/aspose.cad-for-.net-22.3/"
folder_name: "Aspose.CAD для .NET 22.3"
...
{{< Releases/ReleasesHeading H2txt="Aspose.CAD для .NET 22.3" imagelink="/resources/img/msi-icon.png">}}
...
# Поддержка большого шрифта

Добавлена поддержка большого шрифта в API.

# Преобразование DWG в PDF с эффективным использованием памяти

Раньше, когда DWG конвертировался в формат PDF, он потреблял много памяти. Сейчас эта проблема решена. Теперь вы можете конвертировать DWG в PDF с улучшенными результатами.

# Улучшен экспорт DAE в OBJ
