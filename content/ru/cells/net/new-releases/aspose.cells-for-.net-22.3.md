---
title: Шаблон электронной таблицы XLT (Excel) OTS (Calc) API C# .NET Приложение
description: C# .NET API с поддержкой форматов шаблонов электронных таблиц Excel® (XLT) и Calc (OTS), установка внутри границ, сортировка значений сводных полей по выбранному столбцу или строке
keywords: ""
...
{{< Releases/ReleasesWapper >}}
  ...
  {{< Releases/ReleasesButtons >}}
    {{< Releases/ReleasesSingleButtons text=" Скачать" link="/cells/net/new-releases/aspose.cells-for-.net-22.3/c293581525754554a9ea2092b4c27669%20%20" >}}
  ...
  {{< Releases/ReleasesFileArea >}}
    ...
    {{< Releases/ReleasesDetailsUl >}}
      ...
      {{< Common/li id="size-update-c293581525754554a9ea2092b4c27669" >}} 102,1 МБ{{< /Common/li >}} 
      {{< Common/li class="hide" >}} Сообщение от:{{< /Common/li >}} 
      {{< Common/li class="hide" id="author-update-c293581525754554a9ea2092b4c27669" >}} Джонсон Ши{{< /Common/li >}} 
...
#  Поддержка форматов шаблонов электронных таблиц

В этом выпуске API появилась поддержка форматов шаблонов электронных таблиц как для Excel&reg; (XLT) & OpenOffice Calc&reg; (ОТС) программы. Они поддерживаются в качестве выходных форматов через `SaveFormat.Ots` и `SaveFormat.Xlt`.

#  Установить внутренние границы

Возможность установки внутренних границ.

#  Сортировка PivotField по выбранной строке или столбцу
