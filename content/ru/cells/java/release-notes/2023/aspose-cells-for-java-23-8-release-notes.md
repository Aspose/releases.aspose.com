...
linktitle: Aspose.Cells for Java 23.8 Примечание к выпуску
title: Aspose.Cells for Java 23.8 Примечание к выпуску
weight: 5
description: Aspose.Cells for Java 23.8 Примечания к выпуску – последние улучшения, новые функции и исправления.
type: repositor
layout: releas
...
{{% alert color="primary" %}}
 ...
 На этой странице содержатся примечания к выпуску для[Aspose.Cells for Java 23.8](https://releases.aspose.com/cells/java/23-8/).
