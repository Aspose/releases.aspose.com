---
title: "Aspose.cells 22,5 | Форматы электронных таблиц процесса через Java API" 
...
11_. Электронные таблицы (XLS, XLSX, XLSM, XLSB, XLTX, SpreadsheetML, CSV, ODS), HTML, MHTML, PDF и форматы файлов изображения в свои собственные приложения Java без необходимости полагаться на Microsoft Excel?.
