...
linktitle: Aspose.Cells for Python via Java Примечание к выпуску 23.11
title: Aspose.Cells for Python via Java Примечание к выпуску 23.11
weight: 2
description: Aspose.Cells for Python via Java 23.11 Примечания к выпуску – последние обновления и исправления
type: repositor
layout: releas
...
{{% alert color="primary" %}}
 ...
 На этой странице содержатся примечания к выпуску для[Aspose.Cells for Python via Java 23.11](https://releases.aspose.com/cells/python-java/new-releases/aspose.cells-for-python-via-java-23.11/).
...
|CELLSPYTHONJAVA-73|Метки оси X отсутствуют при преобразовании в PDF.|
|CELLSPYTHONJAVA-74|Одна строка по необъяснимым причинам не обрабатывается правильно в PDF из XLSX.|
