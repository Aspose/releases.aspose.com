...
linktitle: Aspose.Cells for PHP via Java 23.6 Примечание к выпуску
title: Aspose.Cells for PHP via Java 23.6 Примечание к выпуску
weight: 7
description: Aspose.Cells for PHP via Java 23.6 Примечания к выпуску – последние улучшения, новые функции и исправления.
type: repositor
layout: releas
...
{{% alert color="primary" %}}
 ...
 На этой странице содержатся примечания к выпуску для[Aspose.Cells for PHP via Java 23.6](https://releases.aspose.com/cells/php/new-releases/aspose.cells-for-php-via-java-23.6/).
