...
linktitle: "Aspose.Cells for PHP via Java 22.8 Примечания к выпуску"
title: "Aspose.Cells for PHP via Java 22.8 Примечания к выпуску"
weight: 5
description: "Aspose.Cells for PHP via Java 22.8 Примечания к выпуску – the latest updates and fixes."
type: "repository"
layout: "release"
family_listing_page_title: "Aspose.Cells for PHP via Java 22.8 Примечания к выпуску"
---
{{% alert color="primary" %}}
