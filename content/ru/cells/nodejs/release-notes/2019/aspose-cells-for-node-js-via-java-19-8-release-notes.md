...
linktitle: "Aspose.Cells for Node.js via Java 19.8 Примечания к выпуску"
title: "Aspose.Cells for Node.js via Java 19.8 Примечания к выпуску"
weight: 10
description: "Aspose.Cells for Node.js via Java 19.8 Примечания к выпуску – the latest updates and fixes."
type: "repository"
layout: "release"
family_listing_page_title: "Aspose.Cells for Node.js via Java 19.8 Примечания к выпуску"
---
{{% alert color="primary" %}} 

Эта страница содержит примечания к выпуску для Aspose.Cells for Node.js via Java 19.8.
...
|CELLSJAVA-42954|Возникло исключение при загрузке и сохранении файла XLSX|Исключение|
|CELLSJAVA-42957|При сохранении файла XLSX выдается недопустимое значение FontUnderlineType.|Исключение|
