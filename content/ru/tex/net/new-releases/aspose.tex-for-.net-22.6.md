...
intro_text: "Он содержит Aspose.tex для .NET 22.6."
...
> For a complete list of features, enhancements, and bug fixes in this release please visit, [Aspose.TeX for .NET 22.6 Выпуск заметок](https://releases.aspose.com/tex/net/release-notes/2022/aspose-tex-for-net-22-6-release-notes/).
