...
linktitle: Aspose.3D для Node.js через Java 24.10 Примечания к выпуску
title: Aspose.3D для Node.js через Java 24.10 Примечания к выпуску
weight: 3
description: Aspose.3D для Node.js через Java 24.10 — журнал изменений и исправления.
type: repository
layout: release
---
...
Эта страница содержит информацию о примечаниях к выпуску Aspose.3D для Node.js via Java 24.10.
...
| THREEDNET-1603 | Добавление поддержки Boolean в IFC | Улучшение |
...
| THREEDNET-1614 | Улучшение совместимости IFC | Задача |
