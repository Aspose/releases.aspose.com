...
linktitle: Aspose.3D для Java 24.11 Примечания к выпуску
title: Aspose.3D для Java 24.11 Примечания к выпуску
weight: 2
description: Aspose.3D для Java 24.11 — журнал обновлений и исправлений.
type: repository
layout: release
---
...
Эта страница содержит информацию о примечаниях к выпуску Aspose.3D для Java 24.11.
...
| THREEDNET-1618 | Улучшить TriMesh для поддержки триангуляции целевых морф | Задача |
...
Добавленные новые семантики используются внутренне TriMesh для поддержки данных о положении/нормали морфа.