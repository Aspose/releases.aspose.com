...
linktitle: Aspose.3D для Java 25.5 Примечания к выпуску
title: Aspose.3D для Java 25.5 Примечания к выпуску
weight: 8
description: Aspose.3D для Java 25.5 — журнал изменений и исправления.
type: repository
layout: release
---
...
Эта страница содержит информацию об изменениях для Aspose.3D для Java 25.5.
...
{{< highlight java >}}
        ...
        //здесь мы предоставим совместимое с EXT_mesh_features имя атрибута, чтобы экспортёр glTF мог его распознать
        ...
        //Сохраните его в glTF, использующий расширения EXT_mesh_features и EXT_structural_metadata
        scene.save("test.glb");
{{< /highlight >}}
