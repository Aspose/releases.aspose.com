...
linktitle: Aspose.3D для Python через .NET 24.1 Примечания к выпуску
title: Aspose.3D для Python через .NET 24.1 Примечания к выпуску
weight: 12
description: Aspose.3D для Python через .NET 24.1 — журнал изменений и исправления.
type: repository
layout: release
---
...
Эта страница содержит информацию о примечаниях к выпуску Aspose.3D для Python через .NET 24.1.
...
| THREEDNET-1476 | Разрешить экспорт анимации вращения на основе углов Эйлера в glTF | Улучшение |
