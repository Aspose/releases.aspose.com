---
title: Скачать C# Gameware, CAD & 3D Processing DLL | Aspose.3D
description: Скачайте DLL, содержащую библиотеку классов C# для работы с 3D‑файлами (3DS, 3MF, DAE, DFX, USD, Blender, OpenUSD, MA, gITF, U3D), сетками, геометрией, сценами, анимациями через .NET on‑premise API.
...
Откройте {{< Common/link href="https://www.nuget.org/packages/Aspose.3D/" text="NuGet"  >}} Package Manager в Microsoft Visual Studio® , найдите <b>Aspose.3D</b> и установите. Вы также можете использовать следующую команду в консоли Package Manager. Для подробных инструкций, пожалуйста, посетите {{< Common/link href="https://docs.aspose.com/3d/net/installation/" text="Installation"  >}} страницу документации.
...
[Страница продукта](https://products.aspose.com/3d/net/) | [Документация](https://docs.aspose.com/3d/net/) | [Ссылка на API](https://reference.aspose.com/3d/net/) | [Примеры](https://github.com/aspose-3d/Aspose.3D-for-.NET/tree/master/Examples) | [Блог](https://blog.aspose.com/category/3d/) | [Выпуски](https://releases.aspose.com/) | [Поддержка](https://forum.aspose.com/c/3d) | [Лицензия](https://purchase.aspose.com/temporary-license)

[Aspose.3D for .NET](https://products.aspose.com/3d/net/) позволяет .NET‑приложениям работать с 3D форматами документов. 3D .NET API дает инженерам возможность читать, конвертировать, создавать, изменять и управлять содержимым [3D форматов документов](https://docs.aspose.com/3d/net/supported-file-formats/) без необходимости установки какого‑либо программного обеспечения для 3D моделирования и рендеринга.
...
Вы можете выполнить приведённый ниже фрагмент кода, чтобы увидеть, как работает Aspose.3D в вашей среде, или посмотреть [репозиторий GitHub](https://github.com/aspose-3d/Aspose.3D-for-.NET) для других типовых сценариев.
...
[![Страница продукта](https://img.shields.io/badge/Product-0288d1?style=for-the-badge&logo=Google-Chrome&logoColor=white)](https://products.aspose.com/3d/net/) [![Документация](https://img.shields.io/badge/Docs-388e3c?style=for-the-badge&logo=Hugo&logoColor=white)](https://docs.aspose.com/3d/net/) [![Ссылка на API](https://img.shields.io/badge/Reference-f39c12?style=for-the-badge&logo=html5&logoColor=white)](https://reference.aspose.com/3d/net/) [![Примеры](https://img.shields.io/badge/Examples-1565c0?style=for-the-badge&logo=Github&logoColor=white)](https://github.com/aspose-3d/Aspose.3D-for-.NET/tree/master/Examples) [![Блог](https://img.shields.io/badge/Blog-d32f2f?style=for-the-badge&logo=WordPress&logoColor=white)](https://blog.aspose.com/category/3d/) [![Выпуски](https://img.shields.io/badge/Releases-43a047?style=for-the-badge&logo=semanticrelease&logoColor=white)](https://releases.aspose.com/) [![Поддержка](https://img.shields.io/badge/Support-7b1fa2?style=for-the-badge&logo=Discourse&logoColor=white)](https://forum.aspose.com/c/3d) [![Лицензия](https://img.shields.io/badge/License-ff6f00?style=for-the-badge&logo=rocket&logoColor=white)](https://purchase.aspose.com/temporary-license)
