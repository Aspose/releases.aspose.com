---
title: "«NET2.0 поддерживает преобразование USDZ в GLB API для C#, приложений ASP.NET»"
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.3D для .NET 22.1" imagelink="/resources/img/msi-icon.png">}}
...
Восстановлена поддержка .NET Standard 2.0.

# Улучшено преобразование USDZ в GLB

Ранее в некоторых случаях API не открывал файлы `USDZ` для преобразования в формат `GLB`. Эта версия API решила эту проблему.

# Кодирование и декодирование примитивных сущностей
