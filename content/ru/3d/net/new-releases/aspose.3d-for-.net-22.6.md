---
title: "Сохранение 3D-сцены, преобразование USDZ в GLTF API для C#, приложений ASP.NET"
description: "C# .NET API, который позволяет сохранять 3D-сцену без указания формата файла, улучшенное преобразование формата USDZ в GLTF и преобразование формата DAE в формат USDZ с помощью API с высоким кодом."
keywords: ""
page_type: single_release_page
folder_link: "/3d/net/new-releases/aspose.3d-for-.net-22.6/"
folder_name: "Aspose.3D для .NET 22.6"
download_link: "/3d/net/new-releases/aspose.3d-for-.net-22.6/1b68321dd5a83fab39246af91b1c2e59-7410"
download_text: "Download"
Intro_text: "Он содержит выпуск Aspose.3D для .NET 22.6."
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.3D для .NET 22.6" imagelink="/resources/img/msi-icon.png">}}
...
Разрешить сохранение 3D-сцены без указания формата файла.

# Улучшено преобразование USDZ в GLTF
