...
folder_name: "Aspose.note для .NET 22.3 (только DLL)"
download_link: " /note/net/new-releases/aspose.note-for-.net-22.3-(dlls-only)/b1afaf8fb46f4c718642e84e195a31fb"
download_text: " Скачать"
Intro_text: "Он содержит Aspose.note для .NET 22.3 (только DLLS)."
image_link: "/resources/img/zip-icon.png"
download_count: "   Added: 4 days ago [4/7/2022]  Скачатьs: 2  Views: 4"
...
{{< Releases/ReleasesWapper >}}
  ...
  {{< Releases/ReleasesFileFeatures >}}
      <h4>Выпуск заметок</h4><div><a href="https://docs.aspose.com/note/net/aspose-note-for-net-22-3-release-notes/">https://docs.aspose.com/note/net/aspose-note-for-net-22-3-release-notes/</a></div><h4>Описание</h4><div class="HTMLDescription">Он содержит Aspose.note для .NET 22.3 (только DLLS).</div>
  {{< /Releases/ReleasesFileFeatures >}}
 {{< /Releases/ReleasesFileArea >}}
{{< /Releases/ReleasesWapper >}}
