---
title: "Быстрое выполнение кода CSS через API для приложений C#, ASP.NET"
...
{{< Releases/ReleasesHeading H2txt="Aspose.svg для .net 22.8" imagelink="/resources/img/msi-icon.png">}}
{{< Releases/ReleasesButtons >}}
{{< Releases/ReleasesSingleButtons text="Скачать" link="/svg/net/new-releases/aspose.svg-for-.net-22.8/255e472850b8230eb343c3da0be88538-4-7825" >}}
...
> For a complete list of features, enhancements, and bug fixes in this release please visit, [Aspose.SVG for .NET 22.8 Выпуск заметок](https://releases.aspose.com/svg/net/release-notes/2022/aspose-svg-for-net-22-8-release-notes/).
