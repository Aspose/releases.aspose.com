---
title: "HTML в JPG преобразование и обработка API для C#, приложения ASP.NET"
...
{{< Releases/ReleasesHeading H2txt="Aspose.html для .net 22.6" imagelink="/resources/img/msi-icon.png">}}
{{< Releases/ReleasesButtons >}}
{{< Releases/ReleasesSingleButtons text="Скачать" link="/html/net/new-releases/aspose.html-for-.net-22.6/b74811a5038f48b643c657551772dcfc-4-7574" >}}
...
> For a complete list of features, enhancements, and bug fixes in this release please visit, [Aspose.HTML for .NET 22.6 Выпуск заметок](https://releases.aspose.com/html/net/release-notes/2022/aspose-html-for-net-22-6-release-notes/).
