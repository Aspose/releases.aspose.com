---
title: "Aspose.tasks | Библиотека Java для CEATE & MANEGE Проект задач" 
...
family_listing_page_description: "Aspose.tasks для Java предлагает API управления проектами, которые позволяют разработчикам приложений Java предоставлять Microsoft Project ® возможности манипулирования в своих приложениях - все это без использования Microsoft Project ®." 
...
Aspose.tasks Java API размещены на [Применить репозиторий](https://releases.aspose.com/tasks/java/). Вы можете легко использовать Aspose.tasks для Java API непосредственно в ваших проектах Maven с простыми конфигурациями. Для получения подробных инструкций, пожалуйста, посетите страницу документации [Installing Aspose.Tasks for Java from Maven Repository](https://docs.aspose.com/tasks/java/installation/).
