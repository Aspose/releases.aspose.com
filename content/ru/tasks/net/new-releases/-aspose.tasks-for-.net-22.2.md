---
title: "Выделение памяти для чтения данных MPP API для C#, приложений ASP.NET"
description: "C# .NET API с уменьшенным количеством выделений памяти при чтении Просмотр данных из файла MPP. Правильно отображайте начало и конец временной шкалы проекта с помощью MS Project®."
keywords: ""
page_type: single_release_page
folder_link: " tasks/net/new-releases/-aspose.tasks-for-.net-22.2/"
folder_name: "Aspose.Tasks для .NET 22.2"
download_link: " /tasks/net/new-releases/-aspose.tasks-for-.net-22.2/273a0666128c43ea831f47dc0fefbcfc"
download_text: " Download"
Intro_text: "Он содержит MSI с выпуском Aspose.Tasks для .NET 22.2."
...
{{< Releases/ReleasesHeading H2txt="Aspose.Tasks для .NET 22.2" imagelink="/resources/img/msi-icon.png">}}
...
{{< Common/li class="hide" id="author-update-273a0666128c43ea831f47dc0fefbcfc" >}} василийсиницын {{< /Common/li >}}
...
# Лучшее распределение памяти для чтения данных MPP

Этот выпуск предлагает уменьшенное количество выделений памяти при чтении данных View из файла `MPP`.

# Сроки начала и окончания проекта для MS Project®
