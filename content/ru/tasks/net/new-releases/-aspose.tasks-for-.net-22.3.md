---
title: "Визуализация диаграммы Ганта, неизменяемый API рабочего времени C#, приложения ASP.NET"
description: "C# .NET API, чтобы сделать значение рабочего времени проекта неизменным, чтение, запись даты состояния из файла XER, поддержка токена отмены для загрузки проекта."
keywords: ""
page_type: single_release_page
folder_link: " tasks/net/new-releases/-aspose.tasks-for-.net-22.3/"
folder_name: "Aspose.Tasks для .NET 22.3"
download_link: " /tasks/net/new-releases/-aspose.tasks-for-.net-22.3/979f1b2d8a3746e58779d874d9cfe76a"
download_text: " Download"
Intro_text: "Он содержит MSI с выпуском Aspose.Tasks для .NET 22.3."
...
{{< Releases/ReleasesHeading H2txt="Aspose.Tasks для .NET 22.3" imagelink="/resources/img/msi-icon.png">}}
...
{{< Common/li class="hide" id="author-update-979f1b2d8a3746e58779d874d9cfe76a" >}} василийсиницын {{< /Common/li >}}
...
# Сделать `WorkingTime` неизменяемым

Сделано значение рабочего времени неизменным.

# Расширенная функциональность даты состояния

Добавлена возможность чтения и записи даты состояния в или из файла `XER`.

# Токен отмены для загрузки проекта
