---
title: "API поддержки TLS обработчика схемы XBRL для приложений C#, .NET"
description: "Выпуск C# .NET API с улучшенным отчетом XBRL в HTML, обработчиком синтаксического анализа схемы XBRL, загрузкой схемы XBRL для поддержки безопасности транспортного уровня (TLS) 1.2."
keywords: ""
page_type: single_release_page
folder_link: " finance/net/new-releases/aspose.finance-for-.net-22.4/"
folder_name: "Aspose.Finance для .NET 22.4"
download_link: " /finance/net/new-releases/aspose.finance-for-.net-22.4/41cb0be968e74742bc13ce40dfdfa9e0"
download_text: " Download"
Intro_text: "Он содержит выпуск Aspose.Finance для .NET 22.4."
...
{{< Releases/ReleasesHeading H2txt="Aspose.Finance для .NET 22.4" imagelink="/resources/img/msi-icon.png">}}
...
# Улучшенный отчет XBRL в HTML

Улучшена функция отчета XBRL в HTML.

# Улучшенный обработчик синтаксического анализа схемы XBRL

Улучшен обработчик синтаксического анализа схемы XBRL.
