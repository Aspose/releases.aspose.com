---
title: "Поддержка GroupDocs для API финансового формата для приложений C#, .NET"
description: "C# .NET API, который теперь поставляется с дополнительной поддержкой GroupDocs. Расширенный локальный API для обработки и обработки форматов цифровых финансовых данных с высоким кодом."
keywords: ""
page_type: single_release_page
folder_link: "/finance/net/new-releases/aspose.finance-for-.net-22.9/"
folder_name: "Aspose.Finance для .NET 22.9"
download_link: "/finance/net/new-releases/aspose.finance-for-.net-22.9/a24dcaf17dd88a38c56751460addd6bf-2-7920"
download_text: "Download"
Intro_text: "Aspose.Finance для .NET 22.9"
...
{{< Releases/ReleasesHeading H2txt="Aspose.Finance для .NET 22.9" imagelink="/resources/img/msi-icon.png">}}
...
<h4>Примечания к выпуску</h4><div> <a href='https://docs.aspose.com/finance/net/aspose-finance-for-net-22-9-release-notes/'>https://docs.aspose.com/finance/net/aspose-finance-for-net-22-9-release-notes/</a></div>
{{< /Releases/ReleasesFileFeatures >}}
{{< Releases/ReleasesFileFeatures >}}
...
# Поддержка групповых документов

Добавлена поддержка GroupDocs.

> Полный список функций, улучшений и исправлений ошибок в этом выпуске можно найти на странице [Aspose.Finance for .NET 22.9 Release Notes](https://docs.aspose.com/finance/net/aspose-finance-for-net-22-9-release-notes/).
