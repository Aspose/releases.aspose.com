---
title: "Оптимизированная скорость изменения размера изображения через API для приложений C#, ASP.NET"
description: "C# .NET API с более высокой скоростью изменения размера изображения, совершенным пиксельным и точным выравниванием текста, улучшенным тестовым охватом субдискретизации YCbCr в RGb для Jpeg2000."
keywords: ""
page_type: single_release_page
folder_link: " imaging/net/new-releases/aspose.imaging-for-.net-22.2/"
folder_name: "Aspose.Imaging для .NET 22.2"
download_link: " /imaging/net/new-releases/aspose.imaging-for-.net-22.2/0b3fdb9d409842d8906d3454587476bb"
download_text: " Download"
Intro_text: "Он содержит выпуск Aspose.Imaging для .NET 22.2."
...
{{< Releases/ReleasesHeading H2txt="Aspose.Imaging для .NET 22.2" imagelink="/resources/img/msi-icon.png">}}
...
<h4>Примечания к выпуску</h4><div> <a href="https://releases.aspose.com/imaging/net/release-notes/2022/aspose-imaging-for-net-22-2-release-notes/">https://releases.aspose.com/imaging/net/release-notes/2022/aspose-imaging-for-net-22-2-release-notes/</a></div>
{{< /Releases/ReleasesFileFeatures >}}
...
# Оптимизированная скорость изменения размера изображения

Улучшена скорость изменения размера изображения и сделана она быстрее.
...
Добавлена поддержка идеального выравнивания текста по пикселям.
...
# Улучшенная субдискретизация YCbCr в RGb

В этом выпуске улучшено тестовое покрытие субдискретизации от YCbCr до RGb для JPEG2000.
...
Полный список функций, улучшений и исправлений ошибок в этом выпуске можно найти на странице [Aspose.Imaging for .NET 22.2](http://localhost:1313/imaging/net/new-releases/aspose.imaging-for-.net-22.2/).
