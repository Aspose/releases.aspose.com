...
title: "Загрузки ---Новые выпуски-aspose.slides-for-.net-24.7 (только dll)"
description: " "
keywords: ""
page_type: single_release_page
folder_link: "/slides/net/new-releases/aspose.slides-for-.net-24.7(dlls-only)/"
folder_name: "Aspose.Slides для .NET 24.7 (только DLL)"
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.Slides для .NET 24.7 (только DLL)" imagelink="/resources/img/zip-icon.png">}}
  {{< Releases/ReleasesButtons >}}
    {{< Releases/ReleasesSingleButtons text="Скачать" link="/slides/net/new-releases/aspose.slides-for-.net-24.7(dlls-only)/3bdbb0f43b3a4e1a19a9faddcc428ba6-36-11213" >}}
  ...
  {{< /Releases/ReleasesFileFeatures >}}
  {{< Releases/ReleasesFileFeatures >}}
      <h4>Описание</h4><div class="HTMLDescription">Он содержит выпуск Aspose.Slides для .NET 24.7 (только DLL).</div>
  {{< /Releases/ReleasesFileFeatures >}}
 {{< /Releases/ReleasesFileArea >}}
{{< /Releases/ReleasesWapper >}}
