...
title: "Загрузки --- Новые релизы-Aspose.slides-for-php-via-java-22.6"
description: " "
keywords: ""
page_type: single_release_page
folder_link: "/slides/php-java/new-releases/aspose.slides-for-php-via-java-22.6/"
folder_name: "Aspose.slides для PHP через Java 22.6"
...
intro_text: "Он содержит Aspose.slides для PHP через Java 22.6."
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.slides для PHP через Java 22.6" imagelink="/resources/img/zip-icon.png">}}
  {{< Releases/ReleasesButtons >}}
    {{< Releases/ReleasesSingleButtons text="Скачать" link="/slides/php-java/new-releases/aspose.slides-for-php-via-java-22.6/84c1dad79f655f6b4a97e8dcc4178454-6-7570" >}}
