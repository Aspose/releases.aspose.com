---
title: "Aspose.slides | Библиотека Java для обработки форматов PowerPoint" 
...
family_listing_page_description: "Aspose.slides для Java - это PowerPoint Presentation Manipulation и обработка API для чтения, записи, манипулирования и преобразования файлов PowerPoint в любом приложении на основе Java. API не имеет никаких внешних зависимостей, поэтому его можно использовать без необходимости Microsoft PowerPoint." 
