---
title: "API извлечения CAB-файлов на основе LZX и Deflate для приложений C#, ASP.NET"
description: "C# .NET API, который может извлекать CAB-архивы, сжатые с использованием алгоритмов LZX и Deflate, улучшенное извлечение зашифрованных RAR5 в .NET 6."
keywords: ""
page_type: single_release_page
folder_link: " zip/net/new-releases/aspose.zip-for-.net-22.3/"
folder_name: "Aspose.ZIP для .NET 22.3"
download_link: " /zip/net/new-releases/aspose.zip-for-.net-22.3/fbd379bca0b049df88c596552bd82d7e"
download_text: " Download"
Intro_text: "Aspose.ZIP для выпуска .NET 22.3."
...
{{< Releases/ReleasesHeading H2txt="Aspose.ZIP для .NET 22.3" imagelink="/resources/img/msi-icon.png">}}
...
Извлеките CAB-архивы, сжатые с использованием алгоритмов LZX и Deflate.

# Извлечь зашифрованный RAR5
