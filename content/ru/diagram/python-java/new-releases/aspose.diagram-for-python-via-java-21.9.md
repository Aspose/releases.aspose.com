...
folder_name: "Aspose.Diagram для Python через Java 21.9"
...
Intro_text: "Он содержит Aspose.Diagram для Python через выпуск Java 21.9."
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.Diagram для Python через Java 21.9" imagelink="/resources/img/zip-icon.png">}}
  ...
  {{< Releases/ReleasesFileFeatures >}}
      <h4>Примечания к выпуску</h4><div> <a href="https://docs.aspose.com/diagram/java/aspose-diagram-for-python-via-java-21-9-release-notes/">https://docs.aspose.com/diagram/java/aspose-diagram-for-python-via-java-21-9-release-notes/</a></div>
  {{< /Releases/ReleasesFileFeatures >}}
 {{< /Releases/ReleasesFileArea >}}
{{< /Releases/ReleasesWapper >}}
