---
title: "Улучшенное выполнение асинхронного метода в API для C#, приложений ASP.NET"
description: "C# .NET API с улучшенным асинхронным выполнением в преобразовании Visio, правильным обновлением полей формулы/значения и улучшенной обработкой текста таблицы при преобразовании VSDX в PDF."
keywords: ""
page_type: single_release_page
folder_link: " diagram/net/new-releases/aspose.diagram-for-.net-22.5/"
folder_name: "Aspose.Diagram для .NET 22.5"
download_link: " /diagram/net/new-releases/aspose.diagram-for-.net-22.5/ab1a7fda7dbb437aa0247e6f8ca0c065"
download_text: " Download"
Intro_text: "Он содержит Aspose.Diagram для выпуска .NET 22.5."
...
{{< Releases/ReleasesHeading H2txt="Aspose.Diagram для .NET 22.5" imagelink="/resources/img/msi-icon.png">}}
...
# Улучшенное выполнение асинхронного метода

При преобразовании Visio® VSDX в PDF выходной файл не сохранялся в асинхронном методе до полного выполнения программы. Текущая версия API решила эту проблему.

# Формула/значение Решение проблемы

Поля формул/значений не обновлялись должным образом. Эта проблема была решена в API.

# Улучшенная обработка текста таблицы при преобразовании VSDX в PDF
