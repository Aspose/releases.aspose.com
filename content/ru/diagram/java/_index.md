---
title: "Aspose.diagram | Библиотека Java для создания, экспорта Visio Док" 
...
family_listing_page_description: "Aspose.diagram для Java-это простой в использовании, высокопроизводительный и хорошо документированный Java API, который позволяет разработчикам создавать, манипулировать и преобразовать форматы файлов Visio из их приложений Java и без необходимости полагаться на Microsoft Visio ®." 
...
- [Печать на конкретный принтер](https://docs.aspose.com/diagram/java/working-with-print/) или установить имя принтера и документа.
