---
title: " Загрузки ---Ресурсы-испанский-язык-ресурс-файл-для-aspose.ocr-для-.net-3.2.0 . "
description:  "    . " 
keywords:  "    . " 
page_type:  single_release_page
folder_link: " ocr/net/resources/spanish-language-resource-file-for-aspose.ocr-for-.net-3.2.0/"
folder_name: "Файл ресурсов на испанском языке для Aspose.OCR для .NET 3.2.0"
...
Intro_text: "Aspose.OCR для .NET использует файлы ресурсов для разных языков для выполнения оп..."
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Файл ресурсов на испанском языке для Aspose.OCR для .NET 3.2.0" imagelink="/resources/img/zip-icon.png">}}
