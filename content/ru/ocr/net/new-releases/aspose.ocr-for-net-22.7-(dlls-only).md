...
title: "Загрузки --- Новые релизы-ocpect.ocr-for-net-22.7- (только DLLS)"
description: " "
keywords: ""
page_type: single_release_page
folder_link: "/ocr/net/new-releases/aspose.ocr-for-net-22.7-(dlls-only)/"
folder_name: "Aspose.ocr для net 22,7 (только DLL)"
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.ocr для net 22,7 (только DLL)" imagelink="/resources/img/zip-icon.png">}}
  {{< Releases/ReleasesButtons >}}
    {{< Releases/ReleasesSingleButtons text="Скачать" link="/ocr/net/new-releases/aspose.ocr-for-net-22.7-(dlls-only)/2c2783f3b186ade780fe597c52d630f4-33-7688" >}}
