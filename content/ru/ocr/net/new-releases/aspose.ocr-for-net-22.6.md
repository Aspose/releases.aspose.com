...
intro_text: "Новая двойная нейронная сеть, распознавание таблиц и удаление системы."
...
For a complete list of features, enhancements, and bug fixes in this release please visit, [Aspose.OCR for .NET 22.6 - Выпуск заметок](https://releases.aspose.com/ocr/net/release-notes/2022/aspose-ocr-for-net-22-6-release-notes/).
