---
title: "Aspose.Words 18.3 | Java APIを介してドキュメント形式を処理します" 
...
## Aspose.Words APIを使用した無料のオンラインアプリ
 ...
 -  ** [無料のオンラインメールマージ](https://products.aspose.app/words/mailmerge) ** Mail Merge Templateの構文を使用して電子メールとドキュメントを作成します。

 -  ** [無料のオンライン翻訳](https://products.aspose.app/words/translator) **単語、PDF、その他のドキュメントの簡単な翻訳。
