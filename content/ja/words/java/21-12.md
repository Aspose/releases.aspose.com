---
title: "Aspose.Words 21.12 | Java APIを介してドキュメント形式を処理します" 
...
### ** JavaのOpenType機能のサポート**
{{< gist aspose-words-gists 827e71ccc0b8516a3cfe247b86ce6d4e "例-src-main-java-com-aspose-words-examples-programming_documents-document-OpenTypeFeatures-OpenTypeFeatures.java" >}}
...
## Aspose.Words APIを使用した無料のオンラインアプリ
 ...
 -  ** [無料のオンライン回転](https://products.aspose.app/words/rotate) ** PDFドキュメントと画像を回転させます。ページの向きをポートレートから風景に変更し、反対方向に変更します。
 ...
 -  ** [Free Online Document 探す](https://products.aspose.app/words/search) **文字列と正規表現のあるドキュメント内のコンテンツを検索します。
