---
title: "Aspose.Words 22.3 | PDF 2.0コンプライアンス| Java API" 
description: "Javaライブラリを作成して、編集ビューを作成して単語文書を変換します。 Aspose.Words 22.4サポートPDF 2.0変換、TOCスタイルの改善など。" 
layout: package
...
## Java API 22.3のAspose.Wordsの新しいもの
...
詳細については、[Release Notes of Aspose.Words for Java 22.3](https://docs.aspose.com/words/java/aspose-words-for-java-22-3-release-notes/)をご覧ください。
...
### ** Javaを使用してWord DocumentをPDF 2.0コンプライアンスに変換する方法**
...
public class Asposeドキュメント2PDF20CompliantConverter {
