---
title: "Aspose.Words 22.6 |修正されたページ形式に対するNewのドキュメント" 
description: "Javaライブラリを作成して、編集ビューを作成して単語文書を変換します。 Aspose.Words 22.6は、ドキュメントの固定ページ形式などへの変換をサポートしています。" 
layout: package
...
## Java API 22.6のAsops.Wordsの新しいもの
 - 高品質とパフォーマンスを備えたドキュメントの固定ページ形式への変換。
-DrawingMlチャートのAPIグラデーション、テクスチャ、パターンの塗りつぶしをサポートします。
- Improvement in converting DOCX to HTML
- Add loading progress notification for ODT documents
 -  XHTMLエンティティによるEPUBドキュメントのロードの改善。

詳細については、[Release Notes of Aspose.Words for Java 22.6](https://docs.aspose.com/words/java/aspose-words-for-java-22-6-release-notes/)をご覧ください。
...
### ** javaを使用して高品質でドキュメントを固定ページJPEG形式に変換する方法**
...
public class Asposeドキュメント2FIXEDPageJpgeHighQualityConverter {
