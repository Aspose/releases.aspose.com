---
title: "Aspose.Words 22.4 | PDFアラビア語のテキストへのNewのドキュメント" 
description: "Javaライブラリを作成して、編集ビューを作成して単語文書を変換します。 Aspose.Words 22.4は、PDF/A-4変換をサポートし、ドキュメントの改善をアラビア語のテキストとPDFにサポートします。" 
layout: package
...
## Java API 22.4のAspose.Wordsの新しいもの
...
詳細については、[Release Notes of Aspose.Words for Java 22.4](https://docs.aspose.com/words/java/aspose-words-for-java-22-4-release-notes/)をご覧ください。
...
### ** javaを使用してアラビア語のテキストでdocxをPDFに変換**
...
public class Asposeドキュメント2ArabicTextPfdfConverter {
