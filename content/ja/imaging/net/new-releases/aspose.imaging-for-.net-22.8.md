...
```
このリリースの機能、拡張機能、バグ修正の完全なリストについては、[Aspose.Imaging for .NET 22.8 - Release notes](https://docs.aspose.com/imaging/net/aspose-imaging-for-net-22-8-release-notes/) にアクセスしてください。
