---
title: "Aspose.Font | Javaフォント処理API | TT、CFF、OT、Type1" 
...
- CFF to WOFF2
- load font
family_listing_page_title: "JavaのAsopsion.Font" 
family_listing_page_description: "Java用のAsopsion.Fontは、柔軟で使いやすいライブラリで、さまざまなフォントファイルを使用して作業します。 APIは、TrueType CFF、Opentype、Type1などの複数のフォント形式をサポートしています。" 
