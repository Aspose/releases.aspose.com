...
title: "ダウンロード ---新しいリリース-aspose.font-for-.net-22.10-(dll のみ)"
description: " "
keywords: ""
page_type: single_release_page
folder_link: "/font/net/new-releases/aspose.font-for-.net-22.10-(dlls-only)/"
folder_name: "Aspose.Font for .NET 22.10 (DLL のみ)"
download_link: "/font/net/new-releases/aspose.font-for-.net-22.10-(dlls-only)/9911279b8ee23753ccbbe5d6fa14140c-1-8070"
download_text: "Download"
Intro_text: "この ZIP ファイルには、Aspose.Font for .NET アセンブリのみが含まれています。アセンブリは、同じバージョンの製品の MSI インストーラーと同じです。 MSI インストーラーなしで Aspose.Font を使用する場合、つまり Mono で MSI インストーラーを実行できない場合は、これをダウンロードしてください。"
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.Font for .NET 22.10 (DLL のみ)" imagelink="/resources/img/zip-icon.png">}}
