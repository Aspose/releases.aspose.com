---
title: "RU テキスト配置、C#、ASP.NET アプリ用の曲線形状 SVG API"
description: "C# .NET API により、Visio を SVG 形式に変換する際に、ロシア語のテキストの配置が改善され、曲線形状の処理が改善されました。また、HTML 表現も改善されました。"
keywords: ""
...
# Visio から SVG への変換の改善

このリリースでは、SVG 変換の処理にさまざまな改良が加えられています。 Microsoft Visio® を SVG 形式に変換する際に、ロシア語のテキストが正しく配置されるようになりました。
