---
title: "C#、ASP.NET アプリ用の VSDX から PDF 画像形状変換 API"
description: "VSDX から PDF への画像変換と背景色の変更、VSDX から SVG への正しいテキスト位置、および VSDX から PNG への変換でのテーブル レンダリングを備えた C# .NET API。"
keywords: ""
...
Intro_text: ".NET 22.4 リリース用の Aspose.Diagram が含まれています。"
...
Microsoft Visio® VSDX を PDF に変換するときに、画像変換が機能しませんでした。現在のリリースでは、この問題が修正されています。

# Visio® 図形の背景色の変換

以前は、VSDX から PDF への変換プロセス中に、形状の背景色が正しく変換されない場合がありました。この問題は解決されました。

# テキスト位置の扱い

Visio から SVG 形式への変換中のテキスト位置の処理が改善されました。

# Visio から PNG への変換でのテーブル レンダリングの改善
