...
linktitle: Aspose.3D for .NET 23.6 リリースノート
title: Aspose.3D for .NET 23.6 リリースノート
weight: 7
description: "Aspose.3D for .NET 23.6 リリースノート - 最新の更新と修正。"
type: repository
layout: release
---
...
このページには、Aspose.3D for .NET 23.6 のリリースノートの情報が記載されています。
...
Aspose.3D for .NET 23.6 は、IFC(2.3 および 4) の実験的なサポートを追加しました。今後も IFC ファイルのサポートが強化されます。

## API の変更点 ##

## **Aspose.ThreeD.FileFormat** クラスに次のメンバーが追加されました:
