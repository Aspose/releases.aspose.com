---
title: "C#、ASP.NET アプリ用の 3D モデル FBX から USDZ への変換 API"
description: "USD / USDZ インポーターでカスタム xform オペレーターをサポートする C# .NET API、改善された 3D モデル FBX から USDZ への変換、マテリアル属性を問題なくエクスポートします。"
keywords: ""
...
Intro_text: "Aspose.3D for .NET 22.8 リリースが含まれています。"
...
{{< Releases/ReleasesWapper >}}
  ...
  {{< Releases/ReleasesFileFeatures >}}
      <h4>リリースノート</h4><div><a href='https://docs.aspose.com/3d/net/aspose-3d-for-net-22-8-release-notes/'>https://docs.aspose.com/3d/net/aspose-3d-for-net-22-8-release-notes/</a></div>
  {{< /Releases/ReleasesFileFeatures >}}
  {{< Releases/ReleasesFileFeatures >}}
      <h4>説明</h4><div class="HTMLDescription">Aspose.3D for .NET 22.8 リリースが含まれています。</div>
  {{< /Releases/ReleasesFileFeatures >}}
...
USD / USDZ インポーターにカスタム `xform` オペレーターのサポートを追加しました。

# 改善された 3D モデル FBX から USDZ への変換

以前は、FBX から USDZ に変換されたモデルはすべて黒くなっていました。この問題は、API の現在のリリースで解決されています。

# 改善されたマテリアル属性のエクスポート

テクスチャがアタッチされていない場合、マテリアル アトリビュートがエクスポートされませんでした。この問題は解決されました。

> このリリースの機能、拡張機能、バグ修正の完全なリストについては、[Aspose.3D for .NET 22.8 Release Notes](https://docs.aspose.com/3d/net/aspose-3d-for-net-22-8-release-notes/) にアクセスしてください。
