---
title: "方向性 /デコード方向 /スポットライト3D API C#.NETアプリ" 
description: "C#.NET APIエンコード、方向ライトをデコード、スポットライト、DXFファイルをGLTFまたはGLB形式に変換します。 3Dシーンとモデルには、GLTF（GL送信形式）を使用します。" 
keywords: ""
page_type: single_release_page
folder_link: "/3d/net/new-releases/aspose.3d-for-.net-22.12/"
folder_name: ".NET 22.12のAsoppes.3d" 
download_link: "/3d/net/new-releases/aspose.3d-for-.net-22.12/584e9b4e26dd0c1c4995c0f0aa8deac4-3-8305"
download_text: "ダウンロード" 
intro_text: ".NET 22.12リリース用のAspose.3dが含まれています。" 
image_link: "/resources/img/msi-icon.png"
download_count: " 21/12/2022 ダウンロードs: 1  Views: 1 "
...
{{< Releases/ReleasesHeading H2txt=".NET 22.12のAsoppes.3d" imagelink="/resources/img/msi-icon.png">}}
{{< Releases/ReleasesButtons >}}
{{< Releases/ReleasesSingleButtons text="ダウンロード" link="/3d/net/new-releases/aspose.3d-for-.net-22.12/584e9b4e26dd0c1c4995c0f0aa8deac4-3-8305" >}}
...
{{< Releases/ReleasesFileFeatures >}}
<h4>説明</h4>
<div class="HTMLDescription">.NET 22.12リリース用のAspose.3dが含まれています。</div>
{{< /Releases/ReleasesFileFeatures >}}
...
このバージョンの3D APIを使用すると、方向ライトとスポットライトのエンコードとデコードを可能にします。

# 3Dシリンダー処理の改善

次の問題は、このリリース内で解決されました。

 -  ** threednet-1294 **シリンダーが定義されたUVを定義しましたが、データはありません

 -  ** threednet-1306 **半径トップ= 0のシリンダーは間違ったモデルを生成します

# 「dxf」から `gltf`/` glb`に変換

`dxf`ファイルを` gltf`または `glb`形式に変換する機能。 GLTF（GL送信形式）は、3Dシーンとモデルで動作する標準ファイル形式として使用されます。
