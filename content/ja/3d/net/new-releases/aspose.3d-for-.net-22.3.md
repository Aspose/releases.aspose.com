---
title: "大型メッシュサポート＆マージ3DシーンAPI C#、ASP.NETアプリのAPI" 
description: "C#.NET API U3D / PDFファイルのエクスポートでの大型メッシュのサポートが改善されたため、3Dシーンがマージして、すべてのノードから現在のノードまですべてをマージします。" 
keywords: "    。" 
...
{{< Releases/ReleasesHeading H2txt=" .NET 22.3のAsoppes.3d" imagelink="/resources/img/msi-icon.png">}}
{{< Releases/ReleasesButtons >}}
{{< Releases/ReleasesSingleButtons text=" ダウンロード" link="/3d/net/new-releases/aspose.3d-for-.net-22.3/34c194c9a52c43788eaf0ae7c19c77dd%20%20" >}}
...
マージシーンの関数を簡素化しました。この新しい方法により、他のノードから現在のノードにすべてをマージすることができます。
...
>このリリースの機能、拡張機能、バグ修正の完全なリストについては、[Net 223リリースノートのAsopse3d](https://docs.aspose.com/3d/net/aspose-3d-for-net-22-3-release-notes/)にアクセスしてください。
{{% /Releases/ReleasesFileFeatures %}}
{{< /Common/wrapper >}}
{{< /Releases/ReleasesFileFeatures >}}
{{< /Releases/ReleasesFileArea >}}
