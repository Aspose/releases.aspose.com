---
title: "「C#、ASP.NET アプリ用の GLTF カスタム頂点属性 API"
...
Intro_text: "Aspose.3D for .NET 22.5 リリースが含まれています。"
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.3D for .NET 22.5" imagelink="/resources/img/msi-icon.png">}}
  ...
  {{< Releases/ReleasesFileFeatures >}}
      <h4>リリースノート</h4><div><a href="https://docs.aspose.com/3d/net/aspose-3d-for-net-22-5-release-notes/">https://docs.aspose.com/3d/net/aspose-3d-for-net-22-5-release-notes/</a></div>
  {{< /Releases/ReleasesFileFeatures >}}
...
Mesh triangulate は、マッピング モード Polygon / PolygonVertex で `VertexElementUserData` をサポートします。

# TriMesh での `VertexElementUserData` のサポート

TriMesh に「VertexElementUserData」のサポートが追加されました。

# `VertexElementUserData` から `glTF` へのエクスポート

`VertexElementUserData` を `glTF` にエクスポートする機能が追加されました。

# `GLTF` カスタム頂点属性

GLTF カスタム頂点属性のサポートが追加されました。

> このリリースの機能、拡張機能、バグ修正の完全なリストについては、[Aspose.3D for .NET 22.5 Release Notes](https://docs.aspose.com/3d/net/aspose-3d-for-net-22-5-release-notes/) にアクセスしてください。
