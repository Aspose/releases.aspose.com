---
title: "C#、ASP.NET アプリ用の FBX インポーター API の一時ファイルのサポート"
description: "FBX インポーターの内部一時ファイル システム サポートを備えた C# .NET API、および 3D フォーマット操作 API による GLTF ファイル エクスポートのサポートの改善。"
keywords: ""
...
Intro_text: "Aspose.3D for .NET 22.9 リリースが含まれています。"
...
{{< Releases/ReleasesWapper >}}
  ...
  {{< Releases/ReleasesFileFeatures >}}
      <h4>リリースノート</h4><div><a href='https://docs.aspose.com/3d/net/aspose-3d-for-net-22-9-release-notes/'>https://docs.aspose.com/3d/net/aspose-3d-for-net-22-9-release-notes/</a></div>
  {{< /Releases/ReleasesFileFeatures >}}
  {{< Releases/ReleasesFileFeatures >}}
      <h4>説明</h4><div class="HTMLDescription">Aspose.3D for .NET 22.9 リリースが含まれています。</div>
  {{< /Releases/ReleasesFileFeatures >}}
...
# FBX インポーターの一時ファイルのサポート

FBX インポーターの内部一時ファイル システム サポートが追加されました。

# GLTF エクスポートの改善

`GLTF` のエクスポートは、以前のリリースではあまり良くありませんでした。ただし、3D API の現在のバージョン リリースでは、`GLTF` 形式のファイルのエクスポート機能が改善されています。

> このリリースの機能、拡張機能、バグ修正の完全なリストについては、[Aspose.3D for .NET 22.9 Release Notes](https://docs.aspose.com/3d/net/aspose-3d-for-net-22-9-release-notes/) にアクセスしてください。
