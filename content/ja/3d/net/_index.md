---
title: C# Gameware、CAD と 3D 処理 DLL をダウンロード | Aspose.3D
description: 3DS、3MF、DAE、DFX、USD、Blender、OpenUSD、MA、glTF、U3D の 3D ファイル、メッシュ、ジオメトリ、シーン、アニメーションを操作する C# クラスライブラリを含む DLL をダウンロードし、.NET のオンプレミス API で使用します。
...
Microsoft Visual Studio® のパッケージ マネージャーを開き、{{< Common/link href="https://www.nuget.org/packages/Aspose.3D/" text="NuGet"  >}} を検索して <b>Aspose.3D</b> をインストールします。また、パッケージ マネージャー コンソール内で次のコマンドを使用できます。詳細な手順については、{{< Common/link href="https://docs.aspose.com/3d/net/installation/" text="Installation"  >}} のドキュメント ページをご覧ください。
...
[製品ページ](https://products.aspose.com/3d/net/) | [ドキュメント](https://docs.aspose.com/3d/net/) | [API リファレンス](https://reference.aspose.com/3d/net/) | [サンプル](https://github.com/aspose-3d/Aspose.3D-for-.NET/tree/master/Examples) | [ブログ](https://blog.aspose.com/category/3d/) | [リリース](https://releases.aspose.com/) | [サポート](https://forum.aspose.com/c/3d) | [ライセンス](https://purchase.aspose.com/temporary-license)
...
以下のコード スニペットを実行して、環境で Aspose.3D がどのように動作するか確認するか、[GitHub リポジトリ](https://github.com/aspose-3d/Aspose.3D-for-.NET) で他の一般的な使用例を確認してください。
