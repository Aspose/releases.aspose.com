...
linktitle: Aspose.3D for Node.js via Java 25.5 リリースノート
title: Aspose.3D for Node.js via Java 25.5 リリースノート
weight: 8
description: "Aspose.3D for Node.js via Java 25.5 リリースノート - 最新の更新と修正。"
type: repository
layout: release
---
...
このページには、Java 25.5 via Node.js Aspose.3D のリリースノートの情報が含まれています。
...
| THREEDNET-1678 | EXT_structural_metadata 用の enum 型サポートを追加 | タスク |
| THREEDNET-1651 | glTF 用の拡張機能 EXT_structural_metadata を使用したメタデータエクスポート機能を追加 | 新機能 |
| THREEDNET-1676 | 頂点要素ユーザーデータにプロパティテーブルをリンク | 新機能 |
...
{{< highlight java >}}
        ...
        //featureId.Data には 0 と 1 の 2 つの特徴しかないので、ここでは 2 つの特徴に対して 2 つのデータのみが必要です。
