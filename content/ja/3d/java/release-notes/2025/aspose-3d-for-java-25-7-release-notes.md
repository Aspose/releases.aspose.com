...
linktitle: Aspose.3D for Java 25.7 リリースノート
title: Aspose.3D for Java 25.7 リリースノート
weight: 6
description: "Aspose.3D for Java 25.7 リリースノート - 最新の更新と修正。"
type: repository
layout: release
---
...
このページには、Aspose.3D for Java 25.7 のリリースノートの情報が記載されています。
...
このクラスは、レンダリングの階層関係を表す `Node` クラスとは異なる、論理的な関係のグループを定義します。現在、この機能は IFC 形式でのみ利用可能です。
