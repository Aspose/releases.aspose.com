---
title: "Aspose.cad 22.6.1 | AutoCAD処理と変換Java API" 
...
Aspose.cad Java APIは[Aspose Repository](https://releases.aspose.com/cad/java/)でホストされています。簡単な構成を使用して、MavenプロジェクトでJava API用のAsopse.Barcodeを簡単に使用できます。詳細な手順については、[Installing Aspose.CAD for Java from Maven Repository](https://docs.aspose.com/cad/java/installation/)ドキュメントページをご覧ください。
