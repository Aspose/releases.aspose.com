...
family_listing_page_description: "Java用のAspose.cadにより、開発者はAutoCAD DWGとDXFとDGN、DWF、DWF、IFC、IGS、IGES、STL、DWT、CF2、CF2、OBJファイル、SVG、WMF、およびラスター画像を変換できます。ネイティブAPIであり、AutoCADやその他のソフトウェアをインストールする必要はありません。" 
