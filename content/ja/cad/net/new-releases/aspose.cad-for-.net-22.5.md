---
title: "C# ASP.NET アプリの API を介して、DWG を WMF に、OBJ を DXF にエクスポートします。"
description: "DWG から WMF 形式へのエクスポート機能が改善された C# .NET API、OBJ から DXF へのエクスポート用に最適化されたファイル サイズ、エクスポートされた PDF 内のテキストのオーバーラップの問題が解決されました。"
keywords: ""
...
DWG の WMF 形式へのエクスポート機能が改善されました。

# OBJ から DXF へのエクスポートのファイル サイズの最適化

OBJ を DXF 形式にエクスポートした後のファイル サイズが膨大になる問題を修正しました。
