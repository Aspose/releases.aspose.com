---
title: "C# .NET アプリ用の Acrobat Reader® & Foxit® Line Rendering API"
description: "Acrobat Reader® と Foxit® のライン レンダリングが改善された C# .NET API、AutoCAD® DXB ファイル形式のサポート、高度なコードの CAD API による DWF から PDF への変換の改善。"
keywords: ""
...
Intro_text: "Aspose.CAD for .NET v22.6 の完全な製品インストール用の MSI インストーラーが含まれています。"
...
# Acrobat Reader® と Foxit® Line レンダリングの改善

以前は、Acrobat Reader® では行が欠落している場合がありましたが、Foxit® では存在していました。この問題は解決されました。

# AutoCAD® DXB フォーマットのサポート

AutoCAD® DXB ファイル形式のサポートを実装および導入しました。通常、「DXB」には 3D CAD 図面が格納されます。 `DXB` は `DXF` ファイルのバイナリ バージョンです。

# DWF から PDF への変換の改善

以前は、DWF から PDF への変換中に一部のインスタンスで、すべてのページが正しく変換されませんでした。この問題は解決されました。

> このリリースの機能、拡張機能、バグ修正の完全なリストについては、[Aspose.CAD for .NET 22.6 - Release Notes](https://releases.aspose.com/cad/net/release-notes/2022/aspose-cad-for-net-22-6-release-notes/) にアクセスしてください。
