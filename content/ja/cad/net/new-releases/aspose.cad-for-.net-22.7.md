---
title: "C#、ASP.NET アプリ用の SHX、STEP、STP フォーマット API のサポート"
description: "AutoCAD® SHX ファイル形式をサポートする C# .NET API。 STEP または STP ファイル形式のサポートも追加されています。 2D および 3D の幾何学的モデルと設計データを操作します。"
keywords: ""
...
Intro_text: "Aspose.CAD for .NET v22.7 の完全な製品インストール用の MSI インストーラーが含まれています。"
...
API のこのリリースでは、AutoCAD® SHX ファイル形式がサポートされています。また、`SHX` 形式に関する次の改善も提供します。

- SHX フォントの表示を改善
- テキストの太さの正規化
- SHX シンボルの操作

# STEP (または STP) 形式のサポート

STP / STEP ファイルのサポートが CAD API に追加されました。通常、STEP (または STP) 形式は、2D および 3D の形状モデルと設計データを保持するために使用されます。 STEP 形式へのエクスポート機能も利用できるようになりました。

> このリリースの機能、拡張機能、バグ修正の完全なリストについては、[Aspose.CAD for .NET 22.7 - Release Notes](https://releases.aspose.com/cad/net/release-notes/2022/aspose-cad-for-net-22-7-release-notes/) にアクセスしてください。
