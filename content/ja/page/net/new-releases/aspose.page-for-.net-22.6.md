---
title: "C#、.NET アプリ用の DeviceN 色空間 CMYK API でのシェーディング"
description: "代替 CMYK を使用して DeviceN 色空間にシェーディング パターンを適用し、96 DPI を超える EPS を TIF に生成し、XPS ファイルをマージし、PS を PDF に変換する C# .NET API。"
keywords: ""
...
Intro_text: "これには、.NET 22.6 リリース用の Aspose.Page が含まれています。"
...
<h4>リリースノート</h4><div><a href='https://releases.aspose.com/page/net/release-notes/2022/aspose-page-for-net-22-6-release-notes/'>https://releases.aspose.com/page/net/release-notes/2022/aspose-page-for-net-22-6-release-notes/</a></div>
{{< /Releases/ReleasesFileFeatures >}}
{{< Releases/ReleasesFileFeatures >}}
...
# DeviceN 色空間のシェーディング パターン

代替 CMYK を使用して、DeviceN 色空間にシェーディング パターンを適用しました。

# EPS t TIF を 96 DPI 以上で変換

96 DPI (ドット/インチ) 以上で「EPS」から「TIF」への変換を実行します。

# XPS をマージする機能

XPS ファイルを XPS ドキュメントにマージする機能。

# PS を PDF に変換

PostScript (PS) ファイルから Adobe Acrobat® PDF ドキュメントへの変換の機能。

> このリリースの機能、拡張機能、バグ修正の完全なリストについては、[Aspose.Page for .NET 22.6 Release Notes](https://releases.aspose.com/page/net/release-notes/2022/aspose-page-for-net-22-6-release-notes/) にアクセスしてください。
