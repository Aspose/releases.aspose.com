---
title: "C#、ASP.NET アプリ用の EPS ドキュメント API で XMP メタデータを設定する"
description: "EPS (Encapsulated PostScript) ドキュメント内に Adobe の XMP (Extensible Metadata Platform) メタデータを設定するための C# .NET API により、アプリの効率が向上します。"
keywords: ""
...
Intro_text: "これには、.NET 22.5 リリース用の Aspose.Page が含まれています。"
