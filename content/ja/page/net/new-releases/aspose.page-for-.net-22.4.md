---
title: "C# ASP.NET アプリの API を介して EPS ファイルに XMP メタデータを挿入する"
description: "Adobe の XMP (Extensible Metadata Platform) メタデータを EPS (Encapsulated PostScript) ドキュメントに挿入し、ファイルのビジネス価値を高める C# .NET API。"
keywords: "    . "
...
Intro_text: "これには、.NET 22.4 リリース用の Aspose.Page が含まれています。"
