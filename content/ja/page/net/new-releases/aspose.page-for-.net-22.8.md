---
title: "C#、ASP.NET アプリ用の強化された XPS 印刷チケット サポート API"
description: "XPS ドキュメントの拡張印刷チケット機能と従量制ライセンスのサポートを提供する C# .NET API。画像から EPS への変換機能も提供します。"
keywords: ""
...
Intro_text: "これには、.NET 22.8 リリース用の Aspose.Page が含まれています。"
...
{{< /Releases/ReleasesFileFeatures >}}
{{< Releases/ReleasesFileFeatures >}}
<h4>説明</h4><div class="HTMLDescription">これには、.NET 22.8 リリース用の Aspose.Page が含まれています。</div>
{{< /Releases/ReleasesFileFeatures >}}
...
& を提供する C# .NET API。機能も提供します。

# 従量制ライセンス

従量制ライセンスのサポートが追加されました。

# XPS の印刷チケット

「XPS」形式のドキュメントの印刷チケット機能が強化されました。

# 画像から `EPS` フォーマットへの変換

画像を「EPS」ファイル形式に変換する機能。

> このリリースの機能、拡張機能、バグ修正の完全なリストについては、[Aspose.Page for .NET 22.8 Release Notes](https://releases.aspose.com/page/net/release-notes/2022/aspose-page-for-net-22-8-release-notes/) にアクセスしてください。
