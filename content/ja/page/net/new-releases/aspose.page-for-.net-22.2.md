---
title: "C#、.NET アプリの API を介して Wingdings および Zapfdingbats フォントを使用する"
description: "C# .NET API では、Wingdings フォントを、さまざまなドキュメント形式をサポートする無料の Zapfdingbats フォントに置き換えることで、dingbat 書体をより適切に処理できます。"
keywords: "    . "
...
Intro_text: "これには、.NET 22.2 リリース用の Aspose.Page が含まれています。"
...
{{< Common/li class="hide" id="author-update-609651ab29be4e888efd1af4013dff0b" >}} スコロッド {{< /Common/li >}}
...
# Wingdings を無料の Zapfdingbats フォントに置き換えます
