---
title: "画像を EPS に変換 C#、ASP.NET アプリ用の NET6.0 サポート API"
description: "C# .NET API を使用して、画像形式を正しい画像方向の EPS ファイル形式に変換します。EPS ドキュメントに XMP メタデータを設定します。.NET6.0 のサポートが利用可能です。"
keywords: ""
...
Intro_text: "これには、.NET 22.9 リリース用の Aspose.Page が含まれています。"
...
画像形式を正しい画像の向きで「EPS」ファイル形式に変換します。

# EPS に XMP メタデータを設定する

「EPS」形式のドキュメントに「XMP」メタデータを設定する機能。
