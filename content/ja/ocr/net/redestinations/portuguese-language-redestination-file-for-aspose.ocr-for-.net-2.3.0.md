...
folder_name: "Aspose.OCR for .NET 2.3.0 のポルトガル語リソース ファイル"
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.OCR for .NET 2.3.0 のポルトガル語リソース ファイル" imagelink="/resources/img/zip-icon.png">}}
