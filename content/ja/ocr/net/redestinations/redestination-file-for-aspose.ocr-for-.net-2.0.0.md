...
folder_name: "Aspose.OCR for .NET 2.0.0 のリソース ファイル"
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.OCR for .NET 2.0.0 のリソース ファイル" imagelink="/resources/img/zip-icon.png">}}
