...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.OCR for .NET 1.7.0 のリソース ファイル" imagelink="/resources/img/zip-icon.png">}}
