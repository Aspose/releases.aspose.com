...
title: "ダウンロード---新しいリリース-Aspose.ocr-for-net-22.8-（dllsのみ）"
description: " "
keywords: ""
page_type: single_release_page
folder_link: "/ocr/net/new-releases/aspose.ocr-for-net-22.8-(dlls-only)/"
folder_name: "ネット22.8のAsophes.ocr（dllsのみ）"
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="ネット22.8のAsophes.ocr（dllsのみ）" imagelink="/resources/img/zip-icon.png">}}
  {{< Releases/ReleasesButtons >}}
    {{< Releases/ReleasesSingleButtons text="ダウンロード" link="/ocr/net/new-releases/aspose.ocr-for-net-22.8-(dlls-only)/ec78cfd7c2447035f28ac68ed0fd8654-33-7951" >}}
