...
title: "ダウンロード---新しいリリース-Aspose.ocr-for-net-22.7-（dllsのみ）"
description: " "
keywords: ""
page_type: single_release_page
folder_link: "/ocr/net/new-releases/aspose.ocr-for-net-22.7-(dlls-only)/"
folder_name: "ネット22.7のasophes.ocr（dllsのみ）"
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="ネット22.7のasophes.ocr（dllsのみ）" imagelink="/resources/img/zip-icon.png">}}
  {{< Releases/ReleasesButtons >}}
    {{< Releases/ReleasesSingleButtons text="ダウンロード" link="/ocr/net/new-releases/aspose.ocr-for-net-22.7-(dlls-only)/2c2783f3b186ade780fe597c52d630f4-33-7688" >}}
