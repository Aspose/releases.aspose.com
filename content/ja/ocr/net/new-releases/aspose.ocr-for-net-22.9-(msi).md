---
title: "c＃、asp.netアプリのOCR API経由の領収書テキスト認識"
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="ネット22.9のasophes.ocr（MSI）" imagelink="/resources/img/msi-icon.png">}}
  {{< Releases/ReleasesButtons >}}
    {{< Releases/ReleasesSingleButtons text="ダウンロード" link="/ocr/net/new-releases/aspose.ocr-for-net-22.9-(msi)/4e2c810dcf93208a23b812945f0de7bb-33-7949" >}}
...
For a complete list of features, enhancements, and bug fixes in this release please visit, [Aspose.OCR for .NET 22.9 - リリースノート](https://releases.aspose.com/ocr/net/release-notes/2022/aspose-ocr-for-net-22-9-release-notes/).
