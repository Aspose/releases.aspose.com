---
title: "C＃、ASP.NETアプリの色とグレースケールの画像認識API"
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="ネット22.8のasophes.ocr（MSI）" imagelink="/resources/img/msi-icon.png">}}
  {{< Releases/ReleasesButtons >}}
    {{< Releases/ReleasesSingleButtons text="ダウンロード" link="/ocr/net/new-releases/aspose.ocr-for-net-22.8-(msi)/a9f902ce935f7a7c69be3e88f7fa5526-33-7804" >}}
  ...
  {{< Releases/ReleasesFileFeatures >}}
      <h4>リリースノート</h4><div><a href='https://releases.aspose.com/ocr/net/release-notes/2022/aspose-ocr-for-net-22-8-release-notes/'>https://releases.aspose.com/ocr/net/release-notes/2022/aspose-ocr-for-net-22-8-release-notes/</a></div>
  {{< /Releases/ReleasesFileFeatures >}}
  {{< Releases/ReleasesFileFeatures >}}
      <h4>説明</h4><div class="HTMLDescription">エリアの前処理フィルター、バイト配列からの認識</div>
  {{< /Releases/ReleasesFileFeatures >}}
...
For a complete list of features, enhancements, and bug fixes in this release please visit, [Aspose.OCR for .NET 22.8 - リリースノート](https://releases.aspose.com/ocr/net/release-notes/2022/aspose-ocr-for-net-22-8-release-notes/).
