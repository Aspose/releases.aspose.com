...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.OCR for Java 1.9.0 のリソース ファイル" imagelink="/resources/img/zip-icon.png">}}
