...
folder_name: "Aspose.OCR for Java 1.5.0 のリソース ファイル"
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.OCR for Java 1.5.0 のリソース ファイル" imagelink="/resources/img/zip-icon.png">}}
