...
> このリリースの機能、拡張機能、バグ修正の完全なリストについては、[Aspose.Drawing for .NET 22.7 Release Notes](https://docs.aspose.com/drawing/net/aspose-drawing-for-net-22-7-release-notes/) にアクセスしてください。
