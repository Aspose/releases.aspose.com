---
title: "C#、ASP.NET アプリ用の透明な PNG API の作成をサポート"
description: "PNG 形式の画像に透明色を適用するためのサポートを備えた C# .NET API、部分文字列のフォント フォールバック オプション、バイキュービック フィルタリングのパフォーマンスの向上。"
keywords: ""
...
Intro_text: "Aspose.Drawing for .NET 22.7 の MSI インストーラー"
...
API 経由で PNG 形式の画像に透明色を適用するサポートが追加されました。

# 部分文字列のフォント フォールバック

部分文字列のフォント フォールバック オプションを追加しました。

# バイキュービック フィルタリング

バイキュービック フィルタリングのパフォーマンスを改善しました。

> このリリースの機能、拡張機能、バグ修正の完全なリストについては、[Aspose.Drawing for .NET 22.7 Release Notes](https://releases.aspose.com/drawing/net/release-notes/2022/aspose-drawing-for-net-22-7-release-notes/) にアクセスしてください。
