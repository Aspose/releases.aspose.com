---
title: "C#、.NET アプリ用の 1 BPP (Bits Per Pixel) TIFF & BMP API を節約"
description: "1 BPP (Bits Per Pixel) .TIFF および .BMP 形式を保存する機能を備えた C# .NET API。API を介して Web ストリームから図面、グラフィックス、および画像ファイルをロードします。"
keywords: ""
...
Intro_text: "Aspose.Drawing for .NET 22.9 の MSI インストーラー"
...
1 (1) BPP (Bits Per Pixel) .TIFF および .BMP 形式への保存を実装しました。

# ウェブ ストリームから画像ファイルを読み込む

Web ストリームから画像ファイルをロードする機能が追加されました。

> このリリースの機能、拡張機能、バグ修正の完全なリストについては、[Aspose.Drawing for .NET 22.9 Release Notes](https://releases.aspose.com/drawing/net/release-notes/2022/aspose-drawing-for-net-22-9-release-notes/) にアクセスしてください。
