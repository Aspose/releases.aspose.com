---
title: "Aspose.Barcode | Java経由のプロセス1D、2D、および郵便バーコード" 
...
- UPCE
- VIN
family_listing_page_title: "Java用のAsoppes.Barcode" 
family_listing_page_description: "JavaのAsopse.Barcodeは、堅牢で信頼性の高いバーコード生成と認識コンポーネントです。これにより、開発者は、Java SE、Java EE、Java MEプラットフォームに基づいて、Javaアプリケーションにバーコード生成と認識機能を迅速かつ簡単に追加できます。" 
...
## サポートされている環境
 -  ** Javaランタイム：** `jre 8`` above
 -  ** Java Development：** `Java se 8`、または上。
