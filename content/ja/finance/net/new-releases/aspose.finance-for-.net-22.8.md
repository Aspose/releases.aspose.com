---
title: "C#、.NET アプリ用の財務データ ファイル要素 API の検証"
description: "XBRL などの財務データ ファイル内の 'continuation' 要素、'exclude' 要素、および 'footnote' 要素の検証規則が改善された C# .NET API。"
keywords: ""
...
footnote 要素の検証ルールを改善しました。

> このリリースの機能、拡張機能、バグ修正の完全なリストについては、[Aspose.Finance for .NET 22.8 Release Notes](https://docs.aspose.com/finance/net/aspose-finance-for-net-22-8-release-notes/) にアクセスしてください。
