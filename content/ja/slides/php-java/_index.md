---
title: "Aspose - ダウンロード"
description: "スライド用のファイルが含まれています"
keywords: "slides"
family_listing_page_title: "Java 経由の PHP 用 Aspose.Slides"
family_listing_page_description: "Microsoft PowerPoint アプリケーションを必要とせずに、PHP アプリケーションが PowerPoint プレゼンテーションを操作、レンダリング、および変換できるようにするプレゼンテーション処理 API。"
...
{{< Common/h1 text="Java 経由の PHP 用 Aspose.Slides" >}}
{{< Common/paragraph>}}
あ
{{< Common/link href="https://products.aspose.com/slides/php-java/" text="プレゼンテーション処理 API"  >}}Microsoft PowerPoint アプリケーションを必要とせずに、PHP アプリケーションが PowerPoint プレゼンテーションを操作、レンダリング、および変換できるようにします。
{{< Common/h4 text="プレゼンテーション用の PHP API"  >}} 
{{< Common/ul>}}
...
{{< /Common/paragraph>}}
{{< Common/hr >}}
{{< Common/h4 text="Composer から aspose/slide をダウンロード"  >}}
{{< Common/paragraph class="package-instructions">}}
aspose/slides は Packagist で
{{< Common/link href="https://packagist.org/packages/aspose/slides" text="アポーズ/スライド"  >}}パッケージ。次のコマンドを実行します。
{{< /Common/paragraph>}}
