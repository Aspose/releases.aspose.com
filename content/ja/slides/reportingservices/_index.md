---
title: "RDL を PowerPoint にエクスポート |レポート サービス用の Aspose.Slides"
description: "SSRS 拡張機能をダウンロードして、RDL レポートをプレゼンテーションにエクスポートします。完全な RDL 仕様をサポートしており、この拡張機能を使用して既存のレポートをカスタマイズできます。"
keywords: "SSRS Extension, RDL to PPT, RDL to PPTX "
family_listing_page_title: "レポート サービス用の Aspose.Slides"
family_listing_page_description: "Aspose.Slides for Reporting Services は、Microsoft SQL Server Reporting Services 内から PowerPoint のネイティブ フォーマットでプレゼンテーションを生成できる市場で唯一のソリューションです。"
    ...
    {{< Common/wrapper class="panel-body downloadfilebody" >}}
        {{< Common/wrapper class="productbox" >}}
            ...
            {{< Common/wrapper class="col-sm-11" >}}
                <h3 class="product-title">レポート サービス用の Aspose.Slides</h3>
                {{< Common/paragraph>}}
{{< Common/link href="https://products.aspose.com/slides/reporting-services/" text="レポート サービス用の Aspose.Slides"  >}}マイクロソフトです
                    すべての一般的な Microsoft をサポートする PowerPoint (PPT および PPS ベース) レポート生成拡張機能
                    SQLサーバー
                    Reporting Services (32 ビット & 64 ビット) バージョン。
                    ...
                    {{< Common/h3 class=" " text="サポートされている出力形式"  >}}
                     ...
                     {{< /Common/ul>}}
                    {{< Common/h3 class=" " text="サポートされる RDL 要素"  >}}
                     {{< Common/ul>}} 
                     ...
                     {{< /Common/ul>}}
                    {{< Common/h3 class=" " text="サポートされているプラットフォーム"  >}}
                     {{< Common/ul>}} 
                     ...
                     {{< /Common/ul>}}
                    {{< Common/h3 class=" " text="サポートされている Microsoft PowerPoint のバージョン"  >}}
                     {{< Common/ul>}} 
                     ...
                     {{< /Common/ul>}}
                    {{< Common/h3 class=" " text="価格"  >}}
                     {{< Common/ul>}} 
                           {{< Common/li >}} For detailed plans please visit the 
{{< Common/link href="https://purchase.aspose.com/pricing/slides/reporting-services" text="価格情報"  >}}ページ。 {{< /Common/li >}}
                     {{< /Common/ul>}}
