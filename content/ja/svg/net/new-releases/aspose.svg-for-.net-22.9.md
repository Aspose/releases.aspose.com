---
title: "svgステンシル、c＃、asp.netアプリのグリフ文字列APIを取得"
...
{{< Releases/ReleasesHeading H2txt=".NET 22.9のAspose.SVG" imagelink="/resources/img/msi-icon.png">}}
{{< Releases/ReleasesButtons >}}
{{< Releases/ReleasesSingleButtons text="ダウンロード" link="/svg/net/new-releases/aspose.svg-for-.net-22.9/20acfb3e3cfeed9c14a656c8ab0c409f-4-7958" >}}
...
> For a complete list of features, enhancements, and bug fixes in this release please visit, [Aspose.SVG for .NET 22.9 リリースノート](https://releases.aspose.com/svg/net/release-notes/2022/aspose-svg-for-net-22-9-release-notes/).
