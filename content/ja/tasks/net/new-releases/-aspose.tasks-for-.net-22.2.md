---
title: "C#、ASP.NET アプリの MPP データ API を読み取るためのメモリ割り当て"
description: "MPP ファイルからビュー データを読み取る際のメモリ割り当て数が削減された C# .NET API。 MS Project® によるプロジェクトのタイムスケールの開始と終了を適切に表示します。"
keywords: ""
page_type: single_release_page
folder_link: " tasks/net/new-releases/-aspose.tasks-for-.net-22.2/"
folder_name: ".NET 22.2 用の Aspose.Tasks"
download_link: " /tasks/net/new-releases/-aspose.tasks-for-.net-22.2/273a0666128c43ea831f47dc0fefbcfc"
download_text: " Download"
Intro_text: "これには、.NET 22.2 リリース用の Aspose.Tasks を含む MSI が含まれています。"
...
{{< Releases/ReleasesHeading H2txt=".NET 22.2 用の Aspose.Tasks" imagelink="/resources/img/msi-icon.png">}}
...
{{< Common/li class="hide" id="author-update-273a0666128c43ea831f47dc0fefbcfc" >}} vasilisinitsyn {{< /Common/li >}}
...
# MPP データを読み取るためのメモリ割り当ての改善

このリリースでは、`MPP` ファイルからビュー データを読み取る際のメモリ割り当て数が削減されています。

# MS Project® のプロジェクト タイムスケールの開始と終了
