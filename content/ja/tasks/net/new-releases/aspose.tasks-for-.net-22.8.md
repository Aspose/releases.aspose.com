---
title: "C# ASP.NET アプリ用の改善された Primavera P6 XER 処理 API"
description: "C# .NET API は、Primavera P6 XER プロジェクト ファイルを処理するための多くの改善を提供します。タスク カレンダーの読み取り、プロジェクト通貨の読み取り、LinkLag の読み取りなど。"
keywords: ""
page_type: single_release_page
folder_link: "/tasks/net/new-releases/aspose.tasks-for-.net-22.8/"
folder_name: ".NET 22.8 用の Aspose.Tasks"
download_link: "/tasks/net/new-releases/aspose.tasks-for-.net-22.8/8006773413dc03f5f9f9ae51cff6d08c-6-7758"
download_text: "Download"
Intro_text: "これには、.NET 22.8 リリース用の Aspose.Tasks を含む MSI が含まれています。"
...
{{< Releases/ReleasesHeading H2txt=".NET 22.8 用の Aspose.Tasks" imagelink="/resources/img/msi-icon.png">}}
...
# Primavera P6 XER ファイル処理の改善

この API リリースでは、Primavera P6 XER プロジェクト ファイルの処理に多くの改良が加えられています。これらには、タスク カレンダーの読み取り、プロジェクトの通貨の読み取り、LinkLag の読み取りなどの機能が含まれます。
