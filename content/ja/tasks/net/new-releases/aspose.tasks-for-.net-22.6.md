---
title: "C#、ASP.NET アプリ用の割り当てタスクとプロジェクト リソース API"
description: "「ResourceAssignment」タスクおよびリソースにアクセスするためのプロパティを持つ C# .NET API。 Primavera P6 XML フォーマット ファイルのユーザー定義型の読み取りをサポート。"
keywords: ""
page_type: single_release_page
folder_link: "/tasks/net/new-releases/aspose.tasks-for-.net-22.6/"
folder_name: ".NET 22.6 用の Aspose.Tasks"
download_link: "/tasks/net/new-releases/aspose.tasks-for-.net-22.6/0ff51d6ef5e0a7552593395de72c7eac-6-7516"
download_text: "Download"
Intro_text: "これには、.NET 22.6 リリース用の Aspose.Tasks を含む MSI が含まれています。"
...
{{< Releases/ReleasesHeading H2txt=".NET 22.6 用の Aspose.Tasks" imagelink="/resources/img/msi-icon.png">}}
...
「ResourceAssignment」タスクとリソースにアクセスするためのプロパティを追加しました。

# P6 XML ファイルのユーザー定義型を読み取る

Primavera P6 XML 形式のプロジェクトのユーザー定義型を読み取るためのサポートが追加されました。

> このリリースの機能、拡張機能、バグ修正の完全なリストについては、[Aspose.Tasks for .NET 22.6 Release Notes](https://docs.aspose.com/tasks/net/aspose-tasks-for-net-22-6-release-notes/) にアクセスしてください。
