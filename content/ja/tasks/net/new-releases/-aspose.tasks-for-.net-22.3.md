---
title: "ガント チャートのレンダリング、不変の作業時間 API C#、ASP.NET アプリ"
description: "プロジェクトの作業時間の値を不変にするための C# .NET API、読み取り、ステータス日付への書き込み、XER ファイルからの、プロジェクトの読み込みに対するキャンセル トークンのサポート。"
keywords: ""
page_type: single_release_page
folder_link: " tasks/net/new-releases/-aspose.tasks-for-.net-22.3/"
folder_name: ".NET 22.3 用の Aspose.Tasks"
download_link: " /tasks/net/new-releases/-aspose.tasks-for-.net-22.3/979f1b2d8a3746e58779d874d9cfe76a"
download_text: " Download"
Intro_text: "これには、.NET 22.3 リリース用の Aspose.Tasks を含む MSI が含まれています。"
...
{{< Releases/ReleasesHeading H2txt=".NET 22.3 用の Aspose.Tasks" imagelink="/resources/img/msi-icon.png">}}
...
{{< Common/li class="hide" id="author-update-979f1b2d8a3746e58779d874d9cfe76a" >}} vasilisinitsyn {{< /Common/li >}}
...
「XER」ファイルとの間で状況報告日を読み書きする機能が追加されました。

# プロジェクト読み込みのキャンセルトークン

プロジェクトの読み込み操作にキャンセル トークンのサポートが追加されました。

> このリリースの機能、拡張機能、バグ修正の完全なリストについては、[Aspose.Tasks for .NET 22.3 Release Notes](https://releases.aspose.com/tasks/net/release-notes/2022/aspose-tasks-for-net-22-3-release-notes/) にアクセスしてください。
