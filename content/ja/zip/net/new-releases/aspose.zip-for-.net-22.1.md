---
title: "C#、ASP.NET アプリの API を介した cpio および Tar 抽出の改善"
description: "オンプレミス API を使用して「Z」アーカイブを抽出する機能を備えた C# .NET API の新しいリリース。 `cpio` および 'tar' 抽出でトリガーされたバグを修正しました。"
keywords: ""
page_type: single_release_page
folder_link: " zip/net/new-releases/aspose.zip-for-.net-22.1/"
folder_name: ".NET 22.1 用の Aspose.ZIP"
download_link: " /zip/net/new-releases/aspose.zip-for-.net-22.1/c15d703160244e16a37304e85f1c6a8c"
download_text: " Download"
Intro_text: ".NET 22.1 リリース用の Aspose.ZIP。"
...
{{< Releases/ReleasesHeading H2txt=".NET 22.1 用の Aspose.ZIP" imagelink="/resources/img/msi-icon.png">}}
...
<h4>リリースノート</h4><div><a href="https://docs.aspose.com/zip/net/aspose-zip-for-net-22-1-release-notes/">https://docs.aspose.com/zip/net/aspose-zip-for-net-22-1-release-notes/</a></div><h4>説明</h4><div class="HTMLDescription">.NET 22.1 リリース用の Aspose.ZIP。</div>
{{< /Releases/ReleasesFileFeatures >}}
...
`cpio` 抽出でトリガーされたバグを修正しました。

# TAR 抽出の改善

`tar` 抽出でトリガーされたバグを修正しました。

> このリリースの機能、拡張機能、バグ修正の完全なリストについては、[Aspose.ZIP for .NET 22.1 Release Notes](https://docs.aspose.com/zip/net/aspose-zip-for-net-22-1-release-notes/) にアクセスしてください。
