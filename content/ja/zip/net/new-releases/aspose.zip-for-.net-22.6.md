---
title: "C#、.NET アプリの API 経由で LZMS を使用して 7z アーカイブ、WIM を抽出"
description: "C# .NET API は、ZIP コンテナー内で拡張されたデフレートをサポートし、LZMS 圧縮で WIM を抽出し、API を使用して 7z アーカイブ内の特定のエントリを抽出します。"
keywords: ""
page_type: single_release_page
folder_link: "/zip/net/new-releases/aspose.zip-for-.net-22.6/"
folder_name: ".NET 22.6 用の Aspose.ZIP"
download_link: "/zip/net/new-releases/aspose.zip-for-.net-22.6/c1f1b8ae8fe0ea6047c0752ac10454b8-2-7595"
download_text: "Download"
Intro_text: "Aspose.ZIP for .NET 22.6 リリース。"
...
{{< Releases/ReleasesHeading H2txt=".NET 22.6 用の Aspose.ZIP" imagelink="/resources/img/msi-icon.png">}}
