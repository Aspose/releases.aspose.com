---
title: "C#、ASP.NET アプリ用の LZX および Deflate ベースの CAB 抽出 API"
description: "「LZX」および Deflate アルゴリズムを使用して圧縮された「CAB」アーカイブを抽出できる C# .NET API は、.NET 6 での暗号化された「RAR5」の抽出を改善しました。"
keywords: ""
page_type: single_release_page
folder_link: " zip/net/new-releases/aspose.zip-for-.net-22.3/"
folder_name: ".NET 22.3 用の Aspose.ZIP"
download_link: " /zip/net/new-releases/aspose.zip-for-.net-22.3/fbd379bca0b049df88c596552bd82d7e"
download_text: " Download"
Intro_text: "Aspose.ZIP for .NET 22.3 リリース。"
...
{{< Releases/ReleasesHeading H2txt=".NET 22.3 用の Aspose.ZIP" imagelink="/resources/img/msi-icon.png">}}
...
`LZX` および Deflate アルゴリズムを使用して圧縮された `CAB` アーカイブを抽出します。
