...
> このリリースの機能、拡張機能、バグ修正の完全なリストについては、[Aspose.Email for .NET 22.7 Release Notes](https://docs.aspose.com/email/net/aspose-email-for-net-22-7-release-notes/) にアクセスしてください。
