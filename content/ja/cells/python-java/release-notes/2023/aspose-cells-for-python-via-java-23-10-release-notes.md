...
linktitle: Aspose.Cells for Python via Java 23.10 リリースノート
title: Aspose.Cells for Python via Java 23.10 リリースノート
weight: 3
description: Aspose.Cells for Python via Java 23.10 リリースノート – 最新の更新と修正
type: repositor
layout: releas
...
このページには、次のリリースノートが含まれています[Aspose.Cells for Python via Java 23.10](https://releases.aspose.com/cells/python-java/new-releases/aspose.cells-for-python-via-java-23.10/).
...
|CELLSPYTHONJAVA-66|計算オプションを設定した後の動的配列数式の計算エラーを更新する|
|CELLSPYTHONJAVA-68|問題: java.lang.NullPointerException: 「\ のため、「com.aspose.cells.DateTime.getyear()」を呼び出すことができません<local3\>.d"はnullです|
|CELLSPYTHONJAVA-71|複数の X 軸カテゴリを無視した箱ひげ図|
