---
title: C#、ASP.NET アプリの CSV および TSV ファイル形式 API を自動検出
description: C# .NET API スプレッドシートをプリンターにレンダリングするための印刷ジョブ名の設定をサポート、テキスト ファイルを CSV / TSV として自動検出、範囲から非表示の行/列を除外
keywords: ""
...
{{< Releases/ReleasesWapper >}}
  ...
  {{< Releases/ReleasesButtons >}}
    {{< Releases/ReleasesSingleButtons text="ダウンロード" link="/cells/net/new-releases/-aspose.cells-for-.net-22.1/8aa0c74982524d5d9ec0a165334ff68d%20%20" >}}
  ...
  {{< Releases/ReleasesFileArea >}}
    ...
    {{< Releases/ReleasesDetailsUl >}}
      ...
      {{< Common/li class="hide" id="author-update-8aa0c74982524d5d9ec0a165334ff68d" >}} <li>ビュー:{{< /Common/li >}} 
      {{< Common/li >}} 205: {{< /Common/li >}} 
      {{< Common/li id="205-update-8aa0c74982524d5d9ec0a165334ff68d" >}}追加日::{{< /Common/li >}} 
...
スプレッドシートをプリンターにレンダリングする際に、印刷ジョブ名に `PrinterSettings` を指定して設定するためのサポートが追加されました。

#  `CSV` および `TSV` ファイル形式を自動検出

この API リリースでは、API を使用してテキスト ファイルをカンマ区切り `CSV` およびタブ区切り `TSV` ファイル形式として自動検出する機能が導入されています。
