---
title: Excel を PDF に変換、レンダリング C# ASP.NET アプリの WordArt API
description: C# .NET API への変換時の Excel® WordArt の図形と効果のレンダリングが改善され、XLS から PDF への変換が改善され、CSV の末尾の空白セルが削除されました。
keywords: ""
...
{{< Releases/ReleasesWapper >}}
  ...
  {{< Releases/ReleasesButtons >}}
    {{< Releases/ReleasesSingleButtons text="ダウンロード" link="/cells/net/new-releases/aspose.cells-for-.net-22.4/b5ba0eebeffe46e9962a78f9bb8bdca1%20%20" >}}
...
Microsoft Excel&reg; が確認されました。 Excel から PDF への変換中に、ワードアートの効果と図形が適切にレンダリングされませんでした。この問題は現在解決されています。

#  XLS から PDF への変換を改善

以前は、`XLS` を `PDF` に変換すると、テキストボックス内の空白のテキスト行のサイズが正しくレンダリングされない場合がありました。この問題は現在解決されています。

#  CSV から末尾の空白 Cells を削除
