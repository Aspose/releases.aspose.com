...
linktitle: "Aspose.Cells for .NET 8.9.2 リリースノート"
title: "Aspose.Cells for .NET 8.9.2 リリースノート"
weight: 50
description: "Aspose.Cells for .NET 8.9.2 リリースノート – the latest updates and fixes."
type: "repository"
layout: "release"
family_listing_page_title: "Aspose.Cells for .NET 8.9.2 リリースノート"
---
### **1) Aspose.Cells**
...
|CELLSNET-44570 |レンダリングされた PDF ファイルでのワードアート図形の書式設定に関する問題|バグ|
...
|CELLSNET-44663 |XLSB ファイルを開く際のエラー|バグ|
|CELLSNET-44657 |結果のスプレッドシートでの HTML から XLSX への変換|バグ|
|CELLSNET-44648 |HTML を XLSX に変換中にコンテンツが見つからない|バグ|
|CELLSNET-44647 |HTML を XLSX に変換中にスタイルが見つからない|バグ|
|CELLSNET-44671 |TextBox を完全に透明にすることはできません|バグ|
|CELLSNET-44662 |Chart.Calculate() メソッドがチャートをめちゃくちゃにする|バグ|
|CELLSNET-44665 |チャートを画像にレンダリング中にシリーズが見つからない|バグ|
|CELLSNET-44674 |廃止された Shape.LineFormat および FillFormat プロパティに対するあいまいなコメント|バグ|
|CELLSNET-44670 |TextBox を Worksheet に追加するデフォルトの動作が変更されました|バグ|
|CELLSNET-44661 |OLELink が変更された (Excel にインポートされた Word テーブル) リンクの更新後もドキュメントに古い値が表示される|バグ|
|CELLSNET-44659 |XLS ファイルを読み込んで保存すると色が変わる|バグ|
...
|CELLSNET-44676 |バージョン番号を知るために、acwmain.js ファイル内に実装またはコメントを追加します。|バグ|
|CELLSNET-44656 |行を貼り付けると、最初の空のセルの右側に余分な空のセルが挿入されます|バグ|
...
#### **TextOptions.Fill、TextOptions.Outline、TextOptions.Shadow プロパティを追加**
