...
linktitle: "Aspose.Cells for PHP via Java 19.8 リリースノート"
title: "Aspose.Cells for PHP via Java 19.8 リリースノート"
weight: 10
description: "Aspose.Cells for PHP via Java 19.8 リリースノート – the latest updates and fixes."
type: "repository"
layout: "release"
family_listing_page_title: "Aspose.Cells for PHP via Java 19.8 リリースノート"
---
{{% alert color="primary" %}} 

このページには、Aspose.Cells for PHP via Java 19.8 のリリース ノートが含まれています。
...
|CELLSJAVA-42951|java.lang.NullPointerException は、comment.setHtmlNote() によってスローされます。|例外|
