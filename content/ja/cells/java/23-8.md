---
title: Aspose.Cells 23.8 |プロセススプレッドシート形式 via Java API
...
Aspose.Cells Java API は次の場所でホストされています。[Aspose リポジトリ](https://repository.aspose.com/cells/)。シンプルな設定で、Aspose.Cells for Java API を Maven プロジェクトで直接簡単に使用できます。詳しい手順については、こちらをご覧ください。[Maven リポジトリから Aspose.Cells for Java をインストールする](https://docs.aspose.com/cells/java/installation/)ドキュメントページ。
