---
title: "Aspose.cells 22.5 | Java API経由のスプレッドシート形式をプロセスします" 
...
[Aspose.Cells for Java](https://products.aspose.com/cells/java)は、Java開発者がExcelの読み取り、書き込み、操作機能を埋め込むことができる、受賞歴のあるExcelスプレッドシート処理APIですか？スプレッドシート（​​xls、xlsx、xlsm、xlsb、xltx、spreadsheetml、csv、ods）、html、mhtml、pdf、および画像ファイル形式は、microsoft excelに依存する必要なく独自のJavaアプリケーションになります。
