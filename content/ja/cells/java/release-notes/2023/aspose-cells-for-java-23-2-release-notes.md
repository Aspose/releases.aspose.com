...
linktitle: "Aspose.Cells for Java 23.2 リリースノート"
title: "Aspose.Cells for Java 23.2 リリースノート"
weight: 11
description: "Aspose.Cells for Java 23.2 リリースノート – the latest updates and fixes."
type: "repository"
layout: "release"
family_listing_page_title: "Aspose.Cells for Java 23.2 リリースノート"
---
{{% alert color="primary" %}}

このページには、次のリリースノートが含まれています[Aspose.Cells for Java 23.2](https://releases.aspose.com/cells/java/).
