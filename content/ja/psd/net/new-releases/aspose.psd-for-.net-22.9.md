...
このリリースで修正された機能、拡張機能、およびバグの完全なリストについては、[Aspose.PSD for .NET 22.9 - Release Notes](https://releases.aspose.com/psd/net/release-notes/2022/aspose-psd-for-net-22-9-release-notes/) にアクセスしてください。
