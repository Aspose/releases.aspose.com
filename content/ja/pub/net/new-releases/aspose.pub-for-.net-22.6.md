...
> このリリースで修正された機能、拡張機能、およびバグの完全なリストについては、[Aspose.PUB for .NET 22.6 Release Notes](https://docs.aspose.com/pub/net/aspose-pub-for-net-22-6-release-notes/) にアクセスしてください。
