---
title: "C# アプリの API を介して MS Publisher 2000 PUB を PDF に変換"
description: "PUB 変換 API は、C#、ASP.NET アプリ内で Microsoft Publisher 2000 PUB ファイルを Adobe PDF ファイル形式に変換できるようになりました。 .NET Framework 5.0 準拠。"
keywords: "    . "
...
Intro_text: "Aspose.PUB for .NET 21.6 リリースが含まれています。"
...
# .NET フレームワーク 5.0 のサポート

このリリースは、.NET Framework 5.0 をサポートしています。

# .NET Core と .NET 5 のサポート

このリリースは、.NET コードと .NET 5 をサポートしています。

# Microsoft Publisher® 2000 のサポート
