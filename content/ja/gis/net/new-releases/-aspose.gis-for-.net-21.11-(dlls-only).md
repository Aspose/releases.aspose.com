---
title: "ダウンロード--- new-releases  -  aspose.gis-for-.net-21.11-（dlls-only）。" 
description:  "    . " 
keywords:  "    . " 
page_type:  single_release_page
folder_link: " gis/net/new-releases/-aspose.gis-for-.net-21.11-(dlls-only)/"
folder_name: ".net 21.11のaspose.gis（dllsのみ）"
...
download_count: "   11/28/2021  ダウンロードs: 8  Views: 40"
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt=".net 21.11のaspose.gis（dllsのみ）" imagelink="/resources/img/zip-icon.png">}}
  {{< Releases/ReleasesButtons >}}
    {{< Releases/ReleasesSingleButtons text=" ダウンロード" link="/gis/net/new-releases/-aspose.gis-for-.net-21.11-(dlls-only)/2ead2f9264b546dbaba673ac7137f70b%20%20" >}}
  ...
  {{< Releases/ReleasesFileFeatures >}}
      <h4>リリースノート</h4><div><a href="https://docs.aspose.com/gis/net/aspose-gis-for-net-21-11-release-notes/">https://docs.aspose.com/gis/net/aspose-gis-for-net-21-11-release-notes/</a></div><h4>説明</h4><div class="HTMLDescription">このZIPファイルには、.NETアセンブリ用のAsops.Gisのみが含まれています。アセンブリは、同じバージョンの製品のMSIインストーラーと同じです。</div>
  {{< /Releases/ReleasesFileFeatures >}}
 {{< /Releases/ReleasesFileArea >}}
{{< /Releases/ReleasesWapper >}}
