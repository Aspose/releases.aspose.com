---
title: "İndirmeler --- New-Saless -pose.pub-for-.NET-242.5- (yalnızca DLLS)." 
description:  "    . " 
keywords:  "    . " 
page_type:  single_release_page
folder_link: " pub/net/new-releases/aspose.pub-for-.net-22.5-(dlls-only)/"
folder_name: ".NET 22.5 için aspose.pub (yalnızca DLL'ler)"
download_link: " /pub/net/new-releases/aspose.pub-for-.net-22.5-(dlls-only)/9e5c0f07add0415cbef1f1bf8879c142"
download_text: " İndirmek"
intro_text: "Bu zip dosyası, yalnızca .NET düzenekleri için aspose.pub içerir. Meclisler A ..."
image_link: "/resources/img/zip-icon.png"
download_count: "   Added: 2 weeks ago [5/6/2022]  İndirmeks: 4  Views: 7"
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt=".NET 22.5 için aspose.pub (yalnızca DLL'ler)" imagelink="/resources/img/zip-icon.png">}}
  {{< Releases/ReleasesButtons >}}
    {{< Releases/ReleasesSingleButtons text=" İndirmek" link="/pub/net/new-releases/aspose.pub-for-.net-22.5-(dlls-only)/9e5c0f07add0415cbef1f1bf8879c142%20%20" >}}
