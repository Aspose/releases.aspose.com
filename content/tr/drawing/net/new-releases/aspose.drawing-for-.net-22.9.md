---
title: "C#, .NET Uygulamaları için 1 BPP (Piksel Başına Bit) TIFF ve BMP API'sini kaydedin"
description: "1 BPP (Piksel Başına Bit) .TIFF ve .BMP formatlarını kaydetme, API aracılığıyla bir web akışından çizimleri, grafikleri ve görüntü dosyalarını yükleme özelliğine sahip C# .NET API."
keywords: ""
...
Intro_text: "Aspose.Drawing for .NET 22.9 için MSI yükleyicisi"
...
# 1 BPP TIFF ve BMP'yi kaydedin

1 (bir) BPP (Piksel Başına Bit) .TIFF ve .BMP biçimlerine kaydetme uygulandı.

# Bir web akışından görüntü dosyalarını yükleyin
