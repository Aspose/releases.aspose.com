---
title: Aspose.Cells 23,8 | İşlem Elektronik Tablosu Formatları via Java API
...
##  Başlamak
 ...
 Aspose.Cells Java API'ler şu adreste barındırılmaktadır:[Aspose Depo](https://repository.aspose.com/cells/) . Aspose.Cells for Java API'i basit konfigürasyonlarla doğrudan Maven projelerinizde rahatlıkla kullanabilirsiniz. Ayrıntılı talimatlar için lütfen şu adresi ziyaret edin:[Aspose.Cells for Java'in Maven Deposundan yüklenmesi](https://docs.aspose.com/cells/java/installation/) dokümantasyon sayfası.
