---
title:  Aspose.Cells 23,6 | İşlem Elektronik Tablosu Formatları via Java API
...
[![afiş](/res_repo/img/compress/aspose_cells-for-java-banner.png)](./)
...
##  Başlamak
 ...
 Aspose.Cells Java API'ler şu adreste barındırılmaktadır:[Aspose Depo](https://releases.aspose.com/cells/java/) . Aspose.Cells for Java API'i basit konfigürasyonlarla doğrudan Maven projelerinizde rahatlıkla kullanabilirsiniz. Ayrıntılı talimatlar için lütfen şu adresi ziyaret edin:[Aspose.Cells for Java'in Maven Deposundan yüklenmesi](https://docs.aspose.com/cells/java/installation/) dokümantasyon sayfası.
