...
linktitle: "Aspose.Cells for Java 20.2 Sürüm Notları"
title: "Aspose.Cells for Java 20.2 Sürüm Notları"
weight: 50
description: "Aspose.Cells for Java 20.2 Sürüm Notları – the latest updates and fixes."
type: "repository"
layout: "release"
family_listing_page_title: "Aspose.Cells for Java 20.2 Sürüm Notları"
---
{{% alert color="primary" %}}

 Bu sayfa için sürüm notları içerir[Aspose.Cells for Java 20.2](https://releases.aspose.com/cells/java/new-releases/aspose.cells-for-java-20.2/).
...
|CELLSJAVA-43108|PDF'e dönüştürme - com.aspose.cells.CellsException|Böcek|
...
### **FormulaParseOptions.Parse özelliğini ekler.**
 Hücreye bir formül ifadesi ayarlarken formülün ayrıştırılıp ayrıştırılmayacağını gösterir. varsayılan**doğru** . Eğer**YANLIŞ**, ardından giriş formülü ifadesi, kullanıcı bunları ayrıştırmak için diğer yöntemleri çağırana veya formül hesaplama gibi diğer işlemler için ayrıştırılmış formül verileri gerekinceye kadar hücre için olduğu gibi tutulur.
