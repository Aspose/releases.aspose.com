---
title: Elektronik Tablo Şablonu XLT (Excel) OTS (Calc) API C# .NET Uygulama
description: C# .NET API Excel® (XLT) ve Calc (OTS) elektronik tablo şablonu formatlarını destekler, sınırların içine ayarlanır, pivot alanı değerlerini seçilen sütun veya satıra göre sıralar
keywords: ""
...
{{< Releases/ReleasesWapper >}}
  ...
  {{< Releases/ReleasesButtons >}}
    {{< Releases/ReleasesSingleButtons text=" İndirmek" link="/cells/net/new-releases/aspose.cells-for-.net-22.3/c293581525754554a9ea2092b4c27669%20%20" >}}
...
#  Elektronik Tablo Şablonu Formatları Desteği

Bu API sürümü, hem Excel&reg; (XLT) & OpenOffice Calc&reg; (OTS) programları. Bunlar, `SaveFormat.Ots` ve `SaveFormat.Xlt` aracılığıyla çıktı formatları olarak desteklenir.

#  İç Sınırları Ayarla

İç sınırları ayarlama yeteneği.

#  PivotField'ı Seçilen Satır veya Sütuna Göre Sırala
