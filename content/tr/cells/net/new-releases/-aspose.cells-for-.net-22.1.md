---
title: C#, ASP.NET Uygulaması için CSV ve TSV Dosya Formatı API'i otomatik olarak algıla
description: C# .NET API, elektronik tabloları yazıcıya aktarmak için yazdırma işi adını ayarlama desteğiyle, metin dosyasını CSV / TSV olarak otomatik olarak algıla, gizli satırları/sütunları aralıktan hariç tut
keywords: ""
...
{{< Releases/ReleasesWapper >}}
  ...
  {{< Releases/ReleasesButtons >}}
    {{< Releases/ReleasesSingleButtons text=" İndirmek" link="/cells/net/new-releases/-aspose.cells-for-.net-22.1/8aa0c74982524d5d9ec0a165334ff68d%20%20" >}}
  ...
  {{< Releases/ReleasesFileArea >}}
    ...
    {{< Releases/ReleasesDetailsUl >}}
      ...
      {{< Common/li class="hide" id="author-update-8aa0c74982524d5d9ec0a165334ff68d" >}} <li> Görüntüleme:{{< /Common/li >}} 
      {{< Common/li >}} 205: {{< /Common/li >}} 
      {{< Common/li id="205-update-8aa0c74982524d5d9ec0a165334ff68d" >}} Ekleme Tarihi::{{< /Common/li >}} 
...
#  Yazıcı İş Adını Ayarla

Yazıcıda e-tablolar oluşturulurken `PrinterSettings` ile yazdırma işi adının sağlanması ve ayarlanması desteği eklendi.

#  `CSV` ve `TSV` Dosya Formatını Otomatik Algıla

Bu API sürümü, API'i kullanarak virgülle ayrılmış `CSV` ve sekmeyle ayrılmış `TSV` dosya formatlarındaki metin dosyalarını otomatik olarak algılama yeteneğini sunar.

#  Gizli Satırları/Sütunları Aralığın Dışında Tut
