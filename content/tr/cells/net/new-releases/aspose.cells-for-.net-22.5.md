---
title:  İndirilenler ---Yeni Çıkanlar-aspose.cells-for-.net-22.5 .
description: C# .NET API, geliştirilmiş dinamik dizi formülü işleme, daha hızlı boş sütun silme, "ODS"den bağlantılı "OLE" eklerini getirme, JSON dizesini Excel®'e aktarma
keywords: ""
...
{{< Releases/ReleasesWapper >}}
  ...
  {{< Releases/ReleasesButtons >}}
    {{< Releases/ReleasesSingleButtons text=" İndirmek" link="/cells/net/new-releases/aspose.cells-for-.net-22.5/c47d4d310c384ad6a29a2cbe74538553%20%20" >}}
  ...
  {{< Releases/ReleasesFileArea >}}
    ...
    {{< Releases/ReleasesDetailsUl >}}
      ...
      {{< Common/li id="added-update-c47d4d310c384ad6a29a2cbe74538553" >}} : 6 gün önce [5/10/2022]{{< /Common/li >}} 
...
#  Geliştirilmiş Dinamik Dizi Formül İşleme

Dinamik dizi formülünü ayarlarken hücrenin hesaplanan değerini başlatma yeteneği.

#  Daha Hızlı Boş Sütun Silme

Boş sütunları silme performansı iyileştirildi.

#  `ODS`'den Bağlantılı `OLE` Eklerini Getir

`ODS` dosyasındaki Bağlantılı OLE ekleri alınırken sorun gözlemlendi. Bu sorun artık çözüldü.

#  JSON Dizesini Excel'e Aktar&reg;
