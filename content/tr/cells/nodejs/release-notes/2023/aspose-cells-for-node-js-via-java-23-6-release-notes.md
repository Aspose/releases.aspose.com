...
linktitle: Aspose.Cells for Node.js via Java 23.6 Sürüm Notu
title: Aspose.Cells for Node.js via Java 23.6 Sürüm Notu
weight: 7
description: Aspose.Cells for Node.js via Java 23.6 Sürüm Notları – en son geliştirmeler, yeni özellikler ve düzeltmeler
type: repositor
layout: releas
...
{{% alert color="primary" %}}
 ...
 Bu sayfa şu sürüm notlarını içerir:[Aspose.Cells for Node.js via Java 23.6](https://releases.aspose.com/cells/nodejs/new-releases/aspose.cells-for-node.js-via-java-23.6/).
...
|CELLSNODEJSJAVA-44|Dosya PDF'e dönüştürülürken metin kutusu içeriği bulanık|
|CELLSNODEJSJAVA-46|Çalışma kitabı PDF'e dönüştürülürken Cell metni kesiliyor ve yanlış kaydırılıyor|
|CELLSNODEJSJAVA-47|Tarih biçimlendirmesi Aspose.Cells'deki tüm sütunlarda uygulanmıyor|
