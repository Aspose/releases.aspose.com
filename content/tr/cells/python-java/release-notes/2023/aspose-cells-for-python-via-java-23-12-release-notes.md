...
linktitle: Aspose.Cells for Python via Java 23.12 Sürüm Notu
title: Aspose.Cells for Python via Java 23.12 Sürüm Notu
weight: 1
description: Aspose.Cells for Python via Java 23.12 Sürüm Notları – en son güncellemeler ve düzeltmeler
type: repositor
layout: releas
...
{{% alert color="primary" %}}
 ...
 Bu sayfa şu sürüm notlarını içerir:[Aspose.Cells for Python via Java 23.12](https://releases.aspose.com/cells/python-java/new-releases/aspose.cells-for-python-via-java-23.12/).
...
|CELLSPYTHONJAVA-79|Çok sayıda x ekseni etiketi grafiğin alt kısmı yerine ortasına yazdırılıyor|
