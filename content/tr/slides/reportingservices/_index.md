---
title: "RDL'yi PowerPoint'e Aktarın | Aspose.Slides for Reporting Services"
description: "RDL raporlarını sunumlara aktarmak için SSRS Uzantısını indirin. Tam RDL spesifikasyonunu destekler ve bu uzantıyı kullanarak mevcut raporları özelleştirebilirsiniz."
keywords: "SSRS Extension, RDL to PPT, RDL to PPTX "
family_listing_page_title: "Aspose.Slides for Reporting Services"
family_listing_page_description: "Aspose.Slides for Reporting Services, Microsoft SQL Server Reporting Services içinden PowerPoint'in yerel formatlarında sunumlar oluşturmayı mümkün kılan piyasadaki tek çözümdür."
    ...
    {{< Common/wrapper class="panel-body downloadfilebody" >}}
        {{< Common/wrapper class="productbox" >}}
            ...
            {{< Common/wrapper class="col-sm-11" >}}
                ...
                {{< Common/paragraph>}}
{{< Common/link href="https://products.aspose.com/slides/reporting-services/" text="Aspose.Slides for Reporting Services"  >}}bir Microsoft'tur
                    Tüm popüler Microsoft desteğiyle PowerPoint (PPT ve PPS tabanlı) rapor oluşturma uzantısı
                    SQL Server
                    Raporlama Servisleri (32-bit ve 64-bit) sürümleri.
                    {{< /Common/paragraph>}}{{< Common/h3 class=" " text="Features"  >}}
                     ...
                     {{< /Common/ul>}}
                    {{< Common/h3 class=" " text="Desteklenen Giriş Formatları"  >}}
                     {{< Common/ul>}}
                           {{< Common/li >}} RPL (Report Page Layout) {{< /Common/li >}}
                           {{< Common/li >}} RDL (Report Definition Language) {{< /Common/li >}}
                     {{< /Common/ul>}}
                    {{< Common/h3 class=" " text="Desteklenen Çıktı Formatları"  >}}
                     {{< Common/ul>}}
                     ...
                     {{< /Common/ul>}}
                    {{< Common/h3 class=" " text="Desteklenen RDL Öğeleri"  >}}
                     {{< Common/ul>}}
                     ...
                     {{< /Common/ul>}}
                    {{< Common/h3 class=" " text="Desteklenen Platformlar"  >}}
                     {{< Common/ul>}}
                     ...
                     {{< /Common/ul>}}
                    {{< Common/h3 class=" " text="Desteklenen Microsoft PowerPoint Sürümleri"  >}}
                     {{< Common/ul>}}
                     ...
                     {{< /Common/ul>}}
                    {{< Common/h3 class=" " text="fiyatlandırma"  >}}
                     {{< Common/ul>}}
                           {{< Common/li >}} For detailed plans please visit the
{{< Common/link href="https://purchase.aspose.com/pricing/slides/reporting-services" text="Fiyatlandırma bilgisi"  >}}sayfa. {{< /Common/li >}}
                     {{< /Common/ul>}}
                {{< Common/paragraph>}}
