...
Aspose.slides Java API'leri [Aspose deposu](https://repository.aspose.com/slides/)'da barındırılmaktadır. Basit konfigürasyonlarla doğrudan Maven projelerinizde Java API için aspose.slides kullanabilirsiniz. Ayrıntılı talimatlar için lütfen [Installing Aspose.Slides for Java from Maven Repository](https://docs.aspose.com/slides/java/installation/) Dokümantasyon sayfasını ziyaret edin.
