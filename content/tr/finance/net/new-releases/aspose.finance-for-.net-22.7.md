---
title: "C#, ASP.NET Uygulamaları için XBRL API'sinde Schemaref Öğelerini Doğrulayın"
description: "Doğrulama desteğine sahip C# .NET API; XBRL dosyalarındaki bağlam öğesindeki şemaref öğeleri, bağlam öğesi kimliği özniteliği ve varlık alt öğesi."
keywords: ""
...
# XBRL Doğrulamasında Şemaref Öğeleri

"XBRL" dosyalarındaki Schemaref öğelerinin doğrulanması için destek.

# Bağlam Öğesi Kimliği Özellik Doğrulaması

"XBRL" dosyasındaki bağlam öğesinin kimlik özniteliğinin doğrulaması eklendi.

# Varlık Alt Öğe Doğrulaması

"XBRL" dosyasındaki bağlam öğesindeki varlık alt öğesinin doğrulamasını tamamlayın.

> Bu sürümdeki özelliklerin, geliştirmelerin ve hata düzeltmelerinin tam listesi için lütfen [Aspose.Finance for .NET 22.7 Release Notes](https://docs.aspose.com/finance/net/aspose-finance-for-net-22-7-release-notes/) adresini ziyaret edin.
