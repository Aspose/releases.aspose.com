---
title: "C#, ASP.NET Uygulamaları için OLM Biçimi Çince Metin API'si desteği"
description: "C# .NET API, macOS® OLM için Microsoft Outlook® biçimini destekler. Microsoft Graph® İstemcisinde e-postaları listelemek için OrderBy. Çince Metin ile EML'den MSG'ye Dönüştürme."
keywords: ""
...
Intro_text: "Aspose.Email for .NET 22.9 sürümünü içerir."
...
<h4>Sürüm notları</h4><div> <a href='https://docs.aspose.com/email/net/aspose-email-for-net-22-9-release-notes/'>https://docs.aspose.com/email/net/aspose-email-for-net-22-9-release-notes/</a></div>
{{< /Releases/ReleasesFileFeatures >}}
{{< Releases/ReleasesFileFeatures >}}
...
> Bu sürümdeki özelliklerin, geliştirmelerin ve hata düzeltmelerinin tam listesi için lütfen [Aspose.Email for .NET 22.9 Release Notes](https://docs.aspose.com/email/net/aspose-email-for-net-22-9-release-notes/) adresini ziyaret edin.
