...
title: "İndirmeler --- Yeni sürümler -posse.html--for-.net-242.8- (sadece DLLS)"
description: " "
keywords: ""
page_type: single_release_page
folder_link: "/html/net/new-releases/aspose.html-for-.net-22.8-(dlls-only)/"
folder_name: ".NET 22.8 için aspose.html (yalnızca DLLS)"
download_link: "/html/net/new-releases/aspose.html-for-.net-22.8-(dlls-only)/35e7e0df035d640efef683310114c403-4-7782"
download_text: "İndirmek"
intro_text: "This ZIP file contains only the Aspose.HTML for .NET assemblies. The assemblies are the same as in the MSI installer of the product of the same version. İndirmek this if you want to use Aspose.HTML without the MSI installer, i.e. you cannot run MSI installers on Mono. This ZIP download does not contain the user documentation in the Microsoft Help format which is included in the MSI installer."
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt=".NET 22.8 için aspose.html (yalnızca DLLS)" imagelink="/resources/img/zip-icon.png">}}
  {{< Releases/ReleasesButtons >}}
    {{< Releases/ReleasesSingleButtons text="İndirmek" link="/html/net/new-releases/aspose.html-for-.net-22.8-(dlls-only)/35e7e0df035d640efef683310114c403-4-7782" >}}
