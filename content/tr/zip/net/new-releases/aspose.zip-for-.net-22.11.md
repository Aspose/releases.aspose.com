---
title: "7Z Arşiv PPMD ​​Sıkıştırma Destek API C#, ASP.NET uygulamaları için" 
description: "C# .NET Arşivi Sıkıştırma ve Ekstraksiyon API, 7Z arşivinde `ppmd 'sıkıştırmasının desteğini tanıtıyor, 7Z (7 ZIP) giriş sıkıştırmasının ilerlemesi." 
keywords: ""
page_type: single_release_page
folder_link: "/zip/net/new-releases/aspose.zip-for-.net-22.11/"
folder_name: "22.11 için aspose.zip" 
download_link: "/zip/net/new-releases/aspose.zip-for-.net-22.11/24a1a21fbba00120ccc363981f405375-2-8204"
download_text: "İndirmek" 
intro_text: ".NET 22.11 sürümü için aspose.zip." 
image_link: "/resources/img/msi-icon.png"
download_count: " 26/11/2022 İndirmeks: 1  Views: 1 "
...
{{< Releases/ReleasesHeading H2txt="22.11 için aspose.zip" imagelink="/resources/img/msi-icon.png">}}
{{< Releases/ReleasesButtons >}}
{{< Releases/ReleasesSingleButtons text="İndirmek" link="/zip/net/new-releases/aspose.zip-for-.net-22.11/24a1a21fbba00120ccc363981f405375-2-8204" >}}
...
{{< Releases/ReleasesFileFeatures >}}
<h4>Açıklama</h4>
<div class="HTMLDescription">.NET 22.11 sürümü için aspose.zip.</div>
{{< /Releases/ReleasesFileFeatures >}}
{{< Releases/ReleasesHeading h4txt="Dikkate değer özellikler">}}
{{< Common/wrapper class="HTMLDescription">}}
{{% Releases/ReleasesFileFeatures %}}

# 7Z Arşivi `ppmd` sıkıştırma desteği

Bu API sürümü, 7Z arşivinde `ppmd 'sıkıştırma desteğini tanıttı.

# Rapor 7Z Sıkıştırma İlerlemesi
