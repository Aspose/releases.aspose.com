---
title: "C#, ASP.NET Uygulamaları için VSDX'ten PDF'ye Görüntü Şekil Dönüştürme API'sı"
description: "VSDX'ten PDF'ye görüntü dönüştürme ve arka plan rengi değişikliği, VSDX'ten SVG'ye doğru metin konumu ve VSDX'ten PNG'ye tablo oluşturma ile C# .NET API."
keywords: ""
page_type: single_release_page
folder_link: " diagram/net/new-releases/aspose.diagram-for-.net-22.4/"
folder_name: ".NET 22.4 için Aspose.Diagram"
download_link: " /diagram/net/new-releases/aspose.diagram-for-.net-22.4/6e208ab2278748a6bf400d16896331ab"
download_text: " Download"
Intro_text: "Aspose.Diagram for .NET 22.4 sürümünü içerir."
...
{{< Releases/ReleasesHeading H2txt=".NET 22.4 için Aspose.Diagram" imagelink="/resources/img/msi-icon.png">}}
...
# Görüntü Dönüştürme Sorununun Çözümü

Microsoft Visio® VSDX'i PDF'ye dönüştürürken görüntü dönüştürme çalışmıyordu. Mevcut sürüm bu sorunu düzeltti.

# Visio® Şekil Arka Planı Renk Dönüşümü

Daha önce bazı durumlarda, VSDX'i PDF'ye dönüştürme işlemi sırasında şekillerin arka plan rengi yanlış dönüştürülüyordu. Bu sorun şimdi çözüldü.

# Metin Konumu İşleme

Visio'dan SVG biçimine dönüştürme sırasında metin konumunun daha iyi işlenmesi.

# Visio'da PNG'ye Dönüştürmede Daha İyi Tablo Oluşturma
