---
title: "Aspose.diagram | Java Kütüphanesi Oluşturmak İçin, Visio Dokümanları Dışa Aktarmak" 
...
family_listing_page_description: "ASPOSE.DIAGRAM için Java, geliştiricilerin Java uygulamalarından yerel Visio dosya formatlarını oluşturmasına, manipüle etmesine ve dönüştürmesine izin veren ve Microsoft Visio'ya güvenmeye gerek kalmadan kullanımı kolay, yüksek performanslı ve iyi belgelenmiş bir Java API'sıdır. ®." 
...
Java için aspose.diagram, herhangi bir kazara değişiklikten kaçınmak için arka planları, şablonları (master) ve şekilleri ve stilleri kilitleyerek [Microsoft Visio çizimlerine koruma uygulayın](https://docs.aspose.com/diagram/java/working-with-protection/)'a da kullanılabilir.
