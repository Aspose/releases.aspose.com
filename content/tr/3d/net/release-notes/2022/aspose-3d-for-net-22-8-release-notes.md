...
linktitle: "Aspose.3D for .NET 22.8 lease elease Notes"
title: "Aspose.3D for .NET 22.8 lease elease Notes"
weight: 5
description: "To Aspose.3D for .NET 22.8 notlarını serbest bıraktı."
type: "repository"
layout: "release"
---
{{% alert color="primary" %}}

Tonun sayfası Aspose.3D for .NET 22.8 için sürüm notları bilgilerini içerir.
...
### 07`Aspose.ThreeD.Formats.UsdSaveOptions` sınıfında yeni mülkiyet dded aterialCon::
