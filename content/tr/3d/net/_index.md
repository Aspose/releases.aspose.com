...
Microsoft Visual Studio&reg; içinde {{< Common/link href="https://www.nuget.org/packages/Aspose.3D/" text="NuGet"  >}} Paket Yöneticisini açın, <b>Aspose.3D</b> aratın ve yükleyin. Ayrıca Paket Yöneticisi Konsolunda aşağıdaki komutu kullanabilirsiniz. Ayrıntılı talimatlar için lütfen {{< Common/link href="https://docs.aspose.com/3d/net/installation/" text="Installation"  >}} dokümantasyon sayfasını ziyaret edin.
...
> #### Vulkan: Yalnızca x64 platform, uyumlu kartlar:
...
Aşağıdaki kod örneğini çalıştırarak Aspose.3D'in ortamınızda nasıl çalıştığını görebilir veya [GitHub Deposu](https://github.com/aspose-3d/Aspose.3D-for-.NET)’nda diğer yaygın senaryolara bakabilirsiniz.
