...
linktitle: "Aspose.3D for Java 22.9 lease elease Notes"
title: "Aspose.3D for Java 22.9 lease elease Notes"
weight: 4
description: "To Aspose.3D for Java 22.9 notlarını serbest bıraktı."
type: "repository"
layout: "release"
---
{{% alert color="primary" %}}

Tonun sayfası Aspose.3D for Java 22.9 için sürüm notları bilgilerini içerir.
...
### A`com.aspose.threed.PbrMaterial` sınıfında yeni yöntemi onayladı:
...
Tonun yardımcı yöntemi diğer malzeme türlerini `PbrMaterial` örneğine dönüştürmeye izin verir ve mümkün olduğunca bilgi ayırmaya çalışır.
