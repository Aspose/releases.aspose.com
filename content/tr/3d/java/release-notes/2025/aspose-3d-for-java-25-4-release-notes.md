...
linktitle: Aspose.3D for Java 25.4 Yayın Notları
title: Aspose.3D for Java 25.4 Yayın Notları
weight: 9
description: Aspose.3D for Java 25.4 Yayın Notları – en son güncellemeler ve düzeltmeler.
type: repository
layout: release
---
...
Bu sayfa, Aspose.3D for Java 25.4 için yayın notlarını içerir.
...
Bu eklenen sınıflar, girdi glTF dosyasından EXT\_structural\_metadata okumanızı sağlar
