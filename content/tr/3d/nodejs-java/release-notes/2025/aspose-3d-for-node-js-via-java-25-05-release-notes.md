...
linktitle: Aspose.3D for Node.js via Java 25.5 Yayın Notları
title: Aspose.3D for Node.js via Java 25.5 Yayın Notları
weight: 8
description: Aspose.3D for Node.js via Java 25.5 Yayın Notları – en son güncellemeler ve düzeltmeler.
type: repository
layout: release
---
...
Bu sayfa, Java 25.5 aracılığıyla Node.js için Aspose.3D için yayın notları bilgilerini içerir.

{{% /alert %}}
## **İyileştirmeler ve Değişiklikler**
|**Anahtar**|**Özet**|**Kategori**|
| :- | :- | :- |
| THREEDNET-1674 | EXT_structural_metadata içe aktarımı bazen çalışmıyor düzeltildi | Görev |
...
| THREEDNET-1676 | Köşe elemanı kullanıcı verisine bağlantı tablosu özelliği | Yeni Özellik |
...
**Örnek kod**
{{< highlight java >}}
        //Bu örnek, EXT_mesh_features ve EXT_structural_metadata uzantılarını kullanan bir glTF dosyası oluşturur
        ...
        //sonra bir kullanıcı verisi oluşturuyoruz, bu kullanıcı verisi köşe noktasına özellik kimliği uygulayacak
        ...
        //sahneyi ve kullanıcı verisine özellik tablosunu ekleyerek dışa aktarılabilir hale getirin
