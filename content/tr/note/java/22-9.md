---
title: "Aspose.not 22.9 | OneNote İşleme Java Yüksek Kod API" 
...
ASPOSE.Not Java API'leri [Aspose deposu](https://repository.aspose.com/note/)'da barındırılır. Basit konfigürasyonlarla doğrudan Maven projelerinizde Java API için aspose.barcode'u kolayca kullanabilirsiniz. Ayrıntılı talimatlar için lütfen [Installing Aspose.Note for Java from Maven Repository](https://docs.aspose.com/note/java/installation/) belge sayfasını ziyaret edin.
