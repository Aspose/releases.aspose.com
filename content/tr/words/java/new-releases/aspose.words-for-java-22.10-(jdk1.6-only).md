...
title: "İndirilenler ---Yeni Çıkanlar-aspose.words-for-java-22.10-(yalnızca jdk1.6)"
description: " "
keywords: ""
page_type: single_release_page
folder_link: "/words/java/new-releases/aspose.words-for-java-22.10-(jdk1.6-only)/"
folder_name: "Aspose.Words for Java 22.10 (yalnızca JDK1.6)"
...
Intro_text: "Aspose.Words'ü eski bir Java 6 ortamında kullanmaktan başka seçeneğiniz yoksa bunu indirin. Aspose.Words for Java'nın bu JAR'ı JDK1.6 için derlenmiştir. Lütfen diğer tüm bileşenleri (Javadoc ve Lisans sözleşmeleri gibi) ana ZIP indirme paketinden alın."
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.Words for Java 22.10 (yalnızca JDK1.6)" imagelink="/resources/img/rastgele-dosya-icon.png">}}
  ...
  {{< /Releases/ReleasesFileFeatures >}}
  {{< Releases/ReleasesFileFeatures >}}
      <h4>Description</h4><div class="HTMLDescription">Download this if you have no choice but to use Aspose.Words on an old Java 6 environment. This JAR of Aspose.Words for Java is compiled for JDK1.6. Lütfen diğer tüm bileşenleri (Javadoc ve Lisans sözleşmeleri gibi) ana ZIP indirme paketinden alın.</div>
  {{< /Releases/ReleasesFileFeatures >}}
 {{< /Releases/ReleasesFileArea >}}
{{< /Releases/ReleasesWapper >}}
