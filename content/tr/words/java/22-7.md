---
title: "Aspose.Words 22.7 | PDF/UA-1 WCAG 2.0'a yeni Dokümanlar" 
description: "Düzenleme görünümü oluşturmak ve kelime belgelerini dönüştürmek için Java Kütüphanesi. Aspose.Words 22.7, WCAG 2.0 PDF, Veritabanı Alanı, OpenType (CFF) ve daha fazlasını destekler." 
layout: package
...
## Java API için Aspose.words'de Yenilikler 22.7
...
Tüm ayrıntılar için lütfen [Release Notes of Aspose.Words for Java 22.7](https://docs.aspose.com/words/java/aspose-words-for-java-22-7-release-notes/)'a bakın.
...
### ** Belgeyi Java ** 'da WCAG 2.0 ile uyumlu PDF/UA-1'e dönüştürün
...
public class AsposeBelgeler2PDF_UA_1_Compliant_WCAG20_Converter {
