---
title: "Aspose.Words 22.4 | PDF Arapça Metin'e Yeni'nin Belgesi" 
description: "Düzenleme görünümü oluşturmak ve kelime belgelerini dönüştürmek için Java Kütüphanesi. Aspose.Words 22.4 PDF/A-4 Dönüşümünü Destek, Arapça metin ile belgede iyileşme PDF'ye." 
layout: package
...
## Java API için Aspose.words'de Yenilikler 22.4
...
Tüm ayrıntılar için lütfen [Release Notes of Aspose.Words for Java 22.4](https://docs.aspose.com/words/java/aspose-words-for-java-22-4-release-notes/)'a bakın.
...
### ** Java ** kullanarak Docx'ı Arapça metinle PDF'ye dönüştürün
...
public class AsposeBelgeler2ArabicTextPfdfConverter {
...
- ** [Ücretsiz çevrimiçi kelimeler kompres](https://products.aspose.app/words/compress) ** Orijinal kaliteyi korurken belgelerin boyutunu küçültmek için.
