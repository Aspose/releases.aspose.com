...
folder_name: ".NET sürüm 22.7 için aspose.cad (yalnızca dlls)"
...
intro_text: "This ZIP file contains only the Aspose.CAD for .NET assemblies v22.7. The assemblies are the same as in the MSI installer of the product of the same version. İndirmek this if you want to use Aspose.CAD for .NET without the MSI installer."
image_link: "/resources/img/zip-icon.png"
download_count: " 17/7/2022 İndirmeks: 1  Views: 1 "
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt=".NET sürüm 22.7 için aspose.cad (yalnızca dlls)" imagelink="/resources/img/zip-icon.png">}}
  {{< Releases/ReleasesButtons >}}
    {{< Releases/ReleasesSingleButtons text="İndirmek" link="/cad/net/new-releases/aspose.cad-for-.net-version-22.7-(dlls-only)/9ef9ac2668ff825da641115e2acf36c4-20-7650" >}}
