---
title: "Downloads --- Novos liberações-proposit.pub-for-.net-21.9- (apenas DLLs)." 
description:  "    . " 
keywords:  "    . " 
page_type:  single_release_page
folder_link: " pub/net/new-releases/aspose.pub-for-.net-21.9-(dlls-only)/"
folder_name: "Aspose.pub para .NET 21.9 (somente DLLs)"
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.pub para .NET 21.9 (somente DLLs)" imagelink="/resources/img/zip-icon.png">}}
