...
{{< Releases/ReleasesWapper >}}
  ...
  {{< Releases/ReleasesFileFeatures >}}
      <h4>Notas de versão</h4><div><a href="https://docs.aspose.com/display/cellsjava/Aspose.Cells+for+Python+via+Java+19.12+Release+Notes">https://docs.aspose.com/display/cellsjava/Aspose.Cells+for+Python+via+Java+19.12+Release+Notes</a></div>
  {{< /Releases/ReleasesFileFeatures >}}
 {{< /Releases/ReleasesFileArea >}}
{{< /Releases/ReleasesWapper >}}
