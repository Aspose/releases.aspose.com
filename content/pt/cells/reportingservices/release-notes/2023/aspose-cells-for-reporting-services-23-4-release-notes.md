...
linktitle: Aspose.Cells Nota de versão do Reporting Services 23.4
title: Aspose.Cells Nota de versão do Reporting Services 23.4
weight: 18
...
---
{{% alert color="primary" %}} 
Esta página contém notas de versão do Aspose.Cells Reporting Services 23.4
'{{% /alert %}} '
##  **Lista completa de problemas e melhorias abordados nesta versão**

|**ID**|**Resumo**|**Categoria**|
| :- | :- | :- |
| 39649 | Otimizar Aspose.Cells Reporting Services Core.|
