---
title: "Aspose.Cells | Biblioteca Java de processamento de planilha do Excel" 
...
family_listing_page_description: "Aspposes.Cells for Java é uma API premiada de processamento de planilhas do Excel que permite que os desenvolvedores Java incorporem a capacidade de ler, escrever e manipular planilhas do Excel em seus próprios aplicativos Java sem precisar confiar no Microsoft Excel." 
...
Aspoms.Cells Java APIs estão hospedadas no [Aspose repositório](https://releases.aspose.com/cells/java/). Você pode usar facilmente as células do Aspose.Cells para Java diretamente em seus projetos Maven com configurações simples. Para as instruções detalhadas, visite [Installing Aspose.Cells for Java from Maven Repository](https://docs.aspose.com/cells/java/installation/) Página de documentação.
