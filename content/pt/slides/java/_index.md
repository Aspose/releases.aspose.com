---
title: "Baixar arquivos JAR do processador de apresentação | Aspose.Slides"
description: "Baixe arquivos JAR para criar, editar, converter formatos de apresentação PowerPoint® e OpenOffice®. Trabalhe com slides, formas, gráficos, objetos, controles e muito mais via API."
keywords: "Java PPTX Library, Java PPT Library, PowerPoint Java API"
family_listing_page_title: "Aspose.Slides para Java"
family_listing_page_description: "Aspose.Slides for Java é uma API de manipulação e processamento de apresentações do PowerPoint para ler, escrever, manipular e converter arquivos do PowerPoint em qualquer aplicativo baseado em Java. A API não possui dependências externas, portanto, pode ser usada sem exigir o Microsoft PowerPoint."
...
{{< Common/h3 text="Baixe o Aspose.Slides para trabalhar com apresentações do PowerPoint®"  >}}
...
{{< Common/link href="https://repository.aspose.com/slides/" text="Aspose.Slides para API Java"  >}}diretamente em seus projetos baseados em Maven adicionando as seguintes configurações ao seu pom.xml. Para obter instruções detalhadas, visite
{{< Common/link href="https://docs.aspose.com/slides/java/installation/" text="Instalando o Aspose.Slides para Java do Repositório Maven"  >}}página de documentação.
...
## Por que baixar Aspose.Slides para Java?

[Aspose.Slides](https://products.aspose.com/slides/java) para Java é uma API local para trabalhar com as apresentações do Microsoft PowerPoint® em seus aplicativos Java. Ele permite que os desenvolvedores leiam, escrevam, convertam e manipulem apresentações do PowerPoint® em aplicativos Java com a capacidade de manipular vários elementos de documentos, como slides, tabelas, texto, gráficos, formas, imagens e diagramas SmartArt e muito mais.

## Manipulação de arquivos do PowerPoint® via Java

- Carregue e converta apresentações para outros formatos.
- Crie apresentações do zero.
- Manipule todos os elementos de apresentação via modelo de objeto intuitivo.
- Criar ou incorporar gráficos.
- Criar ou manipular formas.

Verifique o [product overview](https://docs.aspose.com/slides/java/product-overview/) para saber tudo sobre o Aspose.Slides para Java.

### Ler e escrever apresentações
