---
title: "Aspose.slides | Biblioteca Java para processar formatos de PowerPoint" 
...
- WordArt
- VBA Macros
family_listing_page_title: "Aspose.lide para Java" 
family_listing_page_description: "Aspose.slides para Java é a API do PowerPoint Apresentation Manipulation and Processing para ler, escrever, manipular e converter arquivos do PowerPoint em qualquer aplicativo baseado em Java. A API não possui nenhuma dependência externa, para que possa ser usada sem a necessidade de Microsoft PowerPoint." 
...
[Aspose.Slides](https://products.aspose.com/slides/java) Uma API Java PowerPoint para manipulação e gerenciamento de apresentação. Ele permite que os desenvolvedores leiam, escrevam, convertem e manipulem apresentações do PowerPoint em aplicativos Java com a capacidade de manipular todos os elementos do documento, como slides, tabelas, texto, gráficos, formas, imagens e diagramas SmartArt e muito mais.

Manipulação do arquivo do PowerPoint via java

Confira o [Visão geral do produto](https://docs.aspose.com/slides/java/product-overview/) para saber tudo sobre o Aspose.slide para Java.
...
Asppos.slides Java APIs estão hospedados no [Aspose repositório](https://releases.aspose.com/slides/java/). Você pode usar facilmente o Aspose.slide para a API Java diretamente em seus projetos Maven com configurações simples. Para as instruções detalhadas, visite [Installing Aspose.Slides for Java from Maven Repository](https://docs.aspose.com/slides/java/installation/) Página de documentação.
