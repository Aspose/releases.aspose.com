---
title: "Baixar biblioteca de classes C++ para apresentações | Aspose.Slides"
description: "Baixe C++ DLL Class Library para criar, ler, escrever, editar, converter apresentações do PowerPoint® e OpenOffice® via API. Suporta gráficos, formas, SmartArt, tabelas."
keywords: "C++ PowerPoint Library"
family_listing_page_title: "Aspose.Slides for C++"
family_listing_page_description: "Aspose.Slides for C++ é uma biblioteca de processamento de apresentação que permite que os aplicativos C++ manipulem, renderizem e convertam apresentações do PowerPoint sem exigir o aplicativo Microsoft PowerPoint."
...
{{< Common/h2 text="Baixe a biblioteca C++ para processar apresentações"  >}}
{{< Common/paragraph class="package-instructions">}}
Abrir
{{< Common/link href="https://www.nuget.org/packages/Aspose.Slides.Cpp/" text="NuGetName"  >}}Package Manager dentro do Microsoft Visual Studio®, procure por <b>Aspose.Slides.Cpp</b> e instale. Você também pode usar o seguinte comando no Console do Gerenciador de Pacotes. Para obter instruções detalhadas, visite o
{{< Common/link href="https://docs.aspose.com/slides/cpp/installation/" text="Instalação"  >}}página de documentação.
...
## Por que baixar o Aspose.Slides para C++?

Esta biblioteca de classes C++ autônoma ajuda você a criar, ler, escrever, editar e converter apresentações do Microsoft PowerPoint® sem precisar do PowerPoint® ou do Office Automation.

## Recursos de processamento de apresentação

- Crie, abra e trabalhe com apresentações sem o Microsoft PowerPoint®.
- Converta a apresentação para qualquer um dos formatos de arquivo suportados.
- Adicionar, formatar e manipular gráficos, formas, slides, SmartArt, tabelas e texto em apresentações.
