...
title: "Downloads ---Novos lançamentos-aspose.words-for-python-via-.net-24.4.0-macos-10.14-mojave-x86_64"
description: " "
keywords: ""
page_type: single_release_page
folder_link: "/words/python/new-releases/aspose.words-for-python-via-.net-24.4.0-macos-10.14-mojave-x86_64/"
folder_name: "Aspose.Words para Python via .NET 24.4.0 macOS 10.14 Mojave x86_64"
...
intro_text: "Esta roda contém Aspose.Words para Python via .NET versão 24.4.0, desenvolvido para macOS 10.14 (Mojave) e direcionado à arquitetura x86_64."
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.Words para Python via .NET 24.4.0 macOS 10.14 Mojave x86_64" imagelink="/resources/img/random-file-icon.png">}}
  ...
  {{< Releases/ReleasesFileFeatures >}}
      <h4>Notas de liberação</h4><div><a href='https://releases.aspose.com/words/python/release-notes/2024/aspose-words-for-python-via-dotnet-24-4-release-notes/'>https://releases.aspose.com/words/python/release-notes/2024/aspose-words-for-python-via-dotnet-24-4-release-notes/</a></div>
  {{< /Releases/ReleasesFileFeatures >}}
  {{< Releases/ReleasesFileFeatures >}}
      <h4>Descrição</h4><div class="HTMLDescription">Esta roda contém Aspose.Words para Python via .NET versão 24.4.0, desenvolvido para macOS 10.14 (Mojave) e direcionado à arquitetura x86_64.</div>
  {{< /Releases/ReleasesFileFeatures >}}
 {{< /Releases/ReleasesFileArea >}}
{{< /Releases/ReleasesWapper >}}
