---
title: "Aspose.Words 22.6 | DOC de New para formatos de página fixa" 
description: "Biblioteca Java para criar visualização Editar e converter documentos do Word. Aspose.Words 22.6 suporta a conversão de documentos em formatos de página fixa e muito mais." 
layout: package
...
## O que há de novo em Aspose.Words for Java API 22.6
- Conversão de documentos em formatos de página fixa com alta qualidade e desempenho.
- API para gráficos de desenho com suporte de gradiente, textura e preenchimentos de padrões.
- Improvement in converting DOCX to HTML
- Add loading progress notification for ODT documents
- Melhoria no carregamento de documentos do EPUB com entidades XHTML.

Por favor, consulte [Release Notes of Aspose.Words for Java 22.6](https://docs.aspose.com/words/java/aspose-words-for-java-22-6-release-notes/) para obter detalhes completos.
...
### ** Como converter o documento em formato jpeg de página fixa com alta qualidade usando java **
...
- ** [Encontre e substitua online grátis](https://products.aspose.app/words/replace) ** Para encontrar e substituir o texto no Word, documentos PDF.

- ** [Editor de metadados de documentos online grátis](https://products.aspose.app/words/metadata) ** para visualizar & amp; Editar propriedades de metadados do Microsoft Word & amp; Documentos do OpenOffice.
