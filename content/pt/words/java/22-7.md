---
title: "Aspose.Words 22.7 | Documentos de New para PDF/UA-1 WCAG 2.0" 
description: "Biblioteca Java para criar visualização Editar e converter documentos do Word. Aspose.Words 22.7 suporta WCAG 2.0 pdf, campo de banco de dados, OpenType (CFF) e muito mais." 
layout: package
...
## O que há de novo em Aspose.Words for Java API 22.7
...
Por favor, consulte [Release Notes of Aspose.Words for Java 22.7](https://docs.aspose.com/words/java/aspose-words-for-java-22-7-release-notes/) para obter detalhes completos.
...
### ** Converta o documento em PDF/UA-1 em conformidade com o WCAG 2.0 em java **
