...
title: "Downloads ---Novos lançamentos-aspose.words-for-.net-24.4-(somente dlls)"
description: " "
keywords: ""
page_type: single_release_page
folder_link: "/words/net/new-releases/aspose.words-for-.net-24.4-(dlls-only)/"
folder_name: "Aspose.Words para .NET 24.4 (somente DLLs)"
download_link: "/words/net/new-releases/aspose.words-for-.net-24.4-(dlls-only)/7e203586990e3a461475c4dbe209b15a-26-10602"
download_text: "Download"
intro_text: "Este arquivo ZIP contém os assemblies Aspose.Words para .NET e .NET Standard 2.0. As montagens são as mesmas do instalador MSI do produto da mesma versão."
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.Words para .NET 24.4 (somente DLLs)" imagelink="/resources/img/zip-icon.png">}}
  ...
  {{< Releases/ReleasesFileFeatures >}}
      <h4>Notas de liberação</h4><div><a href='https://releases.aspose.com/words/net/release-notes/2024/aspose-words-for-net-24-4-release-notes/'>https://releases.aspose.com/words/net/release-notes/2024/aspose-words-for-net-24-4-release-notes/</a></div>
  {{< /Releases/ReleasesFileFeatures >}}
  {{< Releases/ReleasesFileFeatures >}}
      <h4>Descrição</h4><div class="HTMLDescription">Este arquivo ZIP contém os assemblies Aspose.Words para .NET e .NET Standard 2.0. As montagens são as mesmas do instalador MSI do produto da mesma versão.</div>
  {{< /Releases/ReleasesFileFeatures >}}
 {{< /Releases/ReleasesFileArea >}}
{{< /Releases/ReleasesWapper >}}
