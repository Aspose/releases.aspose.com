---
title: "API de atributos de vértice personalizado GLTX para aplicativos C#, ASP.NET"
...
Intro_text: "Ele contém Aspose.3D para a versão .NET 22.4."
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.3D para .NET 22.4" imagelink="/resources/img/msi-icon.png">}}
...
Suporte para atributos de vértices personalizados `GLTF` foi adicionado. O snippet de código a seguir demonstra como exportar dados personalizados para `glTF`:
...
# Conversão aprimorada de GLB para U3D

Anteriormente, ao converter `GLB` para `U3D` resultava em orientação errada. Este problema já foi resolvido.

# Importação de Nuvem de Pontos

Adicionado o suporte de importação de nuvem de pontos em USD/USDZ.
