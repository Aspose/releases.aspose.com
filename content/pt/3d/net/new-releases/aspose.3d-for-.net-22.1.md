---
title: "Suporte NET2.0 Converta USDZ para API GLB para C#, aplicativos ASP.NET"
...
Intro_text: "Ele contém Aspose.3D para a versão .NET 22.1."
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.3D para .NET 22.1" imagelink="/resources/img/msi-icon.png">}}
  ...
  {{< Releases/ReleasesFileFeatures >}}
      <h4>Notas de lançamento</h4><div> <a href="https://docs.aspose.com/3d/net/aspose-3d-for-net-22-1-release-notes/">https://docs.aspose.com/3d/net/aspose-3d-for-net-22-1-release-notes/</a></div>
  {{< /Releases/ReleasesFileFeatures >}}
...
Restaurado o suporte do .NET Standard 2.0.

# Conversão melhorada de USDZ para GLB

Anteriormente, em alguns casos, a API não conseguia abrir arquivos `USDZ` para converter para o formato `GLB`. Esta versão da API resolveu esse problema.

# Codificação e Decodificação de Entidades Primitivas

Adicionado o suporte de codificação e decodificação de entidades primitivas no exportador de USD.

> Para obter uma lista completa de recursos, aprimoramentos e correções de bugs nesta versão, visite [Aspose.3D for .NET 22.1 Release Notes](https://docs.aspose.com/3d/net/aspose-3d-for-net-22-1-release-notes/).
