---
title: "API de suporte a arquivos ASCII do Autodesk® Maya para aplicativos C# e ASP.NET"
description: "API C# .NET com o recurso para importar o arquivo Autodesk® Maya ASCII. Agora nossa API 3D suporta o formato Maya ASCII (script MEL) como formato de entrada (.ma)."
keywords: ""
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.3D para .NET 22.10" imagelink="/resources/img/msi-icon.png">}}
...
# Importar arquivo ASCII do Maya

Adicionada a capacidade na API de manipulação 3D para importar o arquivo Autodesk® Maya ASCII. Agora nossa API 3D suporta o formato Maya ASCII como formato de entrada (.ma).

> Para obter uma lista completa de recursos, aprimoramentos e correções de bugs nesta versão, visite [Aspose.3D for .NET 22.10 Release Notes](https://docs.aspose.com/3d/net/aspose-3d-for-net-22-10-release-notes/).
