...
{{< Releases/ReleasesHeading H2txt=" Aspose.3d para .NET 22.3" imagelink="/resources/img/msi-icon.png">}}
...
<div> <a href="https://docs.aspose.com/3d/net/aspose-3d-for--ne--22-3-release-notes/"> https://docs.aspose.com/ 3D/NET/Aspose-3D-For-Net-22-3-Relase-notes/</a> </div>
{{< /Releases/ReleasesFileFeatures >}}
{{< Releases/ReleasesHeading h4txt="Recursos notáveis">}}
{{< Common/wrapper class="HTMLDescription">}}
{{% Releases/ReleasesFileFeatures %}}

# Malha grande melhorada na exportação U3D/PDF

Melhorou a grande malha na exportação de arquivo U3D / PDF.
