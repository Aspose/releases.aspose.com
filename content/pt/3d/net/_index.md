---
title: Baixar DLL de Gameware C#, CAD e Processamento 3D | Aspose.3D
description: Baixe a DLL contendo a biblioteca de classes C# para trabalhar com arquivos 3D (3DS, 3MF, DAE, DFX, USD, Blender, OpenUSD, MA, glTF, U3D), malhas, geometrias, cenas e animações via API .NET on‑premise.
...
Abra o {{< Common/link href="https://www.nuget.org/packages/Aspose.3D/" text="NuGet"  >}} Package Manager dentro do Microsoft Visual Studio&reg;, procure por <b>Aspose.3D</b> e instale. Você também pode usar o comando a seguir no Console do Gerenciador de Pacotes. Para instruções detalhadas, visite a página de {{< Common/link href="https://docs.aspose.com/3d/net/installation/" text="Installation"  >}} documentação.
...
[Aspose.3D for .NET](https://products.aspose.com/3d/net/) permite que aplicações .NET trabalhem com formatos de documentos 3D. A API .NET 3D permite que engenheiros leiam, convertam, criem, alterem e controlem o conteúdo dos [formatos de documentos 3D](https://docs.aspose.com/3d/net/supported-file-formats/) sem necessidade de software de modelagem ou renderização 3D instalado na máquina.
...
> #### Vulkan: Suporta apenas plataforma x64, com compatibilidade de hardware para:
...
Você pode executar o trecho de código abaixo para ver como o Aspose.3D funciona no seu ambiente ou conferir o [Repositório no GitHub](https://github.com/aspose-3d/Aspose.3D-for-.NET) para outros cenários de uso comuns.
