...
- Trabalhe com [extrusão linear](https://docs.aspose.com/3d/java/working-with-linear-extrusion/), [cilindro](https://docs.aspose.com/3d/java/working-with-cilindro/) e [Nuvem](https://docs.aspose.com/3d/java/working-with-pointcloud/).
