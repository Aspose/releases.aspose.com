...
linktitle: Aspose.3D para Java 25.3 – Notas da Versão
title: "Aspose.3D para Java 25.3 - Notas da Versão"
weight: 10
description: Aspose.3D para Java 25.3 – Notas da versão – as últimas atualizações e correções.
type: repository
layout: release
---
...
Esta página contém informações sobre as notas de lançamento do Aspose.3D para Java 25.3.
...
| THREEDNET-1661 | A malha criada a partir do BRep avançado não pode ser usada como operando booleano | Correção de bug |
