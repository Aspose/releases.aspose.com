...
linktitle: Aspose.3D para Node.js via Java 25.1 Notas da Versão
title: Aspose.3D para Node.js via Java 25.1 Notas da Versão
weight: 12
description: Aspose.3D para Node.js via Java 25.1 – Notas da versão – as últimas atualizações e correções.
type: repository
layout: release
---
...
Esta página contém informações sobre as notas de lançamento do Aspose.3D para Node.js via Java 25.1.
...
| THREEDNET-1628 | Malha Draco carregada no glTF estava incorreta | Correção de bug |
