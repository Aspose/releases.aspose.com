...
linktitle: Aspose.3D para Node.js via Java 24.11 Notas da Versão
title: Aspose.3D para Node.js via Java 24.11 Notas da Versão
weight: 2
description: Aspose.3D para Node.js via Java 24.11 – Notas da versão – as últimas atualizações e correções.
type: repository
layout: release
---
...
Esta página contém informações sobre as notas de lançamento do Aspose.3D para Node.js via Java 24.11.
...
### Membros adicionados à classe **com.aspose.threed.VertexFieldSemantic**:
