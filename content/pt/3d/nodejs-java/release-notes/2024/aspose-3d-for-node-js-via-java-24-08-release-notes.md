...
linktitle: Aspose.3D para Node.js via Java 24.8 Notas da Versão
title: Aspose.3D para Node.js via Java 24.8 Notas da Versão
weight: 5
description: Aspose.3D para Node.js via Java 24.8 – Notas da versão – as últimas atualizações e correções.
type: repository
layout: release
---
...
Esta página contém informações de notas de lançamento para Aspose.3D para Node.js via Java 24.8.
...
### Adicionada classe **com.aspose.threed.JtLoadOptions**


{{< highlight java >}}

    /**
     *  Carregar propriedades da tabela de propriedades do JT como propriedades Aspose.3D.
     *  Valor padrão é falso.
     *
     * @return  Carregar propriedades da tabela de propriedades do JT como propriedades Aspose.3D. 
     * Valor padrão é falso.
     */
    ...
    /**
     *  Carregar informações de PMI do arquivo JT, se possível, os dados serão salvos como propriedade "PMI" de {@link com.aspose.threed.Scene#getAssetInfo}.
     *  Valor padrão é falso.
     *
     * @return  Carregar informações de PMI do arquivo JT, se possível, os dados serão salvos como propriedade "PMI" de {@link com.aspose.threed.Scene#getAssetInfo}.
     * Valor padrão é falso.
     */
...
### Adicionados membros à classe **com.aspose.threed.AxisSystem**:
...
{{< highlight java >}}
     ...
     *
     * @param assetInfo De qual informação de ativo ler o sistema de coordenadas, vetor para cima e frontal.
...
{{< highlight java >}}
    ...
    //Criar uma matriz de transformação do sistema de eixos atual da cena para o nosso sistema de eixos personalizado
...
### Adicionados membros à classe **com.aspose.threed.PolygonModifier**:
