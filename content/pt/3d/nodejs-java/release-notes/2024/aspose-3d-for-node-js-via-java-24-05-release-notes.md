...
linktitle: Aspose.3D para Node.js via Java 24.5 Notas da Versão
title: Aspose.3D para Node.js via Java 24.5 Notas da Versão
weight: 8
description: Aspose.3D para Node.js via Java 24.5 – Notas da versão – as últimas atualizações e correções.
type: repository
layout: release
---
...
Esta página contém informações sobre as notas de lançamento do Aspose.3D para Node.js via Java 24.5.
...
Adicionado novo campo para obter a versão de lançamento da assembly Aspose.3D atual.