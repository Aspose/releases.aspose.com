---
title: "Aspose.diagram | Biblioteca Java para criar, exportar Documentos Visio" 
...
- Linux
- Unix
family_listing_page_title: "Aspose.diagram para java" 
family_listing_page_description: "Aspose.diagram para Java é uma API Java fácil de usar, de alto desempenho e bem documentada que permite aos desenvolvedores criar, manipular e converter formatos de arquivo Visio nativos de seus aplicativos Java, e sem a necessidade de depender do Microsoft Visio ®." 
...
Aspose.diagram para java também pode ser usado para [Aplicar proteção aos desenhos do Microsoft Visio](https://docs.aspose.com/diagram/java/working-with-protection/) bloqueando fundos, estênceis (mestre), bem como formas e estilos para evitar alterações acidentais.
