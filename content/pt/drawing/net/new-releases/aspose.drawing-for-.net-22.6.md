---
title: "API de redução de imagem e dimensionamento de vetor para aplicativos C# e ASP.NET"
description: "API C# .NET com melhor qualidade na redução de imagens maiores, dimensionamento de vetor para metarquivos, edição e salvamento de arquivos GIF de vários quadros, adição de maiúsculas de traço redondo e triangular."
keywords: ""
...
Intro_text: "O instalador MSI para Aspose.Drawing for .NET 22.6"
...
# Suporte para redução de imagem

Aprimoramento na obtenção de melhor qualidade para reduzir imagens maiores.

# Escalonamento de vetores de metarquivos

Implementado o novo recurso de dimensionamento de vetor para metarquivos.

# Edite e salve GIF de vários quadros

A API agora suporta a edição e o salvamento de GIFs com vários quadros.

# Suporte para tampas de traço redondo e triangular
