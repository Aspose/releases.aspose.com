---
title: "API de processamento de dados GIS no local | Família de produtos Aspose.GIS"
description: "Baixe a Biblioteca de Processamento de Dados GIS para ler, escrever e converter Shapefile, GeoJSON, FIleGDB, KML e OSM XML, bem como renderizar um mapa de formatos suportados para SVG."
keywords: "GIS .NET Library"
family_listing_page_title: "Família de produtos Aspose.GIS"
...
- Converta dados vetoriais para [popular file formats](https://docs.aspose.com/gis/net/supported-file-formats/).
...
- Realize análise vetorial e [manipulate geometries](https://docs.aspose.com/gis/net/geometry-types/).
- Suporte para [Spatial Reference Systems](https://docs.aspose.com/gis/net/spatial-reference-systems/).
