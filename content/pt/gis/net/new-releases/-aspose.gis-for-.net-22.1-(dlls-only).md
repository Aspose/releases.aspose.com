---
title: "Downloads --- Novos liberações-Asponse.gis-for -.net-22.1- (apenas DLLs)." 
description:  "    . " 
keywords:  "    . " 
page_type:  single_release_page
folder_link: " gis/net/new-releases/-aspose.gis-for-.net-22.1-(dlls-only)/"
folder_name: "Aspose.gis para .NET 22.1 (somente DLLs)"
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.gis para .NET 22.1 (somente DLLs)" imagelink="/resources/img/zip-icon.png">}}
