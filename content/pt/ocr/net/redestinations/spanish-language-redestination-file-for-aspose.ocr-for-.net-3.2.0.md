...
folder_name: "Arquivo de recursos do idioma espanhol para Aspose.OCR para .NET 3.2.0"
...
Intro_text: "Aspose.OCR para .NET usa arquivos de recursos para diferentes idiomas para executar OCR ou ..."
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Arquivo de recursos do idioma espanhol para Aspose.OCR para .NET 3.2.0" imagelink="/resources/img/zip-icon.png">}}
