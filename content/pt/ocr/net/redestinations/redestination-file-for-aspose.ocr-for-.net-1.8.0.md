...
folder_name: "Arquivo de recurso para Aspose.OCR para .NET 1.8.0"
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Arquivo de recurso para Aspose.OCR para .NET 1.8.0" imagelink="/resources/img/zip-icon.png">}}
