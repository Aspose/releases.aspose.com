...
folder_name: "Arquivo de recursos para Aspose.OCR para .NET 2.0.0"
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Arquivo de recursos para Aspose.OCR para .NET 2.0.0" imagelink="/resources/img/zip-icon.png">}}
