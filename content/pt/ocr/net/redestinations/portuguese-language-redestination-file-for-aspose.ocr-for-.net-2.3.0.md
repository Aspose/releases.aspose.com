...
folder_name: "Arquivo de recursos do idioma português para Aspose.OCR para .NET 2.3.0"
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Arquivo de recursos do idioma português para Aspose.OCR para .NET 2.3.0" imagelink="/resources/img/zip-icon.png">}}
