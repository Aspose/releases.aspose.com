...
title: "Downloads ---Novos lançamentos-aspose.ocr-for-net-25.1.0-(somente dlls)"
description: " "
keywords: ""
page_type: single_release_page
folder_link: "/ocr/net/new-releases/aspose.ocr-for-net-25.1.0-(dlls-only)/"
folder_name: "Aspose.OCR para NET 25.1.0 (somente DLLs)"
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.OCR para NET 25.1.0 (somente DLLs)" imagelink="/resources/img/zip-icon.png">}}
