...
title: "Downloads ---Novos lançamentos-aspose.ocr-for-python-via-.net-24.5.0-windows-32-bit"
description: " "
keywords: ""
page_type: single_release_page
folder_link: "/ocr/python-net/new-releases/aspose.ocr-for-python-via-.net-24.5.0-windows-32-bit/"
folder_name: "Aspose.OCR para Python via .NET 24.5.0 Windows 32 bits"
...
intro_text: "Esta roda contém Aspose.OCR para Python via .NET versão 24.5.0, desenvolvido para Windows e voltado para a arquitetura de 32 bits."
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.OCR para Python via .NET 24.5.0 Windows 32 bits" imagelink="/resources/img/random-file-icon.png">}}
  ...
  {{< Releases/ReleasesFileFeatures >}}
      <h4>Notas de liberação</h4><div><a href='https://releases.aspose.com/ocr/python-net/release-notes/2024/aspose-ocr-python-24-5-0-release-notes/'>https://releases.aspose.com/ocr/python-net/release-notes/2024/aspose-ocr-python-24-5-0-release-notes/</a></div>
  {{< /Releases/ReleasesFileFeatures >}}
  {{< Releases/ReleasesFileFeatures >}}
      <h4>Descrição</h4><div class="HTMLDescription">Esta roda contém Aspose.OCR para Python via .NET versão 24.5.0, desenvolvido para Windows e voltado para a arquitetura de 32 bits.</div>
  {{< /Releases/ReleasesFileFeatures >}}
 {{< /Releases/ReleasesFileArea >}}
{{< /Releases/ReleasesWapper >}}
