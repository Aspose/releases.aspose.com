---
title: "Validar elementos Schemaref na API XBRL para C#, aplicativos ASP.NET"
description: "API C# .NET com suporte para validação de; Elementos Schemaref, atributo de ID do elemento de contexto e subelemento de entidade no elemento de contexto nos arquivos `XBRL`."
keywords: ""
page_type: single_release_page
folder_link: "/finance/net/new-releases/aspose.finance-for-.net-22.7/"
folder_name: "Aspose.Finance para .NET 22.7"
download_link: "/finance/net/new-releases/aspose.finance-for-.net-22.7/ed035dc3cdf99d153301c6b7499e8694-2-7696"
download_text: "Download"
Intro_text: "Aspose.Finance para .NET 22.7"
...
{{< Releases/ReleasesHeading H2txt="Aspose.Finance para .NET 22.7" imagelink="/resources/img/msi-icon.png">}}
...
# Elementos Schemaref na Validação XBRL

Suporte para validação de elementos Schemaref em arquivos `XBRL`.

# Validação de atributo de ID de elemento de contexto

Adicionada a validação do atributo ID do elemento context no arquivo `XBRL`.

# Validação do Subelemento da Entidade
