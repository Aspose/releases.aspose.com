...
title: "Downloads ---Novos lançamentos-aspose.imaging-for-.net-24.4_(somente dlls)"
description: " "
keywords: ""
page_type: single_release_page
folder_link: "/imaging/net/new-releases/aspose.imaging-for-.net-24.4_(dlls-only)/"
folder_name: "Aspose.Imaging para .NET 24.4_ (somente DLLs)"
...
intro_text: "Ele contém a versão Aspose.Imaging for .NET 24.4 (somente DLLs)."
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.Imaging para .NET 24.4_ (somente DLLs)" imagelink="/resources/img/zip-icon.png">}}
  ...
  {{< /Releases/ReleasesFileFeatures >}}
  {{< Releases/ReleasesFileFeatures >}}
      <h4>Descrição</h4><div class="HTMLDescription">Ele contém a versão Aspose.Imaging for .NET 24.4 (somente DLLs).</div>
  {{< /Releases/ReleasesFileFeatures >}}
 {{< /Releases/ReleasesFileArea >}}
{{< /Releases/ReleasesWapper >}}
