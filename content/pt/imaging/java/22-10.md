---
title: "Aspose.imaging 22.10 | Processamento de imagem Java High Code API" 
...
Aspom.Imageing Java APIs estão hospedadas no [Aspose repositório](https://releases.aspose.com/imaging/java/). Você pode usar facilmente o Aspose.Barcode para API Java diretamente em seus projetos Maven com configurações simples. Para as instruções detalhadas, visite [Installing Aspose.Imaging for Java from Maven Repository](https://docs.aspose.com/imaging/java/installation/) Página de documentação.
