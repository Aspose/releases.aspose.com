...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.Barcode para PHP via Java 22.1" imagelink="/resources/img/zip-icon.png">}}
  ...
  {{< Releases/ReleasesFileFeatures >}}
      <h4>Notas de liberação</h4><div><a href="https://docs.aspose.com/barcode/java/aspose-barcode-for-php-via-java-22-1/">https://docs.aspose.com/barcode/java/aspose-barcode-for-php-via-java-22-1/</a></div><h4>Descrição</h4><div class="HTMLDescription">Aspose.Barcode para PHP via Java 22.1 foi lançado</div>
  {{< /Releases/ReleasesFileFeatures >}}
 {{< /Releases/ReleasesFileArea >}}
{{< /Releases/ReleasesWapper >}}
