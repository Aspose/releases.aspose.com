---
title: "Aspose.Barcode | Processo 1d, 2d e códigos de barras postais via java" 
...
family_listing_page_description: "Aspose.Barcode para Java é um componente de geração e reconhecimento de código de barras robustos e confiáveis. Ele permite que os desenvolvedores adicionem de maneira rápida e fácil a funcionalidade de geração e reconhecimento de códigos de barras aos seus aplicativos Java com base nas plataformas Java SE, Java EE e Java ME." 
...
## salve códigos de barra como
** Imagens: ** JPEG, TIFF, PNG, BMP, GIF, EXIF, EMF, SVG

## Ambientes suportados
- ** Java Runtime: ** `Jre 8` ou acima
- ** Desenvolvimento Java: ** `Java SE 8` ou acima.
