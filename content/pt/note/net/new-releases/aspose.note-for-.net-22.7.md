---
title: "Defina o OneNote Table Background Color API para C#, APPS ASP.NET"
...
intro_text: "Ele contém asppos.Note para .NET 22.7 Release."
...
{{< Releases/ReleasesHeading H2txt="Aspose.Note for .Net 22.7" imagelink="/resources/img/msi-icon.png">}}
...
> For a complete list of features, enhancements, and bug fixes in this release please visit, [Aspose.Note for .NET 22.7 Notas de liberação](https://releases.aspose.com/note/net/release-notes/2022/aspose-note-for-net-22-7-release-notes/).
