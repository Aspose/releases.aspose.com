---
title: "Aspose.Note 22.11 | OneNote Processing Java High Code API" 
...
Asppos.Note Java APIs estão hospedados no [Aspose repositório](https://releases.aspose.com/note/java/). Você pode usar facilmente o Aspose.Barcode para API Java diretamente em seus projetos Maven com configurações simples. Para as instruções detalhadas, visite [Installing Aspose.Note for Java from Maven Repository](https://docs.aspose.com/note/java/installation/) Página de documentação.
