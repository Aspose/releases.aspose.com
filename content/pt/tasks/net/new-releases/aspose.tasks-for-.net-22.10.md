---
title: "Projeto de importação da API XER ou Primavera P6 para aplicativos C# .NET" 
description: "C# .NET API de gerenciamento de projetos para preservar os UIDs primavera® ao importar projetos XER ou PXML, capacidade de acessar os campos das entidades via propriedades .NET." 
keywords: ""
page_type: single_release_page
folder_link: "/tasks/net/new-releases/aspose.tasks-for-.net-22.10/"
folder_name: "Aspose.Tasks for .Net 22.10" 
download_link: "/tasks/net/new-releases/aspose.tasks-for-.net-22.10/536cc9aae2d74e77c2b4214fd8b12e0c-5-7987"
download_text: "Download" 
intro_text: "Ele contém msi com aspom.Tasks para a versão .NET 22.10." 
...
{{< Releases/ReleasesHeading H2txt="Aspose.Tasks for .Net 22.10" imagelink="/resources/img/msi-icon.png">}}
...
{{< Releases/ReleasesFileFeatures >}}
<h4>Descrição</h4>
<div class="HTMLDescription">Ele contém msi com aspom.Tasks para a versão .NET 22.10.</div>
{{< /Releases/ReleasesFileFeatures >}}
...
Foi adicionada uma nova configuração que permite preservar o primavera & reg; UIDs ao importar projetos dos formatos XER ou P6XML.

### .NET Framework 2.0 Suporte

O suporte ao .NET Framework 2.0 foi removido.

### Fields de entidades de acesso
