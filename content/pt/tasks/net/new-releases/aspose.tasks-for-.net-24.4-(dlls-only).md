...
title: "Downloads ---Novos lançamentos-aspose.tasks-for-.net-24.4-(somente dlls)"
description: " "
keywords: ""
page_type: single_release_page
folder_link: "/tasks/net/new-releases/aspose.tasks-for-.net-24.4-(dlls-only)/"
folder_name: "Aspose.Tasks para .NET 24.4 (somente DLLs)"
download_link: "/tasks/net/new-releases/aspose.tasks-for-.net-24.4-(dlls-only)/47f61e31855fd6272360c4806d2a4aac-5-10676"
download_text: "Download"
intro_text: "Ele contém a versão Aspose.Tasks para .NET 24.4 (somente DLLs)."
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.Tasks para .NET 24.4 (somente DLLs)" imagelink="/resources/img/zip-icon.png">}}
  ...
  {{< Releases/ReleasesFileFeatures >}}
      <h4>Notas de liberação</h4><div><a href='https://releases.aspose.com/tasks/net/release-notes/2024/aspose-tasks-for-net-24-4-release-notes/'>https://releases.aspose.com/tasks/net/release-notes/2024/aspose-tasks-for-net-24-4-release-notes/</a></div>
  {{< /Releases/ReleasesFileFeatures >}}
  {{< Releases/ReleasesFileFeatures >}}
      <h4>Descrição</h4><div class="HTMLDescription">Ele contém a versão Aspose.Tasks para .NET 24.4 (somente DLLs).</div>
  {{< /Releases/ReleasesFileFeatures >}}
 {{< /Releases/ReleasesFileArea >}}
{{< /Releases/ReleasesWapper >}}
