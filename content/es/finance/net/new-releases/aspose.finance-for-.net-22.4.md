...
description: "Lanzamiento de la API C# .NET con el informe mejorado de XBRL a HTML, el controlador del analizador de esquemas XBRL, la descarga del esquema XBRL para admitir Transport Layer Security (TLS) 1.2."
keywords: ""
page_type: single_release_page
folder_link: " finance/net/new-releases/aspose.finance-for-.net-22.4/"
folder_name: "Aspose. Finanzas para .NET 22.4"
download_link: " /finance/net/new-releases/aspose.finance-for-.net-22.4/41cb0be968e74742bc13ce40dfdfa9e0"
download_text: " Download"
Intro_text: "Contiene Aspose.Finance para la versión .NET 22.4."
...
{{< Releases/ReleasesHeading H2txt="Aspose. Finanzas para .NET 22.4" imagelink="/resources/img/icono-msi.png">}}
...
{{< Common/li class="hide" id="autor-actualización-41cb0be968e74742bc13ce40dfdfa9e0" >}} WilliamShen {{< /Common/li >}}
...
# Informe mejorado de XBRL a HTML

Se mejoró la función de informe XBRL a HTML.

# Controlador de analizador de esquemas XBRL mejorado

Se mejoró el controlador del analizador de esquemas XBRL.

# Se agregó el soporte para TLS 1.2
