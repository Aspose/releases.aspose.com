---
title: "Exporte DWG a WMF y OBJ a DXF a través de API para aplicaciones C# ASP.NET"
description: "C# .NET API con función de exportación mejorada de formato DWG a WMF, tamaño de archivo optimizado para exportación de OBJ a DXF, problema de superposición de texto resuelto dentro del PDF exportado."
keywords: ""
page_type: single_release_page
folder_link: "/cad/net/new-releases/aspose.cad-for-.net-22.5/"
folder_name: "Aspose.CAD para .NET 22.5"
...
{{< Releases/ReleasesHeading H2txt="Aspose.CAD para .NET 22.5" imagelink="/resources/img/icono-msi.png">}}
...
Se mejoró la función de exportación de DWG a formato WMF.

# Optimización del tamaño de archivo para exportar OBJ a DXF

Se solucionó el problema del enorme tamaño de archivo después de exportar OBJ a formato DXF.

# Exportación de PDF mejorada

Se resolvió el problema de superposición de texto dentro del archivo PDF exportado.

> Para obtener una lista completa de funciones, mejoras y correcciones de errores en esta versión, visite [Aspose.CAD for .NET 22.5 - Release Notes](https://docs.aspose.com/cad/net/aspose-cad-for-net-22-5-release-notes/).
