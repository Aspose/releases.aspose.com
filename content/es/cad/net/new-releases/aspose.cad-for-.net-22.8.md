---
title: "Conservar modelos 3D, renderizar planos a través de API para C#, aplicaciones .NET"
description: "C# .NET API con la capacidad de conservar los modelos cableados 3D, renderizar planos de dos caras, escalar marcas de agua, renderizar y convertir DWG a PDF mejorados."
keywords: ""
...
Intro_text: "Contiene el instalador MSI para la instalación completa del producto Aspose.CAD para .NET v22.8"
...
{{< Releases/ReleasesHeading H2txt="Aspose.CAD para .NET 22.8" imagelink="/resources/img/icono-msi.png">}}
...
# Conservar modelos 3D (cableados)

Posibilidad de conservar los modelos cableados 3D.

# Renderizar planos laterales dobles

Capacidad para renderizar planos de doble cara.

# Ampliar marcas de agua

Se agregó el soporte para la ampliación de la marca de agua.
