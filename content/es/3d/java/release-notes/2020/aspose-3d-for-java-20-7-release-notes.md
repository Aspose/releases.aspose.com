...
linktitle: "Aspose.3D for Java 20,7 Notas de la versión"
title: "Aspose.3D for Java 20,7 Notas de la versión"
weight: 10
description: "Aspose.3D for Java 20,7 Notas de la versión – the latest updates and fixes."
type: "repository"
layout: "release"
---
{{% alert color="primary" %}} 

Esta página contiene información de notas de la versión para Aspose.3D for Java 20,7.
...
- Añadido nueva clase de modelado procedimental**Com aspose! threed! SweptAreaSolid**
...
- Añadido nueva clase de modelado procedimental**Com aspose! threed! RevolvedAreaSolid**
...
- Añadido nuevos métodos en clase**Com aspose! threed! STLLoadOptions**
...
Algunos archivos STL contienen normales incorrectas, esto permite ignorar los datos normales originales y calcular los nuevos datos por cara durante la importación.
...
- Añadido nuevo perfil clase de forma**Com aspose! threed! HollowCircleShape**
...
- Añadido nuevo perfil clase de forma**Com aspose! threed! HollowRectangleShape**
