...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.3D para .NET 22.1" imagelink="/resources/img/icono-msi.png">}}
  ...
  {{< Releases/ReleasesFileArea >}}
    ...
    {{< Releases/ReleasesDetailsUl >}}
      ...
      {{< Common/li class="hide" id="autor-actualización-24f8b739d9e84d05a64fdcf5c0337182" >}} lex.chou {{< /Common/li >}}
  ...
  {{< Releases/ReleasesFileFeatures >}}
      <h4>Notas de lanzamiento</h4><div> <a href="https://docs.aspose.com/3d/net/aspose-3d-for-net-22-1-release-notes/">https://docs.aspose.com/3d/net/aspose-3d-for-net-22-1-release-notes/</a></div>
  {{< /Releases/ReleasesFileFeatures >}}
...
Restaurado el soporte de .NET Standard 2.0.

# Conversión mejorada de USDZ a GLB

Anteriormente, en algunos casos, la API no podía abrir los archivos 'USDZ' para convertirlos al formato 'GLB'. Esta versión de la API ha resuelto ese problema.

# Codificación y decodificación de entidades primitivas

Se agregó el soporte de codificación y decodificación de entidades primitivas en el exportador USD.

> Para obtener una lista completa de funciones, mejoras y correcciones de errores en esta versión, visite [Aspose.3D for .NET 22.1 Release Notes](https://docs.aspose.com/3d/net/aspose-3d-for-net-22-1-release-notes/).
