---
title: "USDZ HTML5 API de formato interno predeterminado para aplicaciones C#, ASP.NET"
description: "La API C# .NET agregó compatibilidad con .NET 6.0. Para una mejor extensibilidad, cambió el soporte a `USDZ` como formato interno predeterminado de HTML5 en lugar del formato `A3DW`."
keywords: ""
...
Intro_text: "Contiene Aspose.3D para la versión .NET 22.7."
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.3D para .NET 22.7" imagelink="/resources/img/icono-msi.png">}}
...
Se agregó el soporte de .NET 6.0.

# USDZ como formato interno predeterminado de HTML5
