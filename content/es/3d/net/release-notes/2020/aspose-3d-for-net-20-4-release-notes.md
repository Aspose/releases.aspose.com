...
linktitle: "Aspose.3D for .NET 20,4 Notas de la versión"
title: "Aspose.3D for .NET 20,4 Notas de la versión"
weight: 40
description: "Aspose.3D for .NET 20,4 Notas de la versión – the latest updates and fixes."
type: "repository"
layout: "release"
---
{{% alert color="primary" %}} 

Esta página contiene información de notas de la versión para Aspose.3D for .NET 20,4.
...
### **Añadido miembros a la clase Aspose.ThreeD.Utilities.Vertex**
{{< highlight "java" >}}
...
{{< /highlight >}}
### **Miembro agregado a Aspose.ThreeD. Entidades. Clase TriMesh**
...
{{< /highlight >}}
### **Añadido Clase Aspose.ThreeD.Render. Mango de ventana**
Se utiliza para encapsular el controlador de ventana nativo para crear una ventana de modelizado.
### **Miembro añadido a la clase Aspose.ThreeD.Render.RenderFactory**
...
{{< /highlight >}}
### **Miembro obsoleto**
El antiguo CreateRenderWindow está marcado como Obsoleto, para portar el código antiguo a este método, corrige tu código anterior como el siguiente fragmento de código:
...
{{< /highlight >}}
### **Miembros añadidos a la clase Aspose.ThreeD.Utilities.IOUtils**
