...
linktitle: "Aspose.Cells for Python via .NET 22.11 Notas de la versión"
title: "Aspose.Cells for Python via .NET 22.11 Notas de la versión"
weight: 6
description: "Aspose.Cells for Python via .NET 22.11 Notas de la versión – the latest updates and fixes."
type: "repository"
layout: "release"
family_listing_page_title: "Aspose.Cells for Python via .NET 22.11 Notas de la versión"
---
{{% alert color="primary" %}} 

Esta es la primera versión para Aspose.Cells for Python via .NET.
Esta página contiene notas de la versión para Aspose.Cells for Python via .NET 22.11.

{{% /alert %}} 

|**Llave**|**Resumen**|**Categoría**|
|:- |:- |:- |
|CELLSPYTHONNET-82|Volver a guardar un archivo XLSM que tenía controles ActiveX corrompió las macros en el archivo|
