---
title: Plantilla de hoja de cálculo XLT (Excel) OTS (Calc) API C# .NET Aplicación
description: C# .NET API con soporte para formatos de plantilla de hoja de cálculo Excel® (XLT) y Calc (OTS), establece bordes interiores, ordena los valores de los campos dinámicos según la columna o fila seleccionada
keywords: ""
...
{{< Releases/ReleasesWapper >}}
  ...
  {{< Releases/ReleasesButtons >}}
    {{< Releases/ReleasesSingleButtons text=" Descargar" link="/cells/net/new-releases/aspose.cells-for-.net-22.3/c293581525754554a9ea2092b4c27669%20%20" >}}
  ...
  {{< Releases/ReleasesFileArea >}}
    ...
    {{< Releases/ReleasesDetailsUl >}}
      ...
      {{< Common/li id="size-update-c293581525754554a9ea2092b4c27669" >}} 102,1 megas{{< /Common/li >}} 
...
#  Soporte para formatos de plantillas de hojas de cálculo

Esta versión API ha introducido compatibilidad con formatos de plantillas de hojas de cálculo tanto para Excel&reg como para Excel&reg; (XLT) & OpenOffice Calc® (OTS) programas. Estos son compatibles como formatos de salida a través de `SaveFormat.Ots` y `SaveFormat.Xlt`.

#  Establecer bordes interiores

Posibilidad de establecer los límites interiores.

#  Ordenar campo dinámico por fila o columna seleccionada
