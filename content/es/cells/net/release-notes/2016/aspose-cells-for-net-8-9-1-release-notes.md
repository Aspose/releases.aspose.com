...
linktitle: "Aspose.Cells for .NET 8.9.1 Notas de la versión"
title: "Aspose.Cells for .NET 8.9.1 Notas de la versión"
weight: 60
description: "Aspose.Cells for .NET 8.9.1 Notas de la versión – the latest updates and fixes."
type: "repository"
layout: "release"
family_listing_page_title: "Aspose.Cells for .NET 8.9.1 Notas de la versión"
---
### **1) Aspose.Cells**
...
|CELLSNET-44618 | Insertar rango de celdas hace que el fondo de algunas celdas desaparezca| Insecto|
|CELLSNET-44614 | Problema de ruta con enlaces de datos externos para hojas de cálculo XLS| Insecto|
|CELLSNET-44611 | Volver a guardar la hoja de cálculo con un tema personalizado provoca un error en Open XML SDK| Insecto|
|CELLSNET-44649 | El motor de cálculo personalizado hace que el cálculo se realice solo una vez| Insecto|
