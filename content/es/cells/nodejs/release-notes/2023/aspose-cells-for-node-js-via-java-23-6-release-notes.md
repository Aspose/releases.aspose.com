...
linktitle: Aspose.Cells for Node.js via Java 23.6 Nota de versión
title: Aspose.Cells for Node.js via Java 23.6 Nota de versión
weight: 7
description: "Aspose.Cells for Node.js via Java 23.6 Notas de la versión: las últimas mejoras, nuevas funciones y correcciones"
type: repositor
layout: releas
...
{{% alert color="primary" %}}
 ...
 Esta página contiene notas de la versión para[Aspose.Cells for Node.js via Java 23.6](https://releases.aspose.com/cells/nodejs/new-releases/aspose.cells-for-node.js-via-java-23.6/).
...
|CELLSNODEJSJAVA-44|El contenido del cuadro de texto aparece borroso al convertir el archivo a PDF|
|CELLSNODEJSJAVA-46|Cell el texto se corta y se ajusta incorrectamente al convertir el libro a PDF|
|CELLSNODEJSJAVA-47|El formato de fecha no se implementa en todas las columnas en Aspose.Cells|
