...
linktitle: "Aspose.Cells for PHP via Java 23.5 Notas de la versión"
title: "Aspose.Cells for PHP via Java 23.5 Notas de la versión"
weight: 8
description: "Aspose.Cells for PHP via Java 23.5 Notas de la versión – the latest updates and fixes."
type: "repository"
layout: "release"
family_listing_page_title: "Aspose.Cells for PHP via Java 23.5 Notas de la versión"
---
{{% alert color="primary" %}}

 Esta página contiene notas de la versión para[Aspose.Cells for PHP via Java 23.5](https://releases.aspose.com/cells/php/new-releases/aspose.cells-for-php-via-java-23.5/).
