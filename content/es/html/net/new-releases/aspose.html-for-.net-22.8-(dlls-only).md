...
title: "Descargas --- Nuevas comunicadas-asase.html-for-.net-22.8- (Dlls-solo)"
description: " "
keywords: ""
page_type: single_release_page
folder_link: "/html/net/new-releases/aspose.html-for-.net-22.8-(dlls-only)/"
folder_name: "Aspose.html para .net 22.8 (solo dlls)"
download_link: "/html/net/new-releases/aspose.html-for-.net-22.8-(dlls-only)/35e7e0df035d640efef683310114c403-4-7782"
download_text: "Descargar"
intro_text: "This ZIP file contains only the Aspose.HTML for .NET assemblies. The assemblies are the same as in the MSI installer of the product of the same version. Descargar this if you want to use Aspose.HTML without the MSI installer, i.e. you cannot run MSI installers on Mono. This ZIP download does not contain the user documentation in the Microsoft Help format which is included in the MSI installer."
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.html para .net 22.8 (solo dlls)" imagelink="/resources/img/zip-icon.png">}}
  {{< Releases/ReleasesButtons >}}
    {{< Releases/ReleasesSingleButtons text="Descargar" link="/html/net/new-releases/aspose.html-for-.net-22.8-(dlls-only)/35e7e0df035d640efef683310114c403-4-7782" >}}
