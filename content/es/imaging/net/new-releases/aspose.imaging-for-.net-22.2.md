---
title: "Velocidad de cambio de tamaño de imagen optimizada a través de API para aplicaciones C#, ASP.NET"
description: "C# .NET API con una velocidad de cambio de tamaño de imagen más rápida, realiza la alineación de texto precisa y perfecta de píxeles, mejora la cobertura de prueba de submuestreo de YCbCr a RGb para Jpeg2000."
keywords: ""
...
Intro_text: "Contiene Aspose.Imaging para la versión .NET 22.2."
...
{{< Releases/ReleasesHeading H2txt="Aspose. Imaging para .NET 22.2" imagelink="/resources/img/icono-msi.png">}}
...
<h4>Notas de lanzamiento</h4><div> <a href="https://releases.aspose.com/imaging/net/release-notes/2022/aspose-imaging-for-net-22-2-release-notes/">https://releases.aspose.com/imaging/net/release-notes/2022/aspose-imaging-for-net-22-2-release-notes/</a></div>
{{< /Releases/ReleasesFileFeatures >}}
...
# Velocidad de cambio de tamaño de imagen optimizada

Se mejoró la velocidad de cambio de tamaño de la imagen y se hizo más rápida.
...
Se agregó el soporte para realizar la alineación de texto perfecta de píxeles.
...
# Submuestreo mejorado de YCbCr a RGb

Esta versión ha mejorado la cobertura de pruebas de submuestreo de `YCbCr` a `RGb` para `Jpeg2000`.
...
Para obtener una lista completa de funciones, mejoras y correcciones de errores en esta versión, visite [Aspose.Imaging for .NET 22.2](http://localhost:1313/imaging/net/new-releases/aspose.imaging-for-.net-22.2/).
