...
Para obtener una lista completa de funciones, mejoras y correcciones de errores en esta versión, visite [Aspose.Imaging for .NET 22.9 - Release notes](https://docs.aspose.com/imaging/net/aspose-imaging-for-net-22-9-release-notes/).
