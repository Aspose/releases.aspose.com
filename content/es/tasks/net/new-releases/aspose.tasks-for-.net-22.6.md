---
title: "Tarea de asignación y API de recursos del proyecto para aplicaciones C#, ASP.NET"
description: "C# .NET API con las propiedades para acceder a la tarea y los recursos `ResourceAssignment`. Soporte para leer los tipos definidos por el usuario para los archivos de formato XML de Primavera P6."
keywords: ""
page_type: single_release_page
folder_link: "/tasks/net/new-releases/aspose.tasks-for-.net-22.6/"
folder_name: "Aspose.Tareas para .NET 22.6"
download_link: "/tasks/net/new-releases/aspose.tasks-for-.net-22.6/0ff51d6ef5e0a7552593395de72c7eac-6-7516"
download_text: "Download"
Intro_text: "Contiene MSI con Aspose.Tasks para la versión .NET 22.6."
...
{{< Releases/ReleasesHeading H2txt="Aspose.Tareas para .NET 22.6" imagelink="/resources/img/icono-msi.png">}}
...
# Acceso a tareas y recursos de asignación

Se agregaron las propiedades para acceder a la tarea y los recursos `ResourceAssignment`.

# Leer tipos definidos por el usuario para archivos XML P6
