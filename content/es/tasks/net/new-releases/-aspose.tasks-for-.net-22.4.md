---
title: "Importe archivos XER de proyectos múltiples a través de API para aplicaciones C#, ASP.NET"
description: "C# .NET API con soporte para importar archivos Primavera P6 XER de múltiples proyectos, importación mejorada de restricciones de tareas para XER, lectura de campos definidos por el usuario para formato XER."
keywords: ""
page_type: single_release_page
folder_link: " tasks/net/new-releases/-aspose.tasks-for-.net-22.4/"
folder_name: "Aspose.Tareas para .NET 22.4"
download_link: " /tasks/net/new-releases/-aspose.tasks-for-.net-22.4/cb38223312834315985a65994c750d25"
download_text: " Download"
Intro_text: "Contiene MSI con Aspose.Tasks para la versión .NET 22.4."
...
{{< Releases/ReleasesHeading H2txt="Aspose.Tareas para .NET 22.4" imagelink="/resources/img/icono-msi.png">}}
...
# Importar archivos XER de proyectos múltiples

Extendió la importación Primavera P6 `XER` y ahora admite la importación de archivos `XER` con más de un (1) proyecto.

# Importación mejorada de restricciones de tareas para XER

Se agregó la capacidad de especificar el comportamiento de la importación de restricciones de tareas para el formato `XER`.

# Leer campos definidos por el usuario para el formato XER
