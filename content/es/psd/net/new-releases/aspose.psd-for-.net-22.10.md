---
title: "Efecto de trazo de transparencia PSD a través de API para aplicaciones C#, ASP.NET"
description: "C# .NET API para aplicar un efecto de trazo transparente en gráficos PSD de Photoshop, analizar y renderizar símbolos asiáticos, crear una línea de tiempo, configurar marcos específicos."
keywords: ""
...
Intro_text: "Contiene Aspose.PSD para la versión .NET 22.10."
...
{{< Releases/ReleasesHeading H2txt="Aspose.PSD para .NET 22.10" imagelink="/resources/img/icono-msi.png">}}
...
<h4>Notas de lanzamiento</h4><div> <a href='https://releases.aspose.com/psd/net/release-notes/2022/aspose-psd-for-net-22-10-release-notes/'>https://releases.aspose.com/psd/net/release-notes/2022/aspose-psd-for-net-22-10-release-notes/</a></div>
{{< /Releases/ReleasesFileFeatures >}}
{{< Releases/ReleasesFileFeatures >}}
...
# Efectos de trazo transparente de Photoshop®
La transparencia funciona para el efecto Trazo con Posición interior para los archivos PSD.
...
# Análisis y representación de símbolos asiáticos en Photoshop®
Analice o actualice el texto con algunos símbolos asiáticos, por ejemplo, chino.
...
# Creación de la línea de tiempo de Photoshop® a través de C# .NET API
Cree efectos de línea de tiempo y configure marcos específicos.
...
Para obtener una lista completa de funciones, mejoras y errores corregidos en esta versión, visite [Aspose.PSD for .NET 22.10 - Release Notes](https://releases.aspose.com/psd/net/release-notes/2022/aspose-psd-for-net-22-10-release-notes/).
