---
title: "API de soporte de compresión PPMD ​​de 7Z Archive PPMD ​​para C#, ASP.NET Apps" 
description: "C# .NET API de compresión y extracción de archivo introduce el soporte de la compresión `PPMD` dentro del archivo 7Z, el progreso del informe de 7Z (7 ZIP) Compresión de entrada." 
keywords: ""
...
intro_text: "Aspose.zip para .NET 22.11 versión." 
image_link: "/resources/img/msi-icon.png"
download_count: " 26/11/2022 Descargars: 1  Views: 1 "
...
{{< Releases/ReleasesSingleButtons text="Descargar" link="/zip/net/new-releases/aspose.zip-for-.net-22.11/24a1a21fbba00120ccc363981f405375-2-8204" >}}
...
{{< Releases/ReleasesFileFeatures >}}
<h4>Descripción</h4>
<div class="HTMLDescription">Aspose.zip para .NET 22.11 versión.</div>
{{< /Releases/ReleasesFileFeatures >}}
{{< Releases/ReleasesHeading h4txt="Características notables">}}
{{< Common/wrapper class="HTMLDescription">}}
{{% Releases/ReleasesFileFeatures %}}

# 7Z Archive `PPMD` Soporte de compresión

Esta versión de API introdujo el soporte de la compresión `PPMD` dentro del archivo 7Z.

# Informe 7Z Progress de compresión
