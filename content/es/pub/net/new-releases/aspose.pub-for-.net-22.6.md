...
> Para obtener una lista completa de funciones, mejoras y errores corregidos en esta versión, visite [Aspose.PUB for .NET 22.6 Release Notes](https://docs.aspose.com/pub/net/aspose-pub-for-net-22-6-release-notes/).
