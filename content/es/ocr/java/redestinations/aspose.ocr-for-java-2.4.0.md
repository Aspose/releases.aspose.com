...
Intro_text: "Nos complace compartir una nueva versión de Aspose.OCR para Java con las siguientes impr..."
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.OCR para Java 2.4.0" imagelink="/resources/img/zip-icono.png">}}
  ...
  {{< Releases/ReleasesFileArea >}}
    ...
    {{< Releases/ReleasesDetailsUl >}}
      ...
      {{< Common/li class="hide" id="autor-actualización-1cc75ffd7a1e462a97105c36416f097f" >}} egor.kluban {{< /Common/li >}}
