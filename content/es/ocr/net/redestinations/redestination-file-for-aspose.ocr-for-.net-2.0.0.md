---
title: " Descargas ---Recursos-archivo-de-recursos-para-aspose.ocr-para-.net-2.0.0 . "
description:  "    . " 
keywords:  "    . " 
...
Intro_text: "Aspose.OCR para .NET utiliza un archivo de recursos para realizar operaciones de OCR contra el i..."
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Archivo de recursos para Aspose.OCR para .NET 2.0.0" imagelink="/resources/img/zip-icono.png">}}
  ...
  {{< Releases/ReleasesFileArea >}}
    ...
    {{< Releases/ReleasesDetailsUl >}}
      ...
      {{< Common/li class="hide" id="autor-actualización-3d5c658df4bf413aa8cd1fab779f8edf" >}} egor.kluban {{< /Common/li >}}
