---
title: "Descargar biblioteca de clases C++ para presentaciones | Aspose.Diapositivas"
description: "Descargue la biblioteca de clases DLL de C++ para crear, leer, escribir, editar y convertir presentaciones de PowerPoint® y OpenOffice® a través de la API. Admite gráficos, formas, SmartArt, tablas."
keywords: "C++ PowerPoint Library"
family_listing_page_title: "Aspose. Diapositivas para C++"
family_listing_page_description: "Aspose.Slides para C++ es una biblioteca de procesamiento de presentaciones que permite que las aplicaciones de C++ manipulen, rendericen y conviertan presentaciones de PowerPoint sin necesidad de la aplicación de Microsoft PowerPoint."
...
{{< Common/h2 text="Descargue la biblioteca de C++ para procesar presentaciones"  >}}
...
## ¿Por qué descargar Aspose.Slides para C++?

Esta biblioteca de clases de C++ independiente lo ayuda a crear, leer, escribir, editar y convertir presentaciones de Microsoft PowerPoint® sin necesidad de PowerPoint® o Office Automation.

## Funciones de procesamiento de presentaciones

- Cree, abra y trabaje con presentaciones sin Microsoft PowerPoint®.
- Convierta la presentación a cualquiera de los formatos de archivo compatibles.
- Agregar, formatear y manipular gráficos, formas, diapositivas, SmartArt, tablas y texto en presentaciones.
