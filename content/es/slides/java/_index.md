---
title: "Descargar archivos JAR del procesador de presentación | Aspose.Diapositivas"
description: "Descargue archivos JAR para crear, editar y convertir formatos de presentación de PowerPoint® y OpenOffice®. Trabaje con diapositivas, formas, gráficos, objetos, controles y más a través de la API."
keywords: "Java PPTX Library, Java PPT Library, PowerPoint Java API"
family_listing_page_title: "Aspose. Diapositivas para Java"
family_listing_page_description: "Aspose.Slides para Java es una API de manipulación y procesamiento de presentaciones de PowerPoint para leer, escribir, manipular y convertir archivos de PowerPoint dentro de cualquier aplicación basada en Java. La API no tiene dependencias externas, por lo que se puede usar sin necesidad de Microsoft PowerPoint."
...
{{< Common/h3 text="Descarga Aspose.Slides para trabajar con presentaciones de PowerPoint®"  >}}
...
{{< Common/link href="https://repository.aspose.com/slides/" text="Aspose.Slides para la API de Java"  >}}directamente en sus proyectos basados en Maven agregando las siguientes configuraciones a su pom.xml. Para obtener instrucciones detalladas, visite
{{< Common/link href="https://docs.aspose.com/slides/java/installation/" text="Instalación de Aspose.Slides para Java desde el repositorio de Maven"  >}}página de documentación.
...
## ¿Por qué descargar Aspose.Slides para Java?

[Aspose.Slides](https://products.aspose.com/slides/java) para Java es una API local para trabajar con las presentaciones de Microsoft PowerPoint® desde sus aplicaciones Java. Permite a los desarrolladores leer, escribir, convertir y manipular presentaciones de PowerPoint® en aplicaciones Java con la capacidad de manipular varios elementos del documento como diapositivas, tablas, texto, gráficos, formas, imágenes y diagramas SmartArt y más.
...
- Manipule todos los elementos de la presentación a través del modelo de objetos intuitivo.
- Crear o incrustar gráficos.
- Crear o manipular formas.

Consulte el [product overview](https://docs.aspose.com/slides/java/product-overview/) para saber todo sobre Aspose.Slides para Java.

### Leer y escribir presentaciones
