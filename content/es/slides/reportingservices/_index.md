---
title: "Exportar RDL a PowerPoint | Aspose.Slides para servicios de informes"
description: "Descargue la extensión SSRS para exportar informes RDL a presentaciones. Es compatible con la especificación RDL completa y se pueden personalizar los informes existentes utilizando esta extensión."
keywords: "SSRS Extension, RDL to PPT, RDL to PPTX "
family_listing_page_title: "Aspose.Slides para servicios de informes"
family_listing_page_description: "Aspose.Slides for Reporting Services es la única solución del mercado que permite generar presentaciones en los formatos nativos de PowerPoint desde Microsoft SQL Server Reporting Services."
    ...
    {{< Common/wrapper class="panel-body downloadfilebody" >}}
        {{< Common/wrapper class="productbox" >}}
            ...
            {{< Common/wrapper class="col-sm-11" >}}
                <h3 class="product-title">Aspose.Slides para servicios de informes</h3>
                {{< Common/paragraph>}}
{{< Common/link href="https://products.aspose.com/slides/reporting-services/" text="Aspose.Slides para servicios de informes"  >}}es un microsoft
                    Extensión de generación de informes de PowerPoint (basada en PPT y PPS) con soporte para todos los Microsoft populares
                    servidor SQL
