---
title: "Aspose.words 22.5 | Documento de New a Epub Converter" 
description: "Biblioteca Java para crear la vista de edición y convertir documentos de Word. Aspose.Words 22.5 Admite la conversión de Epub, carga XML, mejora en RTF a PDF y más." 
layout: package
...
## ¿Qué hay de nuevo en Aspose.Words para Java API 22.5
...
Consulte [Release Notes of Aspose.Words for Java 22.5](https://docs.aspose.com/words/java/aspose-words-for-java-22-5-release-notes/) para obtener detalles completos.
...
### ** Cómo convertir el documento de Word en formato de archivo Epub usando Java **

[Epub](https://docs.fileformat.com/ebook/epub/) es la extensión de formato de archivo utilizada para proporcionar un formato de publicación digital estándar para editores y consumidores.
