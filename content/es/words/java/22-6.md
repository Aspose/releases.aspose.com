---
title: "Aspose.words 22.6 | El documento de New a formatos de página fijos" 
description: "Biblioteca Java para crear la vista de edición y convertir documentos de Word. Aspose.words 22.6 admite la conversión de documentos a formatos de página fijos y más." 
layout: package
...
## ¿Qué hay de nuevo en Aspose.words para Java API 22.6
- Conversión de documentos a formatos de página fijos con alta calidad y rendimiento.
- API para dibujo de gráficos con soporte de gradiente, textura y rellenos de patrones.
- Improvement in converting DOCX to HTML
- Add loading progress notification for ODT documents
- Mejora en la carga de documentos EPUB con entidades XHTML.

Consulte [Release Notes of Aspose.Words for Java 22.6](https://docs.aspose.com/words/java/aspose-words-for-java-22-6-release-notes/) para obtener detalles completos.
...
### ** Cómo convertir el documento en formato JPEG de página fijo con alta calidad usando Java **
...
public class AsposeDocumentos2FIXEDPageJpgeHighQualityConverter {
...
- ** [Reemplazar y reemplazar en línea gratis](https://products.aspose.app/words/replace) ** para encontrar y reemplazar texto en Word, documentos PDF.
