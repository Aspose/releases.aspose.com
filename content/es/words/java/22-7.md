---
title: "Aspose.words 22.7 | Los documentos de New a PDF/UA-1 WCAG 2.0" 
description: "Biblioteca Java para crear la vista de edición y convertir documentos de Word. Aspose.Words 22.7 admite WCAG 2.0 PDF, campo de base de datos, OpenType (CFF) y más." 
layout: package
...
## ¿Qué hay de nuevo en Aspose.words para Java API 22.7
...
Consulte [Release Notes of Aspose.Words for Java 22.7](https://docs.aspose.com/words/java/aspose-words-for-java-22-7-release-notes/) para obtener detalles completos.
...
### ** Convertir el documento a PDF/UA-1 que cumple con WCAG 2.0 en Java **
...
public class AsposeDocumentos2PDF_UA_1_Compliant_WCAG20_Converter {
