---
title: "Aspose.words 22.9 | Palabra a pdf reducir tamaño | API Java" 
description: "Biblioteca Java para crear la vista de edición y convertir documentos de Word. Aspose.Words 22.9 Apoya la conversión a PDF con formas de almacenamiento en caché para reducir el tamaño del archivo PDF y muchos más." 
layout: package
...
## ¿Qué hay de nuevo en Aspose.Words para Java API 22.9
- Implementación de las formas de encabezado/pie de página almacenado en caché para reducir el tamaño del PDF.
- Implementación de marcas de agua almacenado en caché a través del marco XObjects.
- Mejora en las fronteras de la mesa, los bordes celulares durante la representación a PDF.
- Mejora en la conversión de RTF a PDF en una mesa aplastada.
- Se corrigió el texto superpuesto que la representación de la imagen SVG.
- Los valores de la etiqueta de datos fijos se cambian el orden durante la representación.

Consulte [Release Notes of Aspose.Words for Java 22.9](https://docs.aspose.com/words/java/aspose-words-for-java-22-9-release-notes/) para obtener detalles completos.
...
### ** Cómo reducir el tamaño del archivo al convertir Word a PDF usando Java **
