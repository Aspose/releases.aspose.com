---
id: "aspose-cells-for-node-js-via-cpp-26-2-release-notes"
slug: "aspose-cells-for-node-js-via-cpp-26-2-release-notes"
linktitle: "Aspose.Cells for Node.js via C++ 26.2 Release Notes"
title: "Aspose.Cells for Node.js via C++ 26.2 Release Notes"
weight: 11
description: "Aspose.Cells for Node.js via C++ 26.2 Release Notes – the latest enhancements, new features, and fixes."
type: "repository"
layout: "release"
family_listing_page_title: "Aspose.Cells for Node.js via C++ 26.2 Release Notes"
keywords: "Aspose.Cells for Node.js via C++ 26.2 Release Notes, Aspose.Cells for Node.js via C++ 26.2 updates and fixes"
---

{{% alert color="primary" %}}

This page contains release notes for Aspose.Cells for Node.js via C++ 26.2.

{{% /alert %}}

|**Key**|**Summary**|**Category**|
| :- | :- | :- |
|CELLSNODEJSCPP-93|Calculating formulas causes the crash using v26.1 on Linux|Bug
