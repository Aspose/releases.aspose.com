---
id: "aspose-cells-for-node-js-via-cpp-25-11-release-notes"
slug: "aspose-cells-for-node-js-via-cpp-25-11-release-notes"
linktitle: "Aspose.Cells for Node.js via C++ 25.11 Release Notes"
title: "Aspose.Cells for Node.js via C++ 25.11 Release Notes"
weight: 2
description: "Aspose.Cells for Node.js via C++ 25.11 Release Notes – the latest enhancements, new features, and fixes."
type: "repository"
layout: "release"
family_listing_page_title: "Aspose.Cells for Node.js via C++ 25.11 Release Notes"
keywords: "Aspose.Cells for Node.js via C++ 25.11 Release Notes, Aspose.Cells for Node.js via C++ 25.11 updates and fixes"
---

{{% alert color="primary" %}}

This page contains release notes for Aspose.Cells for Node.js via C++ 25.11.

{{% /alert %}}

|**Key**|**Summary**|**Category**|
| :- | :- | :- |
|CELLSNODEJSCPP-66|Wrong borders when opening and saving a xlsb file twice|Bug
