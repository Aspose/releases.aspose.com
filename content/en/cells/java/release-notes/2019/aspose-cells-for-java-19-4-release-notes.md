...
linktitle: "Aspose.Cells for Java 19.4 Release Notes"
title: "Aspose.Cells for Java 19.4 Release Notes"
weight: 90
description: "Aspose.Cells for Java 19.4 Release Notes – the latest enhancements, new features, and fixes."
type: "repository"
layout: "release"
family_listing_page_title: "Aspose.Cells for Java 19.4 Release Notes"
keywords: "Aspose.Cells for Java 19.4 Release Notes, Aspose.Cells for Java 19.4 updates and fixes"
---

{{% alert color="primary" %}} 

This page contains release notes for Aspose.Cells for Java 19.4.
...
|CELLSJAVA-42852|The label on both of the axis is not shown|Bug|
|CELLSJAVA-42856|Excel to HTML conversion issue|Bug|
...
|CELLSJAVA-42874|Column loss when exporting the file to HTML|Bug|
