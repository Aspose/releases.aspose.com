---
id: "aspose-cells-for-java-25-12-release-notes"
slug: "aspose-cells-for-java-25-12-release-notes"
linktitle: "Aspose.Cells for Java 25.12 Release Notes"
title: "Aspose.Cells for Java 25.12 Release Notes"
weight: 1
description: "Aspose.Cells for Java 25.12 Release Notes - the latest updates and fixes."
type: "repository"
layout: "release"
family_listing_page_title: "Aspose.Cells for Java 25.12 Release Notes"
---

{{% alert color="primary" %}}

This page contains release notes for [Aspose.Cells for Java 25.12](https://releases.aspose.com/cells/java/25-12/).
...
//Print the name of all visible worksheets in a workbook
workbook.getWorksheets()
        .stream()
        .filter(Worksheet::isVisible)
