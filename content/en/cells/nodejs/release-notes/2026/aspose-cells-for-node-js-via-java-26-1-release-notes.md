---
id: "aspose-cells-for-node-js-via-java-26-1-release-notes"
slug: "aspose-cells-for-node-js-via-java-26-1-release-notes"
linktitle: "Aspose.Cells for Node.js via Java 26.1 Release Notes"
title: "Aspose.Cells for Node.js via Java 26.1 Release Notes"
weight: 12
description: "Aspose.Cells for Node.js via Java 26.1 Release Notes – the latest enhancements, new features, and fixes."
type: "repository"
layout: "release"
family_listing_page_title: "Aspose.Cells for Node.js via Java 26.1 Release Notes"
keywords: "Aspose.Cells for Node.js via Java 26.1 Release Notes, Aspose.Cells for Node.js via Java 26.1 updates and fixes"
---

{{% alert color="primary" %}}

This page contains release notes for [Aspose.Cells for Node.js via Java 26.1](https://releases.aspose.com/cells/nodejs/new-releases/aspose.cells-for-node.js-via-java-26.1/).

{{% /alert %}}

|**Key**|**Summary**|**Category**|
| :- | :- | :- |
|CELLSNODEJSJAVA-85|Support automatically updating the chart data to the new range after copying|Improvement
|CELLSNODEJSJAVA-90|HTML content gets stripped when using setHtmlString – text after ‘<’ is removed|Bug
