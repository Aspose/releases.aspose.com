---
id: "aspose-cells-for-python-via-java-20-2-release-notes"
slug: "aspose-cells-for-python-via-java-20-2-release-notes"
linktitle: "Aspose.Cells for Python via Java 20.2 Release Notes"
title: "Aspose.Cells for Python via Java 20.2 Release Notes"
weight: 10
description: "Aspose.Cells for Python via Java 20.2 Release Notes – the latest enhancements, new features, and fixes."
type: "repository"
layout: "release"
family_listing_page_title: "Aspose.Cells for Python via Java 20.2 Release Notes"
keywords: "Aspose.Cells for Python via Java 20.2 Release Notes, Aspose.Cells for Python via Java 20.2 updates and fixes"
---

{{% alert color="primary" %}} 

This page contains release notes for Aspose.Cells for Python via Java 20.2.
