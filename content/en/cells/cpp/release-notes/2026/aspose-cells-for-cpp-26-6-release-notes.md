...
PowerQueryFormulaItemType GetItemType()
...
void SelectItems(const Vector<U16String>& labels, bool append)
...
bool GetShowDataTypeIcons()

void SetShowDataTypeIcons(bool value)
