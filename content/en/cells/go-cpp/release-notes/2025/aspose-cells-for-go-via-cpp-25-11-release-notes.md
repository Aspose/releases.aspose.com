---
id: "aspose-cells-for-go-via-cpp-25-11-release-notes"
slug: "aspose-cells-for-go-via-cpp-25-11-release-notes"
linktitle: "Aspose.Cells for Go via CPP 25.11 Release Notes"
title: "Aspose.Cells for Go via CPP 25.11 Release Notes"
weight: 2
description: "Aspose.Cells for Go via CPP 25.11 Release Notes – the latest enhancements, new features, and fixes."
type: "repository"
layout: "release"
family_listing_page_title: "Aspose.Cells for Go via CPP 25.11 Release Notes"
keywords: "Aspose.Cells for Go via CPP 25.11 Release Notes, Aspose.Cells for Go via CPP 25.11 updates and fixes"
---

{{% alert color="primary" %}}

This page contains release notes for Aspose.Cells for Go via C++ 25.11.
...
func (instance *PivotField) IsValuesField()  (bool,  error)

func (instance *PivotField) GetGroupSettings()  (*PivotFieldGroupSettings,  error)

{{% /alert %}}

Use func (instance *PivotField) IsValuesField()  (bool,  error) instead.
...
func (instance *PivotTable) GetValuesField()  (*PivotField,  error)

{{% /alert %}}

Obsoletes:

Use func (instance *PivotTable) GetValuesField()  (*PivotField,  error) instead.
...
Use func (instance *ListObject) GetHasAutoFilter()  (bool,  error) , func (instance*ListObject) SetHasAutoFilter(value bool)  error methods instead.

{{% alert color="primary" %}}

func (instance *ListObject) GetFilter()  (bool,  error)
func (instance*ListObject) SetFilter(value bool)  error
...
func (instance *Worksheet) Filter(ca*CellArea)  error
...
func (instance *ImportTableOptions) GetStyles()  ([]Style,  error)

func (instance *ImportTableOptions) SetStyles(value []Style)  error
...
func (instance *FilterColumn) GetCustomFilters()  (*CustomFilterCollection,  error)

func (instance *FilterColumn) SetCustomFilters(value*CustomFilterCollection)  error

func (instance *FilterColumn) GetColorFilter()  (*ColorFilter,  error)

func (instance *DynamicFilter) GetDynamicFilterType()  (DynamicFilterType,  error)

func (instance *FilterColumn) GetIconFilter()  (*IconFilter,  error)

func (instance *FilterColumn) GetTop10Filter()  (*Top10Filter,  error)

{{% /alert %}}

Obsolete:

Use func (instance *FilterColumn) GetMultipleFilters()  (*MultipleFilterCollection,  error) and so on... methods, instead.
...
func (instance *MarkdownSaveOptions) GetOfficeMathOutputType()  (HtmlOfficeMathOutputType,  error)

func (instance *MarkdownSaveOptions) SetOfficeMathOutputType(value HtmlOfficeMathOutputType)  error
...
func (instance *HtmlSaveOptions) SetLayoutMode(value HtmlLayoutMode)  error
