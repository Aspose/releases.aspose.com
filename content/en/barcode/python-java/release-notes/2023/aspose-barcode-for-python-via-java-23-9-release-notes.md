---
id: "aspose-barcode-for-python-via-java-23-9-release-notes"
slug: "aspose-barcode-for-python-via-java-23-9-release-notes"
linktitle: "Aspose.BarCode for Python via Java 23.9"
title: "Aspose.BarCode for Python via Java 23.9"
weight: 910
description: "Aspose.BarCode for Python via Java 23.9 – the latest updates and fixes."
type: "repository"
layout: "release"
hideChildren: false
toc: false
family_listing_page_title: "Aspose.BarCode for Python via Java 23.9"
menuItemWithNoContent: false
---

{{% alert color="primary" %}} 

This page contains release notes information for [Aspose.BarCode for Python via Java 23.9](https://releases.aspose.com/barcode/python-java/new-releases/aspose.barcode-for-python-via-java-23.9/).
