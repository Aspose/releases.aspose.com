---
id: "aspose-barcode-for-reporting-services-26-7-release-notes"
slug: "aspose-barcode-for-reporting-services-26-7-release-notes"
linktitle: "Aspose.BarCode for Reporting Services 26.7 Release Notes"
title: "Aspose.BarCode for Reporting Services 26.7 Release Notes"
weight: 170
description: "Aspose.BarCode for Reporting Services 26.7 Release Notes – the latest updates and fixes."
type: "repository"
layout: "release"
hideChildren: false
toc: false
family_listing_page_title: "Aspose.BarCode for Reporting Services 26.7 Release Notes"
menuItemWithNoContent: false
---

{{% alert color="primary" %}}

This page contains release notes information for [Aspose.BarCode for Reporting Services 26.7](https://releases.aspose.com/barcode/reportingservices/new-releases/aspose.barcode-for-reporting-services-26.7/).
...
- From ***Pdf417RSUI***: ***Pdf417CompactionMode***.
- From ***QRRSUI***: ***QrEncodeType***. Use ***BarcodeType.MicroQR*** and ***MicroQRVersion*** to generate Micro QR barcodes.

The following property has been added to ***QRRSUI***:
