---
id: "aspose-barcode-for-node-js-via-java-25-3-release-notes"
slug: "aspose-barcode-for-node-js-via-java-25-3-release-notes"
linktitle: "Aspose.BarCode for Node.js via Java 25.3"
title: "Aspose.BarCode for Node.js via Java 25.3"
weight: 960
description: "Aspose.BarCode for Node.js via Java 25.3 – the latest updates and fixes."
type: "repository"
layout: "release"
hideChildren: false
toc: false
family_listing_page_title: "Aspose.BarCode for Node.js via Java 25.3"
menuItemWithNoContent: false
---

{{% alert color="primary" %}} 

This page contains release notes information for [Aspose.BarCode for Node.js via Java 25.3](https://releases.aspose.com/barcode/nodejs/new-releases/aspose.barcode-for-node.js-via-java-25.3/).
...
testGeneratePDF()
{
    let fullPath = "code128.pdf";
    let generator = new BarcodeGenerator(EncodeTypes.CODE_128, "Aspose");
    generator.save(fullPath, BarCodeImageFormat.PDF);
}
```