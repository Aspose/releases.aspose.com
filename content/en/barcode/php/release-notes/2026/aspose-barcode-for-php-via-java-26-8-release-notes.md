---
id: "aspose-barcode-for-php-via-java-26-8-release-notes"
slug: "aspose-barcode-for-php-via-java-26-8-release-notes"
linktitle: "Aspose.BarCode for PHP via Java 26.8"
title: "Aspose.BarCode for PHP via Java 26.8"
weight: 880
description: "Aspose.BarCode for PHP via Java 26.8 – the latest updates and fixes."
type: "repository"
layout: "release"
hideChildren: false
toc: false
family_listing_page_title: "Aspose.BarCode for PHP via Java 26.8"
menuItemWithNoContent: false
---

{{% alert color="primary" %}}

This page contains release notes information for [Aspose.BarCode for PHP via Java 26.8](https://releases.aspose.com/barcode/php/new-releases/aspose.barcode-for-php-via-java-26.8/).
...
| BARCODEJAVA-2393  | Normalize hashCode() and toString() implementations                           | Enhancement  |
| BARCODEJAVA-2394  | Fix Java-side enum conversion issues and improve cross-platform compatibility | Enhancement  |
...
The `hashCode()` and `toString()` implementations in the underlying Java code have been normalized to use a consistent implementation pattern.

This cleanup makes Java-side implementations consistent across the library and removes differences introduced during the automatic .NET-to-Java porting process.

The changes do not modify the intended public behavior of `Aspose.BarCode for PHP via Java`.

### BARCODEJAVA-2394

Fixed issues related to enum conversion on the Java side and performed stabilization work to maintain compatibility between Aspose.BarCode platforms.

The changes improve enum conversion in the underlying Java layer and ensure that enum values used by `Aspose.BarCode for PHP via Java` remain synchronized and compatible with the corresponding values on other platforms.

The stabilization work covers the following enums:
