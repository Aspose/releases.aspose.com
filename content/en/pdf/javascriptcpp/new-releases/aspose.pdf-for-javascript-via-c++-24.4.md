...
folder_name: "Aspose.PDF for JavaScript via C++ 24.4"
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.PDF for JavaScript via C++ 24.4" imagelink="/resources/img/zip-icon.png">}}
