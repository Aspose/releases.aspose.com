---
id: "aspose-pdf-for-java-19-9-release-notes"
slug: "aspose-pdf-for-java-19-9-release-notes"
linktitle: "Aspose.PDF for Java 19.9 Release Notes"
title: "Aspose.PDF for Java 19.9 Release Notes"
weight: 40
description: "Aspose.PDF for Java 19.9 Release Notes – the latest updates and fixes."
type: "repository"
layout: "release"
family_listing_page_title: "Aspose.PDF for Java 19.9 Release Notes"
---

{{% alert color="primary" %}}

This page contains release notes for [Aspose.PDF for Java 19.9](https://releases.aspose.com/pdf/java/new-releases/aspose.pdf-for-java-19.9/).
...
| :- | :- | :- |
|PDFJAVA-38882|Add [ImageStamp as a background](https://docs.aspose.com/pdf/java/adding-stamp-in-a-pdf-file/#addingstampinapdffile-addimagestampasbackgroundinfloatingbox) in FloatingBox|New Feature|
|PDFJAVA-38883|Unsupported Latex tags: [\begin \end \qedhere](https://docs.aspose.com/pdf/java/advanced-features/#advancedfeatures-supportforlatextags)|New Feature|
