...
title: "Enhance PDFs & Add Accessibility - .NET PDF API 24.6 (DLLs)"
description: "Download Aspose.PDF .NET 24.6 (DLLs package) to empower your C# apps with new features like creating accessible PDFs, signing with certificates & more."
keywords: ""
page_type: single_release_page
folder_link: "/pdf/net/new-releases/aspose.pdf-for-.net-24.6-(dlls-only)/"
folder_name: "Aspose.PDF for .NET 24.6 (DLLs only)"
download_link: "/pdf/net/new-releases/aspose.pdf-for-.net-24.6-(dlls-only)/4fe448699417afe83ef5f4072ed24d53-37-11023"
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.PDF for .NET 24.6 (DLLs only)" imagelink="/resources/img/zip-icon.png">}}
  {{< Releases/ReleasesButtons >}}
    {{< Releases/ReleasesSingleButtons text="Download" link="/pdf/net/new-releases/aspose.pdf-for-.net-24.6-(dlls-only)/4fe448699417afe83ef5f4072ed24d53-37-11023" >}}
  ...
  {{< Releases/ReleasesFileArea >}}
    ...
    {{< Releases/ReleasesDetailsUl >}}
      ...
      {{< Common/li class="downloadcount" id="dwn-update-4fe448699417afe83ef5f4072ed24d53-37-11023" >}} 1 {{< /Common/li >}}
      {{< Common/li >}} File Size: {{< /Common/li >}}
      {{< Common/li id="size-update-4fe448699417afe83ef5f4072ed24d53-37-11023" >}} 181.71MB {{< /Common/li >}}

      {{< Common/li >}} Date Added: {{< /Common/li >}}
      {{< Common/li id="added-update-4fe448699417afe83ef5f4072ed24d53-37-11023" >}}14/6/2024 {{< /Common/li >}}
    {{< /Releases/ReleasesDetailsUl >}}
  ...
  {{< /Releases/ReleasesFileFeatures >}}
  {{< Releases/ReleasesFileFeatures >}}
      <h4>Description</h4><div class="HTMLDescription">This ZIP file contains only the Aspose.PDF for .NET 24.6 assemblies. The assemblies are the same as in the MSI installer of the product of the same version. Download this if you want to use Aspose.PDF without the MSI installer.</div>
  {{< /Releases/ReleasesFileFeatures >}}
...
The DLLs-only package of Aspose.PDF for .NET 24.6 enables creating and manipulating PDF documents for .NET developers with an enhanced set of features.

### Key Highlights

### New Features:
- Inject alternative text for image stamps to enhance accessibility with this C# API version.
- Generate accessible PDFs with low-level functions for better control.
- Digitally sign PDF documents using `X509Certificate2` in base64 format for increased security using the latest .NET PDF API release.


### Enhancements:
- Relaxed evaluation mode restrictions for a simplified developer experience.
- The paragraph replacement functionality within existing PDFs has been improved for easier editing.
- We have introduced the ability to define areas where text retrieval should be prevented in Aspose.PDF for .NET 24.6.

### Bug Fixes:
Several issues related to HTML to PDF conversion, text extraction, PDF/A conversion, and more have been fixed in this release.
