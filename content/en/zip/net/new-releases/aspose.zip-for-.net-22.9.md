---
title: "Verify RAR Decompression Password API for C#, ASP.NET Apps"
description: "C# .NET API that offers to verify RAR password on decompression, supports XZ compression for ZIP container, support for parallel BZip2 compression via API."
keywords: ""
...
Ability to verify `RAR` password on decompression of the archived files.

# XZ Compression for ZIP Container

Supports `XZ` compression for the `ZIP` container.
