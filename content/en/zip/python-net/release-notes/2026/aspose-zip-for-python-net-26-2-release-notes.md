---
id: "aspose-zip-for-python-net-26-2-release-notes"
slug: "aspose-zip-for-python-net-26-2-release-notes"
linktitle: "Aspose.ZIP for Python via .NET 26.2 Release Notes"
title: "Aspose.ZIP for Python via .NET 26.2 Release Notes"
weight: 15
description: "Aspose.ZIP for Python via .NET 26.2 Release Notes – the latest updates and fixes."
type: "repository"
layout: "release"
hideChildren: false
toc: false
family_listing_page_title: "Aspose.ZIP for Python via .NET 26.2 Release Notes"
menuItemWithNoContent: false
---

{{% alert color="primary" %}}

This page contains release notes information for [Aspose.ZIP for Python via .NET 26.2](https://pypi.org/project/aspose-zip/26.2.0/).
