...
folder_name: "Aspose.SVG for .NET 25.3.0 (DLLs only)"
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.SVG for .NET 25.3.0 (DLLs only)" imagelink="/resources/img/zip-icon.png">}}
