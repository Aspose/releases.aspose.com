...
folder_name: "Aspose.SVG for .NET 24.12.0 (DLLs only)"
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.SVG for .NET 24.12.0 (DLLs only)" imagelink="/resources/img/zip-icon.png">}}
