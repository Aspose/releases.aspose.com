---
title:  "  Downloads ---New-Releases-aspose.gis-for-.net-18.4-(dlls-only) . " 
description:  "    . " 
keywords:  "    . " 
page_type:  single_release_page
folder_link: " gis/net/new-releases/aspose.gis-for-.net-18.4-(dlls-only)/"
folder_name: " Aspose.GIS for .NET 18.4 (DLLs only)"
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt=" Aspose.GIS for .NET 18.4 (DLLs only)" imagelink="/resources/img/zip-icon.png">}}
