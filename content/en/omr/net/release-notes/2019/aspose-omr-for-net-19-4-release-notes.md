---
id: "aspose-omr-for-net-19-4-release-notes"
slug: "aspose-omr-for-net-19-4-release-notes"
linktitle: "Aspose.OMR for .NET 19.4 Release Notes"
title: "Aspose.OMR for .NET 19.4 Release Notes"
weight: 40
description: "Aspose.OMR for .NET 19.4 Release Notes – the latest updates and fixes."
type: "repository"
feedback: "OMRNET"
layout: "release"
hideChildren: false
toc: false
family_listing_page_title: "Aspose.OMR for .NET 19.4 Release Notes"
...
We are pleased to announce the first public release of Aspose.OMR for .NET. It is simple to use API that allows developers to perform OMR operation on images. Aspose.OMR can perform OMR operation on JPEG, PNG, GIF, TIFF, and BMP image files and save the output in CSV format. Please visit the [Product Features page](https://docs.aspose.com/omr/net/features-list/) for further details and get the chance to download the first release of [Aspose.OMR for .NET](https://releases.aspose.com/omr/net). You can also get familiar with the solution by using Aspose.OMR for .NET examples and demo projects at [GitHub](https://github.com/aspose-omr/Aspose.OMR-for-.NET).
## **Features**
