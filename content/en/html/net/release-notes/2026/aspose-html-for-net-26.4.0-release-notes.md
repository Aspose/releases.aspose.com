...
linktitle: "Aspose.HTML for .NET 26.4 Release Notes"
title: "Aspose.HTML for .NET 26.4 Release Notes"
weight: 90
description: "Aspose.HTML for .NET 26.4 Release Notes - the latest updates and fixes."
type: "repository"
layout: "release"
hideChildren: false
toc: false
family_listing_page_title: "Aspose.HTML for .NET 26.4 Release Notes"
menuItemWithNoContent: false
---

{{% alert color="primary" %}}
This page contains release notes information for Aspose.HTML for .NET 26.4.
{{% /alert %}}
...
| ------------ | -------------------------------------------------------------------------------------- | ------------ |
| HTMLNET-6670 | Fixed an ArgumentException that could occur when processing auto values in HTML layout. | Bug |
...
| HTMLNET-6957 | Fixed PDF rendering issues that occurred with complex border and path drawing scenarios. | Bug |
...
| HTMLNET-7033 | Added mapping of HTML alt and label text to the PDF form field's /TU metadata for tooltips and accessible names. | Feature |
