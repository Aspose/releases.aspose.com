...
weight: 40
description: "Aspose.HTML for .NET 26.9 Release Notes - the latest updates and fixes."
type: "repository"
layout: "release"
hideChildren: false
toc: false
...
Aspose.HTML for .NET 26.9.0 is published as part of the September monthly release.
...
- Maintenance build for the September 26.9.0 release of Aspose.HTML for .NET.
