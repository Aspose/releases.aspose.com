...
folder_name: "Aspose.HTML for .NET 24.10 (DLLs only)"
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.HTML for .NET 24.10 (DLLs only)" imagelink="/resources/img/zip-icon.png">}}
