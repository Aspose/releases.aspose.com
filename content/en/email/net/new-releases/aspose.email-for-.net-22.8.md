...
description: "C# .NET API to create appointment in the Office® 365, convert MSG to HTML, preserve TNEF attachments in MBOX to PST & PST to MBOX conversions, supports Danish."
keywords: ""
...
> For a complete list of features, enhancements, and bug fixes in this release please visit, [Aspose.Email for .NET 22.8 Release Notes](https://docs.aspose.com/email/net/aspose-email-for-net-22-8-release-notes/).
