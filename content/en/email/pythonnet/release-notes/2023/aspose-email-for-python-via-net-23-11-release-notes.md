...
This page contains release notes information for Aspose.Email for Python via .NET 23.10.
...
Aspose.Email for Python via .NET staritng version 23.10 has an experimental support of MacOS ARM platform.
