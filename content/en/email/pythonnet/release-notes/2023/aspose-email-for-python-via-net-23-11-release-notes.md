---
id: "aspose-email-for-python-via-net-23-11-release-notes"
slug: "aspose-email-for-python-via-net-23-11-release-notes"
linktitle: "Aspose.Email for Python via .NET 23.11 Release Notes"
title: "Aspose.Email for Python via .NET 23.11 Release Notes"
weight: 30
description: "Aspose.Email for Python via .NET 23.11 Release Notes – the latest updates and fixes."
type: "repository"
layout: "release"
family_listing_page_title: "Aspose.Email for Python via .NET 23.11 Release Notes"
---

{{% alert color="primary" %}}

This page contains release notes information for Aspose.Email for Python via .NET 23.11.

{{% /alert %}}

Aspose.Email for Python via .NET 23.11 is based on [Aspose.Email for .NET 23.11](/email/net/release-notes/2023/aspose-email-for-net-23-11-release-notes/).
...
Aspose.Email for Python via .NET staritng version 23.11 has an experimental support of MacOS ARM platform.
