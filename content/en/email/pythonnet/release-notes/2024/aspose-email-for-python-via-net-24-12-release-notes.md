---
id: "aspose-email-for-python-via-net-24-12-release-notes"
slug: "aspose-email-for-python-via-net-24-12-release-notes"
linktitle: "Aspose.Email for Python via .NET 24.12 Release Notes"
title: "Aspose.Email for Python via .NET 24.12 Release Notes"
weight: 10
description: "Aspose.Email for Python via .NET 24.12 Release Notes – the latest updates and fixes."
type: "repository"
layout: "release"
family_listing_page_title: "Aspose.Email for Python via .NET 24.12 Release Notes"
---

{{% alert color="primary" %}}

This page contains release notes information for Aspose.Email for Python via .NET 24.12.

{{% /alert %}}

Aspose.Email for Python via .NET 24.12 is based on [Aspose.Email for .NET 24.11](/email/net/release-notes/2024/aspose-email-for-net-24-11-release-notes/).
