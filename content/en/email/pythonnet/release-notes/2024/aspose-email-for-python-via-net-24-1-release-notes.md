---
id: "aspose-email-for-python-via-net-24-1-release-notes"
slug: "aspose-email-for-python-via-net-24-1-release-notes"
linktitle: "Aspose.Email for Python via .NET 24.1 Release Notes"
title: "Aspose.Email for Python via .NET 24.1 Release Notes"
weight: 10
description: "Aspose.Email for Python via .NET 24.1 Release Notes – the latest updates and fixes."
type: "repository"
layout: "release"
family_listing_page_title: "Aspose.Email for Python via .NET 24.1 Release Notes"
---

{{% alert color="primary" %}}

This page contains release notes information for Aspose.Email for Python via .NET 24.1.

{{% /alert %}}

Aspose.Email for Python via .NET 24.1 is based on [Aspose.Email for .NET 24.1](/email/net/release-notes/2023/aspose-email-for-net-24-1-release-notes/).
...
Aspose.Email for Python via .NET staritng version 24.1 has an experimental support of MacOS ARM platform.
