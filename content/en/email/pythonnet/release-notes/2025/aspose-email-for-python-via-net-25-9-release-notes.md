---
id: "aspose-email-for-python-via-net-25-9-release-notes"
slug: "aspose-email-for-python-via-net-25-9-release-notes"
linktitle: "Aspose.Email for Python via .NET 25.9 Release Notes"
title: "Aspose.Email for Python via .NET 25.9 Release Notes"
weight: 10
description: "Aspose.Email for Python via .NET 25.9 Release Notes – the latest updates and fixes."
type: "repository"
layout: "release"
family_listing_page_title: "Aspose.Email for Python via .NET 25.9 Release Notes"
---

{{% alert color="primary" %}}

This page contains release notes information for Aspose.Email for Python via .NET 25.9.

{{% /alert %}}

Aspose.Email for Python via .NET 25.9 is based on [Aspose.Email for .NET 25.8](/email/net/release-notes/2025/aspose-email-for-net-25-8-release-notes/).
