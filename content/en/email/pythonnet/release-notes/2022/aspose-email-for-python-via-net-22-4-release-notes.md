---
id: "aspose-email-for-python-via-net-23-4-release-notes"
slug: "aspose-email-for-python-via-net-23-4-release-notes"
linktitle: "Aspose.Email for Python via .NET 22.4 Release Notes"
title: "Aspose.Email for Python via .NET 22.4 Release Notes"
weight: 80
description: "Aspose.Email for Python via .NET 22.4 Release Notes – the latest updates and fixes."
type: "repository"
layout: "release"
family_listing_page_title: "Aspose.Email for Python via .NET 22.4 Release Notes"
---
...
Aspose.Email for Python via .NET 22.4 is based on [Aspose.Email for .NET 22.4](/email/net/release-notes/2022/aspose-email-for-net-22-3-release-notes/).
## **Features not implemented**
The following features are not implemented in Aspose.Email for Python via .NET 22.4 but they are implemented in [Aspose.Email for .NET 22.4](/email/net/release-notes/2022/aspose-email-for-net-22-4-release-notes/):
