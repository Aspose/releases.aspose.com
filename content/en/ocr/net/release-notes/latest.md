...
{{% alert color="primary" %}}
This article contains a summary of recent changes, enhancements and bug fixes in [**Aspose.OCR for .NET 25.5.0 (May 2025)**](https://www.nuget.org/packages/Aspose.OCR/25.5.0) release.
...
This section lists all public API changes introduced in **Aspose.OCR for .NET 25.5.0** that may affect the code of existing applications.
