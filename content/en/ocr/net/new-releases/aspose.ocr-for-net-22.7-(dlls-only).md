...
title: "Downloads ---New Releases-aspose.ocr-for-net-22.7-(dlls-only)"
description: " "
keywords: ""
page_type: single_release_page
folder_link: "/ocr/net/new-releases/aspose.ocr-for-net-22.7-(dlls-only)/"
folder_name: "Aspose.OCR for NET 22.7 (DLLs only)"
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.OCR for NET 22.7 (DLLs only)" imagelink="/resources/img/zip-icon.png">}}
