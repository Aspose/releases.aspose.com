...
{{% alert color="primary" %}}
This article contains a summary of recent changes, enhancements and bug fixes in **Aspose.OCR for Python via C++ 25.2.0 (January 2025)** release.
{{% /alert %}}
...
--- | ------- | --------
OCRCPP&#8209;669 | Performance and stability improvements. | Enhancement
OCRCPP&#8209;669 | Minor fixes. | Fix

## Public API changes and backwards compatibility

This section lists all public API changes introduced in **Aspose.OCR for C++ 25.2.0** that may affect the code of existing applications.
