...
Aspose.OCR for JavaScript via C++ is a standalone OCR API that enhances your JavaScript apps to perform the OCR operation on JPEG, PNG, & BMP images for extraction of English content.
...
Aspose OCR library requires onnxruntime library for javascript-cpp in the environment.

### Evaluation Version Limitation

The evaluation version of Aspose.OCR for JavaScript via C++ limits the number of characters extracted from an image to 300.
