...
title: "Python OCR API 24.3.0 (macOS M1): Broad Language Support"
description: "Upgrade your OCR apps with Aspose.OCR Python .NET 24.3.0! Enjoy 135 supported languages & auto-detect extended Latin. Download on macOS M1 now."
keywords: ""
page_type: single_release_page
folder_link: "/ocr/python-net/new-releases/aspose.ocr-for-python-via-.net-24.3.0-macos-arm/"
folder_name: "Aspose.OCR for Python via .NET 24.3.0 MacOS ARM"
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.OCR for Python via .NET 24.3.0 MacOS ARM" imagelink="/resources/img/random-file-icon.png">}}
  ...
  {{< /Releases/ReleasesFileFeatures >}}
  {{< Releases/ReleasesFileFeatures >}}
      <h4>Description</h4><div class="HTMLDescription">It contains Aspose.OCR for Python via .NET 24.3.0 macOS ARM64/M1 release.</div>
  {{< /Releases/ReleasesFileFeatures >}}
