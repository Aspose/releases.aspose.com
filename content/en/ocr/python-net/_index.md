...
{{< Common/paragraph>}}
A&nbsp;{{< Common/link href="https://products.aspose.com/ocr/python-net/" text="OCR API"  >}}&nbsp; that enhances your Python apps to perform the OCR operation on JPEG, PNG, GIF, BMP & TIFF images for extraction content.{{< Common/h2 text="Python API for OCR"  >}} {{< Common/ul>}}
    {{< Common/li >}} Programmatically detect, identify and read characters from images. {{< /Common/li >}}
   {{< Common/li >}} Supports 27 languages based on Latin, Cyrillic and Asian scrips. {{< /Common/li >}}
   {{< Common/li >}} Detects and recognizes all popular typefaces such as Arial, Times New Roman, Courier New, Tahoma, Calibri and more in regular, bold and italic styles. {{< /Common/li >}}
 {{< /Common/ul>}}

{{< /Common/paragraph>}}
{{< Common/hr >}}
{{< Common/h4 text="Download aspose.ocr from Pip"  >}}
{{< Common/paragraph class="package-instructions">}}
You can easily use  <b>aspose.ocr</b> for Python from  {{< Common/link href="https://pypi.org/project/aspose.ocr/" text="pip"  >}} with the following command.
{{< /Common/paragraph>}}
...
{{< Common/release-notes-link family="ocr" product="python-net" href="" text=""  >}}
{{< /Common/wrapper >}}
{{< /Common/wrapper >}}
