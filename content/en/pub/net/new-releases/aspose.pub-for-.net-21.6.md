...
# .NET framework 5.0 Support

This relase supports the .NET framework 5.0.

# .NET Core and .NET 5 Support

This relase supports the .NET Code as well as the .NET 5.

# Microsoft Publisher&reg; 2000 Support
