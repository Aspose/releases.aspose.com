---
title: Aspose.Imaging 22.10 | Image Processing Java High Code API 
...
Aspose.Imaging Java APIs are hosted at the [Aspose Repository](https://releases.aspose.com/imaging/java/). You can easily use Aspose.BarCode for Java API directly in your Maven projects with simple configurations. For the detailed instructions please visit [Installing Aspose.Imaging for Java from Maven Repository](https://docs.aspose.com/imaging/java/installation/) documentation page.
