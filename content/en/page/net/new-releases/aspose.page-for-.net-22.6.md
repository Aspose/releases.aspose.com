...
intro_text: "It contains Aspose.Page for .NET 22.6 release."
...
<h4>Release Notes</h4><div><a href='https://docs.aspose.com/page/net/aspose-page-for-net-22-6-release-notes/'>https://docs.aspose.com/page/net/aspose-page-for-net-22-6-release-notes/</a></div>
{{< /Releases/ReleasesFileFeatures >}}
{{< Releases/ReleasesFileFeatures >}}
...
# Shading Pattern in DeviceN Colorspace

Applied the shading pattern in DeviceN colorspace with alternative CMYK.

# Convert EPS t TIF with over 96 DPI

Perform `EPS` to `TIF` conversion with over 96 DPI (Dots per inch).

# Ability to Merge XPS

Ability to merge XPS files to XPS Document.

# Convert PS to PDF

Features of PostScript (PS) files to Adobe Acrobat&reg; PDF document conversion.

> For a complete list of features, enhancements, and bug fixes in this release please visit, [Aspose.Page for .NET 22.6 Release Notes](https://docs.aspose.com/page/net/aspose-page-for-net-22-6-release-notes/).
