---
title: "Export DWG to WMF and OBJ to DXF via API for C# ASP.NET Apps"
description: "C# .NET API with improved export feature of DWG to WMF format, optimized file size for OBJ to DXF export, resolved text overlap issue within the exported PDF."
keywords: ""
...
Improved the export feature of DWG to WMF format.

# File Size Optimization for OBJ to DXF Export

Fixed the issue of enormous file size after exporting OBJ to DXF format.

# Improved PDF Export

Resolved the text overlap issue within the exported PDF file.

> For a complete list of features, enhancements, and bug fixes in this release please visit, [Aspose.CAD for .NET 22.5 - Release Notes](https://releases.aspose.com/cad/net/release-notes/2022/aspose-cad-for-net-22-5-release-notes/).
