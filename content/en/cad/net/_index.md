---
title: "Download C# Library to Draw & Render CAD and BIM Files | Aspose.CAD"
description: "Download C# SDK library dll to render, edit, report, & convert AutoCAD®, CAD, BIM to PDF & image formats via API. Select & convert specific layouts, layers."
keywords: "CAD .NET SDK Library, AutoCAD .NET API"
linktitle: "Aspose.CAD for .NET"
family_listing_page_title: "Aspose.CAD for .NET"
family_listing_page_description: "Aspose.CAD for .NET allows developers to convert AutoCAD DWG and DXF and DGN, DWF, DWFx, IFC, IGS, IGES, STL, DWT, FBX, PLT, CF2, CF2, OBJ, 3DS, STP, DXB, U3D and other CAD formats files to PDF, PDF-3D, SVG, WMF and Raster images. It is a native API and does not require AutoCAD or any other software to be installed."
...
{{< Common/h2 text="Download Aspose.CAD SDK 24.12 to Process CAD and BIM Files"  >}}
...
Aspose.CAD for .NET is a standalone class library to enhance ASP.NET & Windows applications to process & render CAD drawings without requiring AutoCAD or any other rendering workflow. The CAD Class Library allows high-quality conversion of Draco, U3D, 3DS, GLTF/GLB, CGM, STEP, DXB, Collada, DWFx, FBX, IFC, OBJ, CF2, DWT, PLT, IGES, DWF, STL, DXF, DWG, SVG files, layouts, and layers to PDF & raster image formats.
...
**Others:** Collada(DAE), DXB, 3DS

### Supported Read & Write CAD Formats

**AutoCAD®:** DXF, DWG, DGN, DWT, DWF, DWFx\
**3D Geometry:** OBJ\
**GL Binary:** GLTF/GLB\
**Scalable Vector Graphics:** SVG\
**Others:** FBX, STEP(STP), U3D

### Save CAD files As

**Fixed Layout:** PDF, PDD-3D\
