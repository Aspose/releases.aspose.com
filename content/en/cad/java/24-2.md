---
title: Aspose.CAD Java 24.2 | CAD and BIM drawings SDK with Process and Convert API for Java
...
# CAD and BIM Files API for Conversion, Export and Editing API for Java
