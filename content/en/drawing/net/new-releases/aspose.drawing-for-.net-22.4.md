---
title: "Add Italic & Bold Font Effects via API for C#, ASP.NET Apps"
description: "C# .NET API with support for the italic and bold font effects in drawings, ability for transparency of GIF files, improved the support for the image codecs."
keywords: ""
...
# Support for Italic & Bold Font Effects

Added support for the italic and bold font effects.

# Support for Transparent GIF

Added support for transparency of GIF files.

# Improved Support for Image Codecs

Improved the support for the image codecs.

> For a complete list of features, enhancements, and bug fixes in this release please visit, [Aspose.Drawing for .NET 22.4 Release Notes](https://releases.aspose.com/drawing/net/release-notes/2022/aspose-drawing-for-net-22-4-release-notes/).
