---
title:  "  Downloads ---New-Releases-aspose.drawing-for-.net-22.4-(dlls-only) . " 
description:  "    . " 
keywords:  "    . " 
page_type:  single_release_page
folder_link: " drawing/net/new-releases/aspose.drawing-for-.net-22.4-(dlls-only)/"
folder_name: " Aspose.Drawing for .NET 22.4 (DLLs only)"
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt=" Aspose.Drawing for .NET 22.4 (DLLs only)" imagelink="/resources/img/zip-icon.png">}}
