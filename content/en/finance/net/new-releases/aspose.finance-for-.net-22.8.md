---
title: "Validate Financial Data File Elements API for C#, .NET Apps"
description: "C# .NET API with improved validation rules for the 'continuation' element, 'exclude' element, and 'footnote' element within the financial data files, e.g. XBRL."
keywords: ""
...
# Continuation Element Validation

Improved the validation rules for the continuation element.

# Exclude Element Validation

Improved the validation rules for the exclude element.

# Footnote Element Validation
