---
id: "aspose-words-for-java-20-6-release-notes"
slug: "aspose-words-for-java-20-6-release-notes"
linktitle: "Aspose.Words for Java 20.6 Release Notes"
title: "Aspose.Words for Java 20.6 Release Notes"
weight: 15
description: "Aspose.Words for Java 20.6 Release Notes – the latest updates and fixes."
type: "repository"
layout: "release"
hideChildren: false
toc: false
family_listing_page_title: "Aspose.Words for Java 20.6 Release Notes"
menuItemWithNoContent: false
---

{{% alert color="primary" %}}

This page contains release notes for [Aspose.Words for Java 20.6](https://releases.aspose.com/words/java/20-6/).
...
The "[Accessing JSON Data](https://docs.aspose.com/words/java/linq-reporting-engine-api/#linqreportingengineapi-accessingjsondata)" section of the engine's documentation was updated to describe the change.
