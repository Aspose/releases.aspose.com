---
id: "aspose-words-for-java-21-3-release-notes"
slug: "aspose-words-for-java-21-3-release-notes"
linktitle: "Aspose.Words for Java 21.3 Release Notes"
title: "Aspose.Words for Java 21.3 Release Notes"
weight: 10
description: "Aspose.Words for Java 21.3 Release Notes – the latest updates and fixes."
type: "repository"
layout: "release"
hideChildren: false
toc: false
family_listing_page_title: "Aspose.Words for Java 21.3 Release Notes"
menuItemWithNoContent: false
---

{{% alert color="primary" %}}

This page contains release notes for [Aspose.Words for Java 21.3](https://releases.aspose.com/words/java/21-3/).
...
| WORDSJAVA-2152 | Document.updateFields throws   java.lang.NullPointerException on MAC OS. | Bug |
| WORDSJAVA-2355 | MHTML to PDF conversion lasts "forever" | Bug |
| WORDSJAVA-2442 | Method property names etc are garbled when debugging | Bug |
| WORDSJAVA-2481 | BitsPerSample is incorrect after conversion from DOCX to TIFF | Bug |
...
The following sections of the engine's documentation were updated accordingly (see ["LINQ Reporting Engine API"](https://docs.aspose.com/words/java/linq-reporting-engine-api/)):
...
The ["Merging Table Cells Dynamically"](https://docs.aspose.com/words/java/merging-table-cells-dynamically/) section of the engine's documentation was updated to describe the change.

### Supported Select and SelectMany extension methods for LINQ Reporting Engine

Related issue: WORDSNET-21425 and WORDSNET-17851

The ["Appendix A. Enumeration Extension Methods"](https://docs.aspose.com/words/java/appendix-a-enumeration-extension-methods/) section of the engine's documentation was updated to describe the change.
