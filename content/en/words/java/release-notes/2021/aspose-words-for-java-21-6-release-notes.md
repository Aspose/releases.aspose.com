---
id: "aspose-words-for-java-21-6-release-notes"
slug: "aspose-words-for-java-21-6-release-notes"
linktitle: "Aspose.Words for Java 21.6 Release Notes"
title: "Aspose.Words for Java 21.6 Release Notes"
weight: 7
description: "Aspose.Words for Java 21.6 Release Notes – the latest updates and fixes."
type: "repository"
layout: "release"
hideChildren: false
toc: false
family_listing_page_title: "Aspose.Words for Java 21.6 Release Notes"
menuItemWithNoContent: false
---

{{% alert color="primary" %}}

This page contains release notes for [Aspose.Words for Java 21.6](https://releases.aspose.com/words/java/21-6/).

{{% /alert %}}

## Major Features

There are 105 improvements and fixes in this regular monthly release. The most notable are:
...
| WORDSJAVA-1871 | Regular check&update of OSGI compatibility. | New Feature |
| WORDSJAVA-2589 | Roman numbering style for lists in .txt documents | New Feature |
...
| WORDSJAVA-2548 | TXT file is autodetected as Markdown and   throws FileCorruptedException while loading | Bug |
| WORDSJAVA-2579 | GetText() returns text plus list marker | Bug |
| WORDSJAVA-2584 | java.lang.ExceptionInInitializerError is thrown when aspose-words.jar is   bundled inside the application JAR file | Bug |
| WORDSJAVA-2590 | Markdown loader processes removed nodes incorrectly | Bug |
| WORDSJAVA-2599 | Some JSON and XML tests are failing | Bug |
