---
id: "aspose-words-for-java-13-8-0-release-notes"
slug: "aspose-words-for-java-13-8-0-release-notes"
...
hideChildren: false
toc: false
family_listing_page_title: "Aspose.Words for Java 13.8.0 Release Notes"
menuItemWithNoContent: false
---

{{% alert color="primary" %}}

This page contains release notes for [Aspose.Words for Java 13.8.0](https://releases.aspose.com/words/java/)
...
|WORDSJAVA-751 |Image options (chroma key) unproperly added for grayscale images. |Regression |
