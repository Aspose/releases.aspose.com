---
id: "aspose-words-for-java-26-9-1-release-notes"
slug: "aspose-words-for-java-26-9-1-release-notes"
...
hideChildren: false
toc: false
family_listing_page_title: "Aspose.Words for Java 26.9.1 Release Notes"
menuItemWithNoContent: false
---

{{% alert color="primary" %}}

This page contains release notes for [Aspose.Words for Java 26.9.1](https://releases.aspose.com/words/java/26-9-1/).
...
- **Optional Dependencies:** Make JOGL and GlueGen dependencies optional.
...
This section lists public API changes that were introduced in Aspose.Words 26.9.1. It includes not only new and obsoleted public methods, but also a description of any changes in the behavior behind the scenes in Aspose.Words which may affect existing code. Any behavior introduced that could be seen as regression and modifies the existing behavior is especially important and is documented here.

### Make JOGL and GlueGen dependencies optional
...
- **Without JOGL/GlueGen:** Core document processing (DOCX, PDF, HTML, PNG, JPEG, WebP, TIFF) works unchanged.
