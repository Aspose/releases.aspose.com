---
id: "aspose-words-for-java-23-2-release-notes"
slug: "aspose-words-for-java-23-2-release-notes"
linktitle: "Aspose.Words for Java 23.2 Release Notes"
title: "Aspose.Words for Java 23.2 Release Notes"
weight: 110
description: "Aspose.Words for Java 23.2 Release Notes – the latest updates and fixes."
type: "repository"
layout: "release"
hideChildren: false
toc: false
family_listing_page_title: "Aspose.Words for Java 23.2 Release Notes"
menuItemWithNoContent: false
---

{{% alert color="primary" %}}

This page contains release notes for [Aspose.Words for Java 23.2](https://releases.aspose.com/words/java/23-2/).
...
| :- | :- | :- |
|WORDSJAVA-2819|Utilizing comboboxes leads to unpredictible results|Bug|
|WORDSJAVA-2751|Tiff image is rendered as black rectangle in PDF.|Bug|
|WORDSJAVA-2809|DOCX to PDF: Images not rendered correctly|Bug|
|WORDSJAVA-2817|Problem with rendering with UseGdiRopRasterizer option|Bug|
|WORDSJAVA-2493|Steps to Run and Configure Aspose.Words in Python|Bug|
|WORDSJAVA-2797|LayoutCollector and NodeCollection objects does not count pages properly|Bug|
|WORDSJAVA-2822|Checking the compatibility of Python examples with Python 3|New Feature|
