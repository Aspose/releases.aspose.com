---
id: "aspose-words-for-java-22-11-release-notes"
slug: "aspose-words-for-java-22-11-release-notes"
linktitle: "Aspose.Words for Java 22.11 Release Notes"
title: "Aspose.Words for Java 22.11 Release Notes"
weight: 20
description: "Aspose.Words for Java 22.11 Release Notes – the latest updates and fixes."
type: "repository"
layout: "release"
hideChildren: false
toc: false
family_listing_page_title: "Aspose.Words for Java 22.11 Release Notes"
menuItemWithNoContent: false
---

{{% alert color="primary" %}}

This page contains release notes for [Aspose.Words for Java 22.11](https://releases.aspose.com/words/java/22-11/).
...
| :- | :- | :- |
|WORDSJAVA-1768|Create JavaDoc for Ref class|New Feature
|WORDSJAVA-2787|Update Bouncy Castle library|New Feature
|WORDSJAVA-2759|Update API references for Java (markdown Hugo based)|New Feature
