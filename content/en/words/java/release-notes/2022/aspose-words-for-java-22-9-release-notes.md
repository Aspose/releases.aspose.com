---
id: "aspose-words-for-java-22-9-release-notes"
slug: "aspose-words-for-java-22-9-release-notes"
linktitle: "Aspose.Words for Java 22.9 Release Notes"
title: "Aspose.Words for Java 22.9 Release Notes"
weight: 40
description: "Aspose.Words for Java 22.9 Release Notes – the latest updates and fixes."
type: "repository"
layout: "release"
hideChildren: false
toc: false
family_listing_page_title: "Aspose.Words for Java 22.9 Release Notes"
menuItemWithNoContent: false
---

{{% alert color="primary" %}}

This page contains release notes for [Aspose.Words for Java 22.9](https://releases.aspose.com/words/java/22-9/).
...
| :- | :- | :- |
|WORDSJAVA-2496|Pom refactory so a user can load only needed or specific artifacts|New Feature
|WORDSJAVA-2461|Using JDK6 classifier in pom.xml adds JDK6 and JDK7|Bug
|WORDSJAVA-2537|Unable to integrate Aspose.Words for Java from Maven Repo with Sonatype Nexus|Bug
|WORDSJAVA-2469|DOCX to PDF conversion issue with Noto fonts|Bug
|WORDSJAVA-2654|Non-working optimization of EMR_GRADIENTFILL record with GRADIENT_FILL_TRIANGLE mode|Bug
|WORDSJAVA-2680|FontSettings.saveSearchCache must accept OutputStream as a paramenter|Bug
|WORDSJAVA-2595|ReportingEngine.buildReport throws java.lang.IllegalStateException |Bug
|WORDSJAVA-2767|Not able to render date in hebrew|Bug
|WORDSJAVA-2761|NullPointerException when creating XmlDataSource|Bug
|WORDSJAVA-1895|IBM Domino java.security.AccessControlException|Bug
