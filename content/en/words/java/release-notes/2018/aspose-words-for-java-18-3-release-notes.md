---
id: "aspose-words-for-java-18-3-release-notes"
slug: "aspose-words-for-java-18-3-release-notes"
...
hideChildren: false
toc: false
family_listing_page_title: "Aspose.Words for Java 18.3 Release Notes"
menuItemWithNoContent: false
---

{{% alert color="primary" %}}

This page contains release notes for [Aspose.Words for Java 18.3](https://releases.aspose.com/words/java/18-3/).
...
The "[Using Charts to Represent Sequential Data](https://docs.aspose.com/words/java/using-charts-to-represent-sequential-data/)" section and its subsections in the engine's documentation were updated to describe the change.
