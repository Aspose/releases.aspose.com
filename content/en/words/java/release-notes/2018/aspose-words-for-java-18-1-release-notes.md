---
id: "aspose-words-for-java-18-1-release-notes"
slug: "aspose-words-for-java-18-1-release-notes"
linktitle: "Aspose.Words for Java 18.1 Release Notes"
title: "Aspose.Words for Java 18.1 Release Notes"
weight: 120
description: "Aspose.Words for Java 18.1 Release Notes – the latest updates and fixes."
type: "repository"
layout: "release"
hideChildren: false
toc: false
family_listing_page_title: "Aspose.Words for Java 18.1 Release Notes"
menuItemWithNoContent: false
---

{{% alert color="primary" %}}

This page contains release notes for [Aspose.Words for Java 18.1](https://releases.aspose.com/words/java/18-1/)
...
The "[Working with Table-Row Data Bands](https://docs.aspose.com/words/java/working-with-table-row-data-bands/)" and "[Working with Table-Row Conditional Blocks](https://docs.aspose.com/words/java/working-with-table-row-conditional-blocks/)" sections of the engine's documentation were updated to describe the change.
