...
| :- | :- | :- |
|WORDSJAVA-3077|Fix LowCode OutputStream in Public API|New Feature
|WORDSJAVA-3056|IllegalStateException upon rendering document after comparing|Bug
|WORDSJAVA-3057|Incorrect EMF to PNG conversion|Bug
|WORDSJAVA-3037|HarfBuzz compatibility with RHEL8|Bug
|WORDSJAVA-3017|FileCorruptedException is thrown upon loading EPUB document|Bug
