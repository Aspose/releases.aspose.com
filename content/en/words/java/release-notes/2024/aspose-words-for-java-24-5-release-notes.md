...
| :- | :- | :- |
|WORDSJAVA-2945|Update PNGEncoder|New Feature
|WORDSJAVA-2729|Convert to PDF in IBM JDK|Bug
|WORDSJAVA-2833|java.lang.NullPointerException calling MailMerge.executeWithRegions|Bug
|WORDSJAVA-2754|GIF added to DOCX using Words is converted to PNG which triggers a virus detection in ClamAV|Bug
|WORDSJAVA-2610|Performance degradation in export PDF, in docx with customXml|Bug
|WORDSJAVA-2933|Document.UpdateFields() throws NullPointerException|Bug
