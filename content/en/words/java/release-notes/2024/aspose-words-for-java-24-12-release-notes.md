...
| :- | :- | :- |
|WORDSJAVA-3011|Providing third party component list with each java release Feature
|WORDSJAVA-3004|Conversion docx to pdf italic style is not applied to formula|Bug
|WORDSJAVA-2992|ClassCastException is thrown upon rendering document|Bug
|WORDSJAVA-3005|Small floating-point numbers are treated as zero|Bug
