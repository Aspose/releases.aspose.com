...
| :- | :- | :- |
|WORDSJAVA-2746|Hyperlink is corrupted when saving to PDF with encryption|Bug
|WORDSJAVA-2993|Hyperlinks are broken when generating password-protected PDF files|Bug
|WORDSJAVA-2828|Content Control in header shows incorrect value|Bug
|WORDSJAVA-2811|Images is lost after rendering the document|Bug
|WORDSJAVA-2988|SDT value is lost after rendering|Bug
