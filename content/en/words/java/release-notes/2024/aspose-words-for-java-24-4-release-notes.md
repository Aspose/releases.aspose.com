...
| :- | :- | :- |
|WORDSJAVA-2739|Wrong Sections count in Docx document after inserting nested SDTs from external Xml file.|Bug
|WORDSJAVA-2747|Performance degradation on Linux|Bug
|WORDSJAVA-2877|Aspose.Words throws an exception while converting document to PDF on IBM i (AS/400) |Bug
|WORDSJAVA-2932|Exception is thrown upon setting license with IBM Java|Bug
|WORDSJAVA-2935|Exception is thrown upon saving document to PDF with IBM Java|Bug
|WORDSJAVA-2936|WebP images are lost after conversion to PDF|Bug
|WORDSJAVA-2938|IllegalArgumentException is thrown upon inserting image from BufferedImage|Bug
|WORDSJAVA-2939|Implement WebP image format rendering|New Feature
|WORDSJAVA-2942|Create new jar for IBM VM|New Feature
