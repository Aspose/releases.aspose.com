...
| :- | :- | :- |
|WORDSJAVA-2959|Create new IBM jar for jdk16|New Feature
|WORDSJAVA-2966|Implement VariationAxisCoordinate for Harfbuzz plugin|New Feature
|WORDSJAVA-2909|Document comparison results is marking content as deleted|Bug
|WORDSJAVA-2955|IllegalArgumentException is thrown upon building report|Bug
|WORDSJAVA-2956|StackOverflowError is thrown upon saving document to PNG after saving to FixedHtml|Bug
|WORDSJAVA-2957|Exception in Harfbuzz plugin under Linux|Bug
