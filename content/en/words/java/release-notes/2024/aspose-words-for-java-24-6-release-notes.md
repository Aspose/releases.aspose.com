...
| :- | :- | :- |
|WORDSJAVA-2908|Check and Update OSGI compatibility|New Feature
|WORDSJAVA-2820|DataTableCollection does not have remove method|Bug
|WORDSJAVA-2660|Javadoc errors in Eclipse|Bug
|WORDSJAVA-2583|Shape with non-solid DML texture brushes issue while converting docx to pdf in aspose.words java|Bug
