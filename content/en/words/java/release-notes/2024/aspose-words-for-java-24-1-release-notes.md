...
| :- | :- | :- |
|WORDSJAVA-2634|Shape Fill pattern: WIDE_UPWARD_DIAGONAL parsed instead of UPWARD_DIAGONAL|Bug
|WORDSJAVA-2808|CentOS Linux 7 compatibility issue (UnsatisfiedLinkError)|Bug
|WORDSJAVA-2910|Incorrect behavior of regular expression while searching a sentence ending by a dot|Bug
