---
title: Aspose.Words 22.3 | PDF 2.0 Compliance | Java API
description: Java library to create edit view and convert Word documents. Aspose.Words 22.4 support PDF 2.0 Conversion, improvement in TOC style and much more.
layout: package
...
##  What's New in Aspose.Words for Java API 22.3
...
Please see [Release Notes of Aspose.Words for Java 22.3](https://docs.aspose.com/words/java/aspose-words-for-java-22-3-release-notes/) for full details.
...
## API Example Code
### **How to Convert Word Document to PDF 2.0 Compliance using Java**
```Java
...
public class AsposeDocs2PDF20CompliantConverter {
