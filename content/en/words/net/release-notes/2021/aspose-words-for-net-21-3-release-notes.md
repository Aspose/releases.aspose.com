---
id: "aspose-words-for-net-21-3-release-notes"
slug: "aspose-words-for-net-21-3-release-notes"
...
hideChildren: false
toc: false
family_listing_page_title: "Aspose.Words for .NET 21.3 Release Notes"
...
The following sections of the engine's documentation were updated accordingly (see ["LINQ Reporting Engine API"](https://docs.aspose.com/words/net/linq-reporting-engine-api/)):
...
The ["Merging Table Cells Dynamically"](https://docs.aspose.com/words/net/merging-table-cells-dynamically/) section of the engine's documentation was updated to describe the change.

### Supported Select and SelectMany extension methods for LINQ Reporting Engine

Related issue: WORDSNET-21425 and WORDSNET-17851

The ["Appendix A. Enumeration Extension Methods"](https://docs.aspose.com/words/net/appendix-a-enumeration-extension-methods/) section of the engine's documentation was updated to describe the change.
