---
id: "aspose-words-for-net-17-3-0-release-notes"
slug: "aspose-words-for-net-17-3-0-release-notes"
linktitle: "Aspose.Words for .NET 17.3.0 Release Notes"
title: "Aspose.Words for .NET 17.3.0 Release Notes"
weight: 100
description: "Aspose.Words for .NET 17.3.0 Release Notes – the latest updates and fixes."
type: "repository"
layout: "release"
hideChildren: false
toc: false
family_listing_page_title: "Aspose.Words for .NET 17.3.0 Release Notes"
...
|WORDSNET-12412|Add MailMergeCleanupOptions option to remove empty row|[Feature](https://docs.aspose.com/words/net/clean-up-before-or-during-mail-merge/)|
...
- [Working with DataRow and DataRowView Objects](https://docs.aspose.com/words/net/template-syntax/#templatesyntax-workingwithdatarowanddatarowviewobjects)
- [Inserting Images Dynamically](https://docs.aspose.com/words/net/template-syntax/#templatesyntax-insertingimagesdynamically)
- [Setting Text Background Color Dynamically](https://docs.aspose.com/words/net/template-syntax/#templatesyntax-settingtextbackgroundcolordynamically)
- [Using Variables](https://docs.aspose.com/words/net/template-syntax/#templatesyntax-usingvariables)
- [In-Table List Template with Running (Progressive) Total](https://docs.aspose.com/words/net/typical-templates/#typicaltemplates-in-tablelisttemplatewithrunning-progressive-total)
