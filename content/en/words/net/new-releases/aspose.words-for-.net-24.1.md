---
title: "C# API to Edit TextBox Content & Manage Bibliography Sources"
description: "Modify TextBox OLE object text, work with bibliography sources & secure reporting engine, and set stroke colors. Download the new .NET API release today!"
keywords: ""
...
intro_text: "It includes the MSI installer for Aspose.Words for .NET version 24.1."
...
{{< Releases/ReleasesWapper >}}
  ...
  {{< /Releases/ReleasesFileFeatures >}}
  {{< Releases/ReleasesFileFeatures >}}
      <h4>Description</h4><div class="HTMLDescription">It includes the MSI installer for Aspose.Words for .NET version 24.1.</div>
  {{< /Releases/ReleasesFileFeatures >}}
