...
title: "Aspose.Words .NET 24.2: SVG Export, Chart Types (DLLs only)"
description: "Discover powerful new features in Aspose.Words for .NET 24.2. Better SVG rendering, new chart types in reports & improved footnote handling. Download DLLs!"
keywords: ""
page_type: single_release_page
folder_link: "/words/net/new-releases/aspose.words-for-.net-24.2-(dlls-only)/"
folder_name: "Aspose.Words for .NET 24.2 (DLLs only)"
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.Words for .NET 24.2 (DLLs only)" imagelink="/resources/img/zip-icon.png">}}
  {{< Releases/ReleasesButtons >}}
    {{< Releases/ReleasesSingleButtons text="Download" link="/words/net/new-releases/aspose.words-for-.net-24.2-(dlls-only)/c040a87447c3357ce502fb62fbb6da99-19-10298" >}}
