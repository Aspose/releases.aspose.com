---
title: "Control Track Changes, DrawingML Charts | Download C# DLLs"
description: "API to control document revision (Track Changes), customize DrawingML chart legend font formatting, control data presentation in XLSX export. Download C# DLLs!"
keywords: ""
page_type: single_release_page
folder_link: "/words/net/new-releases/aspose.words-for-.net-23.11-(dlls-only)/"
folder_name: "Aspose.Words for .NET 23.11 (DLLs only)"
...
{{< Releases/ReleasesHeading H2txt="Aspose.Words for .NET 23.11 (DLLs only)" imagelink="/resources/img/zip-icon.png">}}
