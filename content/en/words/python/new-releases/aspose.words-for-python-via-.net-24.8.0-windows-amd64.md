...
title: "Manage Fonts, Charts & More: Python Words API 24.8.0 Win64"
description: "Discover chart customization, manage fonts & more in Aspose.Words for Python .NET 24.8.0 (Windows AMD64). Download the update & improve your apps."
keywords: ""
page_type: single_release_page
folder_link: "/words/python/new-releases/aspose.words-for-python-via-.net-24.8.0-windows-amd64/"
folder_name: "Aspose.Words for Python via .NET 24.8.0 Windows AMD64"
download_link: "/words/python/new-releases/aspose.words-for-python-via-.net-24.8.0-windows-amd64/ab254ec38c449a6bffc96a60bf1ed6cc-13-11546"
download_text: "Download"
intro_text: "This wheel contains Aspose.Words for Python via .NET version 24.8.0, built for Windows and targeting the AMD64 architecture."
image_link: "/resources/img/random-file-icon.png"
download_count: " 6/9/2024 Downloads: 1  Views: 1 "
file_size: "File Size: 62.68MB"
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.Words for Python via .NET 24.8.0 Windows AMD64" imagelink="/resources/img/random-file-icon.png">}}
  {{< Releases/ReleasesButtons >}}
    {{< Releases/ReleasesSingleButtons text="Download" link="/words/python/new-releases/aspose.words-for-python-via-.net-24.8.0-windows-amd64/ab254ec38c449a6bffc96a60bf1ed6cc-13-11546" >}}
  ...
  {{< Releases/ReleasesFileArea >}}
    ...
    {{< Releases/ReleasesDetailsUl >}}
      ...
      {{< Common/li class="downloadcount" id="dwn-update-ab254ec38c449a6bffc96a60bf1ed6cc-13-11546" >}} 1 {{< /Common/li >}}
      {{< Common/li >}} File Size: {{< /Common/li >}}
      {{< Common/li id="size-update-ab254ec38c449a6bffc96a60bf1ed6cc-13-11546" >}} 62.68MB {{< /Common/li >}}

      {{< Common/li >}} Date Added: {{< /Common/li >}}
      {{< Common/li id="added-update-ab254ec38c449a6bffc96a60bf1ed6cc-13-11546" >}}6/9/2024 {{< /Common/li >}}
    {{< /Releases/ReleasesDetailsUl >}}
  ...
  {{< /Releases/ReleasesFileFeatures >}}
  {{< Releases/ReleasesFileFeatures >}}
      <h4>Description</h4><div class="HTMLDescription">This wheel contains Aspose.Words for Python via .NET version 24.8.0, built for Windows and targeting the AMD64 architecture.</div>
  {{< /Releases/ReleasesFileFeatures >}}
...
Aspose.Words for Python via .NET 24.8.0 is now available for Windows AMD64. This release brings significant features, API updates, and bug fixes to enhance your Word document management experience on the Windows platforms.

### Chart Customization
You can achieve precise control over chart axis tick labels with new orientation and rotation settings in this release of the Python Word API release, and make chart presentations more flexible and visually appealing.
...
### Font Management
The new `EmbeddingLicensingRights` property in `FontInfo` and `PhysicalFontInfo` classes in the latest version gives you more control over font embedding permissions so that you can manage fonts with ease.
...
### Document Structure
Easily clear section headers and footers without affecting watermarks, to streamline document structure management on Win64 systems.
...
We have improved backward compatibility for exporting HTML and XAML documents in Aspose.Words for Python via .NET 24.8.0, which addresses issues with backslashes and yen sign conversions.
...
### PDF Functionality
The latest release offers enhanced PDF export options, such as using `StructuredDocumentTag` (SDT) tags as form field names, for better form handling.
...
### Digital Signatures
Aspose.Words for Python via .NET now supports the digital signing of XPS documents via `XpsSaveOptions` on Windows AMD64 and adds an extra layer of document security.
...
### Bug Fixes
- Resolved an issue with inconsistent font embedding rights during document conversion.
- Fixed a bug related to incorrect chart axis labels in exported PDFs.
- Addressed a problem where HTML export failed to replace backslashes with yen signs.
