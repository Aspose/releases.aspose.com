...
title: "Python Word Docs API 23.12: Page Layout, WebP (Windows 32)"
description: "Leverage page layout control in PDF export, WebP image support & more with Aspose.Words for Python via .NET 23.12 version. Download on Windows x32."
keywords: ""
page_type: single_release_page
folder_link: "/words/python/new-releases/aspose.words-for-python-via-.net-23.12.0-windows-x32/"
folder_name: "Aspose.Words for Python via .NET 23.12.0 Windows x32"
...
intro_text: "It contains Aspose.Words for Python via .NET 23.12.0, Windows x32 release."
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.Words for Python via .NET 23.12.0 Windows x32" imagelink="/resources/img/random-file-icon.png">}}
  ...
  {{< /Releases/ReleasesFileFeatures >}}
  {{< Releases/ReleasesFileFeatures >}}
      <h4>Description</h4><div class="HTMLDescription">It contains Aspose.Words for Python via .NET 23.12.0, Windows x32 release.</div>
  {{< /Releases/ReleasesFileFeatures >}}
