---
title: "Python Apps API 24.1: Textbox, Strokes, Export (macOS x64)"
description: "Enhance textbox control, manage stroke colors, customize list labels, work with bibliography sources, export underline to Markdown. macOS Python code examples."
keywords: ""
page_type: single_release_page
folder_link: "/words/python/new-releases/aspose.words-for-python-via-.net-24.1.0-macos-10.14-(mojave)-x86_64-(intel-64-bit)/"
folder_name: "Aspose.Words for Python via .NET 24.1.0 macOS 10.14 (Mojave) x86_64 (Intel 64-bit)"
...
intro_text: "It contains Aspose.Words for Python via .NET 24.1.0, macOS 10.14 (Mojave) x86_64 (Intel 64-bit) release."
...
{{< Releases/ReleasesHeading H2txt="Aspose.Words for Python via .NET 24.1.0 macOS 10.14 (Mojave) x86_64 (Intel 64-bit)" imagelink="/resources/img/random-file-icon.png">}}
...
{{< /Releases/ReleasesFileFeatures >}}
{{< Releases/ReleasesFileFeatures >}}
<h4>Description</h4><div class="HTMLDescription">It contains Aspose.Words for Python via .NET 24.1.0, macOS 10.14 (Mojave) x86_64 (Intel 64-bit) release.</div>
{{< /Releases/ReleasesFileFeatures >}}
