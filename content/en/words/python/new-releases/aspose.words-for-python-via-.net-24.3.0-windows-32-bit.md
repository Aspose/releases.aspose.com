...
title: "TIFF Compression, WMF Files: Python API 24.3 (Windows x32)"
description: "Enhance your apps with a revamped TIFF reader/writer, chart controls & WMF metafile emulation. Download Aspose.Words Python .NET 24.3 on Windows x32."
keywords: ""
page_type: single_release_page
folder_link: "/words/python/new-releases/aspose.words-for-python-via-.net-24.3.0-windows-32-bit/"
folder_name: "Aspose.Words for Python via .NET 24.3.0 Windows 32-bit"
...
intro_text: "This wheel contains Aspose.Words for Python via .NET version 24.3.0, built for Windows and targeting the 32-bit architecture."
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.Words for Python via .NET 24.3.0 Windows 32-bit" imagelink="/resources/img/random-file-icon.png">}}
  ...
  {{< /Releases/ReleasesFileFeatures >}}
  {{< Releases/ReleasesFileFeatures >}}
      <h4>Description</h4><div class="HTMLDescription">This page contains Aspose.Words for Python via .NET version 24.3.0, built for Windows and targeting the 32-bit architecture.</div>
  {{< /Releases/ReleasesFileFeatures >}}
