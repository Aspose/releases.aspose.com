...
title: "Python Word Docs API 23.12: Page Layout, WebP (macOS M1)"
description: "Leverage page layout control in PDF export & WebP image support. Download Aspose.Words for Python via .NET 23.12 on macOS M1. Python code examples."
keywords: ""
...
intro_text: "It contains Aspose.Words for Python via .NET 23.12.0, macOS 11.0 (Big Sur) ARM64 M1 release."
...
{{< Releases/ReleasesWapper >}}
  ...
  {{< /Releases/ReleasesFileFeatures >}}
  {{< Releases/ReleasesFileFeatures >}}
      <h4>Description</h4><div class="HTMLDescription">It contains Aspose.Words for Python via .NET 23.12.0, macOS 11.0 (Big Sur) ARM64 M1 release.</div>
  {{< /Releases/ReleasesFileFeatures >}}
