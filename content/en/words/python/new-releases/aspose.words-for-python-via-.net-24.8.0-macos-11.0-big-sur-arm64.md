...
title: "Customize Charts, Fonts | Python Words API 24.8.0 macOS M1"
description: "Download Aspose.Words for Python .NET 24.8.0 on macOS ARM64. Explore font management, chart customization & more for seamless document processing."
keywords: ""
page_type: single_release_page
folder_link: "/words/python/new-releases/aspose.words-for-python-via-.net-24.8.0-macos-11.0-big-sur-arm64/"
folder_name: "Aspose.Words for Python via .NET 24.8.0 macOS 11.0 Big Sur ARM64"
download_link: "/words/python/new-releases/aspose.words-for-python-via-.net-24.8.0-macos-11.0-big-sur-arm64/197a06ea244c420925d730b665998eaa-13-11544"
download_text: "Download"
intro_text: "This wheel contains Aspose.Words for Python via .NET version 24.8.0, built for macOS 11.0 (Big Sur) and targeting the ARM64 architecture."
image_link: "/resources/img/random-file-icon.png"
download_count: " 6/9/2024 Downloads: 1  Views: 1 "
file_size: "File Size: 62.88MB"
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.Words for Python via .NET 24.8.0 macOS 11.0 Big Sur ARM64" imagelink="/resources/img/random-file-icon.png">}}
  {{< Releases/ReleasesButtons >}}
    {{< Releases/ReleasesSingleButtons text="Download" link="/words/python/new-releases/aspose.words-for-python-via-.net-24.8.0-macos-11.0-big-sur-arm64/197a06ea244c420925d730b665998eaa-13-11544" >}}
  ...
  {{< Releases/ReleasesFileArea >}}
    ...
    {{< Releases/ReleasesDetailsUl >}}
      ...
      {{< Common/li class="downloadcount" id="dwn-update-197a06ea244c420925d730b665998eaa-13-11544" >}} 1 {{< /Common/li >}}
      {{< Common/li >}} File Size: {{< /Common/li >}}
      {{< Common/li id="size-update-197a06ea244c420925d730b665998eaa-13-11544" >}} 62.88MB {{< /Common/li >}}

      {{< Common/li >}} Date Added: {{< /Common/li >}}
      {{< Common/li id="added-update-197a06ea244c420925d730b665998eaa-13-11544" >}}6/9/2024 {{< /Common/li >}}
    {{< /Releases/ReleasesDetailsUl >}}
  ...
  {{< /Releases/ReleasesFileFeatures >}}
  {{< Releases/ReleasesFileFeatures >}}
      <h4>Description</h4><div class="HTMLDescription">This wheel contains Aspose.Words for Python via .NET version 24.8.0, built for macOS 11.0 (Big Sur) and targeting the ARM64 architecture.</div>
  {{< /Releases/ReleasesFileFeatures >}}
...
### Font Information Expansion
The newly added `EmbeddingLicensingRights` property in font classes offers enhanced control over font embedding on macOS M1 systems.
...
Level up your Python applications with the ability to digitally sign XPS documents via `XpsSaveOptions` using the latest Python library version.
