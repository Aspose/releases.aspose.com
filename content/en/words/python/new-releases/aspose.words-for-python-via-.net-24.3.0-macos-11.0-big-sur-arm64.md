...
title: "TIFF Compression, WMF Files in Python API 24.3 (macOS M1)"
description: "Enhance your apps with a revamped TIFF reader/writer, chart controls, WMF metafile emulation with Aspose.Words Python .NET 24.3. Download on macOS M1."
keywords: ""
...
intro_text: "This wheel contains Aspose.Words for Python via .NET version 24.3.0, built for macOS 11.0 (Big Sur) and targeting the ARM64 architecture."
...
{{< Releases/ReleasesWapper >}}
  ...
  {{< /Releases/ReleasesFileFeatures >}}
  {{< Releases/ReleasesFileFeatures >}}
      <h4>Description</h4><div class="HTMLDescription">This page contains Aspose.Words for Python via .NET version 24.3.0, built for macOS 11.0 (Big Sur) and targeting the ARM64 architecture.</div>
  {{< /Releases/ReleasesFileFeatures >}}
