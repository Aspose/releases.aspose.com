...
title: "MD Files, Charts, Export to SVG: Python API 24.2 (macOS M1)"
description: "Add MD import, SVG rendering, Chart API & style improvements to your apps with Aspose.Words Python via .NET 24.2 on macOS M1. Python code samples."
keywords: ""
page_type: single_release_page
folder_link: "/words/python/new-releases/aspose.words-for-python-via-.net-24.2.0-macos-11.0-big-sur-arm64/"
folder_name: "Aspose.Words for Python via .NET 24.2.0 macOS 11.0 Big Sur ARM64"
...
intro_text: "This wheel contains Aspose.Words for Python via .NET version 24.2.0, built for macOS 11.0 (Big Sur) and targeting the ARM64 architecture."
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.Words for Python via .NET 24.2.0 macOS 11.0 Big Sur ARM64" imagelink="/resources/img/random-file-icon.png">}}
  ...
  {{< /Releases/ReleasesFileFeatures >}}
  {{< Releases/ReleasesFileFeatures >}}
      <h4>Description</h4><div class="HTMLDescription">This page contains Aspose.Words for Python via .NET version 24.2.0, built for macOS 11.0 (Big Sur) and targeting the ARM64 architecture.</div>
  {{< /Releases/ReleasesFileFeatures >}}
