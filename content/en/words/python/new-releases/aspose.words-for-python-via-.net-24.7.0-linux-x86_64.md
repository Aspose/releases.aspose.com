...
title: "Python Words API 24.7.0 (Linux): ActiveX Controls & Lists"
description: "Unleash new functionalities like improved XLSX export, accessible PDFs & ActiveX controls with Aspose.Words Python via .NET 24.7.0. Download now on Linux!"
keywords: ""
page_type: single_release_page
folder_link: "/words/python/new-releases/aspose.words-for-python-via-.net-24.7.0-linux-x86_64/"
folder_name: "Aspose.Words for Python via .NET 24.7.0 Linux x86_64"
...
intro_text: "This wheel contains Aspose.Words for Python via .NET version 24.7.0, built for Linux and targeting the x86_64 architecture."
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.Words for Python via .NET 24.7.0 Linux x86_64" imagelink="/resources/img/random-file-icon.png">}}
  ...
  {{< /Releases/ReleasesFileFeatures >}}
  {{< Releases/ReleasesFileFeatures >}}
      <h4>Description</h4><div class="HTMLDescription">This wheel contains Aspose.Words for Python via .NET version 24.7.0, built for Linux and targeting the x86_64 architecture.</div>
  {{< /Releases/ReleasesFileFeatures >}}
