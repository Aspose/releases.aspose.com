...
title: "TIFF Compression, WMF Files: Python API 24.3 (Windows x64)"
description: "Enhance your apps with a revamped TIFF reader/writer, chart controls & WMF metafile emulation. Download Aspose.Words Python .NET 24.3 on Windows x64."
keywords: ""
page_type: single_release_page
folder_link: "/words/python/new-releases/aspose.words-for-python-via-.net-24.3.0-windows-amd64/"
folder_name: "Aspose.Words for Python via .NET 24.3.0 Windows AMD64"
...
intro_text: "This wheel contains Aspose.Words for Python via .NET version 24.3.0, built for Windows and targeting the AMD64 architecture."
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.Words for Python via .NET 24.3.0 Windows AMD64" imagelink="/resources/img/random-file-icon.png">}}
  {{< Releases/ReleasesButtons >}}
    {{< Releases/ReleasesSingleButtons text="Download" link="/words/python/new-releases/aspose.words-for-python-via-.net-24.3.0-windows-amd64/4561c01d8ef4a938e2e59e86711e8f62-12-10452" >}}
  ...
  {{< /Releases/ReleasesFileFeatures >}}
  {{< Releases/ReleasesFileFeatures >}}
      <h4>Description</h4><div class="HTMLDescription">This page contains Aspose.Words for Python via .NET version 24.3.0, built for Windows and targeting the AMD64 architecture.</div>
  {{< /Releases/ReleasesFileFeatures >}}
