...
title: "Python Word Docs API 23.12: Page Layout, Add WebP (Linux)"
description: "Leverage page layout control in PDF export, WebP image support & more. Download Aspose.Words for Python via .NET 23.12 on Linux. Python code examples."
keywords: ""
...
intro_text: "It contains Aspose.Words for Python via .NET 23.12.0, Linux x86, x64 release."
...
{{< Releases/ReleasesWapper >}}
  ...
  {{< /Releases/ReleasesFileFeatures >}}
  {{< Releases/ReleasesFileFeatures >}}
      <h4>Description</h4><div class="HTMLDescription">It contains Aspose.Words for Python via .NET 23.12.0, Linux x86, x64 release.</div>
  {{< /Releases/ReleasesFileFeatures >}}
