...
title: "MD Files, Charts, Export to SVG: Python API 24.2 (macOS x64)"
description: "Add MD import, SVG rendering, Chart API & style improvements to your apps with Aspose.Words Python via .NET 24.2 on macOS x64. Python code samples."
keywords: ""
page_type: single_release_page
folder_link: "/words/python/new-releases/aspose.words-for-python-via-.net-24.2.0-macos-10.14-mojave-x86_64/"
folder_name: "Aspose.Words for Python via .NET 24.2.0 macOS 10.14 Mojave x86_64"
...
intro_text: "This wheel contains Aspose.Words for Python via .NET version 24.2.0, built for macOS 10.14 (Mojave) and targeting the x86_64 architecture."
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.Words for Python via .NET 24.2.0 macOS 10.14 Mojave x86_64" imagelink="/resources/img/random-file-icon.png">}}
  ...
  {{< /Releases/ReleasesFileFeatures >}}
  {{< Releases/ReleasesFileFeatures >}}
      <h4>Description</h4><div class="HTMLDescription">This page contains Aspose.Words for Python via .NET version 24.2.0, built for macOS 10.14 (Mojave) and targeting the x86_64 architecture.</div>
  {{< /Releases/ReleasesFileFeatures >}}
