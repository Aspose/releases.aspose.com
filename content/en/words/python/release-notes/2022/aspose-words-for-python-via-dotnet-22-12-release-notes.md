---
id: "net/aspose-words-for-python-via-dotnet-22-12-release-notes"
slug: "net/aspose-words-for-python-via-dotnet-22-12-release-notes"
linktitle: "Aspose.Words for Python via .NET 22.12 Release Notes"
title: "Aspose.Words for Python via .NET 22.12 Release Notes"
weight: 15
description: "Aspose.Words for Python via .NET 22.12 Release Notes – the latest updates and fixes."
type: "repository"
layout: "release"
hideChildren: false
toc: false
family_listing_page_title: "Aspose.Words for Python via .NET 22.12 Release Notes"
menuItemWithNoContent: false
---

{{% alert color="primary" %}}

This page contains release notes for [Aspose.Words for Python via .NET 22.12](https://www.nuget.org/packages/Aspose.Words/22.12.0).
