---
id: "net/aspose-words-for-python-via-dotnet-21-11-release-notes"
slug: "net/aspose-words-for-python-via-dotnet-21-11-release-notes"
...
hideChildren: false
toc: false
family_listing_page_title: "Aspose.Words for Python via .NET 21.11 Release Notes"
...
The option is specified by setting [PdfSaveOptions.page_mode](https://reference.aspose.com/words/python-net/aspose.words.saving/pdfsaveoptions/page_mode/) to newly created [PdfPageMode.USE_ATTACHMENTS](https://reference.aspose.com/words/python-net/aspose.words.saving/pdfpagemode/#use_attachments) value.
...
Currently, this public class contains a single public property [original_file_name](https://reference.aspose.com/words/python-net/aspose.words.loading/chmloadoptions/original_file_name/).
...
A new [export_images_as_base64](https://reference.aspose.com/words/python-net/aspose.words.saving/markdownsaveoptions/export_images_as_base64/) public option has been added in [MarkdownSaveOptions](https://reference.aspose.com/words/python-net/aspose.words.saving/markdownsaveoptions/) class.
