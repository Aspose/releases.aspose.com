---
id: "aspose-words-for-cpp-21-12-release-notes"
slug: "aspose-words-for-cpp-21-12-release-notes"
linktitle: "Aspose.Words for C++ 21.12 Release Notes"
title: "Aspose.Words for C++ 21.12 Release Notes"
weight: 10
description: "Aspose.Words for C++ 21.12 Release Notes – the latest updates and fixes."
type: "repository"
layout: "release"
hideChildren: false
toc: false
family_listing_page_title: "Aspose.Words for C++ 21.12 Release Notes"
menuItemWithNoContent: false
---

{{% alert color="primary" %}}

This page contains release notes for [Aspose.Words for C++ 21.12](https://www.nuget.org/packages/Aspose.Words.Cpp/21.12.0).
...
| :- | :- | :- |
| WORDSCPP-1144 | Aspose.Words for C++ memory-leaking under MFC-Application | Bug |
| WORDSCPP-1147 | {{GLIBC_2.29}} not found error on Ubuntu 18.04, Red Hat 7 and 8. | Bug |
| WORDSCPP-1148 | Save to a Stream error | Bug |
...
### Unix dynamic libraries changes

Starting with this release, we will publish dynamic libraries built with CLang and linked against GLIBC 2.27 and GLIBCXX 3.4.22 (>= GCC 6.1.0). We have removed dynamic libraries built with GCC and changed the dynamic library names for Linux and macOS - `libAspose.Words.Cpp.so` and `libAspose.Words.Cpp.dylib`.
