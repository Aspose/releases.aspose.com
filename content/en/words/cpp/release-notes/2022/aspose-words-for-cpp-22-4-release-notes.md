---
id: "aspose-words-for-cpp-22-4-release-notes"
slug: "aspose-words-for-cpp-22-4-release-notes"
...
hideChildren: false
toc: false
family_listing_page_title: "Aspose.Words for C++ 22.4 Release Notes"
menuItemWithNoContent: false
---

{{% alert color="primary" %}}

This page contains release notes for [Aspose.Words for C++ 22.4](https://www.nuget.org/packages/Aspose.Words.Cpp/22.4.0).
...
auto shape = System::Static_Cast<Shape>(doc->GetChild(NodeType::Shape, 0, true));
shape->get_Chart()->set_SourceFullName(u"C:\\Documents\\ChartData.xlsx");
doc->Save(fileName);
{{< /highlight >}}
...
auto loadOptions = System::MakeObject<HtmlLoadOptions>();

// Set the new mode of import HTML block-level elements.
loadOptions->set_BlockImportMode(BlockImportMode::Preserve);
auto stream = System::MakeObject<MemoryStream>(Encoding::get_UTF8()->GetBytes(html));
auto doc = System::MakeObject<Document>(stream, loadOptions);
doc->Save(u"sample.docx");
{{< /highlight >}}
