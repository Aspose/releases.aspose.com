---
title: "Convert Visio to PDF Data Graphics API for C#, ASP.NET Apps"
description: "C# .NET API with better support to convert data graphics in Visio® to PDF conversion, better handling of Microsoft Visio® diagrams export to the HTML format."
keywords: ""
...
Intro_text: " It contains Aspose.Diagram for .NET 22.3 release."
...
# Data Graphics in Visio&reg; to PDF Conversion

In previous releases of the API within some instances while converting Visio&reg; to the PDF format, the data graphics encountered problems. This issue has now been resolved within the current release of the API.

# Export Visio&reg; to HTML
