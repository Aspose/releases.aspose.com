---
id: "aspose-slides-for-php-via-java-24-6-release-notes"
slug: "aspose-slides-for-php-via-java-24-6-release-notes"
linktitle: "Aspose.Slides for PHP via Java 24.6 Release Notes"
title: "Aspose.Slides for PHP via Java 24.6 Release Notes"
weight: 70
description: "Aspose.Slides for PHP via Java 24.6 Release Notes – the latest updates and fixes."
type: "repository"
layout: "release"
family_listing_page_title: "Aspose.Slides for PHP via Java 24.6 Release Notes"
---
...
| :- | :- | :- |
|SLIDESPHP-53|[Use Aspose.Slides for Java 24.6 features](/slides/java/release-notes/2024/aspose-slides-for-java-24-6-release-notes/)|Enhancement|
...
# Create callback.
$callback = new Java("aspose.callback.FindResultCallback");
...
echo $callback->getCount();
# Output data for each word "address" found.
for ($i = 0; $i < java_values($callback->getCount()); $i++)
{
    $info = $callback->Words->get($i);
    echo $info->getFoundText() . ", " . $info->getTextPosition();
}
...
JAR: [FindResult-0.1-SNAPSHOT.zip](./FindResult-0.1-SNAPSHOT.zip)
...
$presentation->getSlides()->get_Item(0)->getShapes()->get_Item(0)->getTextFrame()->highlightRegex($regex, $color->BLUE, null);
