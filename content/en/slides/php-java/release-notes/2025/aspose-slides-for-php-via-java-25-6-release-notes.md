---
id: "aspose-slides-for-php-via-java-25-6-release-notes"
slug: "aspose-slides-for-php-via-java-25-6-release-notes"
linktitle: "Aspose.Slides for PHP via Java 25.6 Release Notes"
title: "Aspose.Slides for PHP via Java 25.6 Release Notes"
weight: 70
description: "Aspose.Slides for PHP via Java 25.6 Release Notes – the latest updates and fixes."
type: "repository"
layout: "release"
family_listing_page_title: "Aspose.Slides for PHP via Java 25.6 Release Notes"
---
...
| :- | :- | :- |
|SLIDESPHP-86|[Use Aspose.Slides for Java 25.6 features](/slides/java/release-notes/2025/aspose-slides-for-java-25-6-release-notes/)|Enhancement|
...
echo "Is metered license accepted: " . (java_values(Metered::isMeteredLicensed()) ? "True" : "False");
```
...
try {
	$htmlStream = new Java("java.io.FileInputStream", "content.html");
...
try {
    ...
    if ($shape != null)
    {
        echo "IsCameo: " . (java_values($shape->isCameo()) ? "True" : "False");
    }
} finally {
    if ($pres != null) $pres->dispose();
}
