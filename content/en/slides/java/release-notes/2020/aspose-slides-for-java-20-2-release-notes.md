---
id: "aspose-slides-for-java-20-2-release-notes"
slug: "aspose-slides-for-java-20-2-release-notes"
linktitle: "Aspose.Slides for Java 20.2 Release Notes"
title: "Aspose.Slides for Java 20.2 Release Notes"
weight: 110
description: "Aspose.Slides for Java 20.2 Release Notes – the latest updates and fixes."
type: "repository"
layout: "release"
family_listing_page_title: "Aspose.Slides for Java 20.2 Release Notes"
---

{{% alert color="primary" %}} 

This page contains release notes for [Aspose.Slides for Java 20.2](https://releases.aspose.com/java/repo/com/aspose/aspose-slides/20.2/)
...
Method [**IPortion.getRect()**](https://reference.aspose.com/slides/java/com.aspose.slides/IPortion#getRect--) has been added. This method extends and actually replaces method [IPortion.getCoordinates()](https://reference.aspose.com/slides/java/com.aspose.slides/IPortion#getCoordinates--) which is marked as obsolete now.
Methods [IPortion.getRect()](https://reference.aspose.com/slides/java/com.aspose.slides/IPortion#getRect--) and [IParagraph.getRect()](https://reference.aspose.com/slides/java/com.aspose.slides/IParagraph#getRect--) can be applied to text within table cells.
...
```
 ...
 2) In the next step we're using [IParagrap.getRect()](https://reference.aspose.com/slides/java/com.aspose.slides/IParagraph#getRect--) and [IPortion.getRect()](https://reference.aspose.com/slides/java/com.aspose.slides/IPortion#getRect--) methods in order to add frame to portions and paragraphs.
