---
title: "Disable Project Data Export to XLSX API for C#, ASP.NET Apps"
description: "C# .NET API with ability to turn off export of project tasks, resources, assignments sheets while exporting to XLSX. Better Primavera P6 XML format handling."
keywords: ""
...
# Disable Project Sheets Export to XLSX

Ability to turn off export of tasks, resources, assignments sheets while exporting to the `XLSX` format.

> For a complete list of features, enhancements, and bug fixes in this release please visit, [Aspose.Tasks for .NET 22.5 Release Notes](https://docs.aspose.com/tasks/net/aspose-tasks-for-net-22-5-release-notes/).
