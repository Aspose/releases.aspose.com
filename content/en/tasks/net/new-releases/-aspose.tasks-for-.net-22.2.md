...
> For a complete list of features, enhancements, and bug fixes in this release please visit, [Aspose.Tasks for .NET 22.2 Release Notes](https://docs.aspose.com/tasks/net/aspose-tasks-for-net-22-2-release-notes/).
