...
description: "C# .NET API to make the project working time value immutable, read, write the Status Date to, from XER file, cancellation token support for the Project loading."
keywords: ""
...
Intro_text: " It contains MSI with Aspose.Tasks for .NET 22.3 release."
...
# Make `WorkingTime` immutable

Made the working time value immutable.

# Enhanced Functionality of Status Date

Added the ability to read and write the Status Date to or from an `XER` file.

# Cancellation Token for Project Loading
