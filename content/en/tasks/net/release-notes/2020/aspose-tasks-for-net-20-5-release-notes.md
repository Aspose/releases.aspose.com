---
id: "aspose-tasks-for-net-20-5-release-notes"
slug: "aspose-tasks-for-net-20-5-release-notes"
linktitle: "Aspose.Tasks for .NET 20.5 Release Notes"
title: "Aspose.Tasks for .NET 20.5 Release Notes"
weight: 40
description: "The page contains the release notes for Aspose.Tasks for .NET 20.5."
type: "repository"
layout: "release"
hideChildren: false
toc: false
family_listing_page_title: "Aspose.Tasks for .NET 20.5 Release Notes"
menuItemWithNoContent: false
---

{{% alert color="primary" %}}

This page contains release notes information for [Aspose.Tasks for .NET 20.5](https://releases.aspose.com/tasks/net/new-releases/aspose.tasks-for-.net-20.5/).
