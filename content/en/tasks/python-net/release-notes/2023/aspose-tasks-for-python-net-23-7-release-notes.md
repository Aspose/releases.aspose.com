---
id: "aspose-tasks-for-python-net-23-7-release-notes"
slug: "aspose-tasks-for-python-net-23-7-release-notes"
linktitle: "Aspose.Tasks for Python via .NET 23.7 Release Notes"
title: "Aspose.Tasks for Python via .NET 23.7 Release Notes"
weight: 94
description: "The page contains the release notes for Aspose.Tasks for Python via .NET 23.7."
type: "repository"
layout: "release"
hideChildren: false
toc: false
family_listing_page_title: "Aspose.Tasks for Python via .NET 23.7 Release Notes"
menuItemWithNoContent: false
---
{{% alert color="primary" %}}

This page contains release notes information for [Aspose.Tasks for Python via .Net 23.7](https://pypi.org/project/aspose-tasks/23.7.0/).
