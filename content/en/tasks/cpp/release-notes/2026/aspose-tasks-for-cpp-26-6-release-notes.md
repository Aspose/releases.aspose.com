---
id: "aspose-tasks-for-cpp-26-6-release-notes"
slug: "aspose-tasks-for-cpp-26-6-release-notes"
linktitle: "Aspose.Tasks for C++ 26.6 Release Notes"
title: "Aspose.Tasks for C++ 26.6 Release Notes"
weight: 95
description: "The page contains the release notes for Aspose.Tasks for C++ 26.6."
type: "repository"
layout: "release"
hideChildren: false
toc: false
family_listing_page_title: "Aspose.Tasks for C++ 26.6 Release Notes"
menuItemWithNoContent: false
---

{{% alert color="primary" %}}

This page contains release notes information for [Aspose.Tasks for C++ 26.6](https://releases.aspose.com/tasks/cpp/new-releases/aspose.tasks-for-c++-26.6/).
...
| :- | :- |
| Aspose::Tasks::PrimaveraTaskProperties::get_PlannedDuration() | Gets the original or planned duration -- the total working time from the task planned start date to the planned finish date.. |
...
task->get_ActualDuration() + task->get_RemainingDuration() ≠ task->get_Duration()
...
task.get_Duration - now maps to Primavera's "At Completion Duration"
Primavera's "Planned duration" field is now mapped to task->get_PrimaveraProperties()->get_PlannedDuration()
