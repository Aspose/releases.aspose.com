---
title:  "  Downloads ---New-Releases-aspose.font-for-.net-22.4-(dlls-only) . " 
description:  "    . " 
keywords:  "    . " 
page_type:  single_release_page
folder_link: " font/net/new-releases/aspose.font-for-.net-22.4-(dlls-only)/"
folder_name: " Aspose.Font for .NET 22.4 (DLLs only)"
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt=" Aspose.Font for .NET 22.4 (DLLs only)" imagelink="/resources/img/zip-icon.png">}}
