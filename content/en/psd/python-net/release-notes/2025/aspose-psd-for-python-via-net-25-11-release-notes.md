---
id: "aspose-psd-for-python-via-net-25-11-release-notes"
slug: "aspose-psd-for-python-via-net-25-11-release-notes"
linktitle: "Aspose.PSD for Python via .NET 25.11 - Release Notes"
title: "Aspose.PSD for Python via .NET 25.11 - Release Notes"
weight: 10
description: "Aspose.PSD for Python via .NET 25.11 - Release Notes – the latest updates and fixes."
type: "repository"
layout: "release"
hideChildren: false
toc: false
family_listing_page_title: "Aspose.PSD for Python via .NET 25.11 - Release Notes"
menuItemWithNoContent: false
---

{{% alert color="primary" %}}

This page contains release notes for [Aspose.PSD for Python via .NET 25.11](https://pypi.org/project/aspose-psd/)

{{% /alert %}}

| **Key**       | **Summary**                                                                               | **Category** |
|:--------------|:--------------------------------------------------------------------------------------------|:-------------|
| PSDPYTHON-262 | Support for non-standard mesh points in warp.                                             | Feature      |
| PSDPYTHON-263 | Remaster the process of blending layers with effects.                                     | Enhancement  |
| PSDPYTHON-264 | Improve the Warp smoothing mechanism.                                                     | Enhancement  |
| PSDPYTHON-265 | Can not load pixels from PSD Files after the Aspose.PSD manipulation.                     | Bug          |
| PSDPYTHON-266 | Non-destructive crop and resize do not work as expected.                                  | Bug          |
