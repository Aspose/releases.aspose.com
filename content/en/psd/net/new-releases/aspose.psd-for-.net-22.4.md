---
title: "SHA256 Support in PSD Processing API for C#, ASP.NET Apps"
description: "C# .NET API with support for SHA256 license, ability to render Photoshop's outer glow layer effect and set properties; e.g. range, spread, opacity, blend mode."
keywords: ""
...
For a complete list of features, enhancements, and bug fixes in this release please visit, [Aspose.PSD for .NET 22.4 - Release Notes](https://releases.aspose.com/psd/net/release-notes/2022/aspose-psd-for-net-22-4-release-notes/).
