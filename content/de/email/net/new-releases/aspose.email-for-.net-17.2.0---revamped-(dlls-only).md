...
folder_name: "Aspose.Email für .NET 17.2.0 – Überarbeitet (nur DLLs)"
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.Email für .NET 17.2.0 – Überarbeitet (nur DLLs)" imagelink="/resources/img/zip-icon.png">}}
