...
linktitle: "Aspose.3D for .NET 22.5 Mitteilung hinweise"
title: "Aspose.3D for .NET 22.5 Mitteilung hinweise"
weight: 8
description: "Die Release Notes von Aspose.3D for .NET 22.5."
type: "repository"
layout: "release"
---
{{% alert color="primary" %}}

Diese Seite enthält Versions hinweise für Aspose.3D for .NET 22.5.
...
### Aktualisiert den Objekt typ von `Dictionary<String, Object>` auf `object` in der Klasse `Aspose.ThreeD.Entities.VertexElementUserData`:
...
Wenn der alte Code mehrere Daten in `VertexElementUserData`anhängt, sollten Sie jetzt mehrere `VertexElementUserData` verwenden.

Mit diesen Änderungen API können wir die Konvertierung von `VertexElementUserData` in `TriMesh` unterstützen oder sogar in glTF exportiert werden:
