---
title: "Importieren Sie Autodesk® Binary Maya 3DPDF in GLTF -API für C#, ASP.NET -Apps" 
description: "C# .NET 3D Processing -API unterstützt das Importieren von Autodesk® Binary Maya, verbesserte Qualität des Netzes, während das 3D -PDF in GLTF -Format, restored.net 4.5 Support umwandelt." 
keywords: ""
page_type: single_release_page
folder_link: "/3d/net/new-releases/aspose.3d-for-.net-22.11/"
folder_name: "ASSON.3D für .NET 22.11" 
...
intro_text: "Es enthält ASSOSE.3D für .NET 22.11 Release." 
...
{{< Releases/ReleasesHeading H2txt="ASSON.3D für .NET 22.11" imagelink="/resources/img/msi-icon.png">}}
...
{{< Releases/ReleasesFileFeatures >}}
<h4>Beschreibung</h4>
<div class="HTMLDescription">Es enthält ASSOSE.3D für .NET 22.11 Release.</div>
{{< /Releases/ReleasesFileFeatures >}}
{{< Releases/ReleasesHeading h4txt="Bemerkenswerte Merkmale">}}
{{< Common/wrapper class="HTMLDescription">}}
{{% Releases/ReleasesFileFeatures %}}

# Implementieren Sie Binär -Maya -Importunterstützung

Führte die Unterstützung für die Importierung von Autodesk & reg ein; Binärer Maya.

# 3D -Netzqualität verbessern

Verbesserte Qualität des Netzes beim Umwandeln von 3D -PDF in GLTF -Format.

# .NET 4.5 Support wiederhergestellt
