---
title: "Large Mesh Support & Merge 3D -Szenen -API für C#, ASP.NET -Apps" 
description: "C# .NET -API mit verbesserter Unterstützung des großen Netzes im Exportieren von U3D / PDF -Datei, verbesserte 3D -Szene, um alles zu verschmelzen, um alles von jedem Knoten bis zum aktuellen Knoten zu verschmelzen." 
keywords: "    ." 
...
{{< Releases/ReleasesHeading H2txt=" ASSON.3D für .NET 22.3" imagelink="/resources/img/msi-icon.png">}}
...
<div> <a href="https://docs.asips.com/3d/net/asips-3d-for-net-22-3-release-notes/"> https://docs.asspsid.com/ 3D/net/asspins-3D-für-NET-22-3-Release-notes/</a> </div>
{{< /Releases/ReleasesFileFeatures >}}
{{< Releases/ReleasesHeading h4txt="Bemerkenswerte Merkmale">}}
{{< Common/wrapper class="HTMLDescription">}}
{{% Releases/ReleasesFileFeatures %}}

# Verbessertes großes Netz im U3D/PDF -Export verbessert

Verbesserte das große Netz im Exportieren von U3D / PDF -Datei.
...
> Für eine vollständige Liste von Funktionen, Verbesserungen und Fehlerbehebungen in dieser Version besuchen Sie bitte [ASSON3D für NET 223 Versionsnotizen](https://docs.aspose.com/3d/net/aspose-3d-for-net-22-3-release-notes/).
{{% /Releases/ReleasesFileFeatures %}}
{{< /Common/wrapper >}}
{{< /Releases/ReleasesFileFeatures >}}
{{< /Releases/ReleasesFileArea >}}
