...
linktitle: Aspose.3D für Java 25.7 Versionshinweise
title: Aspose.3D für Java 25.7 Versionshinweise
weight: 6
description: Aspose.3D für Java 25.7 Versionshinweise – die neuesten Updates und Fehlerbehebungen.
type: repository
layout: release
---
...
Diese Seite enthält Versionshinweise für Aspose.3D für Java 25.7.
...
Diese Klasse definiert logische Beziehungsgruppierungen, die sich von der Klasse `Node` unterscheiden, die hierarchische Beziehungen für das Rendering darstellt. Diese Funktionalität ist derzeit nur bei der Arbeit mit dem IFC-Format verfügbar.

### Neue Mitglieder der Klasse **Aspose.ThreeD.Entities.NurbsDirection**:
