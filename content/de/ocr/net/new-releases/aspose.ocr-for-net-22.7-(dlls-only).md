...
title: "Downloads ---Neue Releases-aspose.ocr-for-net-22.7-(nur dlls)"
description: " "
keywords: ""
page_type: single_release_page
folder_link: "/ocr/net/new-releases/aspose.ocr-for-net-22.7-(dlls-only)/"
folder_name: "Aspose.OCR für NET 22.7 (nur DLLs)"
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.OCR für NET 22.7 (nur DLLs)" imagelink="/resources/img/zip-icon.png">}}
  {{< Releases/ReleasesButtons >}}
    {{< Releases/ReleasesSingleButtons text="Download" link="/ocr/net/new-releases/aspose.ocr-for-net-22.7-(dlls-only)/2c2783f3b186ade780fe597c52d630f4-33-7688" >}}
