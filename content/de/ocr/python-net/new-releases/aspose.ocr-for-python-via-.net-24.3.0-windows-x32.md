...
folder_name: "Aspose.OCR für Python über .NET 24.3.0 Windows x32"
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.OCR für Python über .NET 24.3.0 Windows x32" imagelink="/resources/img/random-file-icon.png">}}
