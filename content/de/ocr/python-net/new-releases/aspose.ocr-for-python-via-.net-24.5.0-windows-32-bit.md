...
title: "Downloads ---New Releases-aspose.ocr-for-python-via-.net-24.5.0-windows-32-bit"
description: " "
keywords: ""
page_type: single_release_page
folder_link: "/ocr/python-net/new-releases/aspose.ocr-for-python-via-.net-24.5.0-windows-32-bit/"
folder_name: "Aspose.OCR für Python über .NET 24.5.0 Windows 32-Bit"
...
intro_text: "Dieses Rad enthält Aspose.OCR für Python über .NET Version 24.5.0, das für Windows entwickelt wurde und auf die 32-Bit-Architektur abzielt."
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.OCR für Python über .NET 24.5.0 Windows 32-Bit" imagelink="/resources/img/random-file-icon.png">}}
  ...
  {{< /Releases/ReleasesFileFeatures >}}
  {{< Releases/ReleasesFileFeatures >}}
      <h4>Beschreibung</h4><div class="HTMLDescription">Dieses Rad enthält Aspose.OCR für Python über .NET Version 24.5.0, das für Windows entwickelt wurde und auf die 32-Bit-Architektur abzielt.</div>
  {{< /Releases/ReleasesFileFeatures >}}
 {{< /Releases/ReleasesFileArea >}}
{{< /Releases/ReleasesWapper >}}
