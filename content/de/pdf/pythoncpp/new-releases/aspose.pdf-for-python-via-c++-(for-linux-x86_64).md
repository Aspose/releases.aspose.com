...
folder_name: "Aspose.PDF für Python über C++ (für Linux x86_64)"
...
intro_text: "Aspose.PDF für Python (für Linux x86_64)"
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.PDF für Python über C++ (für Linux x86_64)" imagelink="/resources/img/random-file-icon.png">}}
  ...
  {{< /Releases/ReleasesFileFeatures >}}
  {{< Releases/ReleasesFileFeatures >}}
      <h4>Beschreibung</h4><div class="HTMLDescription">Aspose.PDF für Python (für Linux x86_64)</div>
  {{< /Releases/ReleasesFileFeatures >}}
 {{< /Releases/ReleasesFileArea >}}
{{< /Releases/ReleasesWapper >}}
