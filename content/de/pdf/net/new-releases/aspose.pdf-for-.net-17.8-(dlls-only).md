...
folder_name: "Aspose.PDF für .NET 17.8 (nur DLLs)"
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.PDF für .NET 17.8 (nur DLLs)" imagelink="/resources/img/zip-icon.png">}}
