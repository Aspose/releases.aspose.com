...
folder_name: "Aspose.Tasks für .NET 8.4.1 (nur DLLs)"
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.Tasks für .NET 8.4.1 (nur DLLs)" imagelink="/resources/img/zip-icon.png">}}
