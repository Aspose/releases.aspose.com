---
title: "Lesen" 
description: "C# .NET Primavera® Project Properties Reader API zum Lesen der Aufgabeneigenschaften von XER, P6XML -Formaten, Ändern der Sortierreihenfolge von Zusammenfassungsaufgaben für XER -Projektdateien." 
keywords: ""
page_type: single_release_page
folder_link: "/tasks/net/new-releases/aspose.tasks-for-.net-22.11/"
folder_name: "ASSONE.TASKS FÜR .NET 22.11" 
...
intro_text: "Es enthält MSI mit ASSONE.TASKS für .NET 22.11 Release." 
...
{{< Releases/ReleasesHeading H2txt="ASSONE.TASKS FÜR .NET 22.11" imagelink="/resources/img/msi-icon.png">}}
...
{{< Releases/ReleasesFileFeatures >}}
<h4>Beschreibung</h4>
<div class="HTMLDescription">Es enthält MSI mit ASSONE.TASKS für .NET 22.11 Release.</div>
{{< /Releases/ReleasesFileFeatures >}}
{{< Releases/ReleasesHeading h4txt="Bemerkenswerte Merkmale">}}
{{< Common/wrapper class="HTMLDescription">}}
{{% Releases/ReleasesFileFeatures %}}

### Lesen Sie `xer` /` p6xml` Projekteigenschaften

Stellte den schreibgeschützten Zugriff auf Primavera & Reg vor; Spezifische Aufgabeneigenschaften. Jetzt können Sie die Task -Eigenschaften der "Xer" -P6xml` -Projektdateiformate lesen.

### Sortieren Sie zusammenfassende Aufgaben des `Xer` -Projekts
