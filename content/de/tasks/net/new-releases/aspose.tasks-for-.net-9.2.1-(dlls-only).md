...
folder_name: "Aspose.Tasks für .NET 9.2.1 (nur DLLs)"
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.Tasks für .NET 9.2.1 (nur DLLs)" imagelink="/resources/img/zip-icon.png">}}
