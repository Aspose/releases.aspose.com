...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.Tasks für .NET 19.1" imagelink="/resources/img/msi-icon.png">}}
  ...
  {{< Releases/ReleasesFileArea >}}
    ...
    {{< Releases/ReleasesDetailsUl >}}
      ...
      {{< Common/li class="hide" id="author-update-dcab16ade94b4ecfa4f9abddbc9a387d" >}} alexanderrefremov1 {{< /Common/li >}}
  ...
  {{< Releases/ReleasesFileFeatures >}}
      <h4>Versionshinweise</h4><div> <a href="https://docs.aspose.com/display/tasksnet/Aspose.Tasks+for+.NET+19.1+Release+Notes">https://docs.aspose.com/display/tasksnet/Aspose.Tasks+for+.NET+19.1+Release+Notes</a></div><h4> Beschreibung</h4><div class="HTMLDescription"> Es enthält MSI mit Aspose.Tasks für die Version .NET 19.1.</div>
  {{< /Releases/ReleasesFileFeatures >}}
 {{< /Releases/ReleasesFileArea >}}
{{< /Releases/ReleasesWapper >}}
