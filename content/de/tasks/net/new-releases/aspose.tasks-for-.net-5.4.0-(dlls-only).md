---
title: " Downloads ---Neue-Releases-aspose.tasks-for-.net-5.4.0-(nur-dlls) . "
description:  "    . " 
keywords:  "    . " 
page_type:  single_release_page
folder_link: " tasks/net/new-releases/aspose.tasks-for-.net-5.4.0-(dlls-only)/"
folder_name: "Aspose.Tasks für .NET 5.4.0 (nur DLLs)"
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.Tasks für .NET 5.4.0 (nur DLLs)" imagelink="/resources/img/zip-icon.png">}}
