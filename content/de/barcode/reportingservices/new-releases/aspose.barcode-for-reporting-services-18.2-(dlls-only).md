...
folder_name: "Aspose.BarCode für Reporting Services 18.2 (nur DLLs)"
...
Intro_text: "Es enthält die Version Aspose.BarCode for Reporting Services 18.2 (nur DLLs)."
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.BarCode für Reporting Services 18.2 (nur DLLs)" imagelink="/resources/img/zip-icon.png">}}
  ...
  {{< Releases/ReleasesFileFeatures >}}
      <h4>Versionshinweise</h4><div> <a href="It" contains aspose.barcode for reporting services release>Es enthält Aspose.BarCode für die Version 18.2 von Reporting Services</a></div><h4> Beschreibung</h4><div class="HTMLDescription"> Es enthält die Version Aspose.BarCode for Reporting Services 18.2 (nur DLLs).</div>
  {{< /Releases/ReleasesFileFeatures >}}
 {{< /Releases/ReleasesFileArea >}}
{{< /Releases/ReleasesWapper >}}
