...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.BarCode für PHP über Java 21.12" imagelink="/resources/img/zip-icon.png">}}
  ...
  {{< Releases/ReleasesFileFeatures >}}
      <h4>Versionshinweise</h4><div> <a href="https://docs.aspose.com/barcode/java/aspose-barcode-for-php-via-java-21-12/">https://docs.aspose.com/barcode/java/aspose-barcode-for-php-via-java-21-12/</a></div><h4> Beschreibung</h4><div class="HTMLDescription"> Aspose.BarCode für PHP über Java 21.12 wurde veröffentlicht</div>
  {{< /Releases/ReleasesFileFeatures >}}
 {{< /Releases/ReleasesFileArea >}}
{{< /Releases/ReleasesWapper >}}
