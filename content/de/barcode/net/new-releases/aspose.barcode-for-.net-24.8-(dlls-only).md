...
title: "Downloads ---New Releases-aspose.barcode-for-.net-24.8-(dlls-only)"
description: " "
keywords: ""
page_type: single_release_page
folder_link: "/barcode/net/new-releases/aspose.barcode-for-.net-24.8-(dlls-only)/"
folder_name: "Aspose.BarCode für .NET 24.8 (nur DLLs)"
...
intro_text: "Es enthält Aspose.BarCode für die .NET 24.8-Version (nur DLLs)."
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.BarCode für .NET 24.8 (nur DLLs)" imagelink="/resources/img/zip-icon.png">}}
  ...
  {{< /Releases/ReleasesFileFeatures >}}
  {{< Releases/ReleasesFileFeatures >}}
      <h4>Beschreibung</h4><div class="HTMLDescription">Es enthält Aspose.BarCode für die .NET 24.8-Version (nur DLLs).</div>
  {{< /Releases/ReleasesFileFeatures >}}
 {{< /Releases/ReleasesFileArea >}}
{{< /Releases/ReleasesWapper >}}
