...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="ASSON.PSD für .NET 24.1" imagelink="/resources/img/msi-icon.png">}}
  ...
  {{< Releases/ReleasesFileFeatures >}}
      <h4>Versionshinweise</h4><div><a href='https://docs.aspose.com/psd/net/aspose-psd-for-net-24-1-release-notes/'>https://docs.aspose.com/psd/net/aspose-psd-for-net-24-1-release-notes/</a></div>
  {{< /Releases/ReleasesFileFeatures >}}
  {{< Releases/ReleasesFileFeatures >}}
      <h4>Beschreibung</h4><div class="HTMLDescription">Es enthält asspose.psd für .NET 24.1 Release.</div>
  {{< /Releases/ReleasesFileFeatures >}}
 {{< /Releases/ReleasesFileArea >}}
{{< /Releases/ReleasesWapper >}}
