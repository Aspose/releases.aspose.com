...
folder_name: "Aspose.Imaging für Python über .NET 24.5 Windows amd64"
...
intro_text: "Es enthält Aspose.Words für Python über .NET 24.5, Windows AMD x64-Version."
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.Imaging für Python über .NET 24.5 Windows amd64" imagelink="/resources/img/random-file-icon.png">}}
  ...
  {{< /Releases/ReleasesFileFeatures >}}
  {{< Releases/ReleasesFileFeatures >}}
      <h4>Beschreibung</h4><div class="HTMLDescription">Es enthält Aspose.Words für Python über .NET 24.5, Windows AMD x64-Version.</div>
  {{< /Releases/ReleasesFileFeatures >}}
 {{< /Releases/ReleasesFileArea >}}
{{< /Releases/ReleasesWapper >}}
