---
title: "Exportieren Sie den Texturpinsel in die Vektor-PSD-API für C#- und ASP.NET-Apps"
description: "C# .NET-API zum Exportieren von Texturpinseln in PSD, verbesserte Resampling-Qualität durch Transparenzbehandlung und Randfarbintensität, bessere SVG-TSPAN-Elementausrichtung."
keywords: ""
...
Eine vollständige Liste der Funktionen, Verbesserungen und Fehlerbehebungen in dieser Version finden Sie unter [Aspose.Imaging for .NET 22.4](http://localhost:1313/imaging/net/new-releases/aspose.imaging-for-.net-22.4/).
