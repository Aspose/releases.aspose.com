---
title: "ASSOSE.Words 22.9 | Wort zu PDF Reduzieren Sie die Größe | Java -API" 
description: "Java -Bibliothek zum Erstellen von Ansicht bearbeiten und Wortdokumente konvertieren. ASSOSE.Words 22.9 Unterstützung der Konvertierung in PDF mit Formen Caching, um die Größe der PDF -Datei und vieles mehr zu reduzieren." 
layout: package
...
## Was ist neu in asspose.words für Java API 22.9
- Implementierung von Header-/Fußzeilenformen, um die PDF -Größe zu verringern.
- Implementierung von Wasserzeichen, das durch Rahmen XObjects zwischengespeichert wird.
- Verbesserung der Tabellenränder, Zellgrenzen während des Renders zu PDF.
- Verbesserung der RTF -zu -PDF -Umwandlung in einem zusammengebrachten Tisch.
- Fixed Text überlappte das Rendering des SVG -Bildes.
- Die Reihenfolge der Datenbezeichnungswerte wurde während des Renders geändert.

Weitere Informationen finden Sie in [Release Notes of Aspose.Words for Java 22.9](https://docs.aspose.com/words/java/aspose-words-for-java-22-9-release-notes/).
...
### ** So reduzieren Sie die Dateigröße beim Konvertieren von Wort in PDF mit Java **
...
public class AsposeDokumente2PDFReduceFileSizeConverter {
...
- ** [KOSTENLOSE Online -DOC -Fusion](https://products.aspose.app/words/merger) **, um mehrere Dateien zusammenzuschließen. Kombinieren Sie Dateien, um Sie zu bestellen.
