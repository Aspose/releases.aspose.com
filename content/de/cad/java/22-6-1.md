...
ASSOSS.CAD JAVA APIs werden im [ASSOSE Repository](https://repository.aspose.com/cad/) ​​gehostet. Sie können ASSONE.BARCODE für Java -API direkt in Ihren Maven -Projekten mit einfachen Konfigurationen problemlos verwenden. Für die detaillierten Anweisungen besuchen Sie bitte [Installing Aspose.CAD for Java from Maven Repository](https://docs.aspose.com/cad/java/installation/) -Dokumentationsseite.
