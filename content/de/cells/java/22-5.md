---
title: "ASSONE.CELLS 22.5 | Verarbeiten Sie Tabellenkalkulationsformate über Java -API" 
...
[Aspose.Cells for Java](https://products.aspose.com/cells/java) ist eine preisgekrönte Excel-Tabellenkalkulations-API, mit der Java-Entwickler die Fähigkeit einbetten können, Excel zu lesen, zu schreiben und zu manipulieren? Tabellenkalkulationen (XLS, XLSX, XLSM, XLSB, XLTX, SpreadsheetML, CSV, ODS), HTML, MHTML, PDF und Bilddatei -Formate in ihre eigenen Java -Anwendungen, ohne sich auf Microsoft Excel zu verlassen?
