...
linktitle: Aspose.Cells for Python via Java 23.10 Versionshinweis
title: Aspose.Cells for Python via Java 23.10 Versionshinweis
weight: 3
description: Aspose.Cells for Python via Java 23.10 Versionshinweise – die neuesten Updates und Korrekturen
type: repositor
layout: releas
...
{{% alert color="primary" %}}
 ...
 Diese Seite enthält Versionshinweise für[Aspose.Cells for Python via Java 23.10](https://releases.aspose.com/cells/python-java/new-releases/aspose.cells-for-python-via-java-23.10/).
...
|CELLSPYTHONJAVA-66|Berechnungsfehler beim Aktualisieren dynamischer Array-Formeln nach dem Festlegen der Berechnungsoptionen|
|CELLSPYTHONJAVA-68|Regression: java.lang.NullPointerException: „com.aspose.cells.DateTime.getYear()“ kann nicht aufgerufen werden, weil „\<local3\>.d“ ist null|
|CELLSPYTHONJAVA-71|Box- und Whisker-Diagramm, das mehrere X-Achsen-Kategorien ignoriert|
