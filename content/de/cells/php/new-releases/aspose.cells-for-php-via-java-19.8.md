...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.Cells für PHP über Java 19.8" imagelink="/resources/img/zip-icon.png">}}
  ...
  {{< Releases/ReleasesFileFeatures >}}
      <h4>Versionshinweise</h4><div> <a href="https://docs.aspose.com/display/cellsjava/Aspose.Cells+for+PHP+via+Java+19.8+Release+Notes">https://docs.aspose.com/display/cellsjava/Aspose.Cells+for+PHP+via+Java+19.8+Release+Notes</a></div>
  {{< /Releases/ReleasesFileFeatures >}}
 {{< /Releases/ReleasesFileArea >}}
{{< /Releases/ReleasesWapper >}}
