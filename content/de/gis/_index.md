---
title: "Lokale GIS-Datenverarbeitungs-API | Aspose.GIS-Produktfamilie"
description: "Laden Sie die GIS-Datenverarbeitungsbibliothek herunter, um Shapefile, GeoJSON, FIleGDB, KML und OSM XML zu lesen, zu schreiben und zu konvertieren sowie eine Karte aus unterstützten Formaten in SVG zu rendern."
keywords: "GIS .NET Library"
family_listing_page_title: "Aspose.GIS-Produktfamilie"
...
Offen
{{< Common/link href="https://www.nuget.org/packages/Aspose.GIS/" text="NuGet"  >}}Package Manager in Microsoft Visual Studio®, suchen Sie nach <b>Aspose.GIS</b> und installieren Sie es. Sie können auch den folgenden Befehl in der Paket-Manager-Konsole verwenden. Für die detaillierten Anweisungen besuchen Sie bitte die
...
Die [Aspose.GIS for .NET](https://products.aspose.com/gis/net/)-API hilft Entwicklern beim Rendern von Karten, Lesen, Schreiben und Konvertieren von geografischen Informationen, die aus vektorbasierten Geodatenformaten abgerufen werden, ohne dass eine andere GIS-Software erforderlich ist. Die GIS .NET API unterstützt die Arbeit mit Shapefile, GeoJSON, ESRI File Geodatabase (FileGDB), Geography Markup Language (GML), Keyhole Markup Language (KML), Scalable Vector Graphics (SVG) und vielen anderen.

Damit können Sie GIS-Daten, [convert GIS file formats](https://docs.aspose.com/gis/net/conversion/) und [render maps](https://docs.aspose.com/gis/net/map-rendering/) im SVG-Format lesen und schreiben. Sie können auch Feature-Geometrien erstellen und analysieren sowie grundlegende Geometrien wie Point, MultiPoint, Line, Multiline und Polygon von Grund auf neu erstellen. Die API unterstützt die Erstellung nichtlinearer (Kurven-)Geometrien, die Linearisierung nichtlinearer Geometrien und die Steuerung des Präzisionsmodus von Berechnungen.
...
- Konvertieren Sie Vektordaten in [popular file formats](https://docs.aspose.com/gis/net/supported-file-formats/).
...
- Vektoranalyse durchführen & [manipulate geometries](https://docs.aspose.com/gis/net/geometry-types/).
- Unterstützung für [Spatial Reference Systems](https://docs.aspose.com/gis/net/spatial-reference-systems/).
