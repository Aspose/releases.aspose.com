---
title: "Aspose.Cells for Python 通过 .NET"
...
linktitle: "Aspose.Cells for Python 通过 .NET"
family_listing_page_title: "Aspose.Cells for Python 通过 .NET"
...
{{< Common/h3 text="下载用于电子表格处理的 Aspose.Cells Python 库"  >}}
{{< Common/paragraph class="package-instructions">}}
Aspose.Cells for Python via .NET 是一个可扩展且功能丰富的 API，用于使用 Python 处理 Excel® 电子表格。 API 提供 Excel® 文件创建、操作、转换和渲染。开发人员可以将工作表、行、列或单元格格式化为最精细的级别，创建操作图表和数据透视表，将工作表、图表和特定数据范围呈现为 PDF 或图像，添加计算 Excel® 的内置和自定义公式等等更多 - 完全不依赖于 Microsoft Office 或 Excel® 应用程序。
请使用以下
{{< Common/link href="https://pypi.org/project/aspose-cells-python/" text="点子"  >}}命令：
{{< Common/release-notes-link family="cells" product="python-net" href="https://releases.aspose.com/zh/cells/python-net/release-notes/" text="https://releases.aspose.com/zh/cells/python-net/release-notes/"  >}}
{{< /Common/paragraph>}}
...
- 应用工作表格式。
- 为工作表配置和应用页面设置。
- 创建和自定义 Excel® 图表、数据透视表、条件
  格式化规则、切片器、表格和迷你图。
- 将 Excel® 图表转换为图像和 PDF。
- 将 Excel® 文件转换为各种其他格式。
- 支持所有基本和高级 Excel® 功能的公式计算引擎。

请访问 [official documentation](https://docs.aspose.com/cells/python-net/) 以获取更详细的功能列表。
...
请访问 [Supported File Formats](https://docs.aspose.com/cells/python-net/supported-file-formats/) 了解更多详情。

＃＃＃ 系统要求

您的机器不需要安装 Microsoft Excel® 或 OpenOffice® 软件。
