---
title: "下载光学文本识别 C++ DLL | Aspose.OCR API"
description: "下载包含 C++ 类库的 OCR DLL，以帮助您通过本地文本提取 API 从 JPEG、PNG 和 BMP 图像中识别英文文本字符。"
keywords: "OCR C++, OCR English, Extract Text C++"
family_listing_page_title: "Aspose.OCR for C++"
family_listing_page_description: "Aspose.OCR for C++ 是一个强大的光学字符识别 API。开发人员可以轻松地在他们的应用程序中添加 OCR 功能。 API 是可扩展的、易于使用的、紧凑的，并提供了一组简单的类来控制字符识别。它支持常用的图像格式，并提供诸如从图像中读取字符和字体、粗体和斜体样式、去噪过滤器、扫描整个图像或图像的任何部分等功能。"
...
{{< Common/h2 text="下载用于光学字符识别 (OCR) 的 C++ 库"  >}}
{{< Common/paragraph class="package-instructions">}}
打开
{{< Common/link href="https://www.nuget.org/packages/Aspose.OCR.Cpp/" text="NuGet"  >}}Microsoft Visual Studio® 中的包管理器，搜索<b>Aspose.OCR.Cpp</b>并安装。您还可以在包管理器控制台中使用以下命令。有关详细说明，请访问
{{< Common/link href="https://docs.aspose.com/ocr/cpp/installation/" text="安装"  >}}文档页面。
...
## 为什么要下载 Aspose.OCR for C++？

Aspose.OCR for C++ 是一个独立的 OCR API，可增强您的 C++ 应用程序以对 JPEG、PNG 和 BMP 图像执行 OCR 操作以提取英文内容。
...
**光栅格式：** JPEG、BMP（不支持 32 位和 16 位图像）、PNG
...
Aspose OCR 库在系统路径中需要`onnxruntime.dll`。

### 评估版本限制

Aspose.OCR for C++ 的评估版将从图像中提取的字符数限制为 300 个。
