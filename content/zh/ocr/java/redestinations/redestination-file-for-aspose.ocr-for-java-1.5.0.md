...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.OCR for Java 1.5.0 的资源文件" imagelink="/resources/img/zip-icon.png">}}
