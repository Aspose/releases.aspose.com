...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="用于 Java 22.6 的 Aspose.OCR" imagelink="/resources/img/zip-icon.png">}}
  ...
  {{< /Releases/ReleasesFileFeatures >}}
  {{< Releases/ReleasesFileFeatures >}}
      <h4>描述</h4><div class="HTMLDescription">新的去噪神经网络、表格识别和 PDF 创建修复</div>
  {{< /Releases/ReleasesFileFeatures >}}
 {{< /Releases/ReleasesFileArea >}}
{{< /Releases/ReleasesWapper >}}
