...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="aspose.ocr for Java 21.12" imagelink="/resources/img/random-file-icon.png">}}
  {{< Releases/ReleasesButtons >}}
    {{< Releases/ReleasesSingleButtons text=" 下载" link="/ocr/java/new-releases/aspose.ocr-for-java-21.12/0b072c18edf34432be4b6ab9f6dfc154%20%20" >}}
  ...
  {{< Releases/ReleasesFileFeatures >}}
      <h4>发行说明</h4><div><a href="https://docs.aspose.com/ocr/java/aspose-ocr-for-java-21-12-release-notes/">https://docs.aspose.com/ocr/java/aspose-ocr-for-java-21-12-release-notes/</a></div><h4>描述</h4><div class="HTMLDescription">添加.XLSX格式支持结果和PDF和DOCX的原始结构</div>
  {{< /Releases/ReleasesFileFeatures >}}
 {{< /Releases/ReleasesFileArea >}}
{{< /Releases/ReleasesWapper >}}
