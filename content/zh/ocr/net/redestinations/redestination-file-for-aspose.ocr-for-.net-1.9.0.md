...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.OCR for .NET 1.9.0 的资源文件" imagelink="/resources/img/zip-icon.png">}}
