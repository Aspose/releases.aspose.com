---
title: "下载---新释放 -  aspose.gis-for-.net-21.11-（仅dlls-）。" 
description:  "    . " 
keywords:  "    . " 
page_type:  single_release_page
folder_link: " gis/net/new-releases/-aspose.gis-for-.net-21.11-(dlls-only)/"
folder_name: "aspose.gis for .net 21.11（仅DLL）"
...
download_count: "   11/28/2021  下载s: 8  Views: 40"
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="aspose.gis for .net 21.11（仅DLL）" imagelink="/resources/img/zip-icon.png">}}
  {{< Releases/ReleasesButtons >}}
    {{< Releases/ReleasesSingleButtons text=" 下载" link="/gis/net/new-releases/-aspose.gis-for-.net-21.11-(dlls-only)/2ead2f9264b546dbaba673ac7137f70b%20%20" >}}
  ...
  {{< Releases/ReleasesFileFeatures >}}
      <h4>发行说明</h4><div><a href="https://releases.aspose.com/gis/net/release-notes/2021/aspose-gis-for-net-21-11-release-notes/">https://releases.aspose.com/gis/net/release-notes/2021/aspose-gis-for-net-21-11-release-notes/</a></div><h4>描述</h4><div class="HTMLDescription">该zip文件仅包含.net组件的aspose.gis。组件与同一版本的产品的MSI安装程序相同。</div>
  {{< /Releases/ReleasesFileFeatures >}}
 {{< /Releases/ReleasesFileArea >}}
{{< /Releases/ReleasesWapper >}}
