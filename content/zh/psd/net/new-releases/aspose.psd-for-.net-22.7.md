---
title: "通过 API 为 C#、ASP.NET 应用程序导出的 PSD 大小优化"
description: "支持 PSD 图像部分资源 4000-4999 的 C# .NET API；即插件资源，在使用子文件夹导出后优化了 PSD 文件的大小。"
keywords: ""
...
Intro_text: "它包含 .NET 22.7 版本的 Aspose.PSD。"
...
增加了对PSD Image Section Resource 4000-4999的支持；即插件资源。
