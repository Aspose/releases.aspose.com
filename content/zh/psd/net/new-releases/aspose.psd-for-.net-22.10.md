---
title: "通过 API 为 C#、ASP.NET 应用程序提供 PSD 透明度描边效果"
description: "C# .NET API 用于在 PSD Photoshop 图形中应用透明笔触效果、解析和渲染亚洲符号、创建时间线、配置特定帧。"
keywords: ""
...
Intro_text: "它包含 .NET 22.10 版本的 Aspose.PSD。"
...
# Photoshop® 中的亚洲符号解析和渲染
使用一些亚洲符号（例如中文）解析或更新文本。
