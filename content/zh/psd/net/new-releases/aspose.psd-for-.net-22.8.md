---
title: "通过 API 为 C#、ASP.NET 应用程序应用 Photoshop® 帧时间轴"
description: "C# .NET API 应用对 Adobe Photoshop® PSD 格式文件的 Frame TimeLine 支持。修复了安装程序中的问题。添加了对mlst”资源的支持。"
keywords: ""
...
Intro_text: "它包含 .NET 22.8 版本的 Aspose.PSD。"
...
# 支持 Photoshop® Frame TimeLine

为 Adobe Photoshop® PSD 文件添加了 Frame TimeLine 的 API 支持。

有关此版本中的功能、增强和错误修复的完整列表，请访问 [Aspose.PSD for .NET 22.8 - Release Notes](https://releases.aspose.com/psd/net/release-notes/2022/aspose-psd-for-net-22-8-release-notes/)。
