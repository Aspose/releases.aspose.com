---
title: "通过 C# ASP.NET 应用程序的 API 在 EPS 文件中插入 XMP 元数据"
description: "C# .NET API 将 Adobe 的 XMP（可扩展元数据平台）元数据插入 EPS（封装 PostScript）文档，增加文件的商业价值。"
keywords: "    . "
...
Intro_text: "它包含 .NET 22.4 版本的 Aspose.Page。"
