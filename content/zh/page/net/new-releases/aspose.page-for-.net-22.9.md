---
title: "将图像转换为 EPS NET6.0 支持 C#、ASP.NET 应用程序的 API"
description: "C# .NET API 将图像格式转换为具有正确图像方向的 EPS 文件格式，在 EPS 文档中设置 XMP 元数据，支持 .NET6.0。"
keywords: ""
...
Intro_text: "它包含 .NET 22.9 版本的 Aspose.Page。"
...
将图像格式转换为具有正确图像方向的“EPS”文件格式。

# 在 EPS 中设置 XMP 元数据

能够在“EPS”格式文档中设置“XMP”元数据。
