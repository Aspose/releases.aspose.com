---
title: "通过 API 为 C#、.NET 应用程序使用 Wingdings 和 Zapfdingbats 字体"
description: "C# .NET API 将 Wingdings 字体替换为支持各种文档格式的免费 Zapfdingbats 字体，从而更好地处理 dingbat 字体。"
keywords: "    . "
...
Intro_text: "它包含 .NET 22.2 版本的 Aspose.Page。"
...
# 用免费的 Zapfdingbats 字体替换 Wingdings
