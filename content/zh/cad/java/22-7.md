---
title: "aspose.cad 22.7 | AutoCAD处理和转换Java API" 
description: "Java类库以渲染，编辑，报告和转换应用程序中的AutoCAD图纸。支持3D固体，圆锥，球体，圆环，圆柱，盒子和楔形等。" 
layout: package
type: repository
weight: 00	#rem
publishDate: "2022-11-10T08:21:18+00:00"
---
...
aspose.cad Java API托管在[Aspose存储库](https://releases.aspose.com/cad/java/)。您可以在Maven项目中直接使用Aspose.barcode使用Java API，并具有简单的配置。有关详细说明，请访问[Installing Aspose.CAD for Java from Maven Repository](https://docs.aspose.com/cad/java/installation/)文档页面。
