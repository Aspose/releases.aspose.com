---
title: "保留 3D 模型，通过 API 为 C#、.NET 应用程序渲染平面"
description: "C# .NET API 能够保留 3D 有线模型、渲染双面平面、放大水印、改进 DWG 到 PDF 的渲染和转换。"
keywords: ""
...
Intro_text: "包含用于 .NET v22.8 的 Aspose.CAD 完整产品安装的 MSI 安装程序"
...
据观察，在某些情况下，“DWG”在转换为“PDF”格式时并未完全呈现。此 API 版本已解决上述问题。

> 有关此版本中的功能、增强功能和错误修复的完整列表，请访问 [Aspose.CAD for .NET 22.8 - Release Notes](https://releases.aspose.com/cad/net/release-notes/2022/aspose-cad-for-net-22-8-release-notes/)。
