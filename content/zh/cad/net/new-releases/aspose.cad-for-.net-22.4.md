---
title: "将 DXF 转换为 TIFF 并将 DWG 转换为 C#、ASP.NET 应用程序的 WMF API"
description: "C# .NET API 在将 AutoCAD® DXF 转换为 TIFF、将 DWG 导出为 WMF、从嵌入的图像数据导出图像、改进的 DWG 渲染方面具有更好的内存管理。"
keywords: ""
...
<h4>发行说明</h4><div><a href="https://docs.aspose.com/cad/net/aspose-cad-for-net-22-4-release-notes/">https://docs.aspose.com/cad/net/aspose-cad-for-net-22-4-release-notes/</a></div>
{{< /Releases/ReleasesFileFeatures >}}
...
将 AutoCAD® DXF 转换为 TIFF（光栅图形）格式时发现内存泄漏。因此，此 API 版本为 DXF 到 TIFF 转换提供了更好的内存管理。

# 改进 DWG 到 WMF 导出

改进了 AutoCAD® `DWG` 到 `WMF`（Windows 图元文件）的导出。
...
观察到“DWG”被渲染为没有颜色。此问题现已在此 API 版本中得到解决。

> 有关此版本中的功能、增强功能和错误修复的完整列表，请访问 [Aspose.CAD for .NET 22.4 - Release Notes](https://docs.aspose.com/cad/net/aspose-cad-for-net-22-4-release-notes/)。
