---
title: "通过 C# ASP.NET 应用程序的 API 将 DWG 导出到 WMF 并将 OBJ 导出到 DXF"
description: "C# .NET API 改进了 DWG 到 WMF 格式的导出功能，优化了 OBJ 到 DXF 导出的文件大小，解决了导出 PDF 中的文本重叠问题。"
keywords: ""
...
改进了 DWG 到 WMF 格式的导出功能。

# OBJ 到 DXF 导出的文件大小优化

修复了将 OBJ 导出为 DXF 格式后文件过大的问题。
