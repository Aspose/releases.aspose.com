---
title: "下载 Publisher® 文件转换器 C++ DLL | Aspose.PUB API"
description: "下载 PUB 文件阅读器和转换器 C++ DLL 类库，以通过内部部署 API 处理 MS Publisher® 文件。阅读和编辑 PUB 元数据。将 PUB 转换为 PDF。"
family_listing_page_title: "Aspose.PUB for C++"
family_listing_page_description: "Aspose.PUB for C++ 是一个简单的 API，允许在您的 C++ 应用程序中以编程方式读取 Microsoft Publisher® (PUB) 文件并将其转换为 PDF 格式。它还提供易于理解的界面来编辑 PUB 文件的元数据。"
...
{{< Common/h2 text="下载 C++ 库以处理 PUB 文件"  >}}
{{< Common/paragraph class="package-instructions">}}
打开
{{< Common/link href="https://www.nuget.org/packages/Aspose.PUB.Cpp/" text="NuGet"  >}}Microsoft Visual Studio® 中的包管理器，搜索<b>Aspose.PUB.Cpp</b>并安装。您还可以在包管理器控制台中使用以下命令。有关详细说明，请访问
{{< Common/link href="https://docs.aspose.com/pub/cpp/installation/" text="安装"  >}}文档页面。
...
## 为什么要为 C++ 下载 Aspose.PUB？

Aspose.PUB for C++ 是一个简单的 API，允许您在 C++ 应用程序中以编程方式读取 Microsoft Publisher® (PUB) 文件并将其转换为 PDF 格式。它还提供易于理解的界面来编辑 PUB 文件的元数据。

## PUB 文件处理功能

- 阅读 Microsoft Publisher® (PUB) 文件以转换为 PDF 格式。
- 通过 API 读取和编辑 PUB 文件的元数据。
...
您可以使用 Aspose.PUB for C++ 构建任何类型的 32 位和 64 位 C++ 应用程序。您可以通过简单地复制程序集在服务器和客户端使用它，而无需担心其他服务或模块。
