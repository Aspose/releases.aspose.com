---
title: "通过 C# 应用程序的 API 将 MS Publisher 2000 PUB 转换为 PDF"
description: "PUB Conversion API 现在支持在 C#、ASP.NET 应用程序中将 Microsoft Publisher 2000 PUB 文件转换为 Adobe PDF 文件格式。 .NET Framework 5.0 合规性。"
keywords: "    . "
page_type: single_release_page
folder_link: " pub/net/new-releases/aspose.pub-for-.net-21.6/"
folder_name: "Aspose.PUB for .NET 21.6"
download_link: " /pub/net/new-releases/aspose.pub-for-.net-21.6/7d256447cb2e431e9b19f17cda0a72de"
download_text: " Download"
Intro_text: "它包含 .NET 21.6 版本的 Aspose.PUB。"
...
{{< Releases/ReleasesHeading H2txt="Aspose.PUB for .NET 21.6" imagelink="/resources/img/msi-icon.png">}}
...
<h4>发行说明</h4><div><a href="https://docs.aspose.com/pub/net/aspose-pub-for-net-21-6-release-notes/">https://docs.aspose.com/pub/net/aspose-pub-for-net-21-6-release-notes/</a></div>
{{< /Releases/ReleasesFileFeatures >}}
...
此版本支持 .NET Framework 5.0。

# .NET Core 和 .NET 5 支持

此版本支持 .NET 代码以及 .NET 5。

# Microsoft Publisher® 2000 支持

此版本增加了对 Microsoft Publisher® 2000 `PUB` 文件的支持。

> 有关此版本中的功能、增强功能和错误修复的完整列表，请访问 [Aspose.PUB for .NET 21.6 Release Notes](https://docs.aspose.com/pub/net/aspose-pub-for-net-21-6-release-notes/)。
