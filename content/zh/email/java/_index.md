---
title: "aspose.email | Java类库处理Outlook格式" 
...
family_listing_page_description: "Java的Aspose.Email是一组电子邮件处理API，用于创建，操纵或转换消息格式，例如MSG，EML和MHT，从Java应用程序中。 API提供了操纵消息内容，标题，附件和MAPI属性的能力，以及通过许多流行协议发送和接收消息的能力" 
