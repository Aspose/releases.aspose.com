---
title: "用于 C#、ASP.NET 应用程序的电子邮件 MBOX 收件箱管理 API"
description: "C# .NET API 更好地处理通过 SMTP 发送电子邮件，增强了 IMAP Message Seen Flag (true / false) 的能力，改进了 MBOX 收件箱邮件管理。"
keywords: ""
...
Intro_text: "它包含 .NET 22.1 版本的 Aspose.Email。"
...
在使用 API 21.12 版本时，在某些情况下通过 SMTP 发送电子邮件时会出现“操作已取消”问题。这个问题现在已经解决了。

# 改进的 IMAP 看到标志处理

以前，Aspose IMAP Seen 标志总是返回为“false”。此问题现已修复。
