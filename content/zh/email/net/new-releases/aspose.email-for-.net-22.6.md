---
title: "通过 C#、.NET 应用程序的电子邮件 API 从 PST 中提取时间戳"
description: "C# .NET API 用于从PST”中提取DTSTAMP”并保存为带有原始时间戳的ICS”，POP 客户端的自动 AUTH，改进的 Word 到 EML 的转换。"
keywords: ""
...
Intro_text: "它包含 .NET 22.6 版本的 Aspose.Email。"
...
<h4>发行说明</h4><div><a href='https://docs.aspose.com/email/net/aspose-email-for-net-22-6-release-notes/'>https://docs.aspose.com/email/net/aspose-email-for-net-22-6-release-notes/</a></div>
{{< /Releases/ReleasesFileFeatures >}}
{{< Releases/ReleasesFileFeatures >}}
...
> 有关此版本中的功能、增强功能和错误修复的完整列表，请访问 [Aspose.Email for .NET 22.6 Release Notes](https://docs.aspose.com/email/net/aspose-email-for-net-22-6-release-notes/)。
