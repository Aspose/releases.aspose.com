---
title: "下载文档类型设置 C# 库 | Aspose.TeX API"
description: "下载带有 TeX 引擎扩展的 C# 类库，以通过 .NET API 排版 TeX 文件。将 TeX 转换为 XPS、PDF、JPEG、PNG、TIFF、BMP。支持嵌入字体。"
keywords: "tex"
family_listing_page_title: "Aspose.TeX for .NET"
family_listing_page_description: "Aspose.TeX for .NET 是一个 .NET API，允许开发人员创建用于排版 TeX 文件的应用程序。 Aspose.TeX for .NET 是使用 C# 实现的，它可以与任何 .NET 语言一起使用，如 C#、VB.NET 和 J# 等。它可以与任何类型的应用程序集成，无论是 ASP.NET Web 应用程序还是 Windows 应用程序."
...
打开
{{< Common/link href="https://www.nuget.org/packages/Aspose.TeX/" text="NuGet"  >}}Microsoft Visual Studio® 中的包管理器，搜索<b>Aspose.TeX</b>并安装。您还可以在包管理器控制台中使用以下命令。有关详细说明，请访问
{{< Common/link href="https://docs.aspose.com/tex/net/getting-started/installation/" text="安装"  >}}文档页面。
...
## 为什么要为 .NET 下载 Aspose.TeX？

Aspose.TeX for .NET 是一个提供名为 ObjectTeX 的 TeX 引擎扩展的库。它可用于排版由 TeX 文件描述的文档。 “对象”是指中间排版结果是一个特定的对象模型，然后可以统一转换成多种最终格式。
