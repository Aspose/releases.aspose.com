...
linktitle: Aspose.3D for Node.js via Java 25.7 发布说明
title: Aspose.3D for Node.js via Java 25.7 发布说明
weight: 6
description: Aspose.3D for Node.js via Java 25.7 发布说明 – 最新更新和修复。
type: repository
layout: release
---
...
此页面包含 Aspose.3D for Node.js via Java 25.7 的发布说明信息。
...
此类定义了逻辑关系分组，与用于表示渲染分层关系的 `Node` 类不同。目前，此功能仅在处理 IFC 格式时可用。
