---
title: "保存 3D 场景，将 USDZ 转换为 C#、ASP.NET 应用程序的 GLTF API"
description: "C# .NET API 允许在不指定文件格式的情况下保存 3D 场景，通过高代码 API 改进了 USDZ 到 GLTF 的转换和 DAE 到 USDZ 格式的转换。"
keywords: ""
...
Intro_text: "它包含 .NET 22.6 版本的 Aspose.3D。"
...
{{< Releases/ReleasesWapper >}}
  ...
  {{< Releases/ReleasesFileFeatures >}}
      <h4>发行说明</h4><div><a href='https://docs.aspose.com/3d/net/aspose-3d-for-net-22-6-release-notes/'>https://docs.aspose.com/3d/net/aspose-3d-for-net-22-6-release-notes/</a></div>
  {{< /Releases/ReleasesFileFeatures >}}
  {{< Releases/ReleasesFileFeatures >}}
      <h4>描述</h4><div class="HTMLDescription">它包含 .NET 22.6 版本的 Aspose.3D。</div>
  {{< /Releases/ReleasesFileFeatures >}}
...
允许在不指定文件格式的情况下保存 3D 场景。

# 改进了 USDZ 到 GLTF 的转换

以前在将“USDZ”保存到“GLTF”时发生异常。此问题现已在 API 的当前版本中得到解决。

> 有关此版本中的功能、增强功能和错误修复的完整列表，请访问 [Aspose.3D for .NET 22.6 Release Notes](https://docs.aspose.com/3d/net/aspose-3d-for-net-22-6-release-notes/)。
