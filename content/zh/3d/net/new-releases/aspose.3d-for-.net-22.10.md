---
title: "适用于 C#、ASP.NET 应用程序的 Autodesk® Maya ASCII 文件支持 API"
description: "C# .NET API 具有导入 Autodesk® Maya ASCII 文件的功能。现在我们的 3D API 支持 Maya ASCII 格式（MEL 脚本）作为输入格式 (.ma)。"
keywords: ""
...
Intro_text: "它包含 .NET 22.10 版本的 Aspose.3D。"
...
{{< Releases/ReleasesWapper >}}
  ...
  {{< Releases/ReleasesFileFeatures >}}
      <h4>发行说明</h4><div><a href='https://docs.aspose.com/3d/net/aspose-3d-for-net-22-10-release-notes/'>https://docs.aspose.com/3d/net/aspose-3d-for-net-22-10-release-notes/</a></div>
  {{< /Releases/ReleasesFileFeatures >}}
  {{< Releases/ReleasesFileFeatures >}}
      <h4>描述</h4><div class="HTMLDescription">它包含 .NET 22.10 版本的 Aspose.3D。</div>
  {{< /Releases/ReleasesFileFeatures >}}
...
在 3D 操作 API 中添加了导入 Autodesk® Maya ASCII 文件的功能。现在我们的 3D API 支持 Maya ASCII 格式作为输入格式 (.ma)。

> 有关此版本中的功能、增强功能和错误修复的完整列表，请访问 [Aspose.3D for .NET 22.10 Release Notes](https://docs.aspose.com/3d/net/aspose-3d-for-net-22-10-release-notes/)。
