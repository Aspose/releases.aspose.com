---
title: "导入autodesk®二进制Maya 3DPDF到GLTF API for C#，ASP.NET应用程序" 
description: "C# .NET 3D处理API支持导入Autodesk®二进制MAYA，改善网格质量，同时将3D PDF转换为GLTF格式，Restored.NET 4.5支持。" 
keywords: ""
...
download_text: "下载" 
intro_text: "它包含aspose.3d的.NET 22.11释放。" 
image_link: "/resources/img/msi-icon.png"
download_count: " 17/11/2022 下载s: 1  Views: 1 "
...
{{< Releases/ReleasesSingleButtons text="下载" link="/3d/net/new-releases/aspose.3d-for-.net-22.11/be68c98623ffc159eb54d2a86bc1c958-3-8141" >}}
...
{{< Releases/ReleasesFileFeatures >}}
<h4>描述</h4>
<div class="HTMLDescription">它包含aspose.3d的.NET 22.11释放。</div>
{{< /Releases/ReleasesFileFeatures >}}
...
向导入Autodesk＆Reg介绍了支持；二元玛雅。

# 改善3D网状质量

将3D PDF转换为GLTF格式时提高了网格的质量。
