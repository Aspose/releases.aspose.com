---
title: 下载 C# Gameware, CAD & 3D Processing DLL | Aspose.3D
description: 下载包含 C# 类库的 DLL，以通过 .NET 本地 API 处理 3D 文件（3DS、3MF、DAE、DFX、USD、Blender、OpenUSD、MA、gITF、U3D）、网格、几何体、场景和动画。
...
在 Microsoft Visual Studio® 中打开 {{< Common/link href="https://www.nuget.org/packages/Aspose.3D/" text="NuGet"  >}} 包管理器，搜索 <b>Aspose.3D</b> 并安装。您也可以在包管理器控制台中使用以下命令。有关详细说明，请访问 {{< Common/link href="https://docs.aspose.com/3d/net/installation/" text="Installation"  >}} 文档页面。
