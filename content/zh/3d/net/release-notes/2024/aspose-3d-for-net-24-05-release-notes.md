...
linktitle: Aspose.3D for .NET 24.5 发布说明
title: Aspose.3D for .NET 24.5 发布说明
weight: 8
description: Aspose.3D for .NET 24.5 发布说明 – 最新更新和修复。
type: repository
layout: release
---
...
此页面包含 Aspose.3D for .NET 24.5 的发布说明信息。
...
| THREEDNET-1542 | 西门子 JT 9.5 - 某些文件的压缩 LOD 数据可能无法加载到 TopoMesh 中。 | Bug fix |
