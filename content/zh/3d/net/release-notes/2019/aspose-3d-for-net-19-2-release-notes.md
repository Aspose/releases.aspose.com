...
linktitle: "Aspose.3D for .NET 19.2发行说明"
title: "Aspose.3D for .NET 19.2发行说明"
weight: 110
description: "Aspose.3D for .NET 19.2发行说明 – the latest updates and fixes."
type: "repository"
layout: "release"
---
{{% alert color="primary" %}} 

此页面包含以下内容的发行说明[Aspose.3D for .NET 19.2](https://www.nuget.org/packages/Aspose.3D/19.2.0)
...
|**钥匙**|**摘要**|**类别**|
|:- |:- |:- |
|THREEDNET-472|通过挤压形状创建几何图形|新功能|
### **公共API和向后不兼容的更改**
...
#### **在类Aspose.ThreeD.Entities.Shape中添加了来自controlpoints的方法**
{{< highlight "java" >}}
...
{{< /highlight >}}
#### **添加了新的类Aspose.ThreeD.实体.Linarexinterrentities:**
{{< highlight "java" >}}
