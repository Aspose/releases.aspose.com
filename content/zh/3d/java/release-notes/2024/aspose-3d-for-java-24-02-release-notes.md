...
linktitle: Aspose.3D for Java 24.2 发布说明
title: Aspose.3D for Java 24.2 发布说明
weight: 11
description: Aspose.3D for Java 24.2 发布说明 – 最新更新和修复。
type: repository
layout: release
---
...
此页面包含 Aspose.3D for Java 24.2 的发布说明信息。
...
| THREEDNET-1460 | 导出的 FBX 骨骼节点没有变换，而是有姿态 | 修复 Bug |
| THREEDNET-1494 | 在 GLTF 导入中添加了 KHR_mesh_quantization 扩展支持 | 修复 Bug |
| THREEDNET-1495 | 从 GLB 导出动画到 FBX 可能会导致 Slerp 失败 | 修复 Bug |
| THREEDNET-1496 | 不支持的属性类型可能导致 Maya 导入器停止 | 修复 Bug |
| THREEDNET-1497 | 没有有效属性值的 Primitive 可能无法在 USD 中加载 | 修复 Bug |
| THREEDNET-1498 | 3MF 构建元素中的外部引用问题 | 修复 Bug |
## API 变更 ##

此版本主要是修复 Bug 的版本，API 变更较少：
...
### 向类 **com.aspose.threed.TriMesh** 添加了成员：
...
之前只有 Stream 版本的 save/open/fromStream，现在支持 JDK 的 InputStream/OutputStream。