...
linktitle: Aspose.3D for Java 25.6 发布说明
title: Aspose.3D for Java 25.6 发布说明
weight: 7
description: Aspose.3D for Java 25.6 发布说明 – 最新更新和修复。
type: repository
layout: release
---
...
此页面包含 Aspose.3D for Java 25.6 的发布说明信息。
...
| THREEDNET-1685 | 在轮廓细分曲面中实现焊接操作 | Task |
...
此版本主要是一个 bug 修复版本，提高了挤出、布尔运算等过程建模的稳定性。
