...
linktitle: Aspose.3D for Python 24.12 版发布说明
title: Aspose.3D for Python 24.12 版发布说明
weight: 1
description: Aspose.3D for Python via .NET 24.12 发布说明 – 最新更新和修复。
type: repository
layout: release
---
...
此页面包含 Aspose.3D for Python via .NET 24.12 的发布说明信息。
...
| THREEDNET-1619 | 在拆分网格时保留变形器 | Task |
