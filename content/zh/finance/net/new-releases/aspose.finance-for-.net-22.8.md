---
title: "验证 C#、.NET 应用程序的财务数据文件元素 API"
description: "C# .NET API 改进了财务数据文件中continuation”元素、exclude”元素和footnote”元素的验证规则，例如 XBRL。"
keywords: ""
...
<h4>发行说明</h4><div><a href='https://releases.aspose.com/finance/net/release-notes/2022/aspose-finance-for-net-22-8-release-notes/'>https://releases.aspose.com/finance/net/release-notes/2022/aspose-finance-for-net-22-8-release-notes/</a></div>
{{< /Releases/ReleasesFileFeatures >}}
{{< Releases/ReleasesFileFeatures >}}
...
> 有关此版本中的功能、增强功能和错误修复的完整列表，请访问 [Aspose.Finance for .NET 22.8 Release Notes](https://releases.aspose.com/finance/net/release-notes/2022/aspose-finance-for-net-22-8-release-notes/)。
