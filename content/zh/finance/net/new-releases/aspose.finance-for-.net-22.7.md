---
title: "验证用于 C#、ASP.NET 应用程序的 XBRL API 中的 Schemaref 元素"
description: "C# .NET API 支持验证； `XBRL` 文件中上下文元素中的 Schemaref 元素、上下文元素 ID 属性和实体子元素。"
keywords: ""
...
# XBRL 验证中的 Schemaref 元素

支持验证 `XBRL` 文件中的 Schemaref 元素。

# 上下文元素 ID 属性验证

在 `XBRL` 文件中添加了对上下文元素的 ID 属性的验证。

# 实体子元素验证

在`XBRL`文件的上下文元素中补充实体子元素的验证。

> 有关此版本中的功能、增强功能和错误修复的完整列表，请访问 [Aspose.Finance for .NET 22.7 Release Notes](https://docs.aspose.com/finance/net/aspose-finance-for-net-22-7-release-notes/)。
