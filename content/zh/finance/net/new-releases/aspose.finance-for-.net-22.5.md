---
title: "适用于 C#、.NET 应用程序的 XBRL IFRS 会计分类支持 API"
description: "C# .NET API 能够处理来自 IFRS 会计分类的架构，支持处理嵌套的非数字事实和内联 XBRL排除”元素。"
keywords: ""
...
Intro_text: "它包含 .NET 22.5 版本的 Aspose.Finance。"
...
# 处理来自 xbrl.ifrs.org 的 Schema

能够处理来自 xbrl.ifrs.org（IFRS 会计分类）的模式。
