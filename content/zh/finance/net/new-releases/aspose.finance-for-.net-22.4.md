---
title: "用于 C#、.NET 应用程序的 XBRL 模式解析器处理程序 TLS 支持 API"
description: "C# .NET API 版本具有改进的 XBRL 到 HTML 报告、XBRL 模式解析器处理程序、XBRL 模式下载以支持传输层安全性 (TLS) 1.2。"
keywords: ""
...
Intro_text: "它包含 .NET 22.4 版本的 Aspose.Finance。"
