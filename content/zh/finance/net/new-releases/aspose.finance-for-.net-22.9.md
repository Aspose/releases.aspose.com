---
title: "GroupDocs 对 C#、.NET 应用程序的财务格式 API 的支持"
description: "C# .NET API 现在附带了对 GroupDocs 的额外支持。增强的本地高代码数字金融数据格式处理和操作 API。"
keywords: ""
...
> 有关此版本中的功能、增强功能和错误修复的完整列表，请访问 [Aspose.Finance for .NET 22.9 Release Notes](https://docs.aspose.com/finance/net/aspose-finance-for-net-22-9-release-notes/)。
