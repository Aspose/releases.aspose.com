...
{{< Common/h2 text="下载 Aspose.Finance 以处理支持的格式"  >}}
...
## 为什么要为 .NET 下载 Aspose.Finance？

Aspose.Finance for .NET 是一个独立的本地 API，由 C# 类组成，允许您在 .NET 应用程序中处理和操作与财务相关的格式，例如 XBRL 和 iXBRL。
