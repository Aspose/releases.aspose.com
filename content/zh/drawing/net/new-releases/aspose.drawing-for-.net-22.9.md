---
title: "为 C#、.NET 应用程序节省 1 个 BPP（每像素位数）TIFF 和 BMP API"
description: "C# .NET API 能够保存 1 BPP（每像素位数）.TIFF 和 .BMP 格式，通过 API 从网络流中加载绘图、图形和图像文件。"
keywords: ""
...
Intro_text: "Aspose.Drawing for .NET 22.9 的 MSI 安装程序"
...
实现了保存为 1（一）个 BPP（每像素位数）.TIFF 和 .BMP 格式。

# 从网络流中加载图像文件

添加了从 Web 流加载图像文件的功能。

> 有关此版本中的功能、增强功能和错误修复的完整列表，请访问 [Aspose.Drawing for .NET 22.9 Release Notes](https://releases.aspose.com/drawing/net/release-notes/2022/aspose-drawing-for-net-22-9-release-notes/)。
