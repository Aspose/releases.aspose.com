---
title: "通过 API 为 C#、ASP.NET 应用程序添加斜体和粗体字体效果"
description: "C# .NET API 支持绘图中的斜体和粗体字体效果，支持 GIF 文件的透明度，改进了对图像编解码器的支持。"
keywords: ""
...
Intro_text: "Aspose.Drawing for .NET 22.4 的 MSI 安装程序"
