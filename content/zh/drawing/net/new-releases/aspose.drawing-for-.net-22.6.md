---
title: "用于 C#、ASP.NET 应用程序的图像收缩和矢量缩放 API"
description: "C# .NET API 在缩小较大图像、元文件矢量缩放、编辑和保存多帧 GIF 文件、添加圆形和三角形破折号帽方面具有更好的质量。"
keywords: ""
...
Intro_text: "Aspose.Drawing for .NET 22.6 的 MSI 安装程序"
...
API 现在支持多帧 GIF 的编辑和保存。

# 圆形和三角形破折号支持

添加了对圆形和三角形破折号的支持。

> 有关此版本中的功能、增强功能和错误修复的完整列表，请访问 [Aspose.Drawing for .NET 22.6 Release Notes](https://releases.aspose.com/drawing/net/release-notes/2022/aspose-drawing-for-net-22-6-release-notes/)。
