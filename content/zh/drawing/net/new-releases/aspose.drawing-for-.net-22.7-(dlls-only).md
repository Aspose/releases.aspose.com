...
title: "下载---新版本-ASPOSE.DRAWING--.NET-22.7-（仅DLLS）"
description: " "
keywords: ""
page_type: single_release_page
folder_link: "/drawing/net/new-releases/aspose.drawing-for-.net-22.7-(dlls-only)/"
folder_name: "aspose.drawing for .net 22.7（仅DLL）"
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="aspose.drawing for .net 22.7（仅DLL）" imagelink="/resources/img/zip-icon.png">}}
  {{< Releases/ReleasesButtons >}}
    {{< Releases/ReleasesSingleButtons text="下载" link="/drawing/net/new-releases/aspose.drawing-for-.net-22.7-(dlls-only)/45bfc670b9a574dcf6b3d8a48226dda6-2-7638" >}}
