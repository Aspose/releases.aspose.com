---
title: "从 C#、ASP.NET 应用程序的文件或流 API 保存 GIF 图像"
description: "C# .NET API 能够从文件或通过流保存 GIF（图形交换格式）图像。通过 API 格式化旋转文本的能力。"
keywords: ""
...
Intro_text: "Aspose.Drawing for .NET 22.8 的 MSI 安装程序"
...
> 有关此版本中的功能、增强功能和错误修复的完整列表，请访问 [Aspose.Drawing for .NET 22.8 Release Notes](https://releases.aspose.com/drawing/net/release-notes/2022/aspose-drawing-for-net-22-8-release-notes/)。
