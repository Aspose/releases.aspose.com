---
title: "支持为 C#、ASP.NET 应用程序创建透明 PNG API"
description: "C# .NET API 支持将透明颜色应用于 PNG 格式的图像、子字符串的字体回退选项、改进的双三次过滤性能。"
keywords: ""
...
Intro_text: "Aspose.Drawing for .NET 22.7 的 MSI 安装程序"
...
添加了通过 API 将透明颜色应用于 PNG 格式图像的支持。
