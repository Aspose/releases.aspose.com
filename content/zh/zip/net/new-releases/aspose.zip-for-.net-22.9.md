---
title: "验证 C#、ASP.NET 应用程序的 RAR 解压密码 API"
description: "C# .NET API 提供在解压时验证 RAR 密码，支持 ZIP 容器的 XZ 压缩，通过 API 支持并行 BZip2 压缩。"
keywords: ""
...
Intro_text: "Aspose.ZIP for .NET 22.9 版本。"
...
通过 API 支持并行 `BZip2` 压缩。

> 有关此版本中的功能、增强功能和错误修复的完整列表，请访问 [Aspose.ZIP for .NET 22.9 Release Notes](https://releases.aspose.com/zip/net/release-notes/2022/aspose-zip-for-net-22-9-release-notes/)。
