---
title: "增强的7Z压缩档案格式API，用于C#，.NET应用" 
description: "C#.NET API要获取7Z条目的最后修改（最新）日期和时间，请提取7个ZIP条目以在存档提取时提取流，获取或设置编码。" 
keywords: ""
...
download_text: "下载" 
intro_text: "aspose.zip for .net 22.10释放。" 
image_link: "/resources/img/msi-icon.png"
download_count: " 29/10/2022 下载s: 1  Views: 1 "
...
{{< Releases/ReleasesSingleButtons text="下载" link="/zip/net/new-releases/aspose.zip-for-.net-22.10/3cb74668c1ef2c9eb16cf340e39178fd-2-8079" >}}
...
{{< Releases/ReleasesFileFeatures >}}
<h4>描述</h4>
<div class="HTMLDescription">aspose.zip for .net 22.10释放。</div>
{{< /Releases/ReleasesFileFeatures >}}
...
能够获得7Z条目的最后（最新）修改日期和时间。显示7Z条目的修改时间。
