---
title: "用于 C#、ASP.NET 应用程序的基于 LZX 和 Deflate 的 CAB 提取 API"
description: "C# .NET API 可以提取使用LZX”和 Deflate 算法压缩的CAB”档案，改进了 .NET 6 中加密的RAR5”的提取。"
keywords: ""
...
Intro_text: "Aspose.ZIP for .NET 22.3 版本。"
...
<h4>发行说明</h4><div><a href="https://releases.aspose.com/zip/net/release-notes/2022/aspose-zip-for-net-22-3-release-notes/">https://releases.aspose.com/zip/net/release-notes/2022/aspose-zip-for-net-22-3-release-notes/</a></div><h4>描述</h4><div class="HTMLDescription">Aspose.ZIP for .NET 22.3 版本。</div>
{{< /Releases/ReleasesFileFeatures >}}
...
提取已使用“LZX”和 Deflate 算法压缩的“CAB”档案。

# 提取加密的 RAR5

改进了 .NET 6 中加密的“RAR5”的提取。

> 有关此版本中的功能、增强功能和错误修复的完整列表，请访问 [Aspose.ZIP for .NET 22.3 Release Notes](https://releases.aspose.com/zip/net/release-notes/2022/aspose-zip-for-net-22-3-release-notes/)。
