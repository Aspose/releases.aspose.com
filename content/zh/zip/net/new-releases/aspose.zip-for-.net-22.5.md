---
title: "通过 API 为 C#、ASP.NET 应用程序提取多文件夹 7z"
description: "C# .NET API 支持多文件夹 7z 提取，尊重 .NET 6 重大更改，提取 XAR 存档，使用 Xpress 和 LZX 压缩提取 WIM 存档。"
keywords: ""
...
Intro_text: "Aspose.ZIP for .NET 22.5 版本。"
...
<h4>发行说明</h4><div><a href='https://docs.aspose.com/zip/net/aspose-zip-for-net-22-5-release-notes/'>https://docs.aspose.com/zip/net/aspose-zip-for-net-22-5-release-notes/</a></div>
{{< /Releases/ReleasesFileFeatures >}}
{{< Releases/ReleasesFileFeatures >}}
<h4>描述</h4><div class="HTMLDescription">Aspose.ZIP for .NET 22.5 版本。</div>
...
使用“Xpress”压缩和“LZX”压缩提取 WIM 档案。

> 有关此版本中的功能、增强功能和错误修复的完整列表，请访问 [Aspose.ZIP for .NET 22.5 Release Notes](https://docs.aspose.com/zip/net/aspose-zip-for-net-22-5-release-notes/)。
