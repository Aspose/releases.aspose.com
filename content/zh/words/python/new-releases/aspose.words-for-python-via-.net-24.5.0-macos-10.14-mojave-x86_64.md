...
title: "下载 ---新版本-aspose.words-for-python-via-.net-24.5.0-macos-10.14-mojave-x86_64"
description: " "
keywords: ""
...
download_text: "下载"
intro_text: "该轮子包含 Aspose.Words for Python via .NET 版本 24.5.0，专为 macOS 10.14 (Mojave) 构建并针对 x86_64 架构。"
...
{{< Releases/ReleasesWapper >}}
  ...
  {{< Releases/ReleasesButtons >}}
    {{< Releases/ReleasesSingleButtons text="下载" link="/words/python/new-releases/aspose.words-for-python-via-.net-24.5.0-macos-10.14-mojave-x86_64/6f833950c9426146717924d645501474-15-10972" >}}
  ...
  {{< /Releases/ReleasesFileFeatures >}}
  {{< Releases/ReleasesFileFeatures >}}
      <h4>描述</h4><div class="HTMLDescription">该轮子包含 Aspose.Words for Python via .NET 版本 24.5.0，专为 macOS 10.14 (Mojave) 构建并针对 x86_64 架构。</div>
  {{< /Releases/ReleasesFileFeatures >}}
 {{< /Releases/ReleasesFileArea >}}
{{< /Releases/ReleasesWapper >}}
