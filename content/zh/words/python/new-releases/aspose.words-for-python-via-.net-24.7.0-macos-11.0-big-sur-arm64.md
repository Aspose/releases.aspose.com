...
title: "下载 ---新版本-aspose.words-for-python-via-.net-24.7.0-macos-11.0-big-sur-arm64"
description: " "
keywords: ""
...
download_text: "下载"
intro_text: "该轮子包含 Aspose.Words for Python via .NET 版本 24.7.0，专为 macOS 11.0 (Big Sur) 构建并针对 ARM64 架构。"
...
{{< Releases/ReleasesWapper >}}
  ...
  {{< Releases/ReleasesButtons >}}
    {{< Releases/ReleasesSingleButtons text="下载" link="/words/python/new-releases/aspose.words-for-python-via-.net-24.7.0-macos-11.0-big-sur-arm64/544199a9c48bc1ec7fb08ca23efab1c8-13-11305" >}}
  ...
  {{< /Releases/ReleasesFileFeatures >}}
  {{< Releases/ReleasesFileFeatures >}}
      <h4>描述</h4><div class="HTMLDescription">该轮子包含 Aspose.Words for Python via .NET 版本 24.7.0，专为 macOS 11.0 (Big Sur) 构建并针对 ARM64 架构。</div>
  {{< /Releases/ReleasesFileFeatures >}}
 {{< /Releases/ReleasesFileArea >}}
{{< /Releases/ReleasesWapper >}}
