...
title: "下载 ---新版本-aspose.words-for-python-via-.net-24.5.0-macos-11.0-big-sur-arm64"
description: " "
keywords: ""
...
download_text: "下载"
intro_text: "该轮子包含 Aspose.Words for Python via .NET 版本 24.5.0，专为 macOS 11.0 (Big Sur) 构建并针对 ARM64 架构。"
...
{{< Releases/ReleasesWapper >}}
  ...
  {{< Releases/ReleasesButtons >}}
    {{< Releases/ReleasesSingleButtons text="下载" link="/words/python/new-releases/aspose.words-for-python-via-.net-24.5.0-macos-11.0-big-sur-arm64/60e13a274ed1f99ff0d76c853c284f5c-12-10973" >}}
  ...
  {{< /Releases/ReleasesFileFeatures >}}
  {{< Releases/ReleasesFileFeatures >}}
      <h4>描述</h4><div class="HTMLDescription">该轮子包含 Aspose.Words for Python via .NET 版本 24.5.0，专为 macOS 11.0 (Big Sur) 构建并针对 ARM64 架构。</div>
  {{< /Releases/ReleasesFileFeatures >}}
 {{< /Releases/ReleasesFileArea >}}
{{< /Releases/ReleasesWapper >}}
