---
title: "aspose.words 16.12.0 |通过Java API的处理文档格式" 
...
### ** Java中的Opentype功能的支持**
{{< gist aspose-words-gists 827e71ccc0b8516a3cfe247b86ce6d4e "例子-src-main-java-com-aspose-words-examples-programming_documents-document-OpenTypeFeatures-OpenTypeFeatures.java" >}}

##使用Aspose.words API免费在线应用

 -  ** [免费的在线文档页面删除剂](https://products.aspose.app/words/removepages) **从文档中删除单页或多个页面。删除文档中的空白页。

 -  ** [免费在线发票生成器](https://products.aspose.app/words/invoice) **通过从JSON格式导入数据来创建发票和账单。
