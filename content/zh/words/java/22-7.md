---
title: "aspose.words 22.7 |新的文档到PDF/UA-1 WCAG 2.0" 
description: "Java库创建编辑视图并转换Word文档。 Aspose.Words 22.7支持WCAG 2.0 PDF，数据库字段，Opentype（CFF）等。" 
layout: package
...
请参阅[Release Notes of Aspose.Words for Java 22.7](https://docs.aspose.com/words/java/aspose-words-for-java-22-7-release-notes/)以获取完整的详细信息。
...
### **将文档转换为PDF/UA-1，符合Java中的WCAG 2.0 **
...
public class Aspose文档2PDF_UA_1_Compliant_WCAG20_Converter {
