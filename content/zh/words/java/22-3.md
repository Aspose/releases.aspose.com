---
title: "aspose.words 22.3 | PDF 2.0合规性| Java API" 
description: "Java库创建编辑视图并转换Word文档。 Aspose.Words 22.4支持PDF 2.0转换，TOC样式的改进等等。" 
layout: package
...
请参阅[Release Notes of Aspose.Words for Java 22.3](https://docs.aspose.com/words/java/aspose-words-for-java-22-3-release-notes/)以获取完整的详细信息。
...
public class Aspose文档2PDF20CompliantConverter {
