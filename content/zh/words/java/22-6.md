---
title: "aspose.words 22.6 |新的文档到固定页面格式" 
description: "Java库创建编辑视图并转换Word文档。 aspose.words 22.6支持将文档转换为固定页面格式等。" 
layout: package
...
## Java API 22.6的Aspose.Words。
 - 将文档转换为具有高质量和性能的固定页面格式。
 - 用于绘制图表的API，并支持梯度，纹理和图案填充。
- Improvement in converting DOCX to HTML
- Add loading progress notification for ODT documents
 - 改进使用XHTML实体加载EPUB文档。

请参阅[Release Notes of Aspose.Words for Java 22.6](https://docs.aspose.com/words/java/aspose-words-for-java-22-6-release-notes/)以获取完整的详细信息。
...
public class Aspose文档2FIXEDPageJpgeHighQualityConverter {
...
##使用Aspose.words API免费在线应用
 ...
 -  ** [免费在线查找并更换](https://products.aspose.app/words/replace) **在Word，PDF文档中查找并替换文本。

 -  ** [免费的在线文档元数据编辑器](https://products.aspose.app/words/metadata) **查看＆amp; Microsoft Word＆amp;编辑元数据属性OpenOffice文件。
