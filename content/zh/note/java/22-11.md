---
title: "aspose.note 22.11 | OneNote处理Java高码API" 
...
aspose.note Java API托管在[Aspose存储库](https://releases.aspose.com/note/java/)。您可以在Maven项目中直接使用Aspose.barcode使用Java API，并具有简单的配置。有关详细说明，请访问[Installing Aspose.Note for Java from Maven Repository](https://docs.aspose.com/note/java/installation/)文档页面。
