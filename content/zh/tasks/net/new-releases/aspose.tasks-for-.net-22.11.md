---
title: "阅读XER和P6XML任务属性API，用于C#，ASP.NET应用程序" 
description: "c#.netPrimavera®项目属性读取器API读取XER，P6XML格式的任务属性，更改XER项目文件的摘要任务的分类顺序。" 
keywords: ""
...
{{< Releases/ReleasesSingleButtons text="下载" link="/tasks/net/new-releases/aspose.tasks-for-.net-22.11/23257dbaaa8f7007391a3a18c70e2c34-5-8131" >}}
...
引入了仅阅读访问Primavera＆reg的访问；特定的任务属性。现在，您可以读取“ XER”，“ P6XML”项目文件格式的任务属性。
