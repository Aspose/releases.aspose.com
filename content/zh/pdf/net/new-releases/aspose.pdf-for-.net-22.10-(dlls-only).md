...
title: "下载 --- 新版本-aspose.pdf-for-.net-22.10-(dlls-only)"
description: " "
keywords: ""
page_type: single_release_page
folder_link: "/pdf/net/new-releases/aspose.pdf-for-.net-22.10-(dlls-only)/"
folder_name: "Aspose.PDF for .NET 22.10（仅限 DLL）"
download_link: "/pdf/net/new-releases/aspose.pdf-for-.net-22.10-(dlls-only)/685f30ee8d8daa0d2c50d34dfec29b96-44-8031"
download_text: "Download"
Intro_text: "此 ZIP 文件仅包含 .NET 程序集的 Aspose.PDF。程序集与相同版本产品的 MSI 安装程序中的程序集相同。如果您想在没有 MSI 安装程序的情况下使用 Aspose.PDF，请下载此文件。"
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.PDF for .NET 22.10（仅限 DLL）" imagelink="/resources/img/zip-icon.png">}}
