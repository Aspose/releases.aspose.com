---
title: "aspose.imaging 22.10 |图像处理Java高码API" 
...
aspose.imaging Java API托管在[Aspose存储库](https://releases.aspose.com/imaging/java/)。您可以在Maven项目中直接使用Aspose.barcode使用Java API，并具有简单的配置。有关详细说明，请访问[Installing Aspose.Imaging for Java from Maven Repository](https://docs.aspose.com/imaging/java/installation/)文档页面。
