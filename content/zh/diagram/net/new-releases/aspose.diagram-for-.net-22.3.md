---
title: "将 Visio 转换为 C#、ASP.NET 应用程序的 PDF 数据图形 API"
description: "C# .NET API 更好地支持将 Visio® 中的数据图形转换为 PDF 转换，更好地处理 Microsoft Visio® 图表导出为 HTML 格式。"
keywords: ""
page_type: single_release_page
folder_link: " diagram/net/new-releases/aspose.diagram-for-.net-22.3/"
folder_name: ".NET 22.3 的 Aspose.Diagram"
download_link: " /diagram/net/new-releases/aspose.diagram-for-.net-22.3/dabe5be86e194ee5939019a01d10cdf1"
download_text: " Download"
Intro_text: "它包含 .NET 22.3 版本的 Aspose.Diagram。"
...
{{< Releases/ReleasesHeading H2txt=".NET 22.3 的 Aspose.Diagram" imagelink="/resources/img/msi-icon.png">}}
...
<h4>发行说明</h4><div><a href="https://docs.aspose.com/diagram/net/aspose-diagram-for-net-22-3-release-notes/">https://docs.aspose.com/diagram/net/aspose-diagram-for-net-22-3-release-notes/</a></div>
{{< /Releases/ReleasesFileFeatures >}}
{{< Releases/ReleasesFileFeatures >}}
...
# Visio® 中的数据图形到 PDF 转换

在以前版本的 API 中，在将 Visio® 转换为 PDF 格式时，数据图形遇到了问题。此问题现已在 API 的当前版本中得到解决。

# 将 Visio® 导出为 HTML

将 Visio® 图表导出为 HTML 格式时引发的异常现已解决。

> 有关此版本中的功能、增强功能和错误修复的完整列表，请访问 [Aspose.Diagram for .NET 22.3 Release Notes](https://docs.aspose.com/diagram/net/aspose-diagram-for-net-22-3-release-notes/)。
