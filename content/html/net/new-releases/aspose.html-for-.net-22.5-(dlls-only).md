...
title: "Downloads ---New Releases-aspose.html-for-.net-22.5-(dlls-only)"
description: " "
keywords: ""
page_type: single_release_page
folder_link: "/html/net/new-releases/aspose.html-for-.net-22.5-(dlls-only)/"
folder_name: "Aspose.HTML for .NET 22.5 (DLLs only)"
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt="Aspose.HTML for .NET 22.5 (DLLs only)" imagelink="/resources/img/zip-icon.png">}}
