---
title: "Java Visio Library | Aspose.Diagram for Java"
description: "Download Java API to create, edit or convert Visio files. Developers can create diagrams from scratch as well as easily load existing files and manipulate the elements of the diagram to export the result in other formats. "
...
homepage_package_link: "https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-diagram"
weight:  2
---
...
{{< Common/h1 text="Aspose.Diagram for Java" >}}
{{< Common/paragraph>}}
A specialized designed Java Diagram Library to work with Microsoft Visio files.

{{< Common/h2 text="Java Visio File Processor"  >}} {{< Common/ul>}}
...
{{< /Common/paragraph>}}
{{< Common/hr >}}
{{< Common/h4 text="Download Aspose.Diagram from Maven"  >}}
{{< Common/paragraph class="package-instructions">}}
You can easily use Aspose.Diagram for Java directly from a {{< Common/link href="https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-diagram" text="Maven"  >}} based project by adding following configurations to the pom.xml.
 {{< /Common/paragraph>}}
