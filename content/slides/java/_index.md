---
title: "Download Presentation Processor JAR Files | Aspose.Slides"
description: "Download JAR files to create, edit, convert PowerPoint® & OpenOffice® presentation formats. Work with slides, shapes, charts, objects, controls, & more via API."
...
## Why download Aspose.Slides for Java?

[Aspose.Slides](https://products.aspose.com/slides/java) for Java is an on-premise API to work with the Microsoft PowerPoint&reg; presentations from within your Java Apps. It allows developers to read, write, convert and manipulate PowerPoint&reg; presentations in Java applications with the ability to manipulate various document elements such as slides, tables, text, charts, shapes, images and SmartArt diagrams and more.

## PowerPoint&reg; File Manipulation via Java
...
Please checkout the [product overview](https://docs.aspose.com/slides/java/product-overview/) to know all about Aspose.Slides for Java.
