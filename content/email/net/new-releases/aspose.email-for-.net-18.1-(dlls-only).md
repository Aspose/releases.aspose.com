...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt=" Aspose.Email for .NET 18.1 (Dlls only)" imagelink="/resources/img/zip-icon.png">}}
  ...
  {{< Releases/ReleasesFileFeatures >}}
      <h4>Release Notes</h4><div><a href="https://docs.asposeptyltd.com/display/emailnet/Aspose.Email+for+.NET+18.1+Release+Notes">https://docs.asposeptyltd.com/display/emailnet/Aspose.Email+for+.NET+18.1+Release+Notes</a></div>
  {{< /Releases/ReleasesFileFeatures >}}
 {{< /Releases/ReleasesFileArea >}}
{{< /Releases/ReleasesWapper >}}
