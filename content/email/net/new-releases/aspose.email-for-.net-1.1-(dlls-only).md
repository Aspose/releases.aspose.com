---
title:  "  Downloads ---New-Releases-aspose.email-for-.net-1.1-(dlls-only) . " 
description:  "    . " 
keywords:  "    . " 
page_type:  single_release_page
folder_link: " email/net/new-releases/aspose.email-for-.net-1.1-(dlls-only)/"
folder_name: " Aspose.Email for .NET 1.1 (DLLs only)"
...
{{< Releases/ReleasesWapper >}}
  {{< Releases/ReleasesHeading H2txt=" Aspose.Email for .NET 1.1 (DLLs only)" imagelink="/resources/img/zip-icon.png">}}
