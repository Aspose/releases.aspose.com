...
- Open or save emails in Microsoft&reg; Outlook&reg; & other formats.
- Conversion of email files to various formats.
- Parse, read & save Microsoft&reg; Outlook&reg; emails, PST & OST files.
- Comprehensive support for MIME messages.
- Send & receive emails via POP3, IMAP, Microsoft&reg; Exchange Server.
...
**Microsoft&reg; Outlook&reg;:** MSG, PST, OST, OFT\
**Email:** EML, EMLX, MBOX\
**macOS&reg; Outlook:** OLM\
**iCal&reg;:** ICS\
**Virtual Card:** VCF\
**Web:** HTML, MHTML
