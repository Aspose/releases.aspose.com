...
;(function ($, window, document, undefined) {
  ...
  $(document).ready(function(){
    console.log('KKKKKKKK-1');
    setTimeout(() => {
          console.log('KKKKKKKK-2');
          ...
          if(segments.length == 4 || segments.length == 5 ){
            ...
            var element =  $( '#tree a[href*=\"'+ parentlink +'\"]' );
              ...
              if(ParentNodeId){
                console.log('ParentNodeId-2');
                ParentNodeId.addClass(' active-child dddd');
          ...
          $(".glyphicon-minus").parent().addClass(' active-child dddddd');
          console.log('glyphicon-minus-active-2');
    }, "100")
});
